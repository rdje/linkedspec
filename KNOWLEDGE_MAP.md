...
- "does the .spec parser/compiler/runtime core depend on RTLUtils or FSMGen or VHDL::ConstantEval" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "how big is the legacy VHDL/RTL/FSM generation subsystem" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "what blocks the SPEC-FORMAT-TERSE implementation leaves" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "what depends on RTLUtils FSMGen VHDL::ConstantEval" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "what is RTLUTILS-REGEX-HANG" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "where is the catastrophic regex that hangs phase0" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
...
- "why does t/phase0_regression.t hang" -> [rtlutils-regex-hang](docs/knowledge/rtlutils-regex-hang.md) · 2026-06-18 · reverify: `sed -n '746p' perl/RTLUtils.pm; git grep -lE 'RTLUtils|FSMGen|VHDL::ConstantEval' -- 'perl/LinkedSpec.pm' 'perl/LinkedSpec/'   # core ref = LinkedSpec.pm comment only (line 246); 0 functional`
