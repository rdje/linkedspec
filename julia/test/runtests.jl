...
include("standalone_lifecycle_block_contract_test.jl")
include("sexpr_document_v1_test.jl")
...
include("rule_local_cursor_contract_test.jl")
include("source_boundary_compatibility_aliases_test.jl")
include("typed_source_location_contract_test.jl")
include("recognition_transaction_contract_test.jl")
include("recursive_observation_contract_test.jl")
...
include("map_leaves_mutation_contract_test.jl")
...
include("semantic_index_call_staged_test.jl")
include("semantic_index_query_kernel_test.jl")
include("semantic_index_query_traversal_test.jl")
include("semantic_index_query_public_test.jl")
include("semantic_index_runtime_observation_test.jl")
include("semantic_index_runtime_projection_test.jl")
include("semantic_index_runtime_observation_routes_test.jl")
include("semantic_introspection_julia_admission_test.jl")
