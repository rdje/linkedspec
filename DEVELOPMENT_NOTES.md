...
- 2026-05-17 (PHASE3-EXECUTION-SEMANTICS.4): Verified BACKTRACK+parse_mode interaction already covered by .2 (source-boundary-helper-reference.md) and cross-referenced in .3 (rule-modes-and-parse-modes.md). PHASE3-EXECUTION-SEMANTICS tree COMPLETE (4 leaves). ROADMAP_V2.md Phase 3 → `done` (2026-05-17). Next: PNT to PHASE4-CAPTURE-MARK-API.1.
