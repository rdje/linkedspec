...
checkpoints resume at `.3.3.43` after `LIVE-DOCUMENT-PRESSURE-CONTAINMENT.5` compacts proven duplicate chronology. Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
