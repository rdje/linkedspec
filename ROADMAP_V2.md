...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 initially pending children / 169 exact ranges, now physically read. Dart `.1.55` completes 55/55 children, 80,297 fragments / 2,471,305 bytes. Rust Lispish integration .2.2 is pushed atad290bdb4. Perl setup .1.1 and deployment/errors .1.2 provide native values, optional Unicode diagnostics, structured failure handling and a relocatable source bundle. The updated word/module verifier passes8 groups; deployment passes15 current-checkout groups plus2 trace controls, and the complete17-group verifier passes against clean pinned source. Native resolution, diagnostic and generated-source contracts pass27 tests. Perl parent closure remains at final .7; Dart .3.1 is next. Other guides and .7 precede conformance .1.35; reading remains34/143 and84 complete files. Normal dependency builds are authorized, original nested edits are preserved and strict Lispish repair remains startup .83. Capacities remain canonical at 7d52c98e / 9c644ecb / bef5dafd under containment .8/.9/.10 and ADR0110/0111/0112; prior history and other limits remain. CI intake .80.0 is committed at eaf4331e. Director-approved .7 is implemented by containment .11 / ADR0113: exactly engineering files 27→28 and manifest lines26→27; actual211-line/24521-byte source preservation and 22-validator checks pass, with the director’s explicit September 11 one-time focused/receipt exception. Capacity is committed at ad64f76f; Dart .3.2 / ADR0114 close reading; Julia reading is closed; current Lua capacity ownership is tracked above. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` is complete under ADR0114; all repairs remain open. Repairs `.7`–`.30`, `.32`–`.47`, and
