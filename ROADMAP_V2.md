...
checkpoints resume at `.3.3.43`; `LIVE-DOCUMENT-PRESSURE-CONTAINMENT.5` removes proven duplicate chronology without changing limits. Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
