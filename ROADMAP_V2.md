...
checkpoints resume at `.3.3.38` (staged helper completion and Unicode mapping prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
