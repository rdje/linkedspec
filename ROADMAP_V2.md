...
checkpoints resume at `.3.3.2` (Rust manifests, requirements, AST and callable prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49` remain task-owned before Rust mutation setup;
