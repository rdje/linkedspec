...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, and complete Perl `.14.7.3.0-.4` are closed. The same oracle advances from its historical REDs to 143/143 and now proves native, normalized-descriptor, generated-plan, and independently loaded emitted equality under fresh host-only authority, exact phase-0/canonical admission, 78 mutations, unchanged function-body v1/generated v2, and no public/outward movement. Mandatory segment `4991` remains finitely authorized at 22/21 by ADR `0089`; Rust dormant RED `.14.7.4.0` is next. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
