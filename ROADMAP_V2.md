...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, with native admission 6/6; MCP is complete/141. Typed source is 8 complete / 6 pending and rejects 75 mutations; Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT are recorded on the still-pending recursive-observation row. Recognition transaction `.14.3` stays closed at 133 = 129+4 / 246 / 58 and rollout 9/9 with public 3/26/45 and guide 1/14/18. Shared Lua `.14.4.6` is signoff-complete for atomic 214 after 43 assertions per ABI, complete ordinary/storage and composed proof, CLI 66x2, RAM 61%, and Phase 0 1,031/1,031 in 734 seconds. Its clean commit precedes recurrence `.14.4.7`. Reversed-span remains `.14.2`-owned. Unrelated hygiene/readability and later backlog lanes remain separately owned. |
