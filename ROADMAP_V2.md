...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection is exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6. MCP is complete/141; parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 5/9 with 39 mutations; immutable Dart core landed at `f1b91426`. Projection `.14.2.3.2` gives every Dart execution one copied input authority, exposes fresh detached exact 92-row/47-30-11-4-family plus seven-alias catalogs, and routes positions/spans, coordinates, source slicing/materialization, mark/capture state, and cursor controls through that boundary while retaining all UTF-16 code-unit registers and external results. Dormant proof passes 4/4 across native/reconstructed/generated-plan carriers, focused runtime/emitted proof passes 86/86, ordinary discovery remains 379/379, and complete Dart passes format/analyzer, storage 20/47, CLI 66x2, and corpus 105/105. Neutral 5/9/39 and language coverage 246/105+1/122 remain exact because `.14.2.3.3` alone owns registration and `dart_runtime` promotion. The sole-facing book now distinguishes implemented-but-unadmitted Dart projections; its 79-file/14,164-KiB render preserves separate paragraphs/code blocks. Knowledge Map is 786/6,431, all seven doctrines pass, and definitive canonical CI passes capability 80/0/0, composed semantic/MCP admissions, containment/relocation, CLI 66x2, RAM 68%, and Phase 0 1,031/1,031 in 677 seconds before the exact pass marker. Atomic commit 155/300, brief clearing, and clean proof remain before admission. The nonurgent rendered-readability tree stays queued. `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
