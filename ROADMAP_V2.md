...
policy seams, and `.1-.4` implementation/admission order. No server behavior exists yet; `.10.9.2.1` is next. Six fixture groups now derive 20 digest-locked responses and
...
dependency order; in-process registry/dispatch `.10.9.2.1` is next.
