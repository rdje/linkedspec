...
checkpoints resume at `.3.2.48` (Trace runtime and lazy callback exception-state ownership). Repairs `.7`–`.30` and `.32`–`.44` remain task-owned before Rust mutation setup;
