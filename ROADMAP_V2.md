...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.33` completes 33/55 reading children (47,528 fragments / 1,461,186 bytes). Static projection and SHA-256 are complete; source emitter reaches 55. All 28 selected tests and neutral 6/20/128 checks pass. Eight public native compiled/index/runtime controls extend startup .70 grouped-selector evidence and own regex-arrow correlation under .2.22 with two children: four constructor failures, four valid controls and all eight runtime values correct. All earlier findings retain evidence and gates. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.34 finishes emitter, reads trace and begins validation after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
