...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141, and parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 6 complete / 8 pending / 40 mutations with Perl/Rust/Dart admitted, Julia values/projections implemented but unadmitted, and Lua pending. Immutable Julia core landed at `4d394752`; projection `.14.2.4.2` gives every execution context one copied private authority and routes all 92 canonical helpers plus seven aliases through typed scalar Position/Span conversion, validation, coordinates, slicing, marks, anonymous boundaries, and cursor controls without changing zero-based UTF-8 code-unit registers, results, mutations, schemas, or carriers. Fresh detached catalogs are 47/30/11/4 plus seven. Dormant core/projection pass 112/112 and 127/127 across native/reconstructed/generated-plan execution; aliases remain 141/141, named marks 13/13, cursor 104/104, and language 246/105+1/122. Complete Julia passes byte-fresh MCP, package, storage 19/5, CLI, corpus 105/105, and its exact marker. The sole-facing book now explains implemented-but-unadmitted Julia projections in four surfaces; its 79-file/14,176-KiB HTML keeps status paragraphs, the runnable command, and limitations separate. Knowledge Map 787/6,463, all seven doctrines, canonical CLI 66x2, RAM 64%, and Phase 0 1,031/1,031 in 680 seconds pass. Projection `.14.2.4.2` is signoff-complete for intended atomic commit 161/300; clean landing remains before admission `.14.2.4.3`. The nonurgent rendered-readability tree stays queued; `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
