...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, with native admission 6/6; MCP is complete/141. Typed source is 8 complete / 6 pending and rejects 73 mutations; Perl, Rust, and Dart are recorded on the still-pending recursive-observation row. Recognition transaction `.14.3` stays closed at 133 = 129+4 / 246 / 58 and rollout 9/9 with public 3/26/45 and guide 1/14/18. Rust recursive observation `.14.4.3` landed clean at `91a2b05c` as atomic 211; Dart `.14.4.4` completes as atomic 212 across four carriers and hands off cleanly to Julia `.14.4.5`. Reversed-span remains `.14.2`-owned. Unrelated hygiene/readability and later backlog lanes remain separately owned. |
