...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141, and parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 7 complete / 7 pending / 41 mutations with Perl/Rust/Dart/Julia admitted and PUC-Lua/LuaJIT pending. Lua audit `.14.2.5.0` proves one shared decoded-input/byte-register runtime and 92/92 canonical helper names on both ABIs, but all seven neutral compatibility aliases remain unknown and produce the exact owned unsupported-helper diagnostic. The audit therefore splits alias parity `.14.2.5.0.1` before dormant typed-source RED `.14.2.5.0.2`, with no production/test/public behavior change. Complete Lua passes 177/177 per ABI, byte-fresh MCP 83,166 bytes, CLI 66x2, corpus 105/105, and storage 17/3. The source-unchanged sole-facing book builds 79 files/14,172 KiB with separate rendered blocks; Knowledge Map 788/6,487 and all seven doctrines pass. Definitive canonical CI preserves capability 80/0/0 and typed source 7/7/41, passes CLI 66x2, reports RAM 45%, and completes Phase 0 1,031/1,031 in 672 seconds. Audit `.14.2.5.0` is signoff-complete for commit 163/300; clean landing remains before `.14.2.5.0.1`. The nonurgent rendered-readability tree stays queued; `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
