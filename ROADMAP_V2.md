...
checkpoints resume at `.3.2.41` (recognition runtime and diagnostic/logical/observation owners). Repairs `.7`–`.30` and `.32`–`.38` remain task-owned before Rust mutation setup;
