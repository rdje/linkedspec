...
checkpoints resume at `.3.3.28` (recognition runtime suffix and value runtime prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.65` remain task-owned before Rust mutation setup;
