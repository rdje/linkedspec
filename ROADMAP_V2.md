...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.28` completes 28/55 reading children (40,028 fragments / 1,248,597 bytes). Unicode mapping reaches 2689: lower mappings complete, upper mappings through U+A76F. Fresh generation byte-compares the neutral artifact and all five modules and passes twelve independent fixtures; .1.27/dfc57ce1 retains the 33-test Dart runtime and seventeen provenance-control evidence by exact source identity. No new defect is established. All Dart .2.1-.2.19 and startup findings remain owned and gated, including staged resource and malformed-provenance repairs. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.29 finishes Unicode mapping, reads scaffold and begins semantic call projection after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
