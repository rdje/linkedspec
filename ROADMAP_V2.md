...
compiled identity across artifact/runtime routes, and passes one exact 15-role consumer. Governance is 3 complete
+ 4 pending / 31 mutations; preserving-backend locks `.4-.6` precede recurring/public `.7`.
...
Neutral decision `.1` plus Perl/Rust repairs `.2-.3` are now complete; preserving-backend locks `.4-.6` and
recurring/public admission `.7` remain ordered before public cursor closeout.
