...
checkpoints resume at `.3.3.30` (RuntimeContext completion and semantic index/call projection prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.65` remain task-owned before Rust mutation setup;
