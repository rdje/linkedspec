...
checkpoints resume at `.3.3.32` (semantic query completion and runtime/static projection). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.67` remain task-owned before Rust mutation setup;
