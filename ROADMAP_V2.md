...
checkpoints resume at `.3.3.36` (spec-parser completion and staged-enrichment prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.72` remain task-owned before Rust mutation setup;
