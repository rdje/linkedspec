...
incomplete. Twenty Perl files are read; `.3.2.16` reads ActionIR/AST/Parser.pm 1–1498 next.
Repairs `.7`–`.14` (cleanup, comparison, regex, inputs, diagnostics, edge identity/order, I-block/REP literals/state)
