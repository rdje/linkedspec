...
Director-requested [backend integration guides](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) are the next temporary activity after clean conformance .1.34. Common checkout/version/setup guidance and five native consumer guides will verify dependency preparation and reuse, API/results/errors, grammar packaging and outside-cwd use. The director authorizes this documentation activity before the remaining startup reading; complete it and resume conformance .1.35. ADR0040 keeps one canonical content owner and links the eventual companions. No guide or consumer is claimed implemented by this intake.
