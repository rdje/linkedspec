...
checkpoints resume at `.3.3.39` (Unicode lower-map completion and upper-map prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
