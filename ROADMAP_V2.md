...
checkpoints resume at `.3.2.51` (upper-table tail, contextual properties, and scalar evaluator). Repairs `.7`–`.30` and `.32`–`.44` remain task-owned before Rust mutation setup;
