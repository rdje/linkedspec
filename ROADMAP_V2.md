...
checkpoints resume at `.3.3.29` (RuntimeContext bindings and helper continuation). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.65` remain task-owned before Rust mutation setup;
