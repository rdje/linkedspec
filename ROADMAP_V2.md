...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.24` completes 24/55 reading children (34,028 fragments / 1,079,144 bytes), with 58 selected tests passing. Recognition, semantic observation and source location are fully read; staged entry reaches 306. No new runtime defect is established; .2.1-.2.16 and startup owners retain their evidence. The director approved engineering-history intake `.5`. Containment `.9` and ADR0111 admit exactly files 26→27 and manifest lines 25→26 with all byte limits unchanged. Actual clean-source rollover preserves 207 lines / 32,348 bytes; complete history reconstruction and 22 validator executions pass. Exact staged canonical proof governs landing; then `.1.25` continues staged execution from line 307. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
