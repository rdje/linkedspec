...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, complete Perl `.14.7.3.0-.4`, and Rust `.14.7.4.0-.4` are closed. The Perl oracle is 143/143 across native, normalized-descriptor, generated-plan, and independently loaded emitted fresh-authority routes with exact phase-0/canonical admission. Rust's inert detached marker and typed direct/ordered-derived provenance feed a private caller-frozen already-compiled registry with pure resolution/cache, isolated current-depth policies, breadth-first recurrence, exact cycle/strict-decrease chains, shared cancellation/resources, expiring callback safe points, and original-source rebasing. Its host-only seed constructs fresh authority for native, reconstructed, validated generated-plan, and independently compiled emitted routes after the complete parent result; the exact consumer is admitted in ordinary/canonical topology. Neutral governance rejects 84 mutations and promotes only Perl plus Rust; function-body v1/generated v2 and public/outward behavior remain unchanged. Dart `.14.7.5.0` is next. Mandatory segment `4991` remains finitely authorized at 22/21 by ADR `0089`. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
