...
diagnostics. Live slice `.9.1.3.2` makes normal Perl rules spend those policies independently and preserves the
staged descriptor/generated-v1 boundary. Descriptor projection `.9.1.3.3` follows after the clean commit;
