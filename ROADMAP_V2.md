...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection is exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6. MCP is complete/141; parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 5/9 with 39 mutations; Rust admission landed at `666751ae`, Dart alias parity at `7b76af71`, and dormant Dart RED at `58f4bb85`. Immutable core `.14.2.3.1` now adds one copied decoded-source authority with opaque identity and scalar-boundary UTF-16, line/column, and UTF-8-byte tables plus detached positions, spans, and ordered derived text. Core 2/2 passes exact 3/7/6/3 values and four private errors; fatal analysis and ordinary 379 stay green; full dormant execution passes 3/4 and fails only at absent `.2` projection API `typedSourceProjectionRows`. Complete Dart format 98/0, storage 20/47, CLI 66x2, corpus 105/105, language coverage 246/105/122, neutral 5/9/39, source-unchanged sole-facing mdBook 79/14,152 KiB with separate rendered blocks, and Knowledge Map 786/6,427 pass. No engine/helper route, UTF-16 register, external result, public-book behavior, schema/identity, semantic/MCP/capability state, DSL, root README, rollout row, or other backend moves. All seven doctrines and definitive canonical CI pass capability 80/0/0, composed semantic/MCP admissions, containment/relocation, CLI 66x2, RAM 61%, and Phase 0 1,031/1,031 in 686 seconds. Clean commit 154/300 remains before projection `.14.2.3.2`. The nonurgent rendered-readability tree stays queued. `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
