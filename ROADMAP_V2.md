...
1,031/656 s pass. Exact dual-ABI admission `.10.7.7` is active task-tree-first from clean `17348041`; one unchanged
twelve-role Lua source, identical PUC Lua/LuaJIT topology, nine mutations, and Lua-only promotion are frozen before
implementation. Governance remains 6/20/89 at 5/9 + 4/6.
