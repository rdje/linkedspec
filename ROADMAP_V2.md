...
contract. Native implementations remain `.10.9.2-.7`; Perl is next. Six fixture groups now derive 20 digest-locked responses and
...
ADR `0055`; native Perl implementation `.10.9.2` is next.
