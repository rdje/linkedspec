...
checkpoints resume at `.3.3.34` (source emitter completion and typed source-location prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.70` remain task-owned before Rust mutation setup;
