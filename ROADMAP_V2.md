...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability remains 80/0/0; semantic introspection remains closed at 9/0/128; typed source is 10/4/126 with recursive observation and lossless-gap composition current on all six runtimes. `.14.5.1` is canonical-signoff-complete for atomic 256 after nine doctrines, containment/relocation, CLI 66x2, RAM 51%, Phase 0 1,031/1,031 in 729 seconds, and exact opt-in proof; parent `.14.5` closes. Lua storage remains 19 owners / three dual-ABI native modules. Progressive `.14.6`, staged `.14.7`, final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
