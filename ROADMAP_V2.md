...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.31` completes 31/55 reading children (44,528 fragments / 1,372,913 bytes). Semantic index is complete and query reaches 668. All 18 selected tests and neutral 6/20/128 checks pass. Eight native raw-query controls own rejection response detachment/encoding under .2.21 with two children: four non-JSON defective cases and four detached JSON controls. No MCP defect is inferred; all Dart .2.1-.2.20 and earlier startup findings retain evidence and gates. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.32 finishes query, reads runtime projection and begins static projection after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
