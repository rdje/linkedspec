...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, with native admission 6/6; MCP is complete/141. Typed source is 8 complete / 6 pending and rejects 74 mutations; Perl, Rust, Dart, and Julia are recorded on the still-pending recursive-observation row. Recognition transaction `.14.3` stays closed at 133 = 129+4 / 246 / 58 and rollout 9/9 with public 3/26/45 and guide 1/14/18. Dart recursive observation `.14.4.4` landed clean at `b1895a05` as atomic 212; Julia `.14.4.5` is signoff-complete for atomic 213 after exact containment/relocation, CLI 66x2, RAM 60%, Phase 0 1,031/1,031 in 725 seconds, and the six-runtime typed-source opt-in. Its clean commit must precede shared Lua `.14.4.6`. Reversed-span remains `.14.2`-owned. Unrelated hygiene/readability and later backlog lanes remain separately owned. |
