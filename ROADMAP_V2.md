...
General staged-AST enrichment is privately complete and admitted on all five source backends/six runtime routes.
...
all-pass private capability row at 17/85. Public authoring `.9` and final recomposition `.10` follow.
...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Capability is 85/0/0; semantic introspection is closed at 9/0/128; typed source is 13/1/187. Progressive private six-runtime admission, recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit/diagnostic/neutral `.14.7.0-.2`, complete private Perl `.3`, Rust `.4`, Dart `.5`, Julia `.6`, shared Lua `.7`, and exact five-source/six-route recurrence `.8` are closed. Staged neutral governance is 123 mutations; generated v2, function-body v1, and public/outward behavior remain unchanged. Mandatory change-history segment `4989` is finitely authorized at 24/23 by ADR `0093`; mandatory engineering-notes segment `4989` is separately authorized at 19/18 by ADR `0092`. Public `.9` is next; recomposition `.10`, final `.14.8`, reversed-span, and unrelated hygiene/readability remain separately owned. |
