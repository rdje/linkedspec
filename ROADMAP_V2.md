...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, and neutral authority `.2` are closed. Perl dormant `.14.7.3.0` now proves 60 GREEN neutral/v1 assertions and one missing-marker RED without production, route, rollout, or public movement; mandatory segment `4991` is finitely authorized at 22/21 by ADR `0089`; `.3.1` owns the private annotation/provenance carrier next. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
