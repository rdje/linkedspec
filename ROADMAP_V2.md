...
checkpoints resume at `.3.3.6` (expression parsing and typed write mutation boundaries). Repairs `.7`–`.30`, `.32`–`.47`, and `.49` remain task-owned before Rust mutation setup;
