...
checkpoints resume at `.3.3.12` (remaining validation, descriptors and cursor test prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.55` remain task-owned before Rust mutation setup;
