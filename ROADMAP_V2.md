...
remains non-vivifying/non-bang; `.19.6.1` is next.
...
Julia `.19.5.2` now implements the bang half with 496 focused assertions across its supported routes. Both Lua
mechanisms and portable/public admission remain pending; Lua nested-write `.19.6.1` is next.
