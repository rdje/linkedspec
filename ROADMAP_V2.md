...
| Inter-match gap capture | `active; Julia .5.5 and parent .5 canonical-signoff-complete for intended atomic 245` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | Perl, Rust, Dart, and Julia are privately admitted at governance 5/4/58. Julia `.5.1-.5.5` carries exact authored/static/compiled provenance, private same-recognition-authority native state/lifecycle, normalized reconstruction, compatible descriptors, same-engine generated-v2 and independently loaded emitted proof, plus existing-primary/nine-role admission. Storage remains exactly 20/5 with cleanup; loaded/inline identity, legacy descriptors/refs, exact 246 supported ActionIR names, and format 2 `{label,family}` plans remain unchanged. Both Lua runtimes and public rows remain pending. Recognition stays 137/246/58, public helpers 122, and typed source 9/5/114. |
