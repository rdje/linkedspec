...
Director-requested [backend integration guides](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) are complete under final .7. One common entry and five guides own pinned checkout, native setup/use, direct values, typed failures, diagnostics and relocatable packaging. Independent final replay passes Perl 8 / 17, Dart 9 / 36, Julia 11 / 24 and both Lua runtimes 13 / 24 setup/deployment groups, nine own-workspace Rust controls, public RGX preparation/native reuse and 18 Lispish file groups. Six current runtime routes agree on 24 direct word values; retained native products are unchanged. RGX alone owns transitive preparation; no dependency internals, pins or runtime semantics are changed. Ten ARCHOGEN/SEMULITH reports retain exact dispositions: workspace/prerequisite remedies are verified; strict Lispish .83 and the upstream progress-message report remain open. The known managed-wrapper warning remains startup .7-owned, and minimum-version/platform/malformed-regex exclusions remain explicit. Integration 87b35665e is cleanly committed and pushed after canonical CI. Reading .1.89 records109,904 fragments /4,784,266 baseline bytes and preserves the pinned113-byte current delta; ADR0122/containment .15 remain admitted at ec10be6b. Seven trace/typed-projection consumers pass27 top-level/402 nested results. Existing .2.16 now owns eleven process helpers; new .2.19 owns a source assertion that crosses handler boundaries. Source-pinned controls distinguish test gaps from production behavior. The separate audit retains .1.90 as its next range; current frontier is SEXPR-DOCUMENT-INTEGRATION.2 for independent admission of the verified grammar and native file consumer under ADR0123, with genuine technical prerequisites retained. Helper path .2.3 and stale Phase0 header .2.4 retain repair prerequisites. ADR0040 keeps one content owner per topic; future companion books link these guides.
