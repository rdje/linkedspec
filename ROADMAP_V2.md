...
checkpoints resume at `.3.3.10` (parser tests, core trace and compiled-type prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.54` remain task-owned before Rust mutation setup;
