...
only; Rust/Dart/Julia/Lua remain non-vivifying. Perl `map_leaves!` `.19.2.2` is now complete, and Rust nested-write
implementation `.19.3.1` is next.
...
mutations, and Phase 0 1,032/1,032. Rust nested writes `.19.3.1` follow.
