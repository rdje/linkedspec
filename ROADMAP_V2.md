...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.19` completes 19/55 reading children (26,528 fragments / 865,657 bytes), with 122 selected tests passing. Nine native/reconstructed controls plus nine Perl comparisons own hash splice pairing/order repair under .2.11 alongside FUTURE-PARITY-BACKLOG.5; .2.1-.2.10 and startup .37 retain earlier repairs. Next `.1.20` finishes action-child dispatch and reads supporting value helpers. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
