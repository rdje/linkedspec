...
| Inter-match gap capture | `active; Perl .2.4 and parent .2 signoff-complete for intended atomic 226` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | `.2.4` registers the full 124-test Perl consumer once in ordinary CI and once in the rooted neutral-first route, promotes only `perl_runtime`, and advances governance to 2 complete / 7 pending / 56 mutations. Final canonical signoff passes Phase 0 1,031/1,031 in 765 seconds and exact neutral-plus-Perl routing. Five later runtime routes and both public rows remain pending. Recognition remains 137/246/58, language remains 122 public helpers, typed source remains 9/5/114, generated plan v2 is unchanged, and the ten outward surfaces remain guarded. Rust `.3` is next after atomic 226 lands cleanly. |
