...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, with native admission 6/6; MCP is complete/141. Typed source remains 8 complete / 6 pending and now rejects 70 mutations. Recognition transaction `.14.3` is clean-closed at 132/246/58 and rollout 9/9 with public 3/26/45 and guide 1/14/18. From clean lineage commit `53c687d3`, executable neutral `.14.4.1` selects future `observe_recognition(observation, call(Child))`, a separate detached nine-field harray, and 33 transitions for entry/match/accepted-exit/outcomes/rejection/detach/child policy. No backend/runtime/public/schema/CLI/README behavior or rollout row moves; complete signoff is green and atomic 209 is commit-ready before Perl `.2`. Reversed-span remains `.14.2`-owned. Unrelated hygiene/readability and later backlog lanes remain separately owned. |
