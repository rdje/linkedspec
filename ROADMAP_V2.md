...
checkpoints resume at `.3.3.42` (callable contract completion, named marks and corpus prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
