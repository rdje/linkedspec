...
| Inter-match gap capture | `active; Julia authored metadata .5.1 signoff-complete for intended atomic 241` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | Perl, Rust, and Dart are privately admitted at governance 4/5/57. Julia `.5.1` now carries defaulted logical source identity, pinned-Unicode named/anonymous declarations, unindexed/numeric/named selector provenance, dedicated directive validation, exact source-aware diagnostics, and compiled slot/directive/five-field edge metadata behind ten dormancy mutations. Absolute loaded requests retain path opacity through logical basenames; legacy descriptors/references and generated format 2 `{label,family}` remain unchanged. Native `.5.2`, reconstructed/descriptor/generated `.5.3`, emitted `.5.4`, and primary/admission `.5.5` remain pending, as do Lua and public rows. Recognition stays 137/246/58, public helpers 122, and typed source 9/5/114. |
