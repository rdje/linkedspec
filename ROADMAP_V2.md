...
checkpoints resume at `.3.3.27` (primary CLI suffix and recognition transaction prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.65` remain task-owned before Rust mutation setup;
