...
contracts are frozen without public admission. Perl `.19.2.1-.2` and Rust `.19.3.1-.2` implement both unchanged
...
portable capability admission `.19.7` advances the current census to 100/0/0, and `.19.8` completes exact
six-runtime recurrence with 17 topology mutations; public-current no-drift plus parent closeout remain `.19.9`.
...
`.19.7` adds two exact rows at current census 100/0/0, and `.19.8` completes exact six-runtime recurrence; public
closeout `.19.9` remains.
