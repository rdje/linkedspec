...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141. Typed-source rollout remains 7 complete / 7 pending / 41 mutations because PUC-Lua/LuaJIT admission remains `.14.2.5.3`. Projection `.14.2.5.2` now gives each shared Lua execution input one copied private authority and routes exact 92+7 helpers through typed positions/spans while preserving UTF-8-byte registers, values, and mutation timing. Core 133/133 and projection 240/240 pass on both ABIs across native/reconstructed/generated-plan routes; aliases remain 638/638 with loaded/emitted proof. Complete Lua passes 177/177 per ABI, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, and language 246/105+1/122. Sole-facing book, Knowledge, task, memory, and live projections are synchronized; book 79/14,188, Knowledge 789/6,504, all doctrines, and definitive canonical containment/relocation, CLI 66x2, RAM 65%, and Phase 0 1,031/1,031 in 662 seconds pass. Atomic commit 167/300 remains. The nonurgent rendered-readability tree stays queued; `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
