...
exclusion-freshness plan `.24.0` is signoff-complete after classifying all four records: retain plugin legacy, move valid future parse-job
ownership from superseded `.2` to active `.14`, and remove satisfied semantic/cursor records later. Schema-v2
disposition/retention/status governance plus 24 mutations is frozen; `.24.0.1-.2` repair `.2` provenance/ownership
and the sole-facing callable 24→25 count before `.24.1-.2` implement and close. Capability rows stay 80/0/0;
...
646 seconds pass. Schema-v2 implementation `.24.1` follows after clean landing.
