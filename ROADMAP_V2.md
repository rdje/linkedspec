...
checkpoints resume at `.3.3.7` (callable literal postfix parsing and expression tests). Repairs `.7`–`.30`, `.32`–`.47`, and `.49` remain task-owned before Rust mutation setup;
