...
5x2x66, ten Unicode legs, every ledger, book/KM/doctrines, canonical CI, and safe cleanup; Unicode plan
`.10.7.1.0` is next after the clean audit commit.
