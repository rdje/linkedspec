...
checkpoints resume at `.3.3.41` (Unicode evaluator and callable-codeblock contract prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.75` remain task-owned before Rust mutation setup;
