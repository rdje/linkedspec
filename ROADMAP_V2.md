...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.27` completes 27/55 reading children (38,528 fragments / 1,209,661 bytes), with 33 selected tests and Unicode generation/12 neutral fixtures passing. Both staged runtime modules are fully read; Unicode case mapping reaches 1189. Seventeen private/neutral validator controls confirm six malformed provenance acceptances and eleven agreeing controls; .2.19 and two repair children own strict original-type validation and actual-entrypoint/carrier proof behind startup gates. All earlier Dart .2.1-.2.18 findings, including diagnostic-byte overruns and call-count wrap, remain owned. No ordinary authored or other-backend runtime failure is inferred. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.28 continues Unicode case mapping from 1190 after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
