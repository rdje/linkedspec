...
checkpoints resume at `.3.2.52` (generated XID-Continue table and rule-label authority). Repairs `.7`–`.30` and `.32`–`.44` remain task-owned before Rust mutation setup;
