...
freezes exact static 6/6 -> typed 18/16 -> staged/generated 22/25 ownership, merged authored definition order, typed/staged
integrity, occurrence-safe Unicode source correlation, registry-before-helper resolution, retained generated-v2
plan authority, and no-execution/host/privacy fences. Typed core `.10.7.4.1` is next.
