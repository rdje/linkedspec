...
committed clean at `3a38338d`; dynamic invocation `.11.6.2` is signoff-complete from that boundary and awaits
only its workflow commit and clean-boundary proof before `.11.6.3` activation.
