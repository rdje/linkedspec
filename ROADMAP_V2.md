...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection is exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6. MCP is complete/141; parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout is 6 complete / 8 pending with 40 mutations: Perl, Rust, and Dart internal values/projections are admitted; Julia and both Lua ABIs remain pending. Dart projection landed at `3513508a`; admission `.14.2.3.3` moves its unchanged four-test consumer into ordinary discovery, requires its exact repository-wrapped canonical target, and promotes only `dart_runtime`. Focused 4/4 and complete Dart format 98/0, fatal analysis, ordinary 383, storage 20/47, CLI 66x2, and corpus 105/105 pass without production, register, result, schema, semantic/MCP/capability, DSL, README, or other-backend change. The sole-facing book now reports admitted internal Perl/Rust/Dart support while keeping public typed values and transactions future; its 79-file/14,164-KiB render preserves separate paragraphs and command blocks. Knowledge Map is 786/6,432 and all seven doctrines pass. Definitive canonical CI passes capability 80/0/0, typed Perl 10 plus Rust/Dart 4/4, composed semantic/MCP admissions, containment/relocation, CLI 66x2, RAM 73%, and Phase 0 1,031/1,031 in 685 seconds. Atomic commit 156/300 remains before task-tree-first Julia `.14.2.4.0`. The nonurgent rendered-readability tree stays queued. `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
