...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, complete Perl `.14.7.3.0-.4`, Rust `.14.7.4.0-.4`, and Dart `.14.7.5.0-.4` are closed. The Perl oracle is 143/143 across native, normalized-descriptor, generated-plan, and independently loaded emitted fresh-authority routes with exact phase-0/canonical admission. Rust and Dart now admit equivalent complete private authority and fresh native, reconstructed, generated-plan, and emitted carriers. Dart's inert live-proven marker, caller-frozen recursive engine, complete-depth target reservation, and host-only post-parent seed pass 19/19; ordinary Dart is 435/435 and canonical CI requires/invokes the final-path consumer once. Neutral governance rejects 90 mutations and promotes Perl, Rust, and Dart; function-body v1/generated v2 and public/outward behavior remain unchanged. Julia `.14.7.6.0` is next. Mandatory segment `4990` is finitely authorized at 23/22 by ADR `0091`. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
