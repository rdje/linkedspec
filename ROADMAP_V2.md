...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141. Typed-source `.14.2` is composition-closed at 8 complete / 6 pending / 53 mutations. Recognition transactions remain 132 node rows / 246 calls / 44 semantic mutations with neutral + Perl + Rust + Dart + Julia admitted at rollout 5/9; public governance is 3/17/33, guide 1/8/12, Rust registration 8, Dart registration/privacy 13, and Julia registration/privacy 14. Lua RED `.14.3.6.0` landed as atomic 201 at `6a8ec091`; private authority `.14.3.6.1` passes 187/187 on both PUC Lua and LuaJIT with one shared unexported module, while integration stops only at missing dedicated ActionIR nodes. Twelve dormant and 22 authority mutations lock no discovery/export/ABI/rollout movement. Ordinary Lua stays 177/177 per ABI, CLI 66x2, corpus 105, storage 18/3, book 79/14,412 KiB, KM 816/6,772, all doctrines, RAM 82%, and canonical Phase 0 1,031/1,031 in 753 seconds pass; atomic 202 is commit-ready. Integration `.14.3.6.2`, Lua admission, recurring composition, and final public no-drift remain RED. Reversed-span stays `.14.2`-owned; `.14.8` retains final no-drift; unrelated hygiene/readability and later backlog lanes remain separately owned. |
