...
checkpoints resume at `.3.3.65`; `LIVE-DOCUMENT-PRESSURE-CONTAINMENT.6` consolidates chronology under unchanged limits, and `.7` owns later Dart admission capacity. Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.79` remain task-owned before Rust mutation setup;
