...
diagnostic. Exploratory code is removed and rollout remains pending. Recommended all-twenty `.1.1` now requires a
director-approved neutral contract plus five-server policy repair; preserving current transport bytes would weaken
the claim to 17 identities plus three boundary outcomes. No-change `.2` remains dependency-ordered after repair.
