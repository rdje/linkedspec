...
checkpoints resume at `.3.2.34` (binding / callable / codeblock / gap runtime and MCP header). Repairs `.7`–`.30` and `.32`–`.34` remain task-owned before Rust mutation setup;
