...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141, and parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 6 complete / 8 pending / 40 mutations with Perl/Rust/Dart admitted and Julia/Lua pending. Julia alias leaf `.14.2.4.0.1` starts from clean `57c62ce4` and adds one exact seven-row known-name/canonical adapter without widening the common 246 names or adding typed values. RED is 0/7 known and 7/7 unsupported; GREEN is 141/141 across Unicode, boundary, named-map, diagnostic, and native/loaded/reconstructed/generated/emitted routes. Complete Julia passes package, storage 19/5, CLI, corpus 105/105, and its exact marker; language remains 246/105+1/122 and neutral/capability stay unchanged. The sole-facing book now includes Julia in the seven callable aliases while explicitly leaving Julia typed values/projections pending; its 79-file/14,168-KiB render preserves separate blocks and is removed. Knowledge Map remains 787/6,450 and all seven doctrines pass. Definitive canonical CI passes typed Perl 10 plus Rust/Dart 4/4, composed semantic/MCP, containment/relocation, CLI 66x2, RAM 66%, and Phase 0 1,031/1,031 in 700 seconds before its exact marker. Atomic commit 158/300 remains before dormant typed RED `.14.2.4.0.2`. The nonurgent rendered-readability tree stays queued; `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
