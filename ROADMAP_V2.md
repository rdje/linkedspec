...
| Inter-match gap capture | `active; Rust behavior-free .3.0 signoff-complete for intended atomic 227` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | Perl parent `.2` landed at `eceb15ac`; the full 124-test private consumer runs once ordinarily and once in the rooted neutral-first route at governance 2/7/56. From that clean boundary, `.3.0` reproduces current Rust numeric-only/unknown-directive/helper behavior and signoff-completely assigns `.3.1-.3.5` to authored metadata, native same-authority state, reconstruction/generated plan, repository-local emitted proof, and final primary/admission without behavior movement. `.3.1` waits for atomic-227 clean proof. Five later runtime routes and both public rows remain pending. Recognition remains 137/246/58, language 122 public helpers, typed source 9/5/114, generated plan v2 unchanged, and all outward surfaces guarded. |
