...
or backend behavior. Capacity is composition-closed. Julia `.14.6.5.0` now freezes an exact 55-pass/one-RED
consumer and assigns private authority `.1`, dormant carriers `.2`, canonical admission `.3`, and independent
recomposition `.4`; `.1` is next.
