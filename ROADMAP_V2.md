...
checkpoints resume at `.3.3.37` (staged recursive execution and validation helpers). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.72` remain task-owned before Rust mutation setup;
