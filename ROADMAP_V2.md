...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, with native admission 6/6; MCP is complete/141; typed source is composition-closed at 8 complete / 6 pending / 53 mutations. Lua admission `.14.3.6.3` is signoff-complete after atomics 201-203 landed through `70b4ed04`; the unchanged 243-assertion source runs exactly once per ABI in ordinary and canonical proof. Recognition is now 132/246/46 at rollout 7/9; public governance is 3/20/38, guide governance 1/10/14, and Lua admission rejects 22 mutations beside retained authority 22 and integration 19. Both modules remain unexported. Recurring composition `.14.3.7` and public no-drift `.14.3.8` remain RED; reversed-span remains `.14.2`-owned. Unrelated hygiene/readability and later backlog lanes remain separately owned. |
