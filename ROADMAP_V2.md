...
checkpoints resume at `.3.3.44` after `LIVE-DOCUMENT-PRESSURE-CONTAINMENT.6` restores task capacity under unchanged limits. Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.76` remain task-owned before Rust mutation setup;
