...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity remains 80/0/0; semantic introspection remains closed at 128 mutations, rollout 9/9; typed source remains 9 complete / 5 pending / 114 mutations and recursive observation stays closed on all six runtimes. Inter-match gap recurring admission `.7.1` is canonical-signoff-complete from atomic 252 `be240c14` at 8/1/61: neutral plus all six private runtimes execute in one current gate, with ten Rust, ten Dart, ten Julia, and sixteen Lua admission mutations. Public language/no-drift `.7.2` is next; `.14.5.1` promotes typed `gap_composition` only after gap closeout. Lua storage remains 19 owners / three dual-ABI native modules. Reversed-span and unrelated hygiene/readability and later backlog lanes remain separately owned. |
...
| Inter-match gap capture | `active; .7.1 canonical-signoff-complete from clean atomic 252 be240c14; .7.2 next` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | Recurring proof is current at 8/1/61. `.7.1` promotes only `recurring`, adds `recurring_regression`, preserves the exact neutral/Perl/Rust/Dart/Julia/PUC-Lua/LuaJIT route, and changes five governed markers to recurring-current/public-pending. `.7.2` owns public language/compatibility/no-drift at shared calls 250, public Perl 126, gap 9/0/63 and public 6/12/10/29; `.7.3` is independent no-change closeout and typed-source handoff. Format 2, storage 19/three native modules, calls 246/public Perl 122, recognition 137/246/58, facades/schemas/MCP/CLI/README/capability, and typed source 9/5/114 remain unchanged in `.7.1`. |
