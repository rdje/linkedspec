...
root-semantics cleanup `.19.3.3` is next, while Dart/Julia/Lua remain non-vivifying/non-bang.
...
state tests, and the unchanged 167 base + 592 composition oracle; `.19.3.3` follows.
