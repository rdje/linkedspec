...
checkpoints resume at `.3.3.35` (source-location completion, loader and spec-parser prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.72` remain task-owned before Rust mutation setup;
