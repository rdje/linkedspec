...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.30` completes 30/55 reading children (43,028 fragments / 1,329,169 bytes). Call projection is complete and semantic index reaches 399. All 28 semantic tests and neutral 6/20/128 checks pass. Nine public-query/typed-runtime controls reproduce Dart array-call omission under startup .67 and own regex source miscorrelation under .2.20 with two children; seven valid/arity-rejection controls preserve the distinct scope. All Dart .2.1-.2.19 and earlier startup findings retain evidence and gates. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.31 completes semantic index and begins query after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
