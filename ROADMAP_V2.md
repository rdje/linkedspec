...
checkpoints resume at `.3.3.13` (core integration tests, runtime entry and bounded-child authority). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.57` remain task-owned before Rust mutation setup;
