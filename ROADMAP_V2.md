...
rollout/admission remain unchanged; no-change query closeout `.10.6.5.4` is next after the clean commit.
Full primary 5x2x66, ten Unicode legs, canonical Rust 79.96s + Dart 1/1 + primary 66x2 + Phase 0 1,031/634s,
mdBook/KM 690/5,307, doctrines, and exact 1,613,820-KiB cleanup preserving 517 Pgen artifacts pass.
