...
reject 50 mutations; staged payload/job/result records are explicitly separate from generated artifacts. Neutral
...
execution, records, queries, or admission. Static projection `.10.3.2` waits for its clean commit; `.10.3.3-.10.3.6`
