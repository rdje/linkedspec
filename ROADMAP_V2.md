...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.26` completes 26/55 reading children (37,028 fragments / 1,170,180 bytes), with 44 selected tests and staged neutral 123/129 mutations passing. Staged enrichment reaches 3306. Eleven private scheduler controls confirm retained diagnostic-byte overruns (.2.17) and signed-maximum call-count wrap (.2.18), with seven ordinary/boundary controls; seven new repair nodes own contract/accounting, implementation and carrier closeout behind startup gates. Prior Dart .2.1-.2.16 and startup evidence remains intact; no other-backend or fresh production-carrier failure is inferred. The approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.27 finishes staged enrichment, reads staged_parse_job and begins Unicode case mapping after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
