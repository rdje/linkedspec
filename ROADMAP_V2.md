...
closes parent `.23`. Future-only nested-write `.19.1.1`, receiver-mutation `.19.1.2`, and shared strict composition
`.19.1.3` contracts are frozen without backend admission; Perl implementation `.19.2.1` is next.
