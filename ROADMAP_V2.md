...
Semantic-introspection design `.10.1` accepts ADR `0049` before behavior. The planned
...
compile, path, traversal, or explanation semantics. `.10.2-.10.10` split neutral, all backends/ABIs, recurring,
MCP, and public rollout; `.10.2` is next and `.10.1` changes no current behavior.
