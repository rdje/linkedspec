...
closes parent `.23`. The next roadmap-aligned implementation frontier is `.19.1.1`.
...
The checker covers 5/7/11/16/3/3 cases and rejects 105 mutations. `.19.1.2` next freezes the separate
`map_leaves!` contract.
