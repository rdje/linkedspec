...
portable capability admission `.19.7` advances the current census to 100/0/0, recurring proof remains `.19.8`,
and public-current no-drift plus parent closeout remain `.19.9`.
...
`.19.7` adds two exact rows at current census 100/0/0; recurrence `.19.8` and public closeout `.19.9` remain.
