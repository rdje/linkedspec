...
checkpoints resume at `.3.3.31` (semantic call projection completion and query prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.66` remain task-owned before Rust mutation setup;
