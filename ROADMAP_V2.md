...
checkpoints resume at `.3.3.14` (bounded-child suffix, diagnostics, and engine entry). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.57` remain task-owned before Rust mutation setup;
