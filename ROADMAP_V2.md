...
| Future parity backlog | `in progress` | Deferred/future lanes after the closed language-reference, terse-format, and five-backend implementation trees: staged parsing, function extensions, helper caveats, plugin fate, richer oracle candidates, spec-derived parser/stimuli validation, AND/OR edge-default design, deep semantic introspection with MCP projection, generic first-class codeblocks, compatibility retirement, toolbox reliability, structural/progressive/staged authoring closure, the Unicode structured-text program, and explicit Rust mutation campaigns. | Five-backend capability parity is 80/0/0. Semantic introspection remains exact at six fixture groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141, and parents `.10`, `.11`, `.14.1`, and `.24` are closed. Typed-source rollout remains 7 complete / 7 pending / 41 mutations with Perl/Rust/Dart/Julia admitted and PUC-Lua/LuaJIT pending. Dormant Lua RED landed at `1136b1f2`; immutable core `.14.2.5.1` now adds one private shared copied-source authority, scalar/UTF-8-byte/line/column tables, opaque immutable Position/Span/DerivedText values, detached records, ordered materialization, and four private diagnostics. Core mode passes 133/133 on both ABIs; projection mode stops only at missing `typed_source_projection_rows`, so helper routing and admission remain `.2-.3`. Complete Lua remains 177/177 per ABI, aliases 638/638, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, language 246/105+1/122, and Knowledge 789/6,504. Four synchronized sole-facing book pages distinguish implemented private core from pending routing/admission; their 79-file/14,180-KiB render uses separate blocks. The stale storage fact now records the executable 18-owner census without behavior change. All seven doctrines and definitive canonical containment/relocation, CLI 66x2, RAM 65%, and Phase 0 1,031/1,031 in 672 seconds pass. Atomic commit 166/300 remains before `.14.2.5.2`. The nonurgent rendered-readability tree stays queued; `.22`, `.23`, format/inter-match work, manual mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
