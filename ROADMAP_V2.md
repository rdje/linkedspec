...
and exposes the portable diagnostic envelope. An explicit legacy compact-pipe runtime adapter preserves the
pre-`.2` execution boundary; `.2-.6` still own live policy, descriptor v1, generated v2, option/CLI removal, and
admission.
