...
| Inter-match gap capture | `active; Dart carrier .4.3 signoff-complete for intended atomic 237` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | Perl and Rust are privately admitted at governance 3/6/56 plus ten Rust admission mutations. Dart `.4.1-.4.3` now supply authored/static/compiled identity, private same-authority native execution, normalized reconstruction, separate compatible descriptor projections, and direct/traced generated execution with typed failure preservation. The consumer remains dormant and ten Dart mutations lock no admission. Emitted `.4.4` and primary/admission `.4.5` remain pending. Four later runtime routes and both public rows remain pending. Recognition stays 137/246/58, public helpers 122, typed source 9/5/114, generated plan v2 and legacy descriptor/reference fields unchanged, and outward surfaces guarded. |
