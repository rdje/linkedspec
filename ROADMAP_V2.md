...
checkpoints resume at `.3.3.24` (embedded MCP contract prefix through byte 65536). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.63` remain task-owned before Rust mutation setup;
