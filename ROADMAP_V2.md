...
checkpoints resume at `.3.3.11` (compiled types, Unicode labels and validation prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.55` remain task-owned before Rust mutation setup;
