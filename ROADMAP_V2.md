...
checkpoints resume at `.3.3.26` (MCP server suffix, strict wire and primary CLI prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.64` remain task-owned before Rust mutation setup;
