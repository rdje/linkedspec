...
checkpoints resume at `.3.3.25` (MCP bundle suffix, frozen runtime and server prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.63` remain task-owned before Rust mutation setup;
