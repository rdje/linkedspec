...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.25` completes 25/55 reading children (35,528 fragments / 1,126,398 bytes), with 44 selected tests passing. Recognition, semantic observation and source location remain fully read; staged enrichment reaches 1806. Frozen registry resolution, authority intersections, plan caching and recursive preflight/dispatch reconcile without a new defect. Dart .2.1-.2.16 and startup owners retain their evidence. The approved engineering-history capacity is committed canonically at 9c644ecb under containment .9 / ADR0111: files 26→27 and manifest lines 25→26, with every byte limit unchanged and the exact 207-line history rollover retained. Next .1.26 continues staged enrichment from line 1807 after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
