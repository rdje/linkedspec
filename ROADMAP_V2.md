...
canonically. Julia/shared-Lua `.5-.6`, recurrence `.7`, public `.8`, staged `.14.7`, and
...
or backend behavior. Capacity is composition-closed. Julia `.14.6.5.0` freezes an exact 55-pass/one-RED
consumer; `.1` adds the private immutable registry/invocation/rebased-view authority and complete dormant proof
without moving that RED. Dormant carriers `.2`, canonical admission `.3`, and independent recomposition `.4`
remain disjoint; `.2` is next.
