...
aggregator is outside `.10.9` and may only route. Six fixture groups now derive 20 digest-locked responses and
...
six-runtime `.7` follow in dependency order; exact contract `.1` is next.
