...
fixed. `.10.7.3.1` now retains the exact private immutable 12-record/14-relation/seven-source-reference graph on
both ABIs. Behavior-free `.10.7.3.2.0` reconciles private source authority with ADR-0049 outward redaction; active
`.10.7.3.2.1` owns remaining privacy/failure/runtime-static/isolation.
