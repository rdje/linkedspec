...
focused chain plus canonical MCP opt-in, closes `.10.9.7` and `.10.9`, preserves semantic rollout 8/9 and MCP
complete/141, and hands the clean boundary to public semantic/MCP no-drift `.10.10`.
