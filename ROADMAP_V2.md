...
incomplete. Seventeen Perl files plus the emitter prefix are read; `.3.2.15` reads its suffix/LinkedRE/AST next.
Repairs `.7`–`.14` (cleanup, comparison, regex, inputs, diagnostics, edge identity/order, I-block literals/state)
