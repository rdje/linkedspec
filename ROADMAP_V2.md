...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability remains 80/0/0; semantic introspection remains closed at 9/0/128; typed source remains 9/5/114 and recursive observation stays closed on all six runtimes. `INTER-MATCH-GAP-CAPTURE.1-.7` is canonical-signoff-complete through no-change `.7.3` from public atomic 254 `bb0c3768`; `.14.5.1` is unblocked and next owns only typed `gap_composition` after the clean atomic-255 boundary. Lua storage remains 19 owners / three dual-ABI native modules. Reversed-span and unrelated hygiene/readability remain separately owned. |
