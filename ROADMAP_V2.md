...
behavioral recurring projection and closes no-drift without an outward API. Staged `.14.7` is now current through
exact recurrence `.8`; combined `.14.8` retains its later owner. Behavior-free staged audit `.14.7.0` began from clean `fbcdedb6`: the
current one-depth function-body adapter is separated from general authored/typed-provenance/multi-family/recursive
behavior; compile-diagnostic context parity repair `.1`, neutral `.2`, backend parents `.3-.7`, and recurrence `.8`
are complete, while public authored closeout `.9` and independent recomposition `.10` remain. Capacity `.0` freezes,
...
advances typed projection governance to 13/1/189 without promoting `.14.8`. Final recomposition `.10` follows.
