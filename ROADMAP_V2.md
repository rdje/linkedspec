...
checkpoints resume at `.3.3.33` (static projection completion, observation event types and source emitter prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.69` remain task-owned before Rust mutation setup;
