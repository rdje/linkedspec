...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, and Perl private annotation/provenance, current-depth policies, plus recursive authority `.14.7.3.1-.3` are closed. The same dormant oracle advances from 60 GREEN/missing-marker through 120 GREEN/missing-authority and 133 GREEN/missing-recursion to 141 GREEN top-level checks and one `.3.4` carriers/admission RED after proving breadth-first queueing, strict chains, shared resources, direct/derived rebasing, and unchanged v1 without route, rollout, carrier, format, or public movement. Mandatory segment `4991` remains finitely authorized at 22/21 by ADR `0089`; `.3.4` owns fresh carriers/admission/Perl rollout next. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
