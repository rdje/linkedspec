...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, complete Perl `.14.7.3.0-.4`, Rust `.14.7.4.0-.4`, Dart dormant boundary `.14.7.5.0`, and Dart marker/provenance `.14.7.5.1` are closed. The Perl oracle is 143/143 across native, normalized-descriptor, generated-plan, and independently loaded emitted fresh-authority routes with exact phase-0/canonical admission. Rust's complete private authority and fresh four-route carriers are admitted. Dart now lowers only exact assignment-form `parse_job` to one inert detached marker with strict literal options and live-regex-proven direct/ordered-derived Unicode-scalar provenance; seven dormant groups pass across native, reconstructed, generated-plan, and independently loaded emitted logical routes, while only caller-frozen resolution/cache/result/failure authority remains RED for `.14.7.5.2`. Neutral governance remains 85 mutations and promotes only Perl plus Rust; function-body v1/generated v2 and public/outward behavior remain unchanged. Mandatory segment `4990` is finitely authorized at 23/22 by ADR `0091`. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability remain separately owned. |
