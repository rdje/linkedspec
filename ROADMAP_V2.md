...
limits; approved capacity implementation 4489f5e9 and independent proof a7d392a8 support `.7.4` admission. Canonical admission a67a18bf precedes completed [DART-STARTUP-READING.0](docs/tasks/DART-STARTUP-READING.md) decomposition: 55 pending children / 169 exact ranges. Dart `.1.35` completes 35/55 reading children (50,528 fragments / 1,551,233 bytes). Validation, package inputs and action-parser tests are complete; action-contract tests reach 203. All 35 selected tests and neutral gap/duplicate-slot checks pass. Ten reconstructed controls own .2.23 with two children: two null named selectors select anonymous regexes, six valid/rejecting controls and two additional provenance census inputs. All earlier findings retain evidence and gates. Approved engineering-history capacity remains canonically committed at 9c644ecb under containment .9 / ADR0111. Next .1.36 continues action-contract/callable/compiled test-source reading after the clean focused commit. The director-approved history exception is committed at 7d52c98e under containment `.8` / ADR0110. Switch .2.1, regex .2.2, numeric trace .2.3 and recognition effect integration .2.4 repairs remain owned and gated; startup .54.3 retains broad regex recurrence. Confirmed attached-switch omission/default replacement is owned by Dart .2.1, with repair gated by startup reading/policy prerequisites. Startup `.3.4` remains pending until reading closeout. Repairs `.7`–`.30`, `.32`–`.47`, and
