...
| Inter-match gap capture | `canonical-signoff-complete; closed at atomic 255 5b9c343a` | Historical “super split” means automatic source-gap access between repeated OR/default action-edge matches. The target rule owns the selected regex slot/lifecycle; the enclosing rule owns repeated selection/gap orchestration. It is unrelated to blind calls or adjacency. | The complete authority is gap 9/0/63 plus public 6/12/10/29, language 250/105+1/126, recognition 137/250/58, and exact neutral/Perl-124/Rust-1/Dart-5/Julia-319/PUC-Lua-392/LuaJIT-392 rooted proof. `.7.3` changed no executable or outward surface and closed the tree; `.14.5.1` now composes only the existing `gap_span` into typed source 10/4/126. Format 2, storage 19/three native modules, facades/schemas/MCP/CLI/README/capability, and the separate gap behavior owner remain unchanged. |
