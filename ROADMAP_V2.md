...
four ceilings, opaque values, typed map errors, and dual-ABI isolation at 377 assertions per ABI. Staged outcome
`.10.7.2.2` is active after the clean source commit; semantic governance is unchanged.
