...
checkpoints resume at `.3.3.4` (compiler resolution and descriptor entry diagnostic modules). Repairs `.7`–`.30`, `.32`–`.47`, and `.49` remain task-owned before Rust mutation setup;
