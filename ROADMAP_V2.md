...
checkpoints resume at `.3.3.8` (remaining expression tests, core entrypoint and parser prefix). Repairs `.7`–`.30`, `.32`–`.47`, and `.49`–`.51` remain task-owned before Rust mutation setup;
