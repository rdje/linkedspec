...
cases. Normalization `.9.1.3.1` now implements typed complete-line candidates, forward-declaration resolution,
family-derived action/blind ownership, reserved lifecycle precedence, per-rule cursor facts, and portable
diagnostics. Live rule-local cursor execution remains `.9.1.3.2`-owned.
