...
duplicate-safe/canonical stdio, exact admission, and no-change closeout under `.1-.4`; implementation is next and
the ledger remains 2/5 + 2/6 pending.
