...
checkpoints resume at `.3.2.53` (function registry and legacy plugin/path configuration). Repairs `.7`–`.30` and `.32`–`.44` remain task-owned before Rust mutation setup;
