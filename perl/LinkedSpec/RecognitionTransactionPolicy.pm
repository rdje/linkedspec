...
my %NODES_BY_EFFECT = (
 ...
 dynamic_callable => [],
 parser_registry_or_staged_dispatch => [qw(PROGRESSIVE_DISPATCH_SPAN STAGED_PARSE_JOB_MARKER)],
 external_or_host => [],
 unknown_or_raw => [],
);
