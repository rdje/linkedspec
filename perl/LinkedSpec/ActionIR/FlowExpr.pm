...
sub _lower_flow_composite_expr {
 ...
 if ($trimmed =~ /^(?:scalaref|scalar|array|hash|trim|lowercase|uppercase|count|count_keys|has_key|merge_hash|drop_keys|join_values|coalesce|array_copy|array_values)\s*\(/o) {
