...
#           `length(...)`, `num_add(...)`, `num_sub(...)`, `starts_with(...)`, `ends_with(...)`, `first(...)`, `last(...)`, `tail(...)`, `drop_front(...)`, `take(...)`, `take_last(...)`, `drop_last(...)`, `drop_back(...)`, `contains(...)`,
#           `flat(...)`)
