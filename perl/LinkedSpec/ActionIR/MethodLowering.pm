...
#           `length(...)`, `num_abs(...)`, `num_add(...)`, `num_sub(...)`, `num_mul(...)`, `num_div(...)`, `num_min(...)`, `num_max(...)`, `starts_with(...)`, `ends_with(...)`, `matches(...)`, `first(...)`, `last(...)`, `tail(...)`, `drop_front(...)`, `take(...)`, `take_last(...)`, `drop_last(...)`, `drop_back(...)`, `contains(...)`,
#           `flat(...)`)
...
sub _lower_method_value_expr {
 ...
 $looks_like_array_value_expr = sub {
  ...
  return 1 if $candidate_method =~ /^(?:array|array_copy|array_values|sorted_keys|sorted_values|tail|drop_front|take|take_last|drop_last|drop_back|split|split_each|trim_each|filter_nonempty|lowercase_each|uppercase_each|uniq|filter_match)$/o;
