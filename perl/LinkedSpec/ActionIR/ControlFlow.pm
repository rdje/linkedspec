...
# Purpose : Lazy-load one control-flow dependency owner through the shared
#           owner-dispatch seam.
# Args    : ($pkg)
...
# Purpose : Lazy-load one control-flow dependency owner and resolve one
