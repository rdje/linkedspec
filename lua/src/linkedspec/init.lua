...
M.is_action_parse_error = action_parser.is_action_parse_error
M.action_parse_error_to_json = action_parser.action_parse_error_to_json
...
M.validate_nested_write_serialized_state = compiled_spec.validate_nested_write_serialized_state
M.validate_receiver_mutation_serialized_state = compiled_spec.validate_receiver_mutation_serialized_state
