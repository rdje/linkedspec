...
- Date: 2026-07-29
- Status: accepted; Perl/Rust parents closed and Dart admitted at 3/5 implementations + 3/6 runtimes with rollout
  pending; Dart closeout plus Julia/Lua implementations remain pending
