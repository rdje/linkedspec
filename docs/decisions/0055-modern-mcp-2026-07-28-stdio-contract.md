...
- Date: 2026-07-29
- Status: accepted; neutral contract/canonical governance plus Perl/Rust/Dart/Julia parents complete at 4/5
  implementations and 4/6 runtimes with rollout pending; Lua implementation is planned by ADR `0061`
