...
- **Julia backend parity** - `JULIA-BACKEND-PARITY` is the active second future-backend lane. It starts from the
  ...
  body parsing. All three routed fixtures pass; full tests pass with 827 assertions and status
  `runtime-corpus-function-shells`. `.6.3` owns the independent full-manifest gate.
