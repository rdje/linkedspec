...
- **Julia backend parity** - `JULIA-BACKEND-PARITY` is the active second future-backend lane. It starts from the
  ...
  and preserves pure numeric slicing. Full tests pass with 808 assertions, status is
  `runtime-corpus-statement-mutation`, the window is 30/31, and `.6.2.4.5.3` is active.
