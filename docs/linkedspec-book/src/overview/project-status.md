...
- **Write-vivification and explicit receiver mutation rollout** - ADR `0036` and `FUTURE-PARITY-BACKLOG.19`
  ...
  `.19.6` is closed; portable capability, recurring proof, and public admission remain pending under `.19.7-.9`.
