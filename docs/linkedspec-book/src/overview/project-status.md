...
- **Julia backend parity** - `JULIA-BACKEND-PARITY` is the active second future-backend lane. It starts from the
  ...
  840 assertions and status `runtime-corpus-full`. `.6.4` has since added focused optional-SDK verification;
  `.7.1` owns public documentation closeout.
