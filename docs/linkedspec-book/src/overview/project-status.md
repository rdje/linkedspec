...
- **Future backend parity backlog** - `FUTURE-PARITY-BACKLOG` owns deferred/future work. Lua input/live-cursor
  ...
  portable errors, and direct/traced value roles. Fresh-process PUC Lua/LuaJIT proof remains `.8.1.2`, and the
  capability census remains four-backend 64/0/0 until `.8.4`.
  Cross-backend
  ...
  generated Lua isolation/plan/admission remains `.8.1.2-.8.4`.
