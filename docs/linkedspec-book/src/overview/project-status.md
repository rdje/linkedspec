...
- **Write-vivification and explicit receiver mutation rollout** - ADR `0036` and `FUTURE-PARITY-BACKLOG.19`
  ...
  100 pass / 0 partial / 0 gap; recurring proof remains `.19.8`, and public-current no-drift plus parent closeout
  remain `.19.9`.
