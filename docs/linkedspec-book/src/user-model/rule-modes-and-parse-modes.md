...
> support ledgers. Public no-drift closes the executable ledger at 76 migration files, 8 complete / 0 pending,
...
cases, 76 migration files, 8 complete / 0 pending, and 60 rejected drift mutations.
