...
default/POSIX. `.1.5.4.3` closed recurring four-command integration; `LUA-BACKEND-PARITY.7.2` extends that same
matrix to Lua and 5x2x61, without changing trace semantics.
