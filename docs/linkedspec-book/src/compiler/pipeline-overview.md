...
selector > first authored marker > first authored rule. Rust, Dart, Julia, and Lua retain the temporary
marker-required envelope until their dependency-ordered rollout leaves land.
