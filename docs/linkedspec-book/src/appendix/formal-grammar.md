...
Rust normalizes attached branch forms to the statement-control sequence it executes. `while(...) { ... }`
remains a tracked implementation leaf and will include a deterministic loop-safety contract.
