...
version-2 signature record are adopted by ADR 0030 and the neutral callable-signature contract, but are not current
backend behavior until the active `FUTURE-PARITY-BACKLOG.4.2-.4` rollout closes.
