...
compatibility/legacy/internal names. Dart's separately rolled-out seven source-boundary compatibility aliases are
checked with their canonical targets against the neutral typed-source contract; they do not silently widen the
shared 246-name inventory. This supersedes two historical blind spots: aligned lists first omitted
