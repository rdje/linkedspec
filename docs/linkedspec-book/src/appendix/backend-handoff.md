...
`RUST-PARITY.7.3.3.2`, the corpus has 66 fixtures, including the two minimal shipped
...
case; terse receiver-chain fixtures for arrays, hashes, strings, numbers, aggregate
