...
Exact one-bare-identifier aggregate selectors are not destination syntax. Perl rejects them before lowering; Rust
and Dart reject them while validating complete compiled ActionIR before native or generated execution.
