...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.3` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; ten Perl files read; `.3.2.4` reads bootstrap core next. Codebase/book No; `rgx` excluded. Repairs `.7` (cleanup liveness) and `.8` (stale comparison) follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
