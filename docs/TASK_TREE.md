...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT normalization `.9.1.7.1` is signoff-complete at 258/258x2 plus canonical 1,031/1,031; clean commit precedes activation of intrinsic runtime `.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
