...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode `.10.7.1`, source/outcome `.10.7.2`, private static `.10.7.3`, and calls/staging/generated `.10.7.4` are composition-closed. Query audit `.10.7.5.0` freezes 19 hashes/26 boundaries; private `.10.7.5.1-.2` complete the evaluator and public `.10.7.5.3` exposes typed/raw-neutral calls at all 19 hashes and 26 boundaries with focused 1,492 per ABI. No-change `.10.7.5.4` follows. Governance remains 6/20/89 at rollout 5/9 and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
