...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.14 closes 14/55 exact reading children, 19,028 fragments / 647,237 bytes; Dart .2.1-.2.7 own all confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.15 finishes bounded child-parse authority, reads generated plan and begins interpreter while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.14 complete | `Session required reading / startup .3.4` | Reading is 14/55 children, 19,028 fragments / 647,237 bytes; 24 selected function/progressive tests pass, including emitted analysis/execution. No new confirmed defect. Next .1.15 finishes bounded child-parse authority, reads generated plan and begins interpreter. Approved capacity stays at 7d52c98e; .2.1-.2.7 repairs remain gated; startup .54.3 retains broad regex recurrence. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
