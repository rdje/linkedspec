...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / checkpoint `.3.3.57` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; codebase No; physical mdBook Yes, formal .4 pending. Progressive/punctuation complete; recognition prefix read; classifier repair .77 owned; SimEnv repair .76 owned. Next .3.3.58; containment .7 owns later Dart capacity; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
