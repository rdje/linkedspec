...
| `LUA-STARTUP-READING` | `active` / source reading 48/51; repairs pending | `Session required reading / startup .3.6` | .1.48 reaches 67,540 fragments/2,584,712 bytes with 90 complete files; staged prefix 704 passes per host, neutral 9/9/123 and public 6/17/10/129 pass. All 34 repair roots and prior failures remain open; no new node; next .1.49 under ADR0118, named arguments parked. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
