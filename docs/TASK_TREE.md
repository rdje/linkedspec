...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia runtime-observation parent `.10.6.6` is composition-closed at focused 1,337 without promotion; exact admission `.10.6.7` remains pending and is not active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
