...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Canonical admission a67a18bf and Dart .0 define 55 exact pending children; next DART-STARTUP-READING.1.1 starts reading while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .0 decomposition complete | `Session required reading / startup .3.4` | .1.1 reads the first of 55 pending children / 169 exact ranges after the clean decomposition commit. All 115 baseline paths remain current-identical; .2 owns new repair intake, .3 closes reading. No source-reading credit yet. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
