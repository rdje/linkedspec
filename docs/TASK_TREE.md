...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 39/143 | `Session required reading / startup .3.8` | Phase0 through line 1526; 51,021 fragments / 1,658,268 baseline bytes, 97 complete files. Retained proof covers ten completed subtests; next .1.40 owns the ParserFactory suffix. All runtime repairs and limits remain. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
