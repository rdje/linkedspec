...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 38/143 | `Session required reading / startup .3.8` | Phase0 through line 1110; 50,605 fragments / 1,593,426 baseline bytes, 97 complete files. Exact retained proof covers 38 read subtests; next .1.39 owns the crossing facade suffix. All repairs and limits remain. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
