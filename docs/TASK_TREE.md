...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.6.3` Lua transaction admission atomic 204 commit-ready | `Overall roadmap - future parity backlog` | Lua RED/authority/integration landed through clean atomic 203 at `70b4ed04`; admission signoff passes 243x2, Lua/package/CLI/corpus, book, all doctrines, RAM 65%, and Phase 0 1,031/1,031 in 758 seconds. Recognition is 132/246/46 at rollout 7/9, public 3/20/38, guide 1/10/14; private authority/integration remain 187x2/243x2 and unexported. Recurring `.14.3.7` and public no-drift `.14.3.8` remain RED. `TASK-TREE-METADATA-HYGIENE.5` and rendered readability remain separately queued. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
