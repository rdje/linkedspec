...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / intake `.31` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; `.31` preserves forward Perl/book reading and repairs `.17`–`.30`. Queued comprehension resumes `.3.2.22`. Codebase/book No; `rgx` excluded. `.7` blocks recovery/purge; `.29` belongs to policy adoption `.5`. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
