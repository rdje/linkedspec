...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.15` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twenty Perl files read; `.3.2.16` reads ActionIR/AST/Parser.pm 1–1498. `.14` owns I-block/REP literal/state defects. Codebase/book No; `rgx` excluded. Repairs `.7`–`.14` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
