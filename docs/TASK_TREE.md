...
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | `.6.2.3` splices explicit `flat_array(...)` values through hash construction, closes `pplugin_empty`, and raises offsets 40-98 to 58/59 at 164/164 per ABI; public leading-trivia initialization `.6.2.4` is active. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
