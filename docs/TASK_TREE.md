...
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | `.6.2.1` caches current action-edge calls, skips passive terminals, closes six shipped fixtures, and raises offsets 40-98 to 56/59 at 163/163 per ABI; receiver-copy `.6.2.2` is active. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
