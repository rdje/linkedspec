...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart reading remains36/55, 52,028 fragments / 1,599,420 bytes. Canonical capacity is committed at bef5dafd. Focused .80.0 owns missing PGEN watches, 11 build stages /78m02s and bounded newer-OS samples; .80.1-.4 and .81.1-.2 are pending behind startup prerequisites. All earlier findings and rgx reading exclusion remain; next Dart .1.37. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.36 complete | `Session required reading / startup .3.4` | Reading is 36/55 children, 52,028 fragments / 1,599,420 bytes; action-contract/callable tests complete, compiled through 418. All 38 tests and neutral callable7/11/9/7/4/8/23 checks pass, including fresh offline emitted proof. No new defect; earlier .2.1-.2.23/startup owners retain evidence. Approved intake .6 closes under containment .10 / ADR0112: exactly files31→32, manifest30→31 lines/17039→17615 bytes with full history reconstruction; capacity is canonical at bef5dafd; next .1.37 after focused CI intake .80.0. Every other limit and repair gate remains. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
