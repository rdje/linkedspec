...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Logical helper parent `.5.2` is closed at 8/0. Perl root core `.9.1.1.2.1.1` is complete and canonically verified; clean commit is the only boundary before loaded/generated/trace convergence `.9.1.1.2.1.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
