...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.2.3` done 2026-07-09 - Dart frontend validation and strict-syntax checks landed over parsed source ASTs. Next frontier `.2.4` integrates the spec-defined function-definition shell. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
