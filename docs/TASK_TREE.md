...
| `BACKEND-INTEGRATION-GUIDES` | `active` / consumer reports owned; setup repairs next | `Phase 6 documentation and adoption / native integration` | Lua setup committed at7f2afcbf4; Rust ad290bdb4 pushed. Intake .8.1 records all ten ARCHOGEN/SEMULITH reports. Next .8.2 workspace onboarding, then .8.3 bootstrap and .8.4 guidance. Strict Lispish reports attach to startup .83. Lua .5.2, common navigation and independent .7 remain before conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
