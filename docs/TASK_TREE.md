...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia private query kernel `.10.6.5.1` is a fully verified commit candidate from `58c67035`: nine exact hashes, new 100/focused 630, complete gates/docs/KM/cleanup, and no public exports; commit before traversal `.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
