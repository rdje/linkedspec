...
99/99 corpus execution, mdBook/live-doc alignment, and generated-source deferral are all recorded. Future backend
rollout returns to `FUTURE-PARITY-BACKLOG.1.2` for Julia planning; generated Dart source remains a future split
proof lane.
