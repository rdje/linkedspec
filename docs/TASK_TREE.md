...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.2` done 2026-07-09 - Julia backend parity is scoped into `JULIA-BACKEND-PARITY`, with interpreter-first strategy and Julia-specific CLI ownership. Backlog Lua `.1.3` remains gated until Julia reaches its scoped milestone; active PNT work is delegated to `JULIA-BACKEND-PARITY.6.2.3` after the starter corpus passed 40/40. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.6.2.2` done 2026-07-10 - shipped manifest fixtures 0–39 pass 40/40 unchanged, with a permanent endpoint/count/failure regression. Full tests pass with 751 assertions and status `runtime-corpus-starter`; `.6.2.3` middle non-function fixtures 40–67 are active. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
...
`.6.2.1` and `.6.2.2` have since landed; `.6.2.3` is active.
...
and status `runtime-corpus-starter`; `.6.2.3` middle non-function fixtures 40–67 are active.
