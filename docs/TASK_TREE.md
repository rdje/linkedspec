...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / inventory `.3.1` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; `.3.2.1` reads five exact facade/invocation owners after exhaustive baseline classification. Codebase/book remain No; `rgx` is excluded. `.7` repairs EPERM-as-dead cleanup after reading and before recovery/purge or mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
