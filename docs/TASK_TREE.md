...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.4.0.1` Dart RED signoff-complete | `Overall roadmap - future parity backlog` | Typed-source `.14.2` and transaction neutral/Perl/Rust `.14.3.1-.3` are composition-complete; Rust admission landed at `02c612f5` as atomic 191/300 with recognition 132/246/42, rollout 3/9, public 3/11/25, guide 1/4/8, and Rust admission 8. Corrective `.14.3.4.0.0` landed at `b1c59d03` as atomic 192/300 and derives the exact neutral current boundary from rollout. Dormant Dart RED `.14.3.4.0.1` freezes the final-path consumer at only the missing private module/types while fatal analysis and all 383 ordinary tests remain green; definitive CI passes Phase 0 1,031/1,031 in 700 seconds, and private authority `.14.3.4.1` is next after clean atomic 193. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
