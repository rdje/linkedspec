...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia cursor admission `.9.1.6.6` is fully verified for the prepared clean commit: 15 roles, package 3,291, primary 65x2, corpus 105, neutral 67/5+3/44, canonical Phase 0 1,031. Activate exact Julia root admission `.9.1.1.2.4.3` only after that clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
