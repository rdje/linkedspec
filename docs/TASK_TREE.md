...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `active` / .7 eligible | `Repository architecture / documentation sustainability` | Rust .3.3.67 closeout enables .7: review bounded Dart ownership and evidence capacity before decomposition/reading. .6 remains complete with exact history preserved and unchanged limits. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
