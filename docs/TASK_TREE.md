...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Selector inventory `.12.1.0` is done at 651 exact calls/82 specs; active `.12.1.1` adopts the neutral bare-binding replacement contract before five-backend enablement, migration, and hard rejection. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
