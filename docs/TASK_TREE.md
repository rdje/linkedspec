...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Lua deployment verified; stderr investigation next | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed; workspace .8.2 committed effe3e7b2. Public integration .8.3 committed a1166ee1d removes internal dependency knowledge. Guidance .8.4 committed6e37288f7; Lua .5.2 verifies dual-runtime deployment/diagnostics. Unexplained Lua stderr .5.3 is next and gates final .7; common .6 remains. Strict Lispish stays startup .83. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
