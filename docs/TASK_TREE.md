...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.1.2` done 2026-07-09 - `dart/` scaffold package, lockfile, CLI stubs, corpus-runner stub, and smoke test created. Next frontier `.1.3` adds corpus-fixture IO scaffolding. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
