...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia source leaf `.10.6.2.1` completes strict copied text/bytes, four ceilings, private immutable byte/scalar mapping, SHA-256, typed values/errors, exact accessors, 135 focused / 7,677 package plus complete matrix/canonical proof, and safe cleanup. Outcome `.10.6.2.2` waits for the clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
