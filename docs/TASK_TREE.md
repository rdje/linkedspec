...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.36 closes 36/55 children, 52,028 fragments / 1,599,420 bytes; action-contract/callable tests complete, compiled through 418. All 38 tests and callable7/11/9/7/4/8/23 checks pass, including fresh offline emitted proof; no new defect. Earlier owners/gates and capacity 9c644ecb remain; next Dart .1.37 after approved containment .10 / ADR0112 canonical admission; .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.36 complete | `Session required reading / startup .3.4` | Reading is 36/55 children, 52,028 fragments / 1,599,420 bytes; action-contract/callable tests complete, compiled through 418. All 38 tests and neutral callable7/11/9/7/4/8/23 checks pass, including fresh offline emitted proof. No new defect; earlier .2.1-.2.23/startup owners retain evidence. Approved intake .6 closes under containment .10 / ADR0112: exactly files31→32, manifest30→31 lines/17039→17615 bytes with full history reconstruction; next .1.37 after clean canonical admission. Every other limit and repair gate remains. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .10 change-history capacity | `Repository architecture / documentation sustainability` | Director-approved ADR0112 admits exactly files31→32, manifest lines30→31/bytes17039→17615 from clean e55f7703. Exact 218-line / 32108-byte rollover, prior-history reconstruction and 22 actual-validator executions pass. Exact staged canonical proof governs landing; next Dart .1.37 after brief clearing and clean proof. Other limits and startup gates remain. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
