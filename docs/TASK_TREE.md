...
| `FUTURE-PARITY-BACKLOG` | `active` / Dart dynamic callable invocation `.11.5.2` signoff-complete from clean `5e80be32`; commit pending | `Overall roadmap - future parity backlog` | Dart explicit invocation passes focused 15/15 plus operational Dart 369/369, storage 19/47, CLI 66x2, and corpus 105/105 across native/reconstructed/generated/emitted roles; KM 765/6,213, book 79/13,924, seven doctrines, full canonical admissions/containment/CLI, and Phase 0 1,031/1,031 pass. Clean commit remains; generic final blocks stay `.11.5.3`; no push. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
