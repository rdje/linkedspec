...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.3.1` done 2026-07-09 - Dart now parses helper/action source into typed ActionIR AST nodes. Next frontier `.3.2` maps those nodes to canonical helper contracts and diagnostics. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
