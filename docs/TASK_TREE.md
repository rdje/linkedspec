...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia `.7.3.2.1` closes native trace and `.7.3.2.2` closes exact arguments/resolution/loading. Active PNT is `.7.3.2.3` native execution/canonical JSON; `.1.5`, `.1.6`, and `.3` own global convergence before Lua. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.7.3.2.2` done 2026-07-10 - strict canonical options, deterministic named resolution, exact loading, 920 assertions, and 99/99 green. `.7.3.2.3` is active for primary execution and canonical JSON. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
...
checks, and 99/99 pass; `.7.3.2.3` is active for native execution and canonical JSON.
