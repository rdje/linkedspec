...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust complete and Perl leaves verified | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed. Perl .1.1-.1.2 verify setup, deployment, errors and diagnostics; Dart .3.1 is next. Strict Lispish repair stays startup .83. Finish remaining guides and independent .7, then conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
