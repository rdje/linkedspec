...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.4.2` Dart transaction integration signoff-complete | `Overall roadmap - future parity backlog` | Typed-source `.14.2` and transaction neutral/Perl/Rust `.14.3.1-.3` are composition-complete. Dart private authority `.14.3.4.1` is atomic 194/300 at `f6f154c6`. Integration `.2` passes the enabled dormant consumer 10/10 across four dedicated non-eager nodes, effect/progress policy, and native/reconstructed/generated-plan/emitted carriers; default remains 6 pass / 4 skips. Complete Dart passes format 100/0, strict analysis, ordinary 383, storage 21/47, CLI 66x2, and corpus 105. The module remains unexported; ordinary/canonical discovery, recognition 132/246/42, rollout 3/9, public 3/11/25, guide 1/4/8, and Rust admission 8 remain exact. All eight doctrines and canonical CI pass containment/relocation, CLI 66x2, RAM 64%, and Phase 0 1,031/1,031; atomic 195 commit precedes separate admission `.3`. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
