...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust complete and Perl setup verified | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed. Perl .1.1 provides native setup, clean source and module-closure proof; .1.2 deployment/errors is next. Strict Lispish repair stays startup .83. Finish other guides and .7, then conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
