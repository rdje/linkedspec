...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.24 closes 24/55 exact reading children, 34,028 fragments / 1,079,144 bytes; Dart .2.1-.2.16 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; engineering-history .5 is approved and implemented by containment .9 / ADR0111, then .1.25 resumes while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.24 complete | `Session required reading / startup .3.4` | Reading is 24/55 children, 34,028 fragments / 1,079,144 bytes; recognition/semantic/source complete, staged entry through 306. All 58 selected tests pass; no new runtime defect; one Knowledge link corrected. Approved .5 is implemented by containment .9 / ADR0111: engineering-history files 26→27 and manifest lines 25→26. Next .1.25 follows canonical landing; repairs remain gated and earlier owners remain intact. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .9 engineering-history capacity | `Repository architecture / documentation sustainability` | ADR0111 admits the director-approved files 26→27 and manifest lines 25→26. Exact 207-line rollover, prior-history reconstruction, 22 validator executions and staged canonical proof govern .9; next Dart .1.25. Other limits and startup gates remain. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
