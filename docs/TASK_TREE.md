...
| --- | --- | --- | --- | --- |
| `ACCUMULATOR-CONVENTION-AUDIT` | `active` | `Method-like DSL migration follow-on` | `ACCUMULATOR-CONVENTION-AUDIT.1` | [docs/tasks/ACCUMULATOR-CONVENTION-AUDIT.md](docs/tasks/ACCUMULATOR-CONVENTION-AUDIT.md) |
