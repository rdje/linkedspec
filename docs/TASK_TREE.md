...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **ACTIVE 2026-07-08** — `.10.5.5` fixed `user-model/spec-files-and-rule-paragraphs.md` malformed label-in-block and `Top::AND` sketches with verified 2-rule examples. Next leaf: `.10.5.6`, fixing `user-model/rule-modes-and-parse-modes.md` mode fragments and "both valid shapes" framing. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
