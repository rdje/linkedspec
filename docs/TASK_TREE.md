...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl progressive authority `.14.6.2.1` focused-complete; carriers `.2` next | `Overall roadmap - future parity backlog` | From clean dormant-RED atomic 260 `191465f4`, the private Perl core now executes immutable-registry, rebased-view, narrowing-authority, shared-cancellation/budget, decreasing-chain, isolation/detachment, and 26-diagnostic contracts independently of ActionIR. The final-path consumer stays unrouted at 83/1; `.14.6.2.2` owns four carriers and `.3` admission. Rust/Dart/Julia/Lua `.14.6.3-.6`, recurrence `.7`, public `.8`, staged `.14.7`, and combined `.14.8` remain separate. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
