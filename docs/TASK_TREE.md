...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode `.10.7.1` and opaque source/outcome foundation `.10.7.2` are composition-closed. `.10.7.3.1` implements the exact private 12-record/14-relation/seven-source-reference graph; remaining static/isolation `.10.7.3.2` follows, with semantic governance unchanged at 6/20/89, rollout 5/9, and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
admission movement; `.10.7.3.2` next completes privacy, failure, runtime-static, lifecycle, clone, and host fences.
