...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl/Rust/Dart are 61/61. `.1.5.4.0` splits Julia's warmed 13/61 gap; `.1.5.4.1` is active for shared help/strict UTF-8/stable errors before canonical trace and the four-command driver. `.10.1` parks introspection/MCP; `.11.1` parks generic codeblocks/`with`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
