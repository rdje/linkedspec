...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode `.10.7.1`, source/outcome `.10.7.2`, private static `.10.7.3`, calls/staging/generated `.10.7.4`, and immutable typed/raw-neutral query `.10.7.5` are composition-closed. Native capture `.10.7.6.1`, immutable observed-index derivation `.10.7.6.2`, and generated/emitted propagation `.10.7.6.3` are complete; `.3` passes new 80/focused 1,964 per ABI plus full signoff from clean `ca6d635e`. No-change closeout `.10.7.6.4` follows only after the clean commit. Governance remains 6/20/89 at rollout 5/9 and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
