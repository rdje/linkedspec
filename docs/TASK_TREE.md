...
| `FUTURE-PARITY-BACKLOG` | `active` / lossless-gap handoff `.14.5.0` landed at `3d0384d1`; typed composition waits | `Overall roadmap - future parity backlog` | Recursive observation remains closed at typed-source 9/5/114. `.14.5.0` handed sole named-slot/gap implementation ownership to `INTER-MATCH-GAP-CAPTURE.1-.7`; recurring admission `.7.1` is canonical-signoff-complete from atomic 252 `be240c14` at 8/1/61 plus ten Rust, ten Dart, ten Julia, and sixteen Lua admission mutations. Public `.7.2` and closeout `.7.3` remain before `.14.5.1` resumes typed `gap_composition`. Final typed-source `.14.8`, task metadata `.5`, and rendered readability remain separately owned. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
| `INTER-MATCH-GAP-CAPTURE` | `active` / `.7.1` canonical-signoff-complete from clean atomic 252 `be240c14`; `.7.2` next | `.spec language evolution / lossless segmentation and source preservation` | Recurring is current at 8/1/61: neutral, Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT pass in the unchanged rooted order, and five governed markers say recurring-current/public-pending. Public language/compatibility/no-drift `.7.2` remains at shared calls 250, public Perl 126, and gap 9/0/63 plus public 6/12/10/29; then no-change closeout/handoff `.7.3`. Calls 246/public Perl 122, recognition 137/246/58, format 2, implementation, facade/schema/MCP/CLI/README/capability, storage, and typed source remain unchanged in `.7.1`. | [docs/tasks/INTER-MATCH-GAP-CAPTURE.md](docs/tasks/INTER-MATCH-GAP-CAPTURE.md) |
