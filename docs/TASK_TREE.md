...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT intrinsic runtime `.9.1.7.2` is exact and prepared for commit; descriptor v1 `.9.1.7.3` waits for the clean runtime handoff. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
