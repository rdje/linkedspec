...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Logical helper parent `.5.2` is closed at 8/0. Cursor rollout is 2/6; Rust `.9.1.4.0-.2` are committed through `8780990a`. Verified `.3` derives live/loaded/serialized/reconstructed policy per entered rule; its clean commit precedes descriptor `.4`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
