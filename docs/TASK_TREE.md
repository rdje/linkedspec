...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust complete, Perl/Dart/Julia leaves verified | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed. Perl .1.1-.1.2, Dart .3.1-.3.2 and Julia .4.1-.4.2 are verified; next Lua .5.1 native setup. Strict Lispish repair stays startup .83. Finish remaining guides and independent .7, then conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
