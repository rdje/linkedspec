...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl `.14.7.3.0` task-tree-active from exact clean neutral commit `ab8802c9` | `Overall roadmap - future parity backlog` | `.14.7.2` durably freezes executable neutral staged-AST authority through 72 mutations; `.14.7.3.0` now owns only Perl's dormant v1-GREEN/general-v2-RED compatibility oracle before private implementation. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
