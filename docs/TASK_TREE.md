...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia global option/CLI removal `.9.1.6.5` is complete with package 3,187, primary 65x2, corpus 105, neutral 66/4+4/39, and canonical 1,031/637s proof; its clean commit must land before cursor admission `.6` activates. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
