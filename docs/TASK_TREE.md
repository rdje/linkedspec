...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.2.4.6` done 2026-07-09 - bounded structural regex matchers and action-edge `push(child, index)` parity close the seven PCRE structural fixtures; the shipped-spec/parser-smoke window is 31/31 green. Next frontier `.6.2.5`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
