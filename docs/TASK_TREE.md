...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode negative/isolation audit `.10.7.1.3.0` is complete. Narrow body-fluent remainder repair `.3.1` is active before exhaustive proof `.3.2`, with semantic governance unchanged at 6/20/89, rollout 5/9, and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
