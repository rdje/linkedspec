...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.4.1` private Dart authority complete | `Overall roadmap - future parity backlog` | Typed-source `.14.2` and transaction neutral/Perl/Rust `.14.3.1-.3` are composition-complete. Corrective `.14.3.4.0.0` landed at `b1c59d03` as atomic 192/300; dormant Dart RED `.0.1` landed at `3a29b34e` as atomic 193/300; private authority `.14.3.4.1` is atomic 194/300. Its 6 dormant default-mode tests pass with 4 integration skips; strict analysis is clean, and the enabled RED stops only at dedicated-node, effect/progress, native, and emitted `.2` seams. Production/UTF-16 behavior, ordinary 383 tests, recognition 132/246/42, rollout 3/9, public 3/11/25, guide 1/4/8, and canonical discovery remain unchanged. Eight doctrines, containment/relocation, CLI 66x2, RAM 65%, and Phase 0 1,031/1,031 in 697 seconds complete signoff; activate `.14.3.4.2` task-first next. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
