...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia privacy/failure/runtime-static/isolation `.10.6.3.2` is complete from clean graph base `197538f7`: all five private targets now exist without promotion. Composed no-change static closeout `.10.6.3.3` follows after this commit is clean. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
