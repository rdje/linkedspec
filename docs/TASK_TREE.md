...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl, Rust, Dart, and Julia implement ADR 0030's final `...rest` through exact v1/variadic v2 native and generated execution. No-drift and Lua ownership routing `.4.4` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
