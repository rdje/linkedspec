...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Exact CLI `.1.5`, census `.1.6.0`, 237-name audit `.1.6.1.0`, newline splitting `.1.6.1.1`, and `endswitch` termination `.1.6.1.2.1` are closed. Diagnostic `.2.2.0` exposes 100/105 on Rust/Dart/Julia and splits four semantic families; active `.2.2.1.1` aligns Rust pure values. Later leaves own descriptor/diagnostics/resolution/trace; generated source remains `.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
generator seam remain; mandatory corpus stays green at 99. Active `.2.2.1.1` starts Rust pure-value repair.
