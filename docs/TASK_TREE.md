...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; dormant Dart typed RED `.14.2.3.0.2` signoff-complete, commit pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Rust admission landed at `666751ae`, Dart alias parity landed at `7b76af71`, and typed source-location rollout remains 5/9 with 39 mutations. Dormant `.14.2.3.0.2` freezes one four-test 3/7/6/3 + 92+7 consumer outside ordinary discovery; its explicit wrapped route fails only for the absent future typed module/API while fatal analysis and all 379 ordinary tests stay green. Complete Dart format 97/0, storage 20/47, CLI 66x2, corpus 105/105, language coverage 246/105/122, neutral 5/9/39, sole-facing mdBook 79/14,152 KiB with separate rendered blocks, Knowledge Map 786/6,423, all doctrines, and canonical capability 80/0/0, containment/relocation, CLI 66x2, RAM 39%, and Phase 0 1,031/1,031 in 704 seconds pass without production or public behavior movement. Commit 153/300 and clean proof remain; immutable Dart core `.14.2.3.1` follows only after clean landing. Rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
