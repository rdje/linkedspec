...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `active` / .7.3 verified | `Repository architecture / documentation sustainability` | Canonical .7.2 lands at 4489f5e9; independent .7.3 verifies exact controls, retained evidence, stable lookup and complete Dart reserve. Next .7.4 admits bounded pending Dart ownership. Existing member limits, records and other reading gates remain preserved. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
