...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia private traversal/pages/budgets/costs `.10.6.5.2` are fully verified at all 19 static hashes without exports; commit from clean base `b70e37fc` before public typed/raw completion `.10.6.5.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
