...
| --- | --- | --- | --- | --- |
| `RUST-README-DRIFT-SYNC` | `active` | `Overall roadmap — documentation and book sync` | Startup review on 2026-07-08 found `rust/README.md` still names the full interpreter oracle as 93 fixtures while the manifest, mdBook, live docs, and Knowledge Map are at 95 fixtures. `.0` owns the finding; frontier is `.1` to fix the isolated README wording. | [docs/tasks/RUST-README-DRIFT-SYNC.md](docs/tasks/RUST-README-DRIFT-SYNC.md) |
