...
| `FUTURE-PARITY-BACKLOG` | `active` / Lua typed-source projections `.14.2.5.2` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source rollout remains 7/7/41 with Perl/Rust/Dart/Julia admitted and both Lua ABIs pending admission. Each shared Lua execution input now owns one copied private authority; exact 92+7 routes use typed positions/spans while zero-based UTF-8-byte registers, values, and mutation timing stay unchanged. Core 133/133 and projection 240/240 pass per ABI across native/reconstructed/generated-plan execution; aliases remain 638/638 with loaded/emitted proof. Complete Lua passes 177/177 per ABI, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, and language 246/105+1/122. Sole-facing book, Knowledge, roadmap, memory, and live docs are synchronized; book 79/14,188, Knowledge 789/6,504, all doctrines, and definitive canonical containment/relocation, CLI 66x2, RAM 65%, and Phase 0 1,031/1,031 in 662 seconds pass. Atomic commit 167/300 remains before admission `.14.2.5.3`; rendered readability stays queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
