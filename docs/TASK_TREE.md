...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Dart core/descriptor `.9.1.1.2.3.1` is fully signed off: one resolver, portable failures, immutable identity, package 266, corpus 105, primary 65x2, and canonical pass. Composed routes `.3.2` are next after the clean commit; rollout stays 3/7. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
