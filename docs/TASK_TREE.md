...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.7.2` done 2026-07-09 - generated Dart source is deferred to a future split source-emitter lane; the current Dart conformance gate remains the interpreter-first 99/99 corpus run. Next frontier `.7.4`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
