...
| `FUTURE-PARITY-BACKLOG` | `active` / Lua alias parity `.14.2.5.0.1` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source rollout remains 7/7/41 with Perl/Rust/Dart/Julia admitted and both Lua ABIs pending. A separate seven-name Lua inventory/map now canonicalizes every neutral compatibility spelling to an established helper without widening the common 246 names or adding interpreter branches. Exact RED is 62/572 failures per ABI; GREEN is 638/638 per ABI across all aliases and five carriers. Complete Lua 177/177 per ABI, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, language 246/105+1/122, book 79/14,180 with separate rendered blocks, Knowledge 788/6,489, and all seven doctrines pass. Canonical CI preserves capability 80/0/0 and typed source 7/7/41, reports RAM 59%, and passes Phase 0 1,031/1,031 in 659 seconds. Atomic commit 164/300 and clean proof remain before dormant typed-source RED `.14.2.5.0.2`; rendered readability stays queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
