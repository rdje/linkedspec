...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.8 closes 8/55 exact reading children, 11,527 fragments / 345,207 bytes; Dart .2.1-.2.4 own switch/regex/trace/recognition repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.9 reads the generated MCP bundle while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.8 complete | `Session required reading / startup .3.4` | Reading is 8/55 children, 11,527 fragments / 345,207 bytes; 42 selected tests pass, including 105/105 corpus. Next .1.9 reads the generated MCP bundle. Approved history capacity is committed at 7d52c98e; switch/regex/trace/recognition repairs .2.1-.2.4 remain gated, with broad regex recurrence at startup .54.3. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
