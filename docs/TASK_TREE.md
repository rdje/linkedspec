...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.20` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twenty-five Perl files plus ControlFlow prefix read; `.3.2.21` finishes it and the next adapters. `.15` owns nested-span loss. Codebase/book No; `rgx` excluded. Repairs `.7`–`.15` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
