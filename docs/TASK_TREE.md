...
| `INTER-MATCH-GAP-CAPTURE` | `active` / Rust emitted-source proof `.3.4` signoff-complete from clean `9e6ade98`; landing remains | `.spec language evolution / lossless segmentation and source preservation` | The admitted Perl consumer runs ordinarily and in the rooted route at gap 2/7/56. Rust authored/static `.3.1`, private native `.3.2`, and reconstruction/descriptor/generated-plan `.3.3` landed through atomic 230 at `9e6ade98`. `.3.4` proves fifteen independently compiled modules through paired direct/traced roles while the final consumer remains ignored; its focused, storage, doctrine, and canonical gates pass, and `.3.5` retains primary/admission ownership. Five later runtime routes, recurring/public rows, typed composition, generated-plan v2, and outward surfaces remain pending or unchanged. | [docs/tasks/INTER-MATCH-GAP-CAPTURE.md](docs/tasks/INTER-MATCH-GAP-CAPTURE.md) |
