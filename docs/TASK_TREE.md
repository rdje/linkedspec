...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia `.10.6.7` and parent `.10.6` are verified closed at semantic 6/20/89, rollout 5/9, and admission 4/6; PUC Lua/LuaJIT `.10.7` is the next task-tree-first frontier from the clean Julia closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
