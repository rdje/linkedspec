...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Punctuation-light parent `.16` is complete at capability 64/0/0 and condition headers remain parenthesized. Named-mark `.17.1` adopts the exact seven-helper contract and aligns Perl/Rust live plus generated execution; Dart `.17.2` is active before Julia, Lua, and independent symmetric-omission hardening `.17.3-.17.5`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
cross-backend complete named-mark `.17.1` aligns Perl/Rust; Dart `.17.2` is now the frontier before Julia/Lua and
Lua `.4.3.7.3`.
