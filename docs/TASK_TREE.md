...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode `.10.7.1` and opaque source/outcome foundation `.10.7.2` are composition-closed. Behavior-free static-authority audit `.10.7.3.0` is next, with semantic governance unchanged at 6/20/89, rollout 5/9, and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
