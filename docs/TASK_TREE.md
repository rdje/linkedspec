...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT option removal `.9.1.7.5` is fully verified at 96/96x2, package 177/177x2, primary 65/65x4, corpus 105/105x2, governance 68/5+3/44, and canonical Phase 0 1,031/646s; only its commit remains before `.6`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
