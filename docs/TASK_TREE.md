...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.4.5.0` done 2026-07-09 - the broad runtime diagnostics/trace-controls leaf is split into structured diagnostics, trace controls/sinks, runtime trace instrumentation, and no-drift closeout leaves. Next frontier `.4.5.1` adds structured Dart runtime diagnostics. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
