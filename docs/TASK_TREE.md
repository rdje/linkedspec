...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua root core `.9.1.1.2.5.1` is complete at focused 99x2, primary 32/65x4, corpus 105x2, and canonical Phase 0 1,031/613s; its prepared clean commit is the only boundary before composed routes `.5.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
