...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **ACTIVE 2026-07-08** — `.10.5.20` resolved the lifecycle final-value/direct-`E` Perl handler-shape follow-up as a documented current-reference caveat under ADR `0020`; `.10.5` whole-book scorch is complete. Next leaf: `.5.3`, Array helper worked examples. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
