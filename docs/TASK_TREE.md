...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.1.1` pending - verify local Dart SDK/tool commands and define the repo-owned Dart package layout before implementation code. Strategy is interpreter-first; generated Dart source is a later proof lane after corpus parity. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
...
generated Dart source to a later proof lane after interpreter/corpus parity. Active PNT
frontier is now `DART-BACKEND-PARITY.1.1` for Dart toolchain/package-layout preflight.
