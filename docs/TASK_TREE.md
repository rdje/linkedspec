...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.4.1` executable neutral observation signoff-complete and commit-ready as atomic 209; Perl `.14.4.2` next only after clean landing | `Overall roadmap - future parity backlog` | From clean lineage commit `53c687d3`, `.14.4.1` selects future `observe_recognition(observation, call(Child))`, one separate detached nine-field harray, and a 33-transition neutral machine for entry/match/exit/outcomes/rejection/detach/child cursor policy. Two diagnostics plus 13 mutations advance typed-source governance from 57 to 70 without runtime/API/schema/CLI/README or 8/6 rollout movement. Complete six-runtime/book/doctrine/canonical proof is green; the atomic commit remains. `.14.4.2-.8` retain Perl/Rust/Dart/Julia/shared-Lua/recurring/public ownership. Transaction `.14.3` remains closed at 132/246/58 and rollout 9/9; typed-source `.14.8` is separate. `TASK-TREE-METADATA-HYGIENE.5` and rendered readability remain separately queued. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
