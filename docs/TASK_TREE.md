...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.18` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twenty-four Perl files plus Contracts prefix read; `.3.2.19` reads its suffix. `.15` owns nested-span loss. Codebase/book No; `rgx` excluded. Repairs `.7`–`.15` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
