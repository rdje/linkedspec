...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.4.0` recursive source-observation audit for atomic 207 | `Overall roadmap - future parity backlog` | From clean transaction closeout `3ac018f8`, behavior-free `.14.4.0` freezes one detached entry/match/exit/provenance record on the existing monotonic authority while preserving child family policy. It found neutral `direct_nonprogress` self-parenting and a checker invariant gap; tracked `.14.4.0.1` corrects lineage before `.14.4.1-.8` implementation/rollout. No runtime/API/schema/CLI/README behavior moves. Transaction `.14.3` remains closed at 132/246/58 and rollout 9/9; typed-source `.14.8` is separate. `TASK-TREE-METADATA-HYGIENE.5` and rendered readability remain separately queued. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
