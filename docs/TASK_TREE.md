...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.28 closes 28/55 children, 40,028 fragments / 1,248,597 bytes; Unicode mapping reaches 2689. Fresh generation/12 neutral fixtures pass; .1.27 runtime/provenance proof is retained by source identity. No new defect; all .2.1-.2.19 findings remain intact and gated. Approved capacity remains at 9c644ecb; next .1.29 while startup .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.28 complete | `Session required reading / startup .3.4` | Reading is 28/55 children, 40,028 fragments / 1,248,597 bytes; Unicode lower table complete and upper through U+A76F at line 2689. Fresh generation/12 neutral fixtures pass; .1.27/dfc57ce1 runtime/provenance proof remains unchanged. No new defect; all prior findings retain ownership and gates. Next .1.29 follows the focused clean commit. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
