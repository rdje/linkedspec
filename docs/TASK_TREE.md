...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust integration .2 complete | `Phase 6 documentation and adoption / native integration` | Rust files, clean pinned preparation and deployment verified; requested clean push then Perl .1.1. Strict Lispish parsing owned by startup .83. Normal Cargo builds authorized. Complete other guides and final .7, then return to conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
