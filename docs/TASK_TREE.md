...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.3.1.3.0` found the existing Rust scaffold lacks v1 identity/errors/exact plan rejection/neutral trace roles; `.3.1.3.1` is active before baseline admission, Rust breadth, Dart/Julia emitters, and exact closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
