...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.5` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twelve Perl files read; `.3.2.6` reads the compiler pipeline next. Required rollover and finite ADR 0102 capacity recorded. Codebase/book No; `rgx` excluded. Repairs `.7`–`.9` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
