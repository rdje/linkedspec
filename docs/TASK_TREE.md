...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / checkpoint `.2` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap reading is Yes; `.3` inventories and splits remaining codebase reading, then mdBook and supplied-policy review follow. Codebase/book remain No; `rgx` is excluded by the director. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
