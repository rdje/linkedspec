...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Director instruction activates exact Julia semantic admission `.10.6.7` task-tree-first from clean `48b7d96d`; it owns the ordered 12-role consumer, canonical topology/mutations, Julia-only promotion, lockstep public sync, and `.10.6` closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
