...
| `RUST-PARITY` | `active` | `Phase 9 — Rust variant (parity follow-on)` | `RUST-PARITY.7.3.3.3` — `.7.3.3.2` added the JSON-safe `{abc}` hlink curly-brace fixture; next decide or defer scalar-ref oracle representation for bracket/mixed hlink fixtures | [docs/tasks/RUST-PARITY.md](docs/tasks/RUST-PARITY.md) |
