...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl progressive lane `.14.6.2` complete; Rust split `.14.6.3` next after atomic 263 | `Overall roadmap - future parity backlog` | Exact private Perl admission is canonical-signoff-complete at progressive 2/9/86 and recognition 138/250/58 without shared-helper or outward promotion. Split Rust `.14.6.3` task-tree-first next; Dart/Julia/Lua `.14.6.4-.6`, recurrence `.7`, public `.8`, staged `.14.7`, and combined `.14.8` remain separate. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
