...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 50/143 | `Session required reading / startup .3.8` | ADR0122/containment .15 admit fourteen granted controls with ordinary canonical proof; .4 closes and unread .1.51 follows clean landing. Phase0 remains through13631; repairs .2.5/.2.6 stay open. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .15 approved conformance allowance | `Repository architecture / documentation sustainability` | ADR0122 admits exactly fourteen granted controls; preserves prior source/history/tasks and forecasts remaining98 units. Production156/61 checks and ordinary staged canonical proof govern landing; conformance .1.51 resumes after clean commit. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
