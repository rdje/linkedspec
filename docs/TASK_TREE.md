...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Rust route leaf `.9.1.1.2.2.2` is implemented, documented, cleanup-complete, and canonically signed off; its clean commit boundary precedes topology/admission `.2.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
