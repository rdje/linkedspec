...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Dart cursor admission `.9.1.5.6` has exact 15-role, package 271, primary 65x2, corpus 105, 4/4, KM/mdBook/governance, and canonical Phase-0 signoff. Cleanup plus its clean commit are the sole boundary before Julia cursor `.9.1.6`; root admission `.4.3` follows Julia. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
