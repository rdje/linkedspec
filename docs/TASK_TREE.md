...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.10.0` captures semantic introspection/MCP as a parked future lane; `.1.5.1.6` remains active for the surfaced UTF-8 argv/file/JSON boundary before pending Rust `.1.5.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
and a thin MCP transport that owns no semantic behavior. `.1.5.1.6` remains active.
