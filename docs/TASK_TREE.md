...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.18 closes 18/55 exact reading children, 25,028 fragments / 822,211 bytes; Dart .2.1-.2.10 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.19 continues interpreter helpers while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.18 complete | `Session required reading / startup .3.4` | Reading is 18/55 children, 25,028 fragments / 822,211 bytes; 140 selected tests pass. Nine native/reconstructed controls own false callback cycles and helper-mediated identity loss under .2.10. Next .1.19 continues interpreter helpers. Approved capacity stays at 7d52c98e; .2.1-.2.10 repairs remain gated; startup .37/.54.3 retain progressive/regex ownership. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
