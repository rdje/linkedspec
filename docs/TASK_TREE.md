...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Dart alias parity `.14.2.3.0.1` signoff-complete, commit pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Rust admission landed at `666751ae`; typed source-location rollout remains 5/9 with 39 mutations. From clean Dart audit commit `d3efe221`, all seven compatibility aliases now use Dart's existing canonical helper routes across native, reconstructed, generated-plan, and emitted execution; no typed-value admission, schema/identity, semantic/MCP/capability, DSL, or root README change. Alias 4/4, focused 91, complete Dart format/analyzer/package 379/storage 20/47/CLI 66x2/corpus 105, language coverage 246/105/122, neutral 5/9/39, sole-facing mdBook 79/14,152 KiB, Knowledge Map 786/6,419, all doctrines, and canonical capability 80/0/0, containment/relocation, CLI 66x2, RAM 52%, and Phase 0 1,031/1,031 in 681 seconds pass. Dormant typed RED `.14.2.3.0.2` follows after clean commit; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
