...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.4.0.0` correction signoff-complete | `Overall roadmap - future parity backlog` | Typed-source `.14.2` and transaction neutral/Perl/Rust `.14.3.1-.3` are composition-complete; Rust admission landed at `02c612f5` as atomic 191/300 with recognition 132/246/42, rollout 3/9, public 3/11/25, guide 1/4/8, and Rust admission 8. Dart retrieval found that neutral `policy.current_boundary` and its checker literal still called Rust unavailable; corrective `.14.3.4.0.0` now derives exact boundary prose from expected rollout without changing counts or behavior and passes definitive canonical proof at Phase 0 1,031/1,031. Land atomic 192 cleanly before dormant Dart RED `.14.3.4.0.1`. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
