...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.4.0.1` signoff-complete as atomic 208; `.14.4.1` next, not active | `Overall roadmap - future parity backlog` | From clean audit activation `2c968259`, behavior-free `.14.4.0.1` replaces textual/self-parent fixtures with positive unique monotonic ids and makes neutral validation reject self-parent, reuse, reverse order, and cycles. Four reason-checked mutations advance typed-source governance from 53 to 57 without runtime/API/schema/CLI/README or 8/6 rollout movement. Book 79/14,460, Knowledge 821/6,826, all eight doctrines, containment/relocation, CLI 66x2, RAM 34%, and Phase 0 1,031/1,031 in 739 seconds pass. `.14.4.1-.8` retain executable neutral/six-runtime/recurring/public ownership. Transaction `.14.3` remains closed at 132/246/58 and rollout 9/9; typed-source `.14.8` is separate. `TASK-TREE-METADATA-HYGIENE.5` and rendered readability remain separately queued. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
