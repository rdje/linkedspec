...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | ADR 0025 and `.1.5.1.6.0` ratify/split strict UTF-8; `.1.5.1.6.1` is active for neutral hex-byte fixtures before Perl decode/closeout and Rust. `.10.1` remains parked. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
