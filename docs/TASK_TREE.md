...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Logical helper parent `.5.2` is closed at 8/0. Perl loaded/generated/runtime-context/trace convergence `.9.1.1.2.1.2` is complete and canonically verified; clean commit is the boundary before composed admission `.1.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
