...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Dart route `.9.1.1.2.3.2` is fully signed off and ready for its prepared commit across loaded/reconstructed/generated/emitted/trace/diagnostic paths. Admission `.3` follows after the clean commit; rollout stays 3/7. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
