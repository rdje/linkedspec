...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.2.4.1` done 2026-07-09 - Dart now bridges basic shipped regex dialect forms; remaining PCRE structural constructs are routed to `.6.2.4.6`. Next frontier `.6.2.4.2` is missing shipped-smoke helper/action surfaces. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
