...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Root selection retains final five-backend recurring/public no-drift at 7/0. Dual-ABI Lua duplicate-slot `.6` is signoff-complete at 6+1/46 with 112x2/177x2/canonical/cleanup proof; its prepared commit is the sole boundary before `.7`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
