...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.4` done 2026-07-10 - ADR `0022` makes native in-memory host-language embedding primary; variant CLIs are thin adapters. Julia generated source is deferred to future `.3`; active PNT is `JULIA-BACKEND-PARITY.7.3`; Lua `.1.3` follows Julia closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.7.2` done 2026-07-10 - generated source is deferred to `FUTURE-PARITY-BACKLOG.3` with explicit scaffold/harness/family/corpus proof prerequisites. Native interpreter parity remains 99/99 at 840 assertions; `.7.3` is active. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
