...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia emitted/generated runtime-observation propagation `.10.6.6.3` is complete and fully verified from clean `a5bdd0e6`; no-change composition `.4` waits for the clean propagation commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
