...
| `BACKEND-INTEGRATION-GUIDES` | `active` / workspace repair verified; bootstrap next | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed; Perl/Dart/Julia and Lua setup verified. Intake .8.1 owns all ten reports. Workspace .8.2 passes ten boundary checks and two-member native consumer proof with unchanged pins. Next bootstrap .8.3, then .8.4, Lua .5.2, common navigation and independent .7 before conformance .1.35. Strict Lispish reports remain startup .83. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
