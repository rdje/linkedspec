...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl `.12.1.2`, Rust `.12.1.3`, Dart `.12.1.4`, and Julia `.12.1.5` execute uniform bindings; Lua `.12.1.6` is active before migration/rejection. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
Index note 2026-07-12: `FUTURE-PARITY-BACKLOG.12.1.0` inventories 651 exact selector-shaped calls in 82 tracked
specs, including 227 in 15 shipped specs. Perl toolbox probes prove bare reads and receivers exist but
...
Lua `.12.1.6` is next; selector migration/rejection remains dependency-ordered.
