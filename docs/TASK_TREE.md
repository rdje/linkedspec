...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Rust parent `.9.1.1.2.2` is signed off at 3/7 with 15-role topology, 29 mutations, complete Rust-local/canonical 65x2, public/KM lockstep, and cleanup; the clean commit boundary precedes Dart `.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
