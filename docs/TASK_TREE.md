...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.2.4.4.1` done 2026-07-09 - Dart `array(...)` list-context splicing fixes all five portmap fixtures and `vhdl_library_use`; the parser-smoke window is 13/31 green. Next frontier `.6.2.4.4.2` is hlink delimiter/capture parity. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
