...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Julia audit `.14.2.4.0` signoff-complete, atomic commit pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Dart admission landed clean at `c2a88218`; Julia audit `.14.2.4.0` proves all 92 canonical source-boundary helpers are known across one copied-input, UTF-8-code-unit runtime and shared native/loaded/reconstructed/generated/emitted engine, but 0/7 neutral aliases are known or canonicalized and each fails as unsupported. It adds no production behavior or misleading RED, splitting exact alias parity `.14.2.4.0.1` before dormant typed RED `.14.2.4.0.2`. Focused Julia 82/65/104/13, complete Julia, storage 18/5, CLI 66x2, corpus 105/105, neutral 6/8/40, and language 246/105+1/122 pass. The sole-facing book already limits admitted internal support and the seven aliases to Perl/Rust/Dart while leaving Julia/Lua pending; its 79-file/14,164-KiB render preserves separate paragraphs. Knowledge Map is 787/6,450; all seven doctrines pass. Definitive canonical CI passes capability 80/0/0, typed Perl 10 plus Rust/Dart 4/4, composed semantic/MCP, containment/relocation, CLI 66x2, RAM 79%, Phase 0 1,031/1,031, and the exact pass marker. Atomic commit 157/300, brief clearing, and clean proof remain before task-tree-first Julia alias parity `.14.2.4.0.1`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
