...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT descriptor v1 `.9.1.7.3` is complete and prepared for commit from `d4b910e8`; generated-source v2 `.9.1.7.4` activates only after that commit leaves a clean tree. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
