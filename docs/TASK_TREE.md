...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.30 closes 30/55 children, 43,028 fragments / 1,329,169 bytes; call projection complete, semantic index through 399. All 28 tests and semantic 6/20/128 checks pass. Nine controls extend .67 container evidence and own .2.20 regex correlation with seven valid/arity-rejection controls. Earlier owners/gates and capacity 9c644ecb remain; next .1.31 while .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.30 complete | `Session required reading / startup .3.4` | Reading is 30/55 children, 43,028 fragments / 1,329,169 bytes; call projection complete and semantic index through 399. All 28 tests and semantic 6/20/128 checks pass. Nine controls extend startup .67 and own .2.20 regex correlation with two children; seven valid/arity-rejection controls and all prior findings retain evidence. Next .1.31 follows the focused clean commit; repairs remain gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
