...
| `INTER-MATCH-GAP-CAPTURE` | `active` / Rust reconstruction/generated-plan `.3.3` signoff-complete from clean `5c4e9d50` | `.spec language evolution / lossless segmentation and source preservation` | The admitted Perl consumer runs ordinarily and in the rooted route at gap 2/7/56. Rust authored/static `.3.1` landed at `95127e1d`; private native `.3.2` landed as atomic 229 at `5c4e9d50`. `.3.3` now has green ordinary reconstruction, descriptor projection, and separate generated-plan parity while the final consumer remains ignored; `.3.4-.3.5` retain emitted and primary/admission ownership and `.3.4` waits for clean atomic 230. Five later runtime routes, recurring/public rows, typed composition, generated-plan v2, and outward surfaces remain pending or unchanged. | [docs/tasks/INTER-MATCH-GAP-CAPTURE.md](docs/tasks/INTER-MATCH-GAP-CAPTURE.md) |
