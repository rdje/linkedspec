...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.26 closes 26/55 children, 37,028 fragments / 1,170,180 bytes; 44 tests and staged 123/129 mutations pass. Staged enrichment reaches 3306; eleven private controls own diagnostic-byte overruns (.2.17) and call-count wrap (.2.18). Prior findings stay intact; repairs remain gated. Approved capacity is committed through containment .8/.9, latest 9c644ecb; next .1.27 while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.26 complete | `Session required reading / startup .3.4` | Reading is 26/55 children, 37,028 fragments / 1,170,180 bytes; staged enrichment reaches 3306. All 44 selected tests and staged 123/129 mutations pass; eleven private controls own two resource defects under .2.17/.2.18 and seven repair nodes. Approved capacity remains at 9c644ecb under containment .9 / ADR0111. Next .1.27 follows this focused clean commit; earlier evidence remains intact and repairs are gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
