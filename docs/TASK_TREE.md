...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Generated-source census is 59/0/1: Perl/Rust/Dart pass. Julia scaffold `.3.4.1` is green; family/direct execution `.3.4.2` is active before admission. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
