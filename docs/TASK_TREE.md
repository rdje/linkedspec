...
| `FUTURE-PARITY-BACKLOG` | `active` / Lua boundary audit `.14.2.5.0` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source rollout remains 7/7/41 with Perl/Rust/Dart/Julia admitted and both Lua ABIs pending. The shared Lua audit proves one decoded-input/byte-register runtime and 92/92 canonical helpers across PUC Lua/LuaJIT, but 0/7 neutral compatibility aliases; it therefore splits alias parity `.14.2.5.0.1` before honest dormant RED `.14.2.5.0.2`, with no production/test/public behavior change. Complete Lua 177/177 per ABI, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 17/3, source-unchanged book 79/14,172 with separate rendered blocks, Knowledge 788/6,487, all seven doctrines, RAM 45%, and canonical Phase 0 1,031/1,031 in 672 seconds pass. Atomic commit 163/300, brief clearing, and clean proof remain before `.14.2.5.0.1`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
