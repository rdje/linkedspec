...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia immutable semantic-query no-change closeout `.10.6.5.4` is fully verified from clean public-query commit `1b303cef`; commit the closed `.10.6.5` parent before runtime-observation planning `.10.6.6.0`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
