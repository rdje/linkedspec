...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl metadata-governed attached/parenthesized normalization `.11.3.3.2` is complete; diagnostics/docs/full-gate closeout `.11.3.4` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
helper/user-function/receiver contextual forms. Perl behavior `.11.3.3.2` has since completed and `.11.3.4` is active.
...
is active; the capability remains future before cross-backend parity.
