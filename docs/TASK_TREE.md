...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 35/143 | `Session required reading / startup .3.8` | Generated/inspector tests complete; gap source through 1026. Cumulative 46,538 fragments / 1,405,327 baseline bytes, 86 complete files; approved 113-byte integration delta separately pinned. Next .1.36; all repairs and limits remain. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
