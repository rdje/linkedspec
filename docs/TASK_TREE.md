...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia staged/generated `.10.6.4.2` is a complete verified private 22/25 candidate from clean typed-core commit `9ec3f034`; no-change closeout `.10.6.4.3` follows only after this commit is clean. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
