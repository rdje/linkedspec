...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Exact CLI `.1.5`, census `.1.6.0`, 237-name audit `.1.6.1.0`, universal newline splitting `.1.6.1.1`, and `endswitch` termination `.1.6.1.2.1` are closed. Active `.2.2` completes strict neutral proof. Later leaves own Rust descriptor/diagnostics, native named/file resolution, and Dart full-pipeline trace; generated source remains `.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
