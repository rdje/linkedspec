...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia source/outcome parent `.10.6.2` is composition-closed: committed focused 220, Julia 7,762/primary/105, 5x2x66, ten Unicode legs, no-drift, and canonical proof pass without production change. Static authority plan `.10.6.3.0` is next after the clean closeout commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
