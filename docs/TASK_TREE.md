...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua Unicode exact positive/distinct identity `.10.7.1.2` is complete with unchanged semantic 6/20/89 at rollout 5/9 and admission 4/6. Negative/trust-route and adjacent-grammar isolation `.10.7.1.3` is the next task-tree-first leaf. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
