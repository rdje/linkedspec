...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart 55/55 children, 80,297 fragments / 2,471,305 bytes. Julia .1.51 completes Unicode negative/routes, binding and variadic consumers, then reads write-vivification1–453: 51/52 groups, 74925 lines/2652127 bytes and 93 complete files. Classifier1674, routes81, negative1946, binding61, variadic55 and three complete write testsets362 pass4179 assertions. Neutral Unicode806/9/8/2, binding11/7/6/8, callable3/9/7 and write105 checks pass. Variadic emitted evidence is payload reconstruction, not independent host execution. All repairs remain open; .1.52 completes write and dormant progressive-authority reading. Capacity bef5dafd and CI intake eaf4331e are committed. Next Julia .1.52 after the fifty-first reading commit; containment .11 / ADR0113 is committed at ad64f76f; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Julia .1.51 completes Unicode negative/routes, binding and variadic consumers, then reads write-vivification1–453: 51/52 groups, 74925 lines/2652127 bytes and 93 complete files. Classifier1674, routes81, negative1946, binding61, variadic55 and three complete write testsets362 pass4179 assertions. Neutral Unicode806/9/8/2, binding11/7/6/8, callable3/9/7 and write105 checks pass. Variadic emitted evidence is payload reconstruction, not independent host execution. All repairs remain open; .1.52 completes write and dormant progressive-authority reading. Reading reaches 55/55 children, 80,297 fragments / 2,471,305 bytes; next Julia .1.52 after the fifty-first reading commit; containment .11 / ADR0113 is committed at ad64f76f. All capacities and repair gates remain. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading 51/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged, diagnostic, static, entry and selector-projection and member-suffix and literal-boundary repairs pending | `Session required reading / startup .3.5` | Julia .1.51 completes Unicode negative/routes, binding and variadic consumers, then reads write-vivification1–453: 51/52 groups, 74925 lines/2652127 bytes and 93 complete files. Classifier1674, routes81, negative1946, binding61, variadic55 and three complete write testsets362 pass4179 assertions. Neutral Unicode806/9/8/2, binding11/7/6/8, callable3/9/7 and write105 checks pass. Variadic emitted evidence is payload reconstruction, not independent host execution. All repairs remain open; .1.52 completes write and dormant progressive-authority reading. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
