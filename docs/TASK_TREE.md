...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.5` closes canonical trace at 53/53; `.1.5.1.6` is active for the surfaced UTF-8 argv/file/JSON boundary before pending Rust `.1.5.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
