...
| `MDBOOK-VARIANT-AGNOSTIC` | `active` | `Overall roadmap — documentation and book sync` | `MDBOOK-VARIANT-AGNOSTIC.7` | [docs/tasks/MDBOOK-VARIANT-AGNOSTIC.md](docs/tasks/MDBOOK-VARIANT-AGNOSTIC.md) |
