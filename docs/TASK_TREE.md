...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Rust strict MCP stdio/lifecycle `.10.9.3.2` is complete with focused/canonical proof and exact cleanup. Exact Rust admission `.10.9.3.3` follows only after the clean `.2` commit; no-change closeout `.4` remains later. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
rollout moves in `.1-.2`; exact admission `.10.9.3.3` follows only after the clean `.2` commit.
