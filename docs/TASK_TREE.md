...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.16 closes 16/55 exact reading children, 22,028 fragments / 735,897 bytes; Dart .2.1-.2.8 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.17 continues interpreter value blocks while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.16 complete | `Session required reading / startup .3.4` | Reading is 16/55 children, 22,028 fragments / 735,897 bytes; 100 selected tests pass. Six native controls own action-mediated observer error/stack loss under .2.8. Next .1.17 continues interpreter value blocks. Approved capacity stays at 7d52c98e; .2.1-.2.8 repairs remain gated; startup .37/.54.3 retain progressive/regex ownership. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
