...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.8` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; fourteen Perl files read; `.3.2.9` reads Validation.pm next. Historical coupling records reconciled; `.10` owns unbound AND_BCODE inputs. Codebase/book No; `rgx` excluded. Repairs `.7`–`.10` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
