...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.1.3` done 2026-07-09 - manifest IO scaffold loads the 99-fixture corpus and catches missing/stale fixture drift without parser execution. Next frontier `.2.1` defines frontend AST/data types. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
