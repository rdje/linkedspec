...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.20 closes 20/55 exact reading children, 28,028 fragments / 906,901 bytes; Dart .2.1-.2.14 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.21 continues runtime context/frame and binding machinery while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.20 complete | `Session required reading / startup .3.4` | Reading is 20/55 children, 28,028 fragments / 906,901 bytes; 111 selected tests and neutral numeric 55/18 pass. Eleven number, eight Unicode-order and six slice comparisons own .2.12-.2.14. Next .1.21 continues runtime context/frame and binding machinery. Approved capacity stays at 7d52c98e; repairs remain gated and prior startup/backlog owners remain intact. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
