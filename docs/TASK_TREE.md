...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Containment .7.0 measures Dart demand; .7.1 designs capacity before .3.4 decomposition/reading. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `active` / .7.0 complete | `Repository architecture / documentation sustainability` | From clean Rust closeout 3132596c, .7.0 verifies inventory, bounded packing and insufficient task/Knowledge capacity. Next .7.1 designs the solution; Dart ownership/reading await admission. Limits and exact history remain preserved. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
