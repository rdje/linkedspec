...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust guidance verified; Lua deployment next | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed; workspace .8.2 committed effe3e7b2. Public integration .8.3 committed a1166ee1d removes internal dependency knowledge. Guidance .8.4 verifies prerequisite links and qualified checkout cost. Lua .5.2, common .6 and final .7 remain; strict Lispish stays startup .83. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
