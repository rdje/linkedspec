...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Root selection retains final five-backend recurring/public no-drift at 7/0. Perl duplicate-slot `.9.1.8.1.2` is signoff-complete at 2+5/26 and canonical 1,031/615s; commit preparation remains before Rust `.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
