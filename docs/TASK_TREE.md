...
recovered by startup .85 from integration .8.1. Quoted LF repair .83.2.1 is verified; ADR0124 defines the kind/strict contract; compiler repair .45 is closed; document grammar .83.2.2 is verified on six runtimes; native file delivery and independent public-loader admission close .83 under SEXPR-DOCUMENT-INTEGRATION.1-.2; startup .46 is next.
