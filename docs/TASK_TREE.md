...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia root parent `.9.1.1.2.4` is fully signed off at exact 15 roles, package 3,428, primary 65x2, corpus 105, root 5/7+39, and canonical 1,031/616s; the prepared clean commit precedes Lua root `.5`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
