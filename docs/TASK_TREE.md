...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.5.0` Julia transaction RED signoff-complete | `Overall roadmap - future parity backlog` | Dart admission landed at `38318827` as atomic 196/300 with recognition 132/246/43, rollout 4/9, public 3/14/29, and guide 1/6/10. Julia RED is signoff-complete from that clean boundary: one final-path consumer has explicit authority/integration modes and fails solely for absent private `LinkedSpecJulia.RecognitionTransaction`, while ordinary Julia stays green at storage 19/5 and corpus 105/105. Canonical proof passes CLI 66x2, RAM 60%, and Phase 0 1,031/1,031; commit-ready atomic 197 precedes `.14.3.5.1`. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
