...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.4` locks 33/33 exact help/usage/success/failure cases in default/POSIX environments. `.1.5.1.5` is active for trace and the final Perl gate. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
environments. `.1.5.1.5` is active for explicit trace behavior and the final Perl gate.
