...
recovered by startup .85 from integration .8.1. Quoted LF repair .83.2.1 is verified; ADR0124 defines the kind/strict contract; compiler repair .45.1 is verified; carrier proof .45.2 is verified; canonical .45.3 is next.
...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / targeted startup | `Session continuity / repair selection` | ADR0123 targets2–5 minute recovery and thorough task-specific reading. .85 recovers SEMULITH/LS-001–003; .83.2.1 fixes quoted LF across six runtime routes; ADR0124/.83.1 fixes the design; .45.1 fixes compiler rejection; .45.2 verifies carriers; canonical .45.3 precedes delivery. LS-003 remedies are verified. Full audit remains separate. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is SESSION-STARTUP-READING.45.3 for canonical closeout before strict delivery under ADR0123; historical fixtures retained without further reading. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closed under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is SESSION-STARTUP-READING.45.3 for canonical closeout before strict delivery under ADR0123. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.6` | ADR0119 closes all 51 audited reading children and startup .3.6. All 35 repair roots/145 pending nodes and failed/excluded validation remain intact. Supporting reading and checker correction complete under ADR0120; current verification is SESSION-STARTUP-READING.45.3 under ADR0123. No dependency build or canonical pass claimed. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
| `SUPPORTING-SOURCE-READING` | `active` / required reading closed; six grammar/literal repair roots remain | `Session required reading / startup .3.7` | .1/startup .3.7 close under ADR0120 after checker .2.6. All158 original sources/174 ranges, three reading commits and explicit historical exclusions reconcile. Nine pending repair nodes remain exact. Current verification is SESSION-STARTUP-READING.45.3 under ADR0123. | [docs/tasks/SUPPORTING-SOURCE-READING.md](docs/tasks/SUPPORTING-SOURCE-READING.md) |
| `CONFORMANCE-SOURCE-READING` | `active` / deferred separate audit | `Source audit` | Retain89/143 groups,109904 fragments/4784266 baseline bytes and133 complete files. Next unread .1.90; ADR0123 removes the blanket implementation prerequisite. Current closeout is startup .45.3 before ADR0124 grammar delivery. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
