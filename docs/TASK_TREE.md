...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.3` done 2026-07-09 - Dart corpus execution runs the full checked-in 99-fixture manifest with 99/99 passing and strict manifest drift guards. Next frontier `.6.4`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
