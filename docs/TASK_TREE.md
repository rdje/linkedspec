...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Logical helper parent `.5.2` is closed at 8/0. Cursor rollout is 3/5 at 68 governed migration files; Rust `.9.1.4.0-.6` are committed through `2bba1e91`, and composed admission `.7` plus parent `.9.1.4` are fully verified pending the clean commit before Dart. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
