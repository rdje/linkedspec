...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.1` adds the strict neutral manifest/runner, isolated workspaces, exact channels/files/status, and Perl help baseline. `.1.5.1.2` is active for strict argument/usage fixtures. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
subtests, and direct Perl help conformance pass; `.1.5.1.2` is active for strict argument/usage fixtures.
