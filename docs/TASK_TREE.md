...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia typed core `.10.6.4.1` is a complete verified 18/16 candidate from clean plan commit `3ee4b908`; staged/generated `.10.6.4.2` follows only after this commit is clean. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
