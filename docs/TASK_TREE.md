...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.22 closes 22/55 exact reading children, 31,028 fragments / 989,670 bytes; Dart .2.1-.2.15 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.23 finishes matching and begins recognition transactions while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.22 complete | `Session required reading / startup .3.4` | Reading is 22/55 children, 31,028 fragments / 989,670 bytes; interpreter complete, matching through 900. All 132 selected tests and structural corpus 31/31 pass; no new defect. Next .1.23 finishes matching and begins recognition transactions. Approved capacity stays at 7d52c98e; repairs remain gated and prior startup/backlog owners remain intact. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
