...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.32 closes 32/55 children, 46,028 fragments / 1,418,202 bytes; query/runtime projection complete, static projection through 381. All 21 tests and semantic 6/20/128 checks pass; no new defect. Earlier owners/gates and capacity 9c644ecb remain; next .1.33 while .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.32 complete | `Session required reading / startup .3.4` | Reading is 32/55 children, 46,028 fragments / 1,418,202 bytes; query/runtime projection complete and static projection through 381. All 21 tests and semantic 6/20/128 checks pass; no new defect. Existing .2.1-.2.21 and all startup findings retain evidence. Next .1.33 follows the focused clean commit; repairs remain gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
