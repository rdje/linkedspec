...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.1.1` done 2026-07-09 - Dart SDK 3.9.2 and package layout recorded. Next frontier `.1.2` creates the minimal Dart package scaffold and smoke test. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
