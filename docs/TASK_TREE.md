...
parser-normalized `concat(...)`. Focused Perl AST/trace/validation suites and full phase0 **1022** pass. Active
frontier is now `SPEC-FORMAT-TERSE.8.4` for Rust hard retirement.
