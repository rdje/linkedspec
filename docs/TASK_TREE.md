...
Current director priority: targeted startup under ADR0123, then SEMULITH/LS-001–003,
recovered by startup .85 from integration .8.1. Quoted LF repair .83.2.1 is verified; ADR0124 defines the kind/strict contract; compiler repair .45 is closed; document grammar .83.2.2 is verified on six runtimes; native file delivery and independent public-loader admission close .83 under SEXPR-DOCUMENT-INTEGRATION.1-.2; startup .46 is fixed; .47 is next.
...
| `SESSION-STARTUP-READING` | `active` / targeted startup | `Session continuity / repair selection` | ADR0123 targets2–5 minute recovery and thorough task-specific reading. .85 recovers SEMULITH/LS-001–003; .83.2.1 fixes quoted LF across six runtime routes; ADR0124/.83.1 fixes the design; .45 closes compiler rejection; .83.2.2 verifies the document grammar; .83 is closed by verified grammar, native files and independent public-loader admission. Startup .46 fixes UTF-8 diagnostics and .47.1 fixes argument validation; .47.2 preserves source and values; .47.3 closes the parent; .49 preserves regex boundaries; non-slash .86.1 and division .86.2 are verified; Perl .86.4/.86.5 remain open; PNT resumed; .86.4.2.1 exposes successful-value changes under regex-first selection and restores accepted source/tests. Director precedence decision .86.4.2.2 blocks implementation .86.4.2.3; both rejected candidates are archived. LS-003 remedies are verified. Full audit remains separate. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup repair awaits Perl slash precedence decision SESSION-STARTUP-READING.86.4.2.2 after .86.4.2.1 diagnosis under ADR0123; implementation .86.4.2.3 follows it. Historical fixtures remain retained without further reading. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
