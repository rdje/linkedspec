...
| `FUTURE-PARITY-BACKLOG` | `active` / Lua typed-source admission `.14.2.5.3` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source truth is 8/6/42 with Perl/Rust/Dart/Julia/PUC-Lua/LuaJIT admitted internally. The unchanged Lua value/projection consumer runs once per ABI in ordinary and canonical discovery and passes 240/240 each; only `lua_dual_abi` advances. Complete Lua passes 177/177 per ABI, aliases 638/638, MCP 83,166 bytes, CLI 66x2, corpus 105/105, and storage 18/3 without production, register, result, schema, DSL, README, or other-backend change. The stale artifact guide is root-caused and corrected; book 79/14,184, Knowledge 789/6,512, all seven doctrines, and definitive canonical CI pass, including CLI 66x2, RAM 75%, and Phase 0 1,031/1,031 in 670 seconds. Atomic commit 168/300 remains. Rendered readability stays queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
