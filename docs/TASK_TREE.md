...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust reading and their evidence are complete. Dart .1.25 closes 25/55 children, 35,528 fragments / 1,126,398 bytes; 44 selected tests pass, staged enrichment reaches 1806, and no new defect is established. Existing Dart .2.1-.2.16 and startup owners retain their evidence. Approved .4/.5 capacity is committed through containment .8/.9, latest 9c644ecb; next .1.26 while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.25 complete | `Session required reading / startup .3.4` | Reading is 25/55 children, 35,528 fragments / 1,126,398 bytes; staged enrichment reaches 1806. All 44 selected tests pass; frozen registry and recursive dispatch reconcile without a new defect. Approved engineering-history .5 is committed at 9c644ecb under containment .9 / ADR0111. Next .1.26 follows this focused clean commit; repairs remain gated and earlier owners remain intact. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
