...
| `CONSUMER-REPORT-DELIVERY` | `active` | `SEMULITH / ARCHOGEN blockers` | Director prioritizes consumer delivery: local quote/document fixes are absent from published main87b35665e. .1 verifies native remedies/migration; .2 is next for LS-004 through RGX public reporting; .3 runs canonical proof and publishes the completed fixes. Unrelated startup .86.4.3 stays pending. | [docs/tasks/CONSUMER-REPORT-DELIVERY.md](docs/tasks/CONSUMER-REPORT-DELIVERY.md) |
