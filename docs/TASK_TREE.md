...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT generated-source v2 `.9.1.7.4` is fully verified and prepared for commit; public option removal `.9.1.7.5` activates only after the clean handoff. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
