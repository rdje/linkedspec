...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Containment .7.4 admits bounded Dart ownership; next DART-STARTUP-READING.0 defines children while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `pending` / admitted ownership | `Session required reading / startup .3.4` | .0 freezes exact scoped children after containment .7.4 clean canonical admission. .1 owns reading, .2 owns new repair intake, .3 closes reading and bridges startup .3.4. No source-reading credit yet; existing repairs and parked ideas remain unchanged. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .7.4 admission | `Repository architecture / documentation sustainability` | Canonical implementation 4489f5e9 and independent proof a7d392a8 preserve controls, evidence and reserve. Admission .7.4 creates the pending bounded Dart tree and startup bridge; next DART-STARTUP-READING.0 after exact canonical/commit/clean proof. No source-reading credit or additional capacity change. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
