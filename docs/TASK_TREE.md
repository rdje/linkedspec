...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.2` locks an explicit Perl parser and 22/22 exact help/usage cases in default/POSIX environments. `.1.5.1.3` is active for source/input/parser success bytes. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
