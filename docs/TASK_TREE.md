...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / required codebase reading | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes. Perl/Rust/Dart/Julia reading closed; Lua reading is 51/51. ADR0118 admits finite capacity; Lua reading is closed under ADR0119; startup .3.7.0 owns 21 groups/174 ranges; physical reading 1/21; next SUPPORTING-SOURCE-READING.1.17 reads current authored specs after .0 retires further historical conf/TableScript reading; Lua .2.1-.2.35 own thirty-five concrete repair roots; startup .28.7 owns baseline public-check failure. Supporting code, formal book, policy and all repairs remain. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is SUPPORTING-SOURCE-READING.1.17 after historical configuration dependency disposition; Lua reading is closed. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closes under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is SUPPORTING-SOURCE-READING.1.17 after historical configuration dependency disposition; Lua reading is closed. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.6` | ADR0119 closes all 51 audited reading children and startup .3.6. All 35 repair roots/145 pending nodes and failed/excluded validation remain intact. Next SUPPORTING-SOURCE-READING.1.17 reads current authored specs after .0 historical fixture disposition; no dependency build or canonical pass is claimed. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
| `SUPPORTING-SOURCE-READING` | `active` / one historical group read; six superseded; fourteen code groups pending | `Session required reading / startup .3.7` | Original 158-file/174-range inventory preserved. Conf/TableScript data and smoke tests stay intact; no further manual data reading. Required code: 77 files/88 ranges/17291 fragments/673899 bytes. Next .1.17 authored specs, then EBNF and remaining legacy code. All repairs remain. | [docs/tasks/SUPPORTING-SOURCE-READING.md](docs/tasks/SUPPORTING-SOURCE-READING.md) |
