...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.34 closes 34/55 children, 49,028 fragments / 1,506,533 bytes; emitter/trace complete, validation through 355. All 27 tests, isolated emitted callers, ten-family/eight-case proof and generated-source contract pass; no new defect. Earlier owners/gates and capacity 9c644ecb remain; next .1.35 while .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.34 complete | `Session required reading / startup .3.4` | Reading is 34/55 children, 49,028 fragments / 1,506,533 bytes; emitter/trace complete and validation through 355. All 27 tests, isolated emitted callers, ten-family/eight-case proof and generated-source contract pass; no new defect. Earlier .2.1-.2.22/startup owners retain evidence. Next .1.35 follows the focused clean commit; repairs remain gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
