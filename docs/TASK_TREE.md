...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.33 closes 33/55 children, 47,528 fragments / 1,461,186 bytes; static projection/SHA-256 complete, emitter through 55. All 28 tests and semantic 6/20/128 checks pass. Eight controls extend .70 and own Dart .2.22: four index failures, four valid controls, all runtime results correct. Earlier owners/gates and capacity 9c644ecb remain; next .1.34 while .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.33 complete | `Session required reading / startup .3.4` | Reading is 33/55 children, 47,528 fragments / 1,461,186 bytes; static projection/SHA-256 complete and emitter through 55. All 28 tests and semantic 6/20/128 checks pass. Eight controls extend startup .70 and own regex-arrow .2.22 with two children; four index failures/four valid controls and all runtime results correct. Prior owners retain evidence. Next .1.34 follows the focused clean commit; repairs remain gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
