...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.6.1` private Lua authority signoff-complete; atomic 202 commit-ready | `Overall roadmap - future parity backlog` | Dormant Lua RED landed as atomic 201 at `6a8ec091`. One shared unexported Lua-5.1 authority passes 187/187 on PUC Lua and LuaJIT; integration stops only at missing dedicated ActionIR nodes, with no ordinary/canonical discovery. Recognition stays 132/246/44 at rollout 5/9, public 3/17/33, guide 1/8/12; 12 dormant and 22 authority mutations lock privacy/topology. Ordinary Lua remains 177/177 per ABI, CLI 66x2, corpus 105, storage 18/3; book 79/14,412 KiB, KM 816/6,772, all doctrines, RAM 82%, and Phase 0 1,031/1,031 in 753 sec pass. Integration `.14.3.6.2` follows the clean commit. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
