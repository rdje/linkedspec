...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | All five backends hard-reject exact selectors; cross-variant no-drift `.12.1.8.6` is active. Toolbox repair `.13.1` and structural/progressive/staged authoring arc `.14.1-.4` remain queued behind selector retirement. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
