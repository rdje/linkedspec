...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **ACTIVE 2026-07-08** — `.5.3` added verified Array helper worked examples and tracked split/pipeline return-shape caveats in KM. Next leaf: `.5.4`, Hash + Control Flow helper worked examples. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
