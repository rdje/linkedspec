...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia generated-source v2 `.9.1.6.4` is fully verified and awaiting its prepared clean commit; option removal `.5`, cursor admission `.6`, and root admission `.4.3` remain next in dependency order. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
