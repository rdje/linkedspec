...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Exact CLI `.1.5`, exhaustive current surface `.1.6.1`, and exact descriptors `.1.6.2` are closed. Typed Rust structured diagnostics `.1.6.3.1` pass the full runtime package; final admission `.1.6.3.2` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
