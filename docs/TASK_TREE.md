...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl/Rust v1 baseline proofs are green through Rust exact neutral plan/direct result/trace `.3.1.3.2`; explicit admission `.3.1.3.3` is active before Rust breadth, Dart/Julia emitters, and exact closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
