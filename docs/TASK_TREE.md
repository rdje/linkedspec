...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT cursor parent `.9.1.7` and exact dual-ABI admission `.6` are signoff-complete: 119x2, package 177x2, primary 65x4, corpus 105x2, 69/6+2/49 governance, and canonical 1,031/647s. The clean commit is prepared before root admission. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
