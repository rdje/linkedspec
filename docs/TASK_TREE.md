...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia `.7.3.2.4` closes stable failures/exits and trace sink/reset/emoji behavior after execution/JSON. Active PNT is `.7.3.2.5` direct-process/no-drift closeout; `.1.5`, `.1.6`, and `.3` own global convergence before Lua. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.7.3.2.4` done 2026-07-10 - phase-ordered failures, exit 1/2, complete trace routing/emoji, 1,017 assertions, and 99/99 green. `.7.3.2.5` is active for direct-process/no-drift closeout. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
...
assertions, and 99/99 pass; `.7.3.2.5` is active for direct-process/no-drift closeout.
