...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Scalar numeric v1 is adopted with 55 cases; Perl/Rust alignment `.4.3.3.1.2` is active before Lua implementation. Temporary compatibility retirement is durably owned by `.12.1`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | String helpers close at 76/76; scalar numeric v1 is adopted and Perl/Rust alignment `.4.3.3.1.2` is active. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
