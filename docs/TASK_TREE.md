...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.3.2` Rust integration signoff complete; admission `.14.3.3.3` next | `Overall roadmap - future parity backlog` | Typed-source `.14.2`, neutral transaction `.14.3.1`, and Perl transaction `.14.3.2` are composition-complete. Private Rust authority `.14.3.3.1` landed at `fd8a1934` as atomic 189/300. Integration `.14.3.3.2` is signoff-complete from that clean handoff as intended atomic 190/300: nested dedicated-node/policy/native/reconstructed/generated-plan/emitted proof passes 12/12, outer authority remains 7/7, ordinary discovery remains zero-test, and complete Rust local/canonical gates pass. Production admission, rollout 2/9, and public truth remain unchanged; `.14.3.3.3` is next after clean landing. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
