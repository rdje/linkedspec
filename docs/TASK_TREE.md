...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.4` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; eleven Perl files read; `.3.2.5` reads compiler state next. Codebase/book No; `rgx` excluded. Repairs `.7`–`.9` (cleanup liveness, stale comparison, regex-tail truncation) follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
