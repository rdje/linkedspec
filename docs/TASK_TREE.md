...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.4` done 2026-07-10 - ADR `0022` makes native in-memory host-language embedding the primary backend contract; variant CLIs are thin adapters. Active PNT resumes at `JULIA-BACKEND-PARITY.6.2.4.6`; Lua `.1.3` inherits the native-module gate after Julia. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
