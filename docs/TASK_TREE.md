...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.3.1.0` proved Perl captured source is not standalone-equivalent and corrected the census to 56/2/2. Neutral contract `.3.1.1` is active before Perl repair/admission, Rust breadth, Dart/Julia emitters, and exact closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
