...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia cursor normalization `.9.1.6.1` is verified: exact 36/18/6 typed state, six diagnostics, 353 focused, complete-package/corpus/canonical proof. Its clean commit is required before runtime `.9.1.6.2`; root admission `.4.3` follows cursor closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
