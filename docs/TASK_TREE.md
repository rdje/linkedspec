...
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | `.6.1.4` permanently locks governed offsets 99-104 at 6/6 with endpoints `2,1,2,1,5,5`, closes `.6.1` at 162/162 per ABI, and activates `.6.2` for offsets 40-98. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
