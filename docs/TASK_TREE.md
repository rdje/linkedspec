...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Logical helper parent `.5.2` is closed at 8/0. Composed Perl root-selection admission `.9.1.1.2.1.3` and parent `.1` pass canonical proof at 65x2; clean commit is the boundary before Rust `.2`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
