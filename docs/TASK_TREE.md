...
| `FUTURE-PARITY-BACKLOG` | `active` / dormant Lua typed-source RED `.14.2.5.0.2` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source rollout remains 7/7/41 with Perl/Rust/Dart/Julia admitted and both Lua ABIs pending. One final-path shared Lua consumer is outside ordinary/canonical discovery; explicit core and nested projection modes parse fully and fail identically on PUC Lua/LuaJIT solely for absent `linkedspec.source_location`. It freezes 3/7/6/3 values, four errors, exact 92+7 catalogs, byte/scalar evidence, marks, anonymous boundary, cursor stack, and native/reconstructed/generated-plan results. Parent-declared `.1-.3` core/projection/admission records are now concrete. Complete Lua remains 177/177 per ABI, aliases 638/638, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, language 246/105+1/122; book is source-unchanged at 79/14,180 with separate rendered blocks and Knowledge is 789/6,504. All seven doctrines and definitive canonical containment/relocation, CLI 66x2, RAM 60%, and Phase 0 1,031/1,031 in 667 seconds pass. Atomic commit 165/300 remains before `.14.2.5.1`; rendered readability stays queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
