...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.27 closes 27/55 children, 38,528 fragments / 1,209,661 bytes; 33 tests and Unicode generation/12 neutral fixtures pass. Both staged modules are complete; Unicode mapping reaches 1189. Seventeen private/neutral controls own provenance type repair .2.19; prior .2.1-.2.18 findings remain intact. Approved capacity remains at 9c644ecb; next .1.28 while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.27 complete | `Session required reading / startup .3.4` | Reading is 27/55 children, 38,528 fragments / 1,209,661 bytes; both staged modules complete and Unicode mapping through 1189. All 33 selected tests and Unicode generation/12 neutral fixtures pass. Seventeen private/neutral controls own six malformed provenance acceptances under .2.19 and two children; all prior findings remain intact. Next .1.28 follows this focused clean commit; repairs remain gated. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
