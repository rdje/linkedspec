...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart 46/55 children, 67,028 fragments / 2,053,539 bytes. Dart .1.46 completes interpreter tests and reads matching through 86: 1,500 fragments / 39,292 baseline-identical bytes. All 68 selected tests and write/numeric/named-mark neutral checks pass. The stale current Knowledge answer about absent-container writes is corrected with its historical prose preserved. No new runtime defect; prior findings, CI .80/.81 and source-repair gates remain. Capacity bef5dafd and CI intake eaf4331e are committed. Next Dart .7 capacity decision before .1.47; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.46 complete | `Session required reading / startup .3.4` | Dart .1.46 completes interpreter tests and reads matching through 86: 1,500 fragments / 39,292 baseline-identical bytes. All 68 selected tests and write/numeric/named-mark neutral checks pass. The stale current Knowledge answer about absent-container writes is corrected with its historical prose preserved. No new runtime defect; prior findings, CI .80/.81 and source-repair gates remain. Reading reaches 46/55 children, 67,028 fragments / 2,053,539 bytes; next .7 capacity decision before .1.47. All capacities and repair gates remain. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .10 change-history capacity | `Repository architecture / documentation sustainability` | Director-approved ADR0112 admits exactly files31→32, manifest lines30→31/bytes17039→17615 from clean e55f7703. Exact 218-line / 32108-byte rollover, prior-history reconstruction and 22 actual-validator executions pass. Canonical commit bef5dafd passes nine doctrines, required consumers, CLI66x2 and Phase0 1032/1032; .80.0 records CI findings before Dart .1.37. Other limits and startup gates remain. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
