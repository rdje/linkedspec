...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / checkpoint `.3.3.66` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; codebase No; physical mdBook Yes, formal .4 pending. All sixty-six Rust reading groups reconciled; exact carrier and historical boundaries retained; .77/.78/.79 remain owned; SimEnv repair .76 owned. Next .3.3.67; containment .7 owns later Dart capacity; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
