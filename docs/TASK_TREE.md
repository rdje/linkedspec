...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.7.1` done 2026-07-09 - mdBook usage/status/handoff docs now name the Dart focused gate, opt-in local-CI path, direct Dart commands, interpreter-first 99/99 corpus boundary, and generated-source / Dart-specific CLI follow-ups. Next frontier `.7.2`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
