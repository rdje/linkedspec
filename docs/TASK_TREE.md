...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua/LuaJIT cursor preflight `.9.1.7.0` is complete without behavior changes from clean base `c3bdca44`; typed family/edge normalization `.9.1.7.1` is the next frontier after the preflight commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
