...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia private compiled graph/source/evidence `.10.6.3.1` is complete from clean `99795ddf`: exact 12/14 graph, new 70/focused 290, Julia 7,832/primary/105, full matrix/canonical proof, and no promotion. Remaining privacy/failure/runtime-static/isolation `.10.6.3.2` follows only after the clean graph commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
