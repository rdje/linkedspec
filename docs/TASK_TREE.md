...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / checkpoint `.1` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | `.2` finishes the roadmap reading from baseline line 1341; codebase, mdBook, and supplied-policy review follow. Full-reading answers remain No; `rgx` is excluded by the director. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
