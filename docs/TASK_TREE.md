...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia calls/staging/generated plan `.10.6.4.0` is a complete verified candidate from clean static closeout `4a580295`; typed core `.10.6.4.1` waits for the clean plan commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
