...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.9 closes 9/55 exact reading children, 11,528 fragments / 410,743 bytes; Dart .2.1-.2.4 own switch/regex/trace/recognition repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.10 finishes the bundle and reads MCP runtime/server while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.9 complete | `Session required reading / startup .3.4` | Reading is 9/55 children, 11,528 fragments / 410,743 bytes; four binding tests, neutral 35/10/10/76 validation, generator freshness and embedded-value identity pass. Next .1.10 finishes the bundle and reads MCP runtime/server. Approved history capacity is committed at 7d52c98e; .2.1-.2.4 repairs remain gated, with broad regex recurrence at startup .54.3. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
