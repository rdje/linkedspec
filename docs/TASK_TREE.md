...
| `BACKEND-INTEGRATION-GUIDES` | `active` / RGX public correction verified; guidance next | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed; workspace .8.2 committed effe3e7b2. Verified .8.3 removes internal dependency procedures/knowledge and uses RGX published integration only. Guidance .8.4, Lua .5.2, common .6 and final .7 remain; strict Lispish stays startup .83. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
