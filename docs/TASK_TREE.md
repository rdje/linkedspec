...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.4.3.6` done 2026-07-09 - Dart helper/value no-drift fixed nested value-path assignment to match the no-autovivification updated-root/null contract. Next frontier `.4.4` implements BACKTRACK behavior. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
