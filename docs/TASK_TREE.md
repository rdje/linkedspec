...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.14` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; seventeen Perl files plus emitter prefix read; `.3.2.15` reads its suffix/LinkedRE/AST. `.14` owns I-block literal/state defects. Codebase/book No; `rgx` excluded. Repairs `.7`–`.14` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
