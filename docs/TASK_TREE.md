...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Generated-source `.3` is closed at 60/0/0. Lua string mechanisms pass 76/76; focused public no-drift `.4.3.2.2.5.1` is active, with shipped proof routed to phase 6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | Helper regex, pure split, and scalar/array mutation pass 76/76; focused public no-drift `.4.3.2.2.5.1` is active, with shipped proof routed to phase 6. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
