...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Dart projection `.14.2.3.2` signoff-complete, atomic commit pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Immutable Dart core landed at `f1b91426`; projection `.14.2.3.2` gives every execution one copied input authority and routes exact typed positions/spans, coordinates, materialization, source slicing, mark/capture state, and cursor controls through that boundary while retaining UTF-16 code-unit registers and all external values/mutations. Fresh detached catalogs expose all 92 rows in 47/30/11/4 families plus seven aliases. Dormant projection passes 4/4, focused runtime/carrier proof 86/86, ordinary discovery 379/379, complete Dart format/analyzer/storage/CLI 66x2/corpus 105, neutral rollout 5/9/39, language coverage 246/105+1/122, sole-facing mdBook 79/14,164 KiB with separate rendered blocks, and Knowledge Map 786/6,431. All seven doctrines and definitive canonical CI pass capability 80/0/0, composed semantic/MCP admissions, containment/relocation, CLI 66x2, RAM 68%, and Phase 0 1,031/1,031 in 677 seconds before the exact pass marker. Commit 155/300, brief clearing, and clean proof remain before admission `.14.2.3.3`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
