...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.7` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; thirteen Perl files read; `.3.2.8` reads SpecEntry.pm next. Pipeline phase/mode boundaries are indexed in Knowledge. Codebase/book No; `rgx` excluded. Repairs `.7`–`.9` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
