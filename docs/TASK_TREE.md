...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.3` locks 29/29 exact help/usage/success cases in default/POSIX environments. `.1.5.1.4` is active for operational failures and stdout purity. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
`.1.5.1.4` is active for operational failures and stdout purity.
