...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust complete, Perl leaves and Dart setup verified | `Phase 6 documentation and adoption / native integration` | Rust ad290bdb4 pushed. Perl .1.1-.1.2 and Dart .3.1 setup are verified; next Dart .3.2 deployment/errors. Strict Lispish repair stays startup .83. Finish remaining guides and independent .7, then conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
