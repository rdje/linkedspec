...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 41/143 | `Session required reading / startup .3.8` | Phase0 through line 3739; 53,234 fragments / 1,789,223 baseline bytes, 97 complete files. Retained proof covers forty-two completed subtests; next .1.42 continues the missing-dot-spec-name test. All runtime repairs and limits remain. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
