...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / required codebase reading | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes. All five backend reading lanes closed; repairs remain. Supporting .4 retains three current grammars/five ranges/629 fragments/96781 bytes; seventeen groups superseded without credit. Supporting .1/startup .3.7 close under ADR0120; next CONFORMANCE-SOURCE-READING.1.60 after exact160-input/143-group decomposition. Later startup/book/policy and repairs remain. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is CONFORMANCE-SOURCE-READING.1.60 after exact conformance/test/Unicode decomposition; historical fixtures retained without further reading. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closed under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is CONFORMANCE-SOURCE-READING.1.60 after exact conformance/test/Unicode decomposition. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.6` | ADR0119 closes all 51 audited reading children and startup .3.6. All 35 repair roots/145 pending nodes and failed/excluded validation remain intact. Supporting reading and checker correction complete under ADR0120; next CONFORMANCE-SOURCE-READING.1.60. No dependency build or canonical pass claimed. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
| `SUPPORTING-SOURCE-READING` | `active` / required reading closed; six grammar/literal repair roots remain | `Session required reading / startup .3.7` | .1/startup .3.7 close under ADR0120 after checker .2.6. All158 original sources/174 ranges, three reading commits and explicit historical exclusions reconcile. Nine pending repair nodes remain exact. Next CONFORMANCE-SOURCE-READING.1.60. | [docs/tasks/SUPPORTING-SOURCE-READING.md](docs/tasks/SUPPORTING-SOURCE-READING.md) |
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading59/143 | `Session required reading / startup .3.8` | Phase0 through25258;74,753 fragments/2,951,000 baseline bytes,97 complete files. Deep inline/marker switch metadata preserves .2.10 observation limits. Next .1.60; .2.5–.2.11 and all prerequisites remain. ADR0122 admitted at ec10be6b. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
