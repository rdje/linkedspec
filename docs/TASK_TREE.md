...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart 55/55 children, 80,297 fragments / 2,471,305 bytes. Containment .13 / ADR0116 implements the director-approved Knowledge lines72000→79000 and decision lines12000→13000. Only these two registry scalars change; the .13-only focused exception keeps normal hooks and future canonical/push requirements. Production validators pass20 threshold and24 authorization executions; exact prior evidence and the full actual-plus-reserve census are preserved. Julia reading remains37/52 groups,53925 lines/1880598 bytes and53 complete files; .1.38 resumes after the clean capacity commit. All previously owned repairs remain open. Capacity bef5dafd and CI intake eaf4331e are committed. Next Julia .1.38 after the approved capacity commit; containment .11 / ADR0113 is committed at ad64f76f; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Containment .13 / ADR0116 implements the director-approved Knowledge lines72000→79000 and decision lines12000→13000. Only these two registry scalars change; the .13-only focused exception keeps normal hooks and future canonical/push requirements. Production validators pass20 threshold and24 authorization executions; exact prior evidence and the full actual-plus-reserve census are preserved. Julia reading remains37/52 groups,53925 lines/1880598 bytes and53 complete files; .1.38 resumes after the clean capacity commit. All previously owned repairs remain open. Reading reaches 55/55 children, 80,297 fragments / 2,471,305 bytes; next Julia .1.38 after the approved capacity commit; containment .11 / ADR0113 is committed at ad64f76f. All capacities and repair gates remain. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading 37/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged, diagnostic, static, entry and selector-projection and member-suffix and literal-boundary repairs pending | `Session required reading / startup .3.5` | Containment .13 / ADR0116 implements the director-approved Knowledge lines72000→79000 and decision lines12000→13000. Only these two registry scalars change; the .13-only focused exception keeps normal hooks and future canonical/push requirements. Production validators pass20 threshold and24 authorization executions; exact prior evidence and the full actual-plus-reserve census are preserved. Julia reading remains37/52 groups,53925 lines/1880598 bytes and53 complete files; .1.38 resumes after the clean capacity commit. All previously owned repairs remain open. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .13 approved finite evidence allowance | `Repository architecture / documentation sustainability` | Containment .13 / ADR0116 implements the director-approved Knowledge lines72000→79000 and decision lines12000→13000. Only these two registry scalars change; the .13-only focused exception keeps normal hooks and future canonical/push requirements. Production validators pass20 threshold and24 authorization executions; exact prior evidence and the full actual-plus-reserve census are preserved. Julia reading remains37/52 groups,53925 lines/1880598 bytes and53 complete files; .1.38 resumes after the clean capacity commit. All previously owned repairs remain open. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
