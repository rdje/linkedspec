...
| `SCALAREF-RETIREMENT` | `active` | `Overall roadmap — .spec language evolution / compatibility retirement` | `SCALAREF-RETIREMENT.4` — remove Perl/Rust recognition/execution for `scalaref(...)` after the live spec/test/corpus/doc surface was migrated in `.3` | [docs/tasks/SCALAREF-RETIREMENT.md](docs/tasks/SCALAREF-RETIREMENT.md) |
