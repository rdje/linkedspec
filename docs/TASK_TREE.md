...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart 55/55 children, 80,297 fragments / 2,471,305 bytes. Julia .1.45 completes staged-call, compilation and three query consumers, then reads observation-routes1–149: 45/52 groups, 65925 lines/2312746 bytes and 74 complete files. Six suites pass759 assertions: compilation85, call core79, staged62, kernel100, traversal118 and public315. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Static hashes and rejected-request fixtures do not close shared budget .82 or other repairs. Runtime-route bodies remain partial; .1.46 continues observation/source/static consumers. Capacity bef5dafd and CI intake eaf4331e are committed. Next Julia .1.46 after the forty-fifth reading commit; containment .11 / ADR0113 is committed at ad64f76f; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Julia .1.45 completes staged-call, compilation and three query consumers, then reads observation-routes1–149: 45/52 groups, 65925 lines/2312746 bytes and 74 complete files. Six suites pass759 assertions: compilation85, call core79, staged62, kernel100, traversal118 and public315. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Static hashes and rejected-request fixtures do not close shared budget .82 or other repairs. Runtime-route bodies remain partial; .1.46 continues observation/source/static consumers. Reading reaches 55/55 children, 80,297 fragments / 2,471,305 bytes; next Julia .1.46 after the forty-fifth reading commit; containment .11 / ADR0113 is committed at ad64f76f. All capacities and repair gates remain. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading 45/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged, diagnostic, static, entry and selector-projection and member-suffix and literal-boundary repairs pending | `Session required reading / startup .3.5` | Julia .1.45 completes staged-call, compilation and three query consumers, then reads observation-routes1–149: 45/52 groups, 65925 lines/2312746 bytes and 74 complete files. Six suites pass759 assertions: compilation85, call core79, staged62, kernel100, traversal118 and public315. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Static hashes and rejected-request fixtures do not close shared budget .82 or other repairs. Runtime-route bodies remain partial; .1.46 continues observation/source/static consumers. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
