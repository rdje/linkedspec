...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Clean commit `41ed8300` admits Rust at 3/7. Dart behavior-free preflight `.9.1.1.2.3.0` is signed off at exact 64/65x2, package 260, corpus 105, canonical Phase 0, and cleanup; core `.1` waits for its clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
