...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Immutable Julia runtime-observation derivation `.10.6.6.2` is complete and fully verified from clean typed-capture commit `efd0474c`; emitted/generated public propagation `.3` waits for the clean `.2` commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
