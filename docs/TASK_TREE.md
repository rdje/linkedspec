...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | All five backends execute uniform bindings through Lua `.12.1.6`; shipped-source migration `.12.1.7.1` is active before rejection. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
