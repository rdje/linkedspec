...
| --- | --- | --- | --- | --- |
| `MEDIUM-IMPACT` | `active` | `Overall roadmap — medium-impact follow-on` | `.3.3 dual-path cross-check, .1.1 inventory, .2.1 fuzz harness` | [docs/tasks/MEDIUM-IMPACT.md](docs/tasks/MEDIUM-IMPACT.md) |
