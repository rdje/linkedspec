...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **ACTIVE 2026-07-08** — `.5.4` added verified Hash + Control Flow helper worked examples and tracked the direct odd-arity `hash(...)` current-Perl caveat in KM. Next leaf: `.5.5`, Declaration/Capture-Mark/Entry-Match/Input/Call helper worked examples. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
