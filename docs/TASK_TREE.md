...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Root selection retains final five-backend recurring/public no-drift at 7/0. Duplicate-slot neutral ADR/contract `.9.1.8.1.1` is signoff-complete from clean audit `4902f218`; Perl repair `.2` waits for its clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
