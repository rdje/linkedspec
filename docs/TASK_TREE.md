...
| `CONFORMANCE-SOURCE-READING` | `active` / physical reading 40/143 | `Session required reading / startup .3.8` | Phase0 through line 2566; 52,061 fragments / 1,723,739 baseline bytes, 97 complete files. Retained proof covers thirty completed subtests; next .1.41 continues dependency-builder setup. All runtime repairs and limits remain. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
