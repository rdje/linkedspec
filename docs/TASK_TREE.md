...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Immutable Rust semantic capabilities/query `.10.4.4` is signoff-complete from clean `68e31222`; commit/clean-boundary proof is in flight before `.10.4.5`. Semantic rollout/admission remain 2/9 and 1/6. Startup mdBook drift is queued separately under `.23`. repeated-action recurring/public no-drift is closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
