...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.5 closes 5/55 exact reading children, 7,500 fragments / 225,536 bytes; Dart .2.1/.2.2 own switch/regex repairs, and next DART-STARTUP-READING.1.6 resumes spec AST/CLI/compiler while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.5 complete | `Session required reading / startup .3.4` | .1.6 resumes spec AST/CLI/compiler after the clean .1.5 commit. Reading is 5/55 children, 7,500 fragments / 225,536 bytes; 55/55 selected tests pass. Confirmed switch .2.1 and regex .2.2 repairs remain gated; startup .54.3 owns broad regex recurrence. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `done` / .7.4 admission | `Repository architecture / documentation sustainability` | Canonical admission a67a18bf closes the approved capacity prerequisite after implementation 4489f5e9 and independent proof a7d392a8. Controls, retained evidence and finite reserve are preserved; the active Dart tree owns subsequent reading. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
