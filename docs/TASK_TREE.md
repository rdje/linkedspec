...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl `.14.7.3.0-.4` closed through intended canonical admission | `Overall roadmap - future parity backlog` | The 143-check Perl oracle proves four fresh-authority routes and exact ordinary/canonical admission at 78 neutral mutations without public or format movement; Rust dormant RED `.14.7.4.0` is next. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
