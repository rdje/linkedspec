...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / required codebase reading | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes. Perl/Rust/Dart/Julia reading closed. Lua has 51 frozen pending children across all 99 baseline files; next LUA-STARTUP-READING.4.2 records explicit capacity/verification disposition. Supporting code, formal book and policy review remain; all repairs and rgx exclusion persist. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is LUA-STARTUP-READING.4.2 explicit capacity/verification disposition before Lua reading. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | All 52 reading groups and independent component/audit proof close under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is LUA-STARTUP-READING.4.2 capacity disposition. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / plan frozen; reading pending | `Session required reading / startup .3.6` | 51 pending children / 149 exact ranges cover 99 files, 71,269 fragments and 2,732,450 bytes with no reading credit. Next `.4.2` records explicit disposition of eleven finite controls and the .14-only verification exception; the committed proposal preserves all evidence. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `active` / .0-.13 complete; proposed .14 | `Repository architecture / documentation sustainability` | Lua .4.1 proposes eleven finite evidence-control changes under .14. Lua .4.2 owns explicit approval and the .14-only focused/receipt disposition before implementation. All previous controls and completed evidence remain unchanged. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
