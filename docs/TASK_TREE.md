...
Current director priority: publish verified SEMULITH/ARCHOGEN remedies under CONSUMER-REPORT-DELIVERY after fresh proof; LS-004 remains upstream-owned. Targeted startup follows ADR0123. SEMULITH/LS-001–003 were
...
| `CONSUMER-REPORT-DELIVERY` | `active` | `SEMULITH / ARCHOGEN blockers` | Director prioritizes consumer delivery: local quote/document fixes are absent from published main87b35665e. .1 verifies native remedies/migration; .2 reconfirms LS-004 through RGX public reporting; .3 is next for canonical proof and publishes the completed fixes. Unrelated startup .86.4.3 stays pending. | [docs/tasks/CONSUMER-REPORT-DELIVERY.md](docs/tasks/CONSUMER-REPORT-DELIVERY.md) |
