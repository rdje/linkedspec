...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete; Dart 55/55 children, 80,297 fragments / 2,471,305 bytes. Julia .1.44 finishes runtests and semantic call-core consumers, then reads staged-call1–42: 44/52 groups, 64425 lines/2252996 bytes and 69 complete files. Main396 and semantic core79 pass475 assertions, including exact105/105 native corpus output. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Core projection preserves18/16 identity and detached source evidence; its regex fixture does not close .2.15. AST JSON roundtrip is distinct from source/metadata validation. All repairs remain open; .1.45 continues staged/query/observation consumers. Capacity bef5dafd and CI intake eaf4331e are committed. Next Julia .1.45 after the forty-fourth reading commit; containment .11 / ADR0113 is committed at ad64f76f; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Julia .1.44 finishes runtests and semantic call-core consumers, then reads staged-call1–42: 44/52 groups, 64425 lines/2252996 bytes and 69 complete files. Main396 and semantic core79 pass475 assertions, including exact105/105 native corpus output. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Core projection preserves18/16 identity and detached source evidence; its regex fixture does not close .2.15. AST JSON roundtrip is distinct from source/metadata validation. All repairs remain open; .1.45 continues staged/query/observation consumers. Reading reaches 55/55 children, 80,297 fragments / 2,471,305 bytes; next Julia .1.45 after the forty-fourth reading commit; containment .11 / ADR0113 is committed at ad64f76f. All capacities and repair gates remain. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading 44/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged, diagnostic, static, entry and selector-projection and member-suffix and literal-boundary repairs pending | `Session required reading / startup .3.5` | Julia .1.44 finishes runtests and semantic call-core consumers, then reads staged-call1–42: 44/52 groups, 64425 lines/2252996 bytes and 69 complete files. Main396 and semantic core79 pass475 assertions, including exact105/105 native corpus output. Neutral semantic6/20/128 remains rollout9/0 and admission6/0. Core projection preserves18/16 identity and detached source evidence; its regex fixture does not close .2.15. AST JSON roundtrip is distinct from source/metadata validation. All repairs remain open; .1.45 continues staged/query/observation consumers. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
