...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl `.12.1.2`, Rust `.12.1.3`, and Dart `.12.1.4` execute uniform bindings; Julia `.12.1.5` is active before migration/rejection. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
and CLI 61x2 pass; Julia `.12.1.5` is next.
