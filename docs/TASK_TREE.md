...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.0` done 2026-07-10 through Julia `.7.3.1` - ADR `0023` defines complete user-observable parity and one exact primary CLI. Active PNT is Julia `.7.3.2`; `.1.5`, `.1.6`, and `.3` own global convergence before Lua. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.7.3.1` done 2026-07-10 - ADR `0023` ratifies exact public capability/behavior and primary-CLI parity, routes global repairs, and makes public generated source mandatory for complete parity. `.7.3.2` is active for Julia CLI alignment. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
