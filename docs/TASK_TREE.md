...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / required codebase reading | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes. Perl/Rust/Dart/Julia reading closed; Lua reading is 19/51. ADR0118 admits finite capacity; next LUA-STARTUP-READING.1.20 continues exact reading; Lua .2.1-.2.19 own nineteen concrete repairs; startup .28.7 owns baseline public-check failure. Supporting code, formal book, policy and all repairs remain. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is LUA-STARTUP-READING.1.20 after the nineteenth exact Lua reading child. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closes under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is LUA-STARTUP-READING.1.20 after the nineteenth exact Lua reading child. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / source reading 19/51; repairs pending | `Session required reading / startup .3.6` | .1.19 reaches 24,151 fragments/971,258 bytes; 1,202 selected assertions pass. .2.19 owns conditional entry coverage; shared .22/.67.2 retain call/binding omissions. All nineteen roots and prior host failures remain open; next .1.20 under ADR0118; named arguments stay parked. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
