...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.16` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twenty Perl files plus AST parser prefix read; `.3.2.17` finishes the parser and adapters. `.15` owns nested-span loss. Codebase/book No; `rgx` excluded. Repairs `.7`–`.15` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
