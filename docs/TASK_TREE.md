...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; immutable Dart core `.14.2.3.1` signoff-complete, commit pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Rust admission landed at `666751ae`; Dart alias parity landed at `7b76af71`; dormant typed RED landed at `58f4bb85`; neutral rollout remains 5/9 with 39 mutations. Core `.14.2.3.1` adds one copied authority with scalar/UTF-16/line/column/UTF-8 tables and opaque detached positions, spans, and derived text. Exact core 2/2 passes; fatal analysis and ordinary 379 pass; full dormant execution passes 3/4 and fails only at the absent `.2` projection catalog. Complete Dart format 98/0, storage 20/47, CLI 66x2, corpus 105/105, language coverage 246/105/122, neutral 5/9/39, sole-facing source-unchanged mdBook 79/14,152 KiB with separate rendered blocks, and Knowledge Map 786/6,427 pass without helper routing, admission, or public behavior movement. All seven doctrines and definitive canonical CI pass capability 80/0/0, composed semantic/MCP admissions, containment/relocation, CLI 66x2, RAM 61%, and Phase 0 1,031/1,031 in 686 seconds before the exact pass marker. Commit 154/300, brief clearing, and clean proof remain before projection `.14.2.3.2`. Rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
