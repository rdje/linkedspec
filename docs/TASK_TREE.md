...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / checkpoint `.3.3.47` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; codebase No; physical mdBook Yes, formal .4 pending. Minimal-rule/user-function reading reconciled; SimEnv repair .76 owned. Next .3.3.48; containment .7 owns later Dart capacity; rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
