...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Callable extension `.4` is closed: Perl/Rust/Dart/Julia implement exact v1/variadic v2 native/generated execution; Lua remaining work is routed to `.5.1`/`.5.3`/`.8`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
