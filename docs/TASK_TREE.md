...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl progressive carriers `.14.6.2.2` canonical-signoff-complete; admission `.2.3` next | `Overall roadmap - future parity backlog` | From clean authority atomic 261 `e185b352`, one private dedicated node now executes through live, reconstructed, generated-plan, and independently loaded generated-source carriers at 125/125 while preserving Compiler laziness and keeping CI/rollout/outward boundaries closed. `.14.6.2.3` alone owns Perl admission. Rust/Dart/Julia/Lua `.14.6.3-.6`, recurrence `.7`, public `.8`, staged `.14.7`, and combined `.14.8` remain separate. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
