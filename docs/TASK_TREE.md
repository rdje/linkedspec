...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / required codebase reading | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes. Perl/Rust/Dart/Julia reading closed; Lua reading is 5/51. ADR0118 admits finite capacity; next LUA-STARTUP-READING.1.6 continues exact reading; Lua .2.1-.2.7 own seven concrete repairs. Supporting code, formal book, policy and all repairs remain. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is LUA-STARTUP-READING.1.6 after the fifth exact Lua reading child. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closes under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is LUA-STARTUP-READING.1.6 after the fifth exact Lua reading child. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / source reading 5/51; repairs pending | `Session required reading / startup .3.6` | .1.5 reaches 6,945 fragments/283,881 bytes; 578 valid selected controls pass. Existing startup .37.1 owns Lua nested step inheritance; all seven local repairs remain pending. Next .1.6 under ADR0118. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
