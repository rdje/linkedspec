...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Root selection retains final five-backend recurring/public no-drift at 7/0. Cursor admission `.9.1.8` is signoff-complete at 72/7+1/56 with canonical 1,031/631s; its commit is prepared before `.9.1.8.1` may activate. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
