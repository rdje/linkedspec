...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Rust v1 identity/metadata/errors are green under `.3.1.3.1`; exact neutral plan rejection/trace `.3.1.3.2` is active before baseline admission, Rust breadth, Dart/Julia emitters, and exact closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
