...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Variadic callable audit `.4.0` is complete: exact arity spans grammar/staged/descriptor/registry/runtime seams, while open-bound helpers already follow purpose. Neutral syntax/contract `.4.1` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
