...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Exact CLI `.1.5`, exhaustive current surface `.1.6.1`, descriptors `.1.6.2`, structured diagnostics `.1.6.3`, and native resolution `.1.6.4` are closed. Dart trace audit `.1.6.5.0` split the gap; frontend/compiler `.1.6.5.1` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
