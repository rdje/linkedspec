...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.4` done 2026-07-09 - focused Dart verification is available through `tools/run_dart_local.sh` and optional `LINKEDSPEC_RUN_DART=1` local-CI integration. Next frontier `.7.1`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
