...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Exact CLI `.1.5`, exhaustive current surface `.1.6.1`, canonical descriptor identity `.1.6.2.1`, and typed Rust projection `.1.6.2.2` are closed. Active `.1.6.2.3` normalizes outer function records and admits exact four-backend descriptor parity. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
