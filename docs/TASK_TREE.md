...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia behavior-free root preflight `.9.1.1.2.4.0` is signed off at exact 31/65x2, corpus 105, root 34, canonical 1,031, and no behavior. Its clean commit is the boundary before core `.1`; routes `.2`, cursor `.9.1.6`, and admission `.3` follow. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
