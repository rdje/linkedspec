...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl contract-v1 reconstruction/API proof `.3.1.2` is implemented and green; census remains 56/2/2 until active admission `.3.1.3`, followed by Rust breadth, Dart/Julia emitters, and exact closeout. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
