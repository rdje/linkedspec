...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Generated-source `.3.0` audited/split the only 57/1/2 residual: neutral executable contract `.3.1` is active, followed by Rust full-manifest breadth, Dart/Julia emitters, and exact admission. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
