...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.2.5` done 2026-07-09 - Dart corpus execution routes top-level `fn` fixtures through the spec-defined user-function shell; parser-smoke remains 31/31 green. Next frontier `.6.3`. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
