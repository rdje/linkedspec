...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia source `.10.6.2.1` is complete. Outcome `.10.6.2.2` adds one opaque staged compiled-or-failed authority, detached snapshot/diagnostic/entry/generated-plan values, 85 new/focused 220, and Julia 7,762/primary/105 without execution or promotion; composed closeout `.10.6.2.3` follows its clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
