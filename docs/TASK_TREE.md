...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.9` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; fourteen Perl files plus Validation.pm 1–1320 read; `.3.2.10` reads its suffix. `.11.1`–`.11.3` own diagnostic source repairs; Knowledge retrieval corrected. Codebase/book No; `rgx` excluded. Repairs `.7`–`.11` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
