...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | ADR 0032 adopts final-only `name: codeblock`; Perl attached/parenthesized normalization `.11.3.3.2` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
helper/user-function/receiver contextual forms. Perl behavior `.11.3.3.2` is active.
