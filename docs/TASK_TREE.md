...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Julia admission `.14.2.4.3` signoff-complete | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Julia projection routing landed at `779e9757`. The unchanged 127-assertion consumer is included once in ordinary/canonical Julia discovery, and only `julia_runtime` advances neutral truth to 7/7/41. Focused 127/127 and complete Julia byte-fresh MCP/package/storage 19/5/CLI/corpus 105/105 pass without production, register, result, carrier, schema, semantic/MCP, DSL, README, or other-backend changes. Five sole-facing pages build as 79 files/14,172 KiB with separate rendered blocks; Knowledge Map 787/6,467 and all seven doctrines pass. Definitive canonical CI proves capability 80/0/0, typed 7/7/41, composed semantic/MCP, containment/relocation, CLI 66x2, RAM 79%, and Phase 0 1,031/1,031 in 716 seconds. Atomic commit 162/300, brief clearing, and clean proof remain before Lua `.14.2.5.0`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
