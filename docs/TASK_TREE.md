...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **REACTIVATED 2026-07-08** — `.10.5.4.1` resolved the old scorch pause by user directive. Next leaf: `.10.5.5`, fixing `user-model/spec-files-and-rule-paragraphs.md` malformed label-in-block and `Top::AND` sketches. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
