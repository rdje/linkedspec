...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.21` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twenty-nine Perl files read; `.3.2.22` reads MethodExpr. `.16` owns emptiness/host-slot repair. Codebase/book No; `rgx` excluded. Repairs `.7`–`.16` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
