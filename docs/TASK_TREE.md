...
| `RUST-PARITY` | `active` | `Phase 9 — Rust variant (parity follow-on)` | `RUST-PARITY.7.3.4.2` — `.7.3.4.4` added Rust statement-form scalar regex substitution and array split mutation parity plus `lib_reader_sattribute`/`lib_reader_cattribute`; next fix runtime boolean/list-context parity for `portmap` | [docs/tasks/RUST-PARITY.md](docs/tasks/RUST-PARITY.md) |
