...
| `LUA-STARTUP-READING` | `active` / source reading 50/51; repairs pending | `Session required reading / startup .3.6` | .1.50 reaches 70,540 fragments/2,704,332 bytes and 97 complete files; 4976 assertions and two neutral checks pass. New .2.35 owns nineteen missing failure-state oracles proven by 38 surviving mutations; all 35 roots and prior failures stay open; next .1.51 under ADR0118. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
