...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl/Rust complete. Dart .1.29 closes 29/55 children, 41,528 fragments / 1,285,769 bytes; Unicode/scaffold complete, call projection through 347. Eleven tests and semantic 6/20/128 checks pass. Existing .22 and Dart .2.1-.2.19 evidence remains intact and gated; no new defect. Capacity 9c644ecb retained; next .1.30 while startup .3.4 stays pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.29 complete | `Session required reading / startup .3.4` | Reading is 29/55 children, 41,528 fragments / 1,285,769 bytes; Unicode/scaffold complete and call projection through 347. Eleven tests and semantic 6/20/128 checks pass; twelve Unicode runtime fixtures pass. No new defect; existing startup .22 and all prior findings retain ownership and gates. Next .1.30 follows the focused clean commit. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
