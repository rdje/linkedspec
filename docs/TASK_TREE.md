...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.15 closes 15/55 exact reading children, 20,528 fragments / 692,714 bytes; Dart .2.1-.2.7 plus startup .37 own confirmed Dart repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.16 continues interpreter rule dispatch while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.15 complete | `Session required reading / startup .3.4` | Reading is 15/55 children, 20,528 fragments / 692,714 bytes; 82 selected tests and neutral progressive proof pass. Ten controls route nested authority and diagnostic review to startup .37.1/.37.2. Next .1.16 continues interpreter rule dispatch. Approved capacity stays at 7d52c98e; .2.1-.2.7 repairs remain gated; startup .54.3 retains broad regex recurrence. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
