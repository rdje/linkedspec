...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua negative/isolation `.10.7.1.3` is closed at 1,542 assertions per ABI. No-change Unicode recomposition `.10.7.1.4` is active, with semantic governance unchanged at 6/20/89, rollout 5/9, and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
`.10.7.1.4` is active without semantic rollout or admission movement.
