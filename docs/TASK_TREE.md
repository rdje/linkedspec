...
| `LIVE-DOCUMENT-PRESSURE-CONTAINMENT` | `active` / `.6` pending | `Repository architecture / documentation sustainability` | `.5` committed at d6f37492 with exact canonical proof. `.6` owns measured task capacity after the clean .3.3.43 intake; preserve all unique evidence, stable IDs and existing limits. | [docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md](docs/tasks/LIVE-DOCUMENT-PRESSURE-CONTAINMENT.md) |
