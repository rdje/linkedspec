...
| --- | --- | --- | --- | --- |
| `DOC-CODEBASE-ALIGNMENT` | `active` | `Doc/codebase alignment (no-drift doctrine)` | `DOC-CODEBASE-ALIGNMENT.1` | [docs/tasks/DOC-CODEBASE-ALIGNMENT.md](docs/tasks/DOC-CODEBASE-ALIGNMENT.md) |
