...
| `BACKEND-INTEGRATION-GUIDES` | `active` / inventory .0 complete | `Phase 6 documentation and adoption / native integration` | Rust .2.1 next: verified native consumer and guide, then Perl/Dart/Julia/Lua, deployment/errors and final .7. Canonical destinations and setup/API matrix are recorded; return to conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
