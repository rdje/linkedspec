...
| --- | --- | --- | --- | --- |
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.0` done 2026-07-09 - backlog tree created for the seven deferred/future lanes; ADR `0021` records backend rollout order as Dart -> Julia -> Lua with full parity against Perl5/Rust. Next frontier is `.1.1` for Dart backend parity scoping. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
Rust. Active frontier is `FUTURE-PARITY-BACKLOG.1.1` for Dart backend parity scoping.
