...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | ADR 0031 settles callable codeblock design as `{|args| ...}` with dynamic caller context and no lexical capture; neutral contract `.11.2` is active before backend code. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
