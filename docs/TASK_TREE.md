...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / reading `.3.2.6` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; twelve Perl files plus Compiler.pm 1–1041 read; `.3.2.7` reads the compiler suffix. Prior canonical receipt and dated loader evidence preserved. Codebase/book No; `rgx` excluded. Repairs `.7`–`.9` follow reading before mutation setup. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
