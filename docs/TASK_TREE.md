...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Behavior-free Lua Unicode plan `.10.7.1.0` is complete with unchanged semantic 6/20/89 at rollout 5/9 and admission 4/6. Generated classifier/parser/validator implementation `.10.7.1.1` is the next task-tree-first leaf. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
