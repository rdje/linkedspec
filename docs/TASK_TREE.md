...
| `BACKEND-INTEGRATION-GUIDES` | `proposed` / director-authorized next activity | `Phase 6 documentation and adoption / native integration` | `.0` starts after clean conformance .1.34; common onboarding plus Perl/Rust/Dart/Julia/Lua guides and executable consumers, preparation/reuse, packaging/errors and final verification. Return to conformance .1.35 after .7. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
