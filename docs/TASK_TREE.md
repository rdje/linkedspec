...
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | `.6.2.4` mirrors the public leading-trivia cursor boundary, closes history, and raises offsets 40-98 to 59/59 at 165/165 per ABI; successor remeasurement `.6.2.5` is active. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
