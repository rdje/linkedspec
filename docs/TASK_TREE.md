...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia Unicode closeout `.10.6.1.4` is complete from clean `0ce5505f`: focused 3,831, Julia 7,542/primary/105, 5x2x66, ten-leg manifest, unchanged ledgers, canonical Rust 78.46s + Dart 1/1 + primary 66x2 + Phase 0 1,031/630s, and exact 1.57-GB cleanup close `.10.6.1` without code/test/fixture/API/format/ledger change. `.10.6.2.0` follows the clean commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
