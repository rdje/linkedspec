...
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.6.2.4.0` done 2026-07-09 - shipped-spec/parser-smoke corpus window measured at 2/31 green and split into regex, helper, recursion/output, residual parity, and closeout leaves. Next frontier `.6.2.4.1` is the Dart regex-dialect bridge. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
