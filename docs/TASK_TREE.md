...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Lua body-fluent repair `.10.7.1.3.1` is complete at 166 assertions per ABI. Exhaustive negative/trust and adjacent-grammar proof `.3.2` is active, with semantic governance unchanged at 6/20/89, rollout 5/9, and admission 4/6. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
