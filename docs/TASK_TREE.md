...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.2.1` done 2026-07-09 - source-level AST/data types and staged parse-job JSON round-trips landed. Next frontier `.2.2` implements the Dart `.spec` parser. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
