...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Composed PUC Lua/LuaJIT root routes `.9.1.1.2.5.2` are complete: 101x2 focused, exact 32/65x4 primary residuals, and canonical Phase 0 1,031/643s. Cursor `.9.1.7` is next after the clean route commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
