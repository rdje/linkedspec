...
recovered by startup .85 from integration .8.1. Quoted LF repair .83.2.1 is verified; ADR0124 defines the kind/strict contract; compiler repair .45 is closed; document grammar .83.2.2 is verified on six runtimes; native file delivery .83.2.3 is verified under SEXPR-DOCUMENT-INTEGRATION.1; independent final admission .2 is next.
ARCHOGEN/LS-002 complete-document/all-form parsing and ARCHOGEN/LS-003 atom kinds
share the pending ADR0124 delivery under startup .83 with SEMULITH/LS-002.
...
| --- | --- | --- | --- | --- |
| `SEXPR-DOCUMENT-INTEGRATION` | `active` | `Native integration / ARCHOGEN and SEMULITH reports` | `.1` verifies native file delivery with37 cases/36 groups and legacy compatibility; `.2` owns independent canonical admission and startup-parent closeout. | [docs/tasks/SEXPR-DOCUMENT-INTEGRATION.md](docs/tasks/SEXPR-DOCUMENT-INTEGRATION.md) |
| `SESSION-STARTUP-READING` | `active` / targeted startup | `Session continuity / repair selection` | ADR0123 targets2–5 minute recovery and thorough task-specific reading. .85 recovers SEMULITH/LS-001–003; .83.2.1 fixes quoted LF across six runtime routes; ADR0124/.83.1 fixes the design; .45 closes compiler rejection; .83.2.2 verifies the document grammar; .83.2.3 native implementation is verified under SEXPR-DOCUMENT-INTEGRATION.1; .2 owns final admission. LS-003 remedies are verified. Full audit remains separate. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.4` | Dart reading closed under ADR0114; all 69 repair nodes retain their owners. Current startup frontier is SEXPR-DOCUMENT-INTEGRATION.2 for independent document admission under ADR0123; historical fixtures retained without further reading. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
| `JULIA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.5` | Julia reading closed under ADR0117 at 9824c0971; all 80 repair nodes remain pending. Current startup frontier is SEXPR-DOCUMENT-INTEGRATION.2 for independent document admission under ADR0123. | [docs/tasks/JULIA-STARTUP-READING.md](docs/tasks/JULIA-STARTUP-READING.md) |
| `LUA-STARTUP-READING` | `active` / reading complete / repairs open | `Session required reading / startup .3.6` | ADR0119 closes all 51 audited reading children and startup .3.6. All 35 repair roots/145 pending nodes and failed/excluded validation remain intact. Supporting reading and checker correction complete under ADR0120; current frontier is SEXPR-DOCUMENT-INTEGRATION.2 under ADR0123. No dependency build or canonical pass claimed. | [docs/tasks/LUA-STARTUP-READING.md](docs/tasks/LUA-STARTUP-READING.md) |
| `SUPPORTING-SOURCE-READING` | `active` / required reading closed; six grammar/literal repair roots remain | `Session required reading / startup .3.7` | .1/startup .3.7 close under ADR0120 after checker .2.6. All158 original sources/174 ranges, three reading commits and explicit historical exclusions reconcile. Nine pending repair nodes remain exact. Current frontier is SEXPR-DOCUMENT-INTEGRATION.2 under ADR0123. | [docs/tasks/SUPPORTING-SOURCE-READING.md](docs/tasks/SUPPORTING-SOURCE-READING.md) |
| `CONFORMANCE-SOURCE-READING` | `active` / deferred separate audit | `Source audit` | Retain89/143 groups,109904 fragments/4784266 baseline bytes and133 complete files. Next unread .1.90; ADR0123 removes the blanket implementation prerequisite. Current frontier is SEXPR-DOCUMENT-INTEGRATION.2 for independent admission after verified grammar and native file delivery. | [docs/tasks/CONFORMANCE-SOURCE-READING.md](docs/tasks/CONFORMANCE-SOURCE-READING.md) |
