...
| `FUTURE-PARITY-BACKLOG` | `active` / `.14.3.3.0` Rust RED signoff complete | `Overall roadmap - future parity backlog` | Typed-source `.14.2`, neutral transaction `.14.3.1`, and Perl transaction `.14.3.2` are composition-complete; Perl admission landed at `a0595411` as atomic 187/300. Rust dormant RED `.14.3.3.0` is signoff-complete from that clean handoff and commit-ready as atomic 188/300: one neutral-derived cfg-gated consumer reaches sole missing-authority `E0432`, while production behavior, rollout 2/9, and public truth remain unchanged. Private authority `.14.3.3.1` remains pending until the clean commit. `TASK-TREE-METADATA-HYGIENE.5` separately owns active-frontier prevention; rendered readability remains queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
