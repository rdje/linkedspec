...
| `SCALAREF-RETIREMENT` | `active` | `Overall roadmap — .spec language evolution / compatibility retirement` | `SCALAREF-RETIREMENT.2` — inventory all `scalaref(...)` use and select the canonical replacement before migrating specs/docs or removing implementation support | [docs/tasks/SCALAREF-RETIREMENT.md](docs/tasks/SCALAREF-RETIREMENT.md) |
