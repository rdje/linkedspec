...
| `SPEC-LANG-REFERENCE` | `active` | `Overall roadmap — documentation and book sync` | **ACTIVE 2026-07-08** — `.5.5` added verified Declaration, Capture/Mark, Entry/Match, Input, and Call helper examples, corrected stale entry-vs-match book examples to the verified ordered-child shape, and closed helper-catalog sweep `.5`. Next leaf: `.6`, capture/mark cross-example + remaining thin spots. | [docs/tasks/SPEC-LANG-REFERENCE.md](docs/tasks/SPEC-LANG-REFERENCE.md) |
