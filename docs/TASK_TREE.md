...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; typed source-location public teaching `.14.1.2` signoff-complete | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Neutral v1 remains exact at 3/7/6/3 fixtures, 8+8 transitions, six recursive/four structural cases, 92 projections, seven aliases plus two internal ids, 31 diagnostics, 36 mutations, and 14 rollout legs. The sole-facing book now teaches zero/one/two-regex linked responsibilities and accurately reframes five compatibility passages without behavior drift. Knowledge Map 784/6,363, book 79/14,120 KiB, all seven doctrines, definitive CLI 66x2, RAM 48%, and Phase 0 1,031/1,031 in 640 seconds pass. No-change `.14.1.3` follows after the clean 134/300 landing. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
