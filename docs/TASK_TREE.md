...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Dart admission `.9.1.1.2.3.3` is fully signed off at exact 15 roles, 34 mutations, package 270, primary 65x2, corpus 105, 4/7 public/KM lockstep, and canonical Phase 0 1,031/1,031. The prepared clean commit is the sole boundary before Julia `.4` activation. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
