...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Perl now implements ADR 0030's final `...rest`, exact v1/variadic v2 records, eager positional binding, and fresh rest arrays. Rust `.4.2.2` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
