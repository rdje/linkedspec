...
| `FUTURE-PARITY-BACKLOG` | `active` / immutable Lua typed-source core `.14.2.5.1` signoff-complete | `Overall roadmap - future parity backlog` | Typed-source rollout remains 7/7/41 with Perl/Rust/Dart/Julia admitted and both Lua ABIs pending. Private shared Lua core now owns copied decoded sources, scalar/UTF-8-byte/coordinate tables, opaque immutable Position/Span/DerivedText values, detached records, ordered materialization, and four errors. Core mode passes 133/133 on PUC Lua and LuaJIT; projection stops only at missing `typed_source_projection_rows`, leaving routing/admission to `.2-.3`. Complete Lua remains 177/177 per ABI, aliases 638/638, MCP 83,166 bytes, CLI 66x2, corpus 105/105, storage 18/3, language 246/105+1/122; four synchronized book pages render 79/14,180 in separate blocks and Knowledge is 789/6,504. The stale storage card now matches the executable 18-owner census. All seven doctrines and definitive canonical containment/relocation, CLI 66x2, RAM 65%, and Phase 0 1,031/1,031 in 672 seconds pass. Atomic commit 166/300 remains before `.14.2.5.2`; rendered readability stays queued/nonurgent. Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; exclusion public closeout `.24.2` remains closed. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
