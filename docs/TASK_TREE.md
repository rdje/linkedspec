...
| `FUTURE-PARITY-BACKLOG` | `active` / diagnostic `.14.7.1` focused-signoff-complete from clean `e50965b0`; neutral `.14.7.2` next after commit | `Overall roadmap - future parity backlog` | `.14.7.1` preserves normalized wrong-top compile context on all five source backends/six runtimes without moving general staged behavior; `.14.7.2` next ratifies the neutral executable contract. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
