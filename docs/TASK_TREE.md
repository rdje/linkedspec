...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | ADR 0030 and `linkedspec-callable-signature-v1` adopt final `...rest`, v1 exact/v2 variadic records, typed rest arrays, and positional diagnostics. Perl implementation `.4.2.1` is active. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
