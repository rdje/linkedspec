...
| --- | --- | --- | --- | --- |
| `DART-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Dart first)` | `.2.2` done 2026-07-09 - Dart core `.spec` rule parser landed with shipped-spec and rule-only corpus parser coverage. Next frontier `.2.3` implements frontend validation and strict syntax behavior. | [docs/tasks/DART-BACKEND-PARITY.md](docs/tasks/DART-BACKEND-PARITY.md) |
