...
| `BACKEND-INTEGRATION-GUIDES` | `active` / Rust native setup .2.1 complete | `Phase 6 documentation and adoption / native integration` | Rust Lispish/deployment .2.2 next; native example passes two four-value runs. Normal Cargo dependency builds authorized. Complete other guides and final .7, then return to conformance .1.35. | [docs/tasks/BACKEND-INTEGRATION-GUIDES.md](docs/tasks/BACKEND-INTEGRATION-GUIDES.md) |
