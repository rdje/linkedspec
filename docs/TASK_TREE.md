...
| `LUA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Lua third)` | `.6.2.2` preserves one evaluated receiver through `.copy()`, closes the hash-receiver fixture, and raises offsets 40-98 to 57/59 at 164/164 per ABI; flat-array hash splicing `.6.2.3` is active. | [docs/tasks/LUA-BACKEND-PARITY.md](docs/tasks/LUA-BACKEND-PARITY.md) |
