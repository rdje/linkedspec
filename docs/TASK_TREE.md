...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.10 closes 10/55 exact reading children, 13,028 fragments / 472,678 bytes; Dart .2.1-.2.5 own switch/regex/trace/recognition/Unicode ordering repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.11 finishes MCP server/wire and starts the spec parser while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.10 complete | `Session required reading / startup .3.4` | Reading is 10/55 children, 13,028 fragments / 472,678 bytes; 11 selected tests pass. Five controlled probes own Unicode canonical ordering under .2.5. Next .1.11 finishes MCP server/wire and starts the spec parser. Approved history capacity remains at 7d52c98e; .2.1-.2.5 repairs stay gated, with broad regex recurrence at startup .54.3. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
