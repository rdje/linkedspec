...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Dual-ABI Lua root admission `.9.1.1.2.5.3` and parent `.5` are signoff-complete from `7dd70a2d`: exact RED 3/3x2, focused 139/139x2, package 177/177x2, primary 65/65x4, corpus 105/105x2, root 6/1/44, and canonical 1,031/641s pass before the prepared commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
