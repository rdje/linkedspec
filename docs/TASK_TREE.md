...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; dormant Julia RED `.14.2.4.0.2` signoff-complete | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Julia alias parity landed at `3a848631`. One final-path consumer freezes private `LinkedSpecJulia.SourceLocation`, neutral 3/7/6/3 values, four diagnostics, detached exact 92+7 catalogs, named-mark/capture/cursor behavior, and native/reconstructed/generated-plan carriers outside ordinary/canonical discovery. Core and nested projection selections parse and fail only for the absent namespace; production, registers, schema, neutral 6/8/40, language 246/105+1/122, and capability 80/0/0 remain unchanged. Complete Julia passes byte-fresh MCP, package, storage 19/5, CLI, corpus 105/105, and its exact marker. The source-unchanged sole-facing book still leaves Julia typed values/projections pending; its 79-file/14,168-KiB HTML keeps separate audited blocks. Declared implementation children `.14.2.4.1-.3` have full task nodes. Knowledge Map 787/6,455, all seven doctrines, containment/relocation, CLI 66x2, RAM 62%, and Phase 0 1,031/1,031 in 705 wallclock seconds pass. Atomic commit 159/300, brief clearing, and clean proof remain before immutable core `.14.2.4.1`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
