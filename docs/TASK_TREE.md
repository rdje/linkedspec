...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / Rust .3.3.67 complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; full codebase No; physical mdBook Yes, formal .4 pending. Perl and Rust reading complete; exact coverage and pending repairs retained. Dart .1.11 closes 11/55 exact reading children, 14,528 fragments / 512,478 bytes; Dart .2.1-.2.6 own switch/regex/trace/recognition/Unicode ordering/body suffix repairs, and containment .8 / ADR0110 admit the approved history capacity at 7d52c98e; next .1.12 finishes the spec parser and reads the staged registry prefix while startup .3.4 remains pending. rgx reading exclusion remains. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
| `DART-STARTUP-READING` | `active` / .1.11 complete | `Session required reading / startup .3.4` | Reading is 11/55 children, 14,528 fragments / 512,478 bytes; 16 selected tests pass. Fourteen controls own regex/lifecycle-E suffix loss under .2.6. Next .1.12 finishes the spec parser and reads the staged registry prefix. Approved history capacity remains at 7d52c98e; .2.1-.2.6 repairs stay gated, with broad regex recurrence at startup .54.3. | [docs/tasks/DART-STARTUP-READING.md](docs/tasks/DART-STARTUP-READING.md) |
