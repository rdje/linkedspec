...
`.hash_copy()` and wrapper alias `h(...)` remain to be classified by `SPEC-FORMAT-TERSE.8.2.2.2.5`. Active
frontier is now `SPEC-FORMAT-TERSE.8.2.2.2.5`.
