...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia private calls/staging/generated `.10.6.4` is composition-closed in verified closeout `.3` from clean implementation commit `cc229cc5`; query authority audit `.10.6.5.0` follows after the closeout commit. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
