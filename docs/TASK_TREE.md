...
| --- | --- | --- | --- | --- |
| `SESSION-STARTUP-READING` | `active` / diagnosis `.6` complete | `Session continuity prerequisite to RUST-MUTATION-TESTING.1` | Roadmap Yes; `.3` inventories/splits codebase reading, then book/policy review follows. `.7` repairs confirmed EPERM-as-dead cleanup before recovery/purge or mutation setup. Codebase/book remain No; `rgx` is excluded. | [docs/tasks/SESSION-STARTUP-READING.md](docs/tasks/SESSION-STARTUP-READING.md) |
