...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Dart typed audit `.14.2.3.0` signoff-complete / commit-pending | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Rust admission landed at `666751ae`; typed source-location rollout remains 5/9 with 39 mutations. Dart has all 92 canonical source-boundary names but none of the seven neutral aliases: each stays uncanonicalized and returns exact structured `unknown_helper`. The behavior-free audit therefore splits alias parity `.14.2.3.0.1` before dormant typed RED `.14.2.3.0.2`; no production, neutral, schema/identity, semantic/MCP/capability, DSL, root README, or sole-facing book behavior changes. Focused 87, complete Dart format/analyzer/package 375/storage 19/47/CLI 66x2/corpus 105, neutral 5/9/39, all doctrines, canonical capability 80/0/0, containment/relocation, CLI 66x2, RAM 39%, and Phase 0 1,031/1,031 in 666 seconds pass. Alias parity `.0.1` is next after the clean audit commit; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
