...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Julia projections `.14.2.4.2` signoff-complete | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`. Immutable Julia core landed at `4d394752`. Every execution context now owns one copied private source authority, and all 92 canonical helpers plus seven aliases cross typed Position/Span validation, conversion, coordinates, slicing, marks, anonymous boundaries, and cursor controls while retaining zero-based UTF-8 code-unit registers and exact external results/mutations. Fresh detached catalogs are 47/30/11/4 plus seven. Dormant core/projection pass 112/112 and 127/127 across native/reconstructed/generated-plan carriers; alias 141/141, named marks 13/13, cursor 104/104, neutral 6/8/40, and language 246/105+1/122 pass. Complete Julia passes byte-fresh MCP, package, storage 19/5, CLI, corpus 105/105, and its exact marker. The sole-facing book now distinguishes implemented-but-unadmitted Julia projections in four surfaces; its 79-file/14,176-KiB HTML keeps status, command, and limitations separate. Knowledge Map 787/6,463, all seven doctrines, canonical CLI 66x2, RAM 64%, and Phase 0 1,031/1,031 in 680 seconds pass. Atomic commit 161/300 and clean proof remain before admission `.14.2.4.3`; rendered readability stays queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
