...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia routes `.9.1.1.2.4.2` are signed off: focused 57, core 79, loader 82, emitter 59, exact primary 32/65x2, corpus 105, 4/7 governance, KM/book/live lockstep, canonical proof, and cleanup pass without promotion. Its clean commit precedes cursor `.9.1.6`, then admission `.4.3`. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
