...
| `FUTURE-PARITY-BACKLOG` | `active` / exclusion public closeout `.24.2` complete; Perl typed-source projection `.14.2.1.2` signoff-complete | `Overall roadmap - future parity backlog` | Capability exclusion freshness is public-closed under `FUTURE-PARITY-BACKLOG.24`; typed source-location neutral/public `.14.1`, runtime plan/correction `.14.2.0-.0.1`, Perl RED `.14.2.1.0`, immutable core `.1`, and projection `.2` are signoff-complete. Projection `.2` routes the detached 92-row/four-family catalog plus seven aliases through the typed authority with focused 423/423 and canonical Phase 0 1,031/1,031 green. Rollout truth stays 3/11 and sole-facing support stays unchanged until next admission `.14.2.1.3`; rendered readability remains independently queued/nonurgent. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
