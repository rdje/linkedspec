...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | `.1.5.1.0` proves and splits Perl reference drift: implicit options/positionals/environment behavior plus failure stdout trace. `.1.5.1.1` is active for the neutral fixture manifest/runner and help baseline. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
...
failures, and trace/gate are split before code; `.1.5.1.1` is active.
