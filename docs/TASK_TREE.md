...
| `FUTURE-PARITY-BACKLOG` | `active` / recurring four-backend callable governance `.11.7.1` signoff-complete from clean `2a9c6f15` | `Overall roadmap - future parity backlog` | Routed neutral/Perl/Rust/Dart/Julia proof passes 7/11/9/7/4/8 + 10 + 18 + 21 + 125/118/239; 17 mutations, capability 80/0/0, routing 42, KM 774/6,274, mdBook 79/13,992 KiB, seven doctrines, and canonical Phase 0 1,031/1,031 in 825s pass. Commit/clean precede `.11.7.2`; Lua stays `.11.8`; exclusion freshness stays `.24.0-.2`. No runtime/capability-row/MCP movement or push. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
