...
| `FUTURE-PARITY-BACKLOG` | `active` | `Overall roadmap - future parity backlog` | Julia `.7.3.2` is done through nine-family direct process conformance and `runtime-corpus-primary-cli`. Active PNT is Julia `.7.3.3` honest outer no-drift; `.1.5`, `.1.6`, and `.3` own global convergence before Lua. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
| `JULIA-BACKEND-PARITY` | `active` | `Overall roadmap - future backend parity (Julia second)` | `.7.3.2.5` done 2026-07-10 - nine direct process families, focused gate, `runtime-corpus-primary-cli`, 1,017 assertions, and 99/99 green. `.7.3.3` is active for honest outer no-drift. | [docs/tasks/JULIA-BACKEND-PARITY.md](docs/tasks/JULIA-BACKEND-PARITY.md) |
...
`runtime-corpus-primary-cli`. `.7.3.3` is active for honest outer no-drift; global parity remains separately owned.
