...
| `FUTURE-PARITY-BACKLOG` | `active` / Perl `.14.7.3.3` focused-signoff-complete | `Overall roadmap - future parity backlog` | `.14.7.3.3` advances the dormant oracle to 141 GREEN/one carrier-admission RED with breadth-first recurrence, decreasing chains, shared resources, and source rebasing; `.14.7.3.4` owns fresh carriers/admission/Perl rollout next. | [docs/tasks/FUTURE-PARITY-BACKLOG.md](docs/tasks/FUTURE-PARITY-BACKLOG.md) |
