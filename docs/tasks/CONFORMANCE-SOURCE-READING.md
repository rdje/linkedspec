...
- ID: `CONFORMANCE-SOURCE-READING.1.80`
  Status: `done`
  Activation commit: `a19e2588eeff6e4f06de889b4abdd165be5c06cf`.
  Verification tier: `focused`
  Focused checks: Complete source/window/coverage and retained TAP checks; reconcile observation boundaries with canonical Knowledge; preservation, memory, histories, rendered book, direct public checks and normal doctrines.
  Canonical trigger: Ordinary bounded reading and fact reconciliation; no source/public-contract/dependency/infrastructure change or parent closeout.
  ...
  Acceptance: Read every scoped byte in complete bounded windows; retain source identity, exact comprehension, canonical Knowledge reconciliation, concrete finding ownership, focused proof and per-leaf continuity. Unread crossing constructs retain the next range owner.
  Reading evidence: 11 complete windows / 1116 fragments / 65486 bytes; ordered window SHA-256 `22f63513d9476c07cb7936e5124a36243391d1bed417b8ea1b4c884eb92c0eae`.
  Comprehension: Colon literals evaluate bare keys and preserve quoted fixed fields, nested values and expression blocks; retired fat-arrow source diagnoses without raw fallback. Shape binding, receiver families, terminal continuations and numeric/string alias distinctions have exact lowering/runtime checks. Existing .2.14 extends to remaining obsolete explicit-aggregate descriptions and the missing-receiver preamble claim, with public source confirming no missing scalar declaration but an undeclared host-array read. Four public controls reproduce independently loaded host-state sensitivity, now owned by startup .17.1. Scalar assignment expressions return stored values across function/block/helper contexts. Aggregate assignment expression test is partial inside its runtime helper.
  ...
  Candidate proof: Exact baseline inventory/windows and retained TAP PASS; fresh array-receiver 12/12 and public host-state controls 4/4 PASS, with the durable recipe replayed. Knowledge 1157 facts / 9292 question keys; memory 60 lines; histories 284 lines / 46705 bytes and 282 lines / 50060 bytes; mdBook rendered; mutation and aggregate-selector public checks PASS. Preservation verifies 2851 other tracked files / 50664406 bytes, prior task bodies apart from the documented .2.14 and startup .17.1 extensions, 53 other book files / all 1039 headings, histories and parent gitlink. No canonical rerun or push.
...
- ID: `CONFORMANCE-SOURCE-READING.1.84`
  Status: `done`
  Activation commit: `4480cc52b7ca67e54ae02995c02f27aacb5cd45b`.
  Verification tier: `focused`
  Focused checks: Exact complete source/window/coverage reading, scoped Perl TAP and four neutral contracts; source-pinned process controls, prior evidence preservation, memory, Knowledge, histories, rendered book, direct public checks and normal doctrines.
  Canonical trigger: Ordinary bounded reading and existing repair-scope extension; no production, public-contract, dependency or infrastructure change and no parent closeout.
  Director authorization: September 22 confirms the existing reading-checkpoint documentation exception and resumes PNT; implementation remains gated.
  ...
  Acceptance: Read every scoped byte in complete bounded windows; retain source identity, exact comprehension, canonical Knowledge reconciliation, concrete finding ownership, focused proof and per-leaf continuity. Unread crossing constructs retain the next range owner.
  Reading evidence: 10 complete windows / 1500 fragments / 54362 bytes; ordered window SHA-256 `3ca32d29209411869425074b019fa6a21ae019e62e79dc5e15e603573aca37c1`.
  Comprehension: Recognition completion checks typed direct/mutual zero-progress errors and generated falsey commit results. Recursive observation locks dedicated lowering, static/effect barriers, exact detached nine-field records, falsey/failure outcomes, cursor ownership and recursion identities. Repetition executes eight mode and ten special cases, loaded/descriptor/generated/trace/CLI/corpus roles. Root selection preserves explicit/first-marker/first-rule precedence, authored identity, strict graph independence and generated-role attribution. Generated packages share the host process. Root trace reading ends inside an invocation at 359; only complete constructs through line 324 execute. Strict Get remains intentionally unwired and the neutral strict loop is model arithmetic, with separate real-validator cases.
  Verification: Fresh focused proof passes 79 top-level and 475 nested TAP results: recognition 51/99, recursive observation 7/78, repeated action results 10/122, root selection core 7/78 and the complete root routes prefix through line 324 at 4/98. Neutral recognition 138/250/58, typed 14/0/231, repetition 8/0/54 and root 7/0/54 pass. Twelve source-extracted repeated-action process controls confirm signal-status loss and sequential-pipe blocking; both timed-out owned children are reaped. Existing .2.16.1/.2.16.2 now also own the repeated-action CLI helper; all previous repairs and required source/book/policy prerequisites remain. No production repair, fresh-process generated proof, dependency build, canonical run or push is claimed. The first prefix-extraction setup asserted line 329; source inspection corrected it to 324 before any prefix execution.
  Candidate proof: Exact160-input/143-group/302-range audit and ten-window reconstruction PASS; cumulative84 groups/102404 fragments/4504055 baseline bytes/107 complete files independently verified. Four full Perl consumers plus complete route prefix pass79 top-level/475 nested results; all four neutral checks and the source-pinned12-control replay PASS. Preservation checks2855 other files/50693202 bytes,174 conformance/348 startup nodes, all prior recipe blocks, book headings, immutable histories and parent gitlink. Knowledge1160 facts/9309 keys, memory60, both bounded-history checks, mdBook rendering and direct public mutation69/50 and selector68/11 checks pass. Notes are at warning pressure, below mandatory rollover. Normal doctrine hooks govern focused landing; no canonical run or push.
...
- ID: `CONFORMANCE-SOURCE-READING.1.86`
  Status: `done`
  Activation commit: `7e6a8fbfc2ce44f5da94d7536cedfaeebc1ad420`.
  Verification tier: `focused`
  Focused checks: Exact source/window/coverage reading; six complete Perl consumers plus duplicate-slot direct dependency, semantic/duplicate-slot neutral checks, source/task/history preservation, memory, Knowledge, histories, rendered book, public checks and normal doctrine hooks.
  Canonical trigger: Ordinary bounded reading and evidence clarification; no production, public-contract, dependency or infrastructure change or parent closeout.
  ...
  Acceptance: Read every scoped byte in complete bounded windows; retain source identity, exact comprehension, canonical Knowledge reconciliation, concrete finding ownership, focused proof and per-leaf continuity. Unread crossing constructs retain the next range owner.
  Reading evidence: 13 complete windows / 1500 fragments / 61968 bytes; ordered window SHA-256 `4809bc148e5052220956c468ea5fdfdf17cf5a8cfce23351b708e8bcfc36009c`.
  Comprehension: Foundation tests distinguish strict UTF-8 bytes from scalar columns, reject split characters and retain cloned failed-compilation data. Query tests compare all 19 static digests, 26 error boundaries, privacy, detached responses and silence with compilation disabled. Runtime observations preserve exact input, cursor, typed slot/final events, derived copies, sink exception identity and trace/diagnostic neutrality across eight rows. Generated packages share the process; reconstructed_plan validates the minimal plan then calls the same generated executor, without rebuilding it from that plan. Static projections deep-compare neutral snapshots and both mutated copy fields. Admission composes 12 roles and all 20 digests. Sparse AND preserves structural slots 0/1/2 while dispatching only authored actions, live and generated.
  Verification: Six complete consumers pass 146 top-level/634 nested TAP results; the direct-dependent duplicate-slot suite adds 12/62, totaling 158/696. Semantic governance passes 6 fixture groups/20 exact queries/128 mutations with rollout 9/0 and admission 6/0. Duplicate-slot governance passes 5 fixtures/2 diagnostics/6 runtime rows/59 mutations with rollout 7/0. Known runtime and observation repairs remain open with required source/book/policy prerequisites. No new defect or repair closure, fresh-process generated proof, production change, canonical run, dependency build or push is claimed.
  Focused run counts: foundation 5/69, query 9/287, runtime observation 106/37, static projection 5/10, admission 18/197, sparse slots 3/34; duplicate-slot compatibility 12/62 (top-level/nested TAP results).
  Candidate proof: Exact 160-input/143-group/302-range source audit and 13-window reconstruction PASS. Independent cumulative proof confirms 86 groups/105404 fragments/4618616 baseline bytes/120 complete files. Preserve 2857 other files/50716175 bytes, 178 conformance and 348 startup nodes, prior recipes, book headings, immutable histories and parent gitlink. Knowledge 1161 facts/9317 keys, memory 60, both histories below mandatory rollover, rendered book and direct public mutation69/50 and selector68/11 checks pass. Normal doctrine hooks govern focused landing; no canonical run or push.
...
- ID: `CONFORMANCE-SOURCE-READING.1.89`
  Status: `done`
  Activation commit: `dfdb201b63440e3d7c458f026d65233d2966754c`.
  Verification tier: `focused`
  Focused checks: Exact source/window reading; seven complete Perl consumers; typed-source neutral checker; source-pinned process and handler-observation controls; preservation, memory, Knowledge, histories, rendered book, public checks and normal doctrine hooks.
  Canonical trigger: Ordinary bounded reading, diagnostic repair ownership and current fact correction; no production, public-contract, dependency, infrastructure or capacity change or parent closeout.
  ...
  Acceptance: Read every scoped byte in complete bounded windows; retain source identity, exact comprehension, canonical Knowledge reconciliation, concrete finding ownership, focused proof and per-leaf continuity. Unread crossing constructs retain the next range owner.
  Reading evidence: 13 complete windows / 1500 fragments / 53547 bytes; ordered window SHA-256 `53b9f5f72e1d3121a1e20402b1d5850520a916bc37f5d832fd5de6182bf09465`.
  Comprehension: Trace CLI checks exact routed JSON, stderr, compile/invoke events and ambient-trace isolation on operational failure. EmitContext checks removed-selector rejection, canonical lowering, dependency injection and actual cold-process before/after Trace absence. Generated branch helpers test disabled lazy details, enabled context and caught detail errors; startup .24 still owns incoming exception preservation. Non-repetition and repetition consumers execute selected branch outcomes, while four repetition emitter templates are source-checked separately. RuleIR compares planning metadata, lifecycle routing, mixed-action rejection and descriptor compile events. Typed projections compare all 92 catalog rows plus seven aliases, detached catalog copies, live and same-process generated named-mark/absent-match results, and a present zero-width control. Values through226 cover exact scalar positions, coordinates, direct/derived materialization, detached position records and part of the diagnostic subtest; no partial value test is executed.
  Verification: Seven complete consumers pass 27 top-level/402 nested TAP results: CLI3/17, EmitContext4/29, branch3/16, nonrep4/35, rep4/54, RuleIR5/39 and typed projections4/212. Typed neutral governance passes14 complete/0 pending/231 mutations. Twelve EmitContext process controls reproduce both known defects and reap both timeout children. Four source-observation controls prove original6/6 assertions miss Top-only instrumentation removal; the bounded twin passes pristine and fails only assertion4 after removal. Existing .2.16 repairs now own eleven process helpers. New .2.19 owns the cross-handler source assertion; production instrumentation passes the stronger control. Corrected stale EmitContext fallback wording to current rejection. Startup .24 and all prior repair/source/book/policy prerequisites remain. No production change, full immutable-value execution, fresh-process generated proof, canonical run, dependency build or push is claimed.
  Candidate proof: Exact160-input/143-group/302-range audit and13-window reconstruction PASS; independent totals89 groups/109904 fragments/4784266 baseline bytes/133 complete files. All seven consumers, typed231 governance and both durable diagnostic replays pass. Preserve2857 other tracked files/50732575 bytes,175 prior conformance and348 startup nodes, all prior recipe blocks, book headings, immutable histories and parent gitlink; only new .2.19 and its card are added. Knowledge1163 facts/9329 keys, memory60, histories320/56808 and190/36669 lines/bytes, rendered book and direct public mutation69/50 plus selector68/11 pass. Corrected the scratch book command to the wrapper's no-argument interface and the new reading-evidence line to its existing exact spacing; both replays then pass without changing tools. Normal nine-doctrine hooks govern focused landing; no canonical run or push.
  Commit: `CONFORMANCE-SOURCE-READING.1.89 - read trace dispatch and typed source consumers`
...
- ID: `CONFORMANCE-SOURCE-READING.2.16`
  Status: `pending`
  Goal: Make Perl conformance subprocess capture preserve child failure and remain live under output on either pipe.
  ...
  Reading .1.89 extension: Include _run_perl_snippet in t/trace_emit_context_bridge.t, byte-identical to the three prior trace snippets (fced4162bfd99d0d567ae7b83d8acf3a3a0e313c1b4e355e33c838ae3afedccd). Twelve source-pinned original/guard controls confirm both defects and reap both timeout children. Retain exact rejection, owner-injection and cold-process lazy-loading observations. TRACE_EMIT_PROCESS_CAPTURE in the existing fact card owns replay; all repair prerequisites remain.
  Commit: `pending`
...
- ID: `CONFORMANCE-SOURCE-READING.2.16.1`
  ...
  Scope: The eleven subprocess helpers owned by .2.16; retain public helper tuple compatibility or update all direct consumers coherently.
...
- ID: `CONFORMANCE-SOURCE-READING.2.16.2`
  ...
  Scope: The same eleven .2.16 helpers and their direct consumers; check shared TestHelpers separately before choosing reuse.
...
- ID: `CONFORMANCE-SOURCE-READING.2.19`
  Status: `pending`
  Goal: Make the generated non-repetition wrapper source assertion observe only its named handler.
  Scope: The final source-probe subtest in t/trace_generated_nonrep_dispatch.t, preserving its live Get/dump_parser_source carrier, repetition assertions and existing runtime branch controls.
  Dependencies: Required source/book/policy reading; .1.89 scratch diagnosis is not a tracked test repair.
  Evidence: Source-extracted pristine and Top-instrumentation-removed controls both pass all six original assertions. Toolbox dump_parser_source observes four calls in the exact Top body before the scratch-only removal and zero afterward; all source outside Top remains byte-exact. The greedy cross-handler assertion can borrow a later Plus trace call. Bounding assertion4 to the exact Top body passes pristine production and fails only that assertion after removal. Replay: docs/knowledge/perl-trace-wrapper-source-observation-gap.md. No production instrumentation defect is claimed.
  Acceptance: Bound the observation to the exact Top handler and require its instrumentation there. Preserve existing positive source and runtime controls. Pristine production must pass and isolated removal of only Top instrumentation must fail the intended assertion while Plus remains instrumented. Record exact source/tool evidence, focused proof and aligned Knowledge/book claims before commit.
  Verification: `pending`
  Commit: `pending`
...
- `2026-09-22` .1.84: Director confirms documentation-only reading checkpoints before full reading completion; continue PNT, with implementation prerequisites unchanged.
...
- `2026-09-22` .1.89: `CONFORMANCE-SOURCE-READING.1.89 - read trace dispatch and typed source consumers`; activation dfdb201b6; .1.90 follows clean handoff and empty brief.
...
- `2026-09-22` .1.89: Complete trace/typed-projection reading, extend process repair to EmitContext, own and diagnose wrapper-source observation .2.19, and correct stale current fallback wording.
