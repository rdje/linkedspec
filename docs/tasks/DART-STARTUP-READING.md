...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.48` | `pending` | Continue Julia emitter/loader/staged reading after the clean .1.47 commit; Dart repairs retain their startup prerequisites. |
