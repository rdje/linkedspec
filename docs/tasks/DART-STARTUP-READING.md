...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.50` | `pending` | Continue Julia staged/lifecycle/source/Unicode reading after the clean .1.49 commit; Dart repairs retain their startup prerequisites. |
