...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.45` | `pending` | Continue Julia staged/query/observation reading after the clean .1.44 commit; Dart repairs retain their startup prerequisites. |
