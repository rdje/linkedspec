...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.51` | `pending` | Complete Julia Unicode and continue binding/variadic/write reading after clean .1.50; Dart repairs retain their startup prerequisites. |
