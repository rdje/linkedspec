...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.40` | `pending` | Continue Julia root/cursor consumer reading after the clean .1.39 commit; Dart repairs retain their startup prerequisites. |
