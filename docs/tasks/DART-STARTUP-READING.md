...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.49` | `pending` | Continue Julia staged800–2299 reading after the clean .1.48 commit; Dart repairs retain their startup prerequisites. |
