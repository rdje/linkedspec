...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.41` | `pending` | Continue Julia cursor/runtests reading after the clean .1.40 commit; Dart repairs retain their startup prerequisites. |
