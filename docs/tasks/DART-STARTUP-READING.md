...
| --- | --- | --- | --- |
| 1 | `JULIA-STARTUP-READING.1.44` | `pending` | Continue Julia main/semantic-call reading after the clean .1.43 commit; Dart repairs retain their startup prerequisites. |
