...
- Created: `2026-06-16`
- Last updated: `2026-07-01` (**`.2.3.5.4` DONE; frontier `.2.3.5.5`** — number receiver-dot value chains
  ...
  Perl, and Rust `num_add`/`num_mul` consume all supplied operands. The oracle corpus is **50 fixtures** and
  phase0 is **999 green**. Prior **`.2.3.5.3` DONE** — string/scalar receiver-dot value
