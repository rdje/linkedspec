...
| 5 | `DOC-CODEBASE-ALIGNMENT.5` | `pending` | Sync ROADMAP.md's whole status tracker with ROADMAP_V2/reality (split out of .4 — broader drift than .4 anticipated). |
...
| `DOC-CODEBASE-ALIGNMENT.4` | `Reconcile ROADMAP_V2.md Phase 1A row: ActionRewriter historical (DOC-CODEBASE-ALIGNMENT.4)` | Hash backfilled later if useful. |
