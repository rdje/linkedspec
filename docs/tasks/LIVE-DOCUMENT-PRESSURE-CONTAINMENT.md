...
Complete through .14 under director-approved ADR0118. After the verified commit, empty brief and clean proof, continue conformance .1.3 after .1.2 completes guide/callable/signature/mark reading and diagnostic prefix; cumulative1578 fragments/130987 bytes; startup .3.8.0 owns all160 inputs/143 groups; supporting .1/startup .3.7 close under ADR0120; .2.6 applies the granted checker correction without changing registry ceilings; Lua reading is closed under ADR0119. All source repairs and later canonical/push requirements remain.
