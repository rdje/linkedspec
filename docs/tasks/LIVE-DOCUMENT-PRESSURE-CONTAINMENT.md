...
Complete through .14 under director-approved ADR0118. After the verified commit, empty brief and clean proof, continue `LUA-STARTUP-READING.1.14` after the thirteenth reading child. All source repairs and later canonical/push requirements remain.
