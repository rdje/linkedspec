...
Complete through .14 under director-approved ADR0118. After the verified commit, empty brief and clean proof, continue conformance .1.29 after .1.28 reads Unicode-case through EOF and Unicode-rule-label1-517; cumulative36431 fragments/1072226 bytes; startup .3.8.0 owns all160 inputs/143 groups; supporting .1/startup .3.7 close under ADR0120; .2.6 applies the granted checker correction without changing registry ceilings; Lua reading is closed under ADR0119. All source repairs and later canonical/push requirements remain.
