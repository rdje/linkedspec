...
Complete through .14 under director-approved ADR0118. After the verified commit, empty brief and clean proof, continue `SUPPORTING-SOURCE-READING.1.17` with current authored specs after .0 retires further historical fixture reading; Lua reading is closed under ADR0119. All source repairs and later canonical/push requirements remain.
