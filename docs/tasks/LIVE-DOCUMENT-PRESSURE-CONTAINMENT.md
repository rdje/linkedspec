...
Complete through .14 under director-approved ADR0118. After the verified commit, empty brief and clean proof, continue `SUPPORTING-SOURCE-READING.0` to audit the director-narrowed historical configuration scope after the first reading group; Lua reading is closed under ADR0119. All source repairs and later canonical/push requirements remain.
