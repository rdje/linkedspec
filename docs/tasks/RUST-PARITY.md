...
- Created: `2026-06-16`
- Last updated: `2026-06-16` (`.5.5.3` in_progress — Open Question RESOLVED as option (a): fix `capture_from` to Perl match-start parity, user-confirmed; implementing the mark-based capture family)
...
- ID: `RUST-PARITY.5.5`
  ...
  Children: `.5.5.1` (done), `.5.5.2` (done), `.5.5.3` (done), `.5.5.4`
...
| 1 | `RUST-PARITY.5.5.4` | `pending` | anonymous capture-slice variants + fix anon `capture_slice`/`_len` endpoint to match-start (discovered in `.5.5.3`) |
