- ID: `FUTURE-PARITY-BACKLOG.14`
  Status: `active` (2026-08-13; `.14.5.0` landed at `3d0384d1`; `.14.5.1` waits for separate gap admission `.7`)
...
- ID: `FUTURE-PARITY-BACKLOG.14.5`
  Status: `active` (2026-08-13; behavior-free boundary audit `.14.5.0` landed at `3d0384d1`; `.14.5.1` waits for active separate `INTER-MATCH-GAP-CAPTURE.1-.7` program)
