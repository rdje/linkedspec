...
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.1`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from clean dormant-RED atomic 260 `191465f4`; intended atomic 261; no push)
  Goal: Implement immutable Perl registry resolution, bounded rebased source-view authority, cancellation/budget/cycle/progress enforcement, isolated child execution, detachment, and exact private diagnostics; Depends on: `.14.6.2.0`.
  Acceptance: retrieve the committed neutral/RED/ADR/Knowledge/source-location/registry/cancellation/detachment authorities first; add one private authority/core module plus focused authority consumer independent of authored syntax, ActionIR, live/generated wrappers, and rollout; execute every neutral registry/view/authority/cancellation/chain/execution case and exact diagnostics; preserve staged registry, production parser/compiler/runtime/generated source, every rollout/outward path, and parent progress/state.
  Verification tier: `focused`
  Focused checks: authority RED/GREEN and mutations; dormant 83/1 boundary unchanged; neutral/typed/recognition/generated direct dependents; Perl source-location/transaction regressions; Knowledge, task metadata, book/no-public-change, histories, README/memory, nine doctrines, no-carrier/no-production diff, exact diff.
  Canonical trigger: `none — private authority/core and focused consumer only; no authored syntax, carrier, admission, executable governance/CI topology, generated format, storage/path/doctrine infrastructure, or outward behavior`.
  Checklist: [x] ownership [x] committed authority retrieval [x] authority RED [x] registry/source view [x] narrowing/cancellation/bounds [x] isolation/detachment/diagnostics [x] focused proof [x] durable synchronization [x] atomic commit/clean handoff.
  Evidence: exact missing-module RED precedes `LinkedSpec::ProgressiveSpanDispatch`; GREEN executes all neutral 8 view/6 authority/6 cancellation/8 chain/4 execution/26 diagnostic rows plus registry-seed mutation, nested shared budget/calls, view expiry, diagnostic rebase, cyclic result, false payload, and aggregate detachment; six focused Perl files pass 84 top-level tests, neutral 1/9/86, typed 11/3/152, recognition 137/250/58, dormant final-path 83/1 and CI absence stay exact, Knowledge 844/7,146, book/task/history/memory/doctrines/diff pass; no ActionIR/carrier/generated/rollout/outward movement.
  Commit: `FUTURE-PARITY-BACKLOG.14.6.2.1 - add private Perl progressive dispatch authority`
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.2`
  Status: `pending`; Goal: Integrate the dedicated private node through Perl ActionIR recognition/lowering and live, reconstructed, generated-plan, and independently compiled generated-source carriers without widening public surfaces; Depends on: `.14.6.2.1`; Planned tier: `focused`.
