...
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.3`
  Status: `pending`; Goal: Admit the exact Perl contract, remove RED dormancy, promote only the Perl progressive rollout leg, recompose direct dependents, and close `.14.6.2`; Depends on: `.14.6.2.2`; Planned tier: `canonical`.
