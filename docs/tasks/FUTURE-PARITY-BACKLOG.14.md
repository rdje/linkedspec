...
- ID: `FUTURE-PARITY-BACKLOG.14.6.3`
  Status: `active` (2026-08-17; private authority `.3.1` focused-signoff-complete at atomic 265 `58d39fe5`; four dormant carriers `.3.2` canonical-signoff-complete for intended atomic 266; admission `.3.3` next; no push); Goal: Split, implement, and privately admit Rust parity across native, reconstructed, generated-plan, and independently compiled emitted carriers; Depends on: `.14.6.2`; Children: `.14.6.3.0-.14.6.3.3`.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.2`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from exact clean authority atomic 265 `58d39fe5cf481cee6fba9d3bb38ea0e1094fb569`; intended atomic 266; no push); Goal: Integrate the dedicated private Rust node through static recognition/lowering and native, reconstructed, generated-plan, and independently compiled emitted-source carriers while the final consumer remains unrouted; Depends on: `.14.6.3.1`.
  Acceptance: retrieve ADR `0080`, neutral authority, committed Rust authority, dormant final-path consumer, admitted Perl node/carrier topology, Rust static recognition/lowering, engine reconstruction, generated-v2 plan/emitter, and invocation-option seams before implementation; add one exclusive dedicated Rust node with exact literal/identity/top-rule/bare-span policy, carry only its portable operands through native, reconstructed, generated-plan, and independently compiled emitted-source routes, and delegate every route to the committed authority; promote the exact dormant consumer from RED to GREEN without changing its neutral inventory, fixture identity, four-route scope, or ordinary/canonical dormancy; add no CI route, Rust rollout, format version, dependency, other backend, typed recurrence, public/facade/schema/CLI/README, or outward movement.
  Verification tier: `canonical`
  Focused checks: exact authority and final-path consumers including ordinary dormancy; static recognition/lowering and four-carrier local proof; progressive, typed-source, recognition, generated-source, capability, and language direct dependents; Knowledge, mdBook, bounded histories, task/index, README/memory, nine doctrines, exact diff.
  Canonical trigger: `dedicated executable ActionIR/static-language governance plus native, reconstructed, generated-plan, and independently compiled emitted-source carrier behavior move together; exact staged receipt-bound local CI is required before landing even though rollout and CI discovery remain unchanged`.
  Checklist: [x] clean activation/ownership [x] committed authority retrieval [x] Toolbox-led node/carrier audit [x] dedicated static node/lowering [x] native/reconstructed carrier integration [x] generated-plan/emitted-source carrier integration [x] exact dormant consumer GREEN and dormancy [x] direct-dependent synchronization [x] canonical staged receipt [x] atomic commit/clean handoff. Evidence: one exclusive logical-only node, five exact static denials plus residual-generic fail-closed behavior, static recognition effect closure and live-token defense, fresh opaque execution seed, and identical detached native/reconstructed/generated-plan/independently compiled emitted results pass; serialized carriers contain no callback/registry/fingerprint/cancellation/authority; exact authority 4/4 and carrier 1/1 opt in while both ordinary targets execute 0, recursive observation is 7/7, staged registry is 1/1, package check/format pass; first canonical attempt catches six stale neutral snapshot fields in the admitted Perl consumer, then its exact 125/125 proof passes; progressive 2/9/91 with 9 Rust carrier paths + 3 pending groups/11 paths + 10 outward guards, typed 11/3/152, recognition 138/250/58, generated strict Rust 105/105, capability 80/0/0, language 250/126, Knowledge 851/7,198, book 79 files/15 MiB, bounded histories/task/index/memory/nine doctrines/diff and exact staged receipt pass; no admission/format/dependency/other-backend/typed/public/outward movement; Commit: `FUTURE-PARITY-BACKLOG.14.6.3.2 - add dormant Rust progressive dispatch carriers`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.3`
  Status: `pending`; Goal: Admit the unchanged exact Rust consumer in canonical CI, promote only the Rust progressive rollout leg, recompose direct dependents, and close `.14.6.3` without outward or typed-recurring movement; Depends on: `.14.6.3.2`.
