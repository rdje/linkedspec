- ID: `FUTURE-PARITY-BACKLOG.14`
  Status: `active` (2026-08-16; `.14.5.0` landed at `3d0384d1`; `.14.5.1` is unblocked by `INTER-MATCH-GAP-CAPTURE.7.3` signoff from clean `bb0c3768` but remains pending until that closeout lands cleanly)
...
- ID: `FUTURE-PARITY-BACKLOG.14.5`
  Status: `active` (2026-08-16; `.14.5.0` landed at `3d0384d1`; `.14.5.1` is the clean-boundary next owner after canonical-signoff-complete `INTER-MATCH-GAP-CAPTURE.7.3` lands)
...
- ID: `FUTURE-PARITY-BACKLOG.14.5.1`
  Status: `pending; dependency satisfied by INTER-MATCH-GAP-CAPTURE.7.3 signoff from clean bb0c3768; do not activate until its atomic-255 commit/receipt/brief/clean proof`; Goal: Compose the closed separate program's unchanged named-slot/gap-span evidence into typed-source `gap_composition` and a dedicated recurring proof; Depends on: `.14.5.0`, `INTER-MATCH-GAP-CAPTURE.7`; Acceptance: reuse exact gap 9/0/63, public 6/12/10/29, language 250/105+1/126, recognition 137/250/58, six-runtime/carrier, compatibility, and outward-no-drift evidence; add no second syntax/lifecycle/implementation/compatibility/migration owner; promote only `gap_composition`; preserve `recurring_public_no_drift` for `.14.8`; recompose runtime/support ledgers and close `.14.5`.
