- ID: `FUTURE-PARITY-BACKLOG.14`
  Status: `active` (2026-08-25; progressive `.14.6` and staged audit `.14.7.0` are committed; compile-diagnostic parity repair `.14.7.1` is focused-signoff-complete from clean `e50965b0`; neutral contract `.14.7.2` is next after its atomic commit)
...
- ID: `FUTURE-PARITY-BACKLOG.14.4.4`
  Status: `done; signoff-complete` (2026-08-12; task-tree-first from clean Rust-admission commit `91a2b05c`; intended atomic 212/300; no push); Goal: Implement and admit the exact private Dart recursive-observation authority across native, reconstructed, generated-plan, and emitted carriers; Depends on: `.14.4.3`; Acceptance: retrieve the committed neutral/Perl/Rust/Dart invocation, carrier, emitted-source, test, CI, ADR, Knowledge, and Toolbox authorities before implementation; write exact final-path RED before production edits; reuse the source-local monotonic invocation authority and detached nine-field carrier semantics; preserve UTF-16 code-unit registers, child-owned family policy, falsey payloads, typed failures, cursor/mark behavior, and history absence; execute every neutral positive/failure/abort/rejection/cursor/detach case across native, reconstructed, generated-plan, and independently analyzed/executed emitted carriers; promote only Dart; lock ordinary/canonical/storage/public no-drift and preserve the governed repeated-action seam; synchronize task/roadmap/live/Knowledge/mdBook; pass analysis/focused/composed/book/doctrine/canonical signoff; commit as `FUTURE-PARITY-BACKLOG.14.4.4 - admit Dart recursive observation`; clear the brief and land clean before Julia `.14.4.5`; Checklist: [x] clean activation/task ownership; [x] committed authority retrieval; [x] exact final-path RED; [x] private Dart node/policy/authority/runtime implementation; [x] four-carrier execution; [x] rollout/effect/language no-drift; [x] exact six-runtime composition; [x] roadmap/ADR/Knowledge/book/live alignment; [x] doctrine/canonical signoff; [x] atomic commit/clean handoff; Evidence: clean activation boundary `91a2b05c`; no Dart behavior changed before ownership. Retrieval followed the canonical recursive-observation audit, Perl/Rust admissions, Dart transaction and typed-source rollout, and repeated-action authorities before code archaeology. ADR 0056 sections 19-23 and TOOLBOX probe/recurring/transaction routes require one dedicated static form, the existing monotonic authority, one ephemeral detached nine-field completion, unchanged UTF-16 registers and child-owned family/cursor policy, falsey-safe bind-before-error behavior, and shared-engine native/reconstructed/generated/emitted execution without a second stack or history. The new seven-case ordinary-discovery consumer first reaches exact RED: dedicated-node lookup has no element and every execution carrier reports `unknown_helper name="observe_recognition"`; no production source was edited before this missing dedicated-form boundary was captured. GREEN adds one serialized `ActionObserveRecognitionExpr`; fail-closed target/operand/rule and recursive rule/function effect closure; direct-parent/rejected identity in the existing authority; pending-child-only observation scopes; ephemeral completion and detached nine-field binding; typed UTF-16-to-scalar projection; and action-edge single dispatch through the shared engine. The exact consumer passes 7/7 across native, reconstructed, generated-plan, and independently analyzed/executed emitted source; combined transaction/observation/typed-source/repeated-action proof passes 24/24, ordinary package discovery passes 400, fatal analysis reports no issues, and storage passes 22 owners / 47 packages. Typed source is 8/6/73 with Perl, Rust, and Dart on the pending observation row; recognition stays 129+4/246/58, language stays 246/105+1/122, and repeated-action stays 8 governed seams / 54 mutations. Exact six-runtime composition passes Perl 17, Rust observation 7 plus typed source 4, Dart observation 7 plus typed source 4, Julia 127, PUC Lua/LuaJIT 240/240, generated source 105/105, capability 80/0/0, and language 246/105+1/122. Exact five-backend repeated-action composition passes 8/54, Perl 10, Rust/Dart 3/3, Julia 162, Lua 175/175 per ABI, its 5x2 CLI case, and support ledgers. The final rendered book passes 79 files / 14,524 KiB and Knowledge passes 824 facts / 6,869 question keys. All eight doctrines pass. The first staged canonical invocation reached representative-process containment and stopped only because the outer harness denied nested macOS `sandbox-exec` with status 71; the unchanged permission-authorized rerun passes containment/relocation, CLI 66/66 in both option environments, RAM 57%, Phase 0 1,031/1,031 in 752 seconds, and the complete six-runtime typed-source opt-in through exact `[ci] local CI gate passed` with exit 0.
- ID: `FUTURE-PARITY-BACKLOG.14.4.5`
  Status: `done; signoff-complete` (2026-08-12; task-tree-first from clean Dart-admission commit `b1895a05`; intended atomic 213/300; no push); Goal: Implement and admit the exact private Julia recursive-observation authority across native, reconstructed, generated-plan, and emitted carriers; Depends on: `.14.4.4`; Acceptance: retrieve the committed neutral/Perl/Rust/Dart/Julia invocation, carrier, generated/emitted-source, test, CI, ADR, Knowledge, and Toolbox authorities before implementation; write exact final-path RED before production edits; reuse the source-local monotonic invocation authority and detached nine-field carrier semantics; preserve Julia code-unit registers, child-owned family policy, falsey payloads, typed failures, cursor/mark behavior, and history absence; execute every neutral positive/failure/abort/rejection/cursor/detach case across native, reconstructed, generated-plan, and independently executed emitted carriers; promote only Julia; lock ordinary/canonical/storage/public no-drift and the governed repeated-action seam; synchronize task/roadmap/live/Knowledge/mdBook; pass analysis/focused/composed/book/doctrine/canonical signoff; commit as `FUTURE-PARITY-BACKLOG.14.4.5 - admit Julia recursive observation`; clear the brief and land clean before shared Lua `.14.4.6`; Checklist: [x] clean activation/task ownership; [x] committed authority retrieval; [x] exact final-path RED; [x] private Julia node/policy/authority/runtime implementation; [x] four-carrier execution; [x] rollout/effect/language no-drift; [x] exact six-runtime composition; [x] roadmap/ADR/Knowledge/book/live alignment; [x] doctrine/canonical signoff; [x] atomic commit/clean handoff; Activation evidence: Dart `.14.4.4` landed at clean `b1895a05` as atomic 212/300 with empty status and staged/unstaged diffs, zero-byte brief, no rendered-book residue, no background result, and a post-commit memory pointer resolving activation `91a2b05c` to `HEAD^1`. No Julia source or non-task documentation changed before this activation. Authority evidence: the complete recursive-observation audit; Perl, Rust, and Dart admission cards; all four Julia recognition-transaction cards; typed-source rollout; ADR `0056` sections 19-24; and Toolbox typed-source/transaction/storage routes were read before Julia source archaeology. Exact routed baselines pass Julia transaction 207/207, typed source 127/127, repeated action 162/162, and neutral typed source 8/6/73. The Julia admission card's current-labeled 205 count is stale because its own dated boundary leaves recurring/public RED; the two later promotions explain and the executable consumer proves 207. This leaf aligns that Knowledge fact without changing transaction behavior. RED evidence: the seven-group ordinary-discovery consumer was added before production edits and the routed focused run exited 1 with 3 pass / 3 fail / 8 error: dedicated-node lookup was empty, while native, reconstructed, generated-plan, and independently loaded emitted execution all reported unsupported runtime helper `observe_recognition`. This was the exact missing private-form boundary; no Julia production source changed before it was captured. GREEN evidence: one private `ActionObserveRecognitionExpr`, exact static target/operand/rule validation, recursive rule/function effect closure, direct-parent and rejected-attempt identity in the existing authority, pending-entry-only scopes, one ephemeral completion, detached nine-field binding, Unicode-scalar projection from zero-based UTF-8 code-unit registers, and action-edge single dispatch now converge through the shared engine. The final-path consumer passes seven groups / 30 assertions across native, reconstructed, generated-plan, and independently loaded emitted-module carriers; combined Julia transaction/observation/typed-source/repeated-action proof passes 207+30+127+162. Full ordinary Julia, storage 19/5, neutral 8/6/74, exact six-runtime typed-source composition, and exact five-backend repeated-action composition pass. Recognition remains 129+4/246/58 and language remains 246/105+1/122; no public surface moves. An all-live-doc census also caught ARCHITECTURE_STATE.md still claiming Perl-only observation after the already-landed Rust/Dart admissions; this leaf corrects that projection to the current four-runtime boundary without a behavior change. The synchronized book renders 79 files / 14,528 KiB, Knowledge indexes 825 facts / 6,883 question keys, all eight doctrines pass, and the final full Julia package plus storage 19/5 rerun is clean. The first fully staged canonical run exposed one real governance drift at the repeated-action checkpoint: the bounded MEMORY.md rewrite had omitted its still-enforced historical next owner `FUTURE-PARITY-BACKLOG.10.1`. Knowledge retrieval identified the already-recorded task-index marker-anchor hazard; restoring the compact marker within the 60-line cap returned the focused contract to 8 complete / 0 pending / 54 mutations without weakening the checker or changing behavior. The unchanged sandboxed rerun then reached representative process containment and stopped only because the outer harness denied nested macOS `sandbox-exec` with status 71. The permission-authorized unchanged canonical run passes all eight doctrines, exact containment and relocation, CLI 66/66 in both option environments, RAM 60%, Phase 0 1,031/1,031 in 725 seconds, and the optional six-runtime typed-source matrix through exact `[ci] local CI gate passed` with exit 0.
- ID: `FUTURE-PARITY-BACKLOG.14.4.6`
  Status: `done; signoff-complete` (2026-08-12; task-tree-first from clean Julia-admission commit `4666ae9c`; intended atomic 214/300; no push); Goal: Implement one shared Lua-5.1-compatible recursive-observation authority and admit it independently on PUC Lua and LuaJIT across native, reconstructed, generated-plan, and emitted carriers; Depends on: `.14.4.5`; Acceptance: retrieve the committed neutral/Perl/Rust/Dart/Julia/Lua invocation, carrier, emitted-source, test, CI, ADR, Knowledge, and Toolbox authorities before implementation; write exact final-path RED before production edits; reuse the source-local monotonic authority and detached nine-field carrier semantics; preserve UTF-8-byte registers, child-owned family policy, falsey payloads, typed failures, cursor/mark behavior, Lua-5.1 compatibility, and history absence; execute every neutral positive/failure/abort/rejection/cursor/detach case once per PUC Lua and LuaJIT ABI across all four carriers; promote only both Lua observation rows; lock ordinary/canonical/storage/public no-drift and the governed repeated-action seam; synchronize task/roadmap/live/Knowledge/mdBook; pass analysis/focused/composed/book/doctrine/canonical signoff; commit as `FUTURE-PARITY-BACKLOG.14.4.6 - admit Lua recursive observation`; clear the brief and land clean before recurrence `.14.4.7`; Checklist: [x] clean activation/task ownership; [x] committed authority retrieval; [x] exact final-path RED; [x] shared Lua node/policy/authority/runtime implementation; [x] four-carrier execution on both ABIs; [x] rollout/effect/language no-drift; [x] exact six-runtime composition; [x] roadmap/ADR/Knowledge/book/live alignment; [x] doctrine/canonical signoff; [x] atomic commit/clean handoff; Activation evidence: Julia `.14.4.5` landed at clean `4666ae9c` as atomic 213/300 with empty status and staged/unstaged diffs, zero-byte brief, no rendered-book residue, no background result, and a post-commit memory pointer resolving activation `b1895a05` to `HEAD^1`. No Lua source or non-task documentation changed before this activation. Authority evidence: the canonical recursive-observation audit; Perl, Rust, Dart, and Julia admission cards; all three current Lua recognition-transaction cards; typed-source rollout; ADR `0056` sections 19-25; and Toolbox typed-source/transaction/storage routes were read before Lua source archaeology. The shared Lua transaction authority/runtime, typed source adapter, action AST/parser/contracts, compiled-spec validation seam, interpreter rule/action-edge lifecycle, generated plan, emitter, and final-path consumers were then inspected. Exact routed baselines pass recognition 246, typed source 240, and repeated action 175 independently on PUC Lua and LuaJIT; neutral typed source remains 8 complete / 6 pending / 74 mutations. RED evidence: the Lua-5.1-compatible seven-boundary consumer was added at its final ordinary/canonical path before production edits. Both repository-routed ABI runs exit 1 identically with 20 of 29 reached assertions failed: zero dedicated nodes and serialized occurrences, absent target/operand/missing-rule/effect rejection, and unsupported execution across native, reconstructed, generated-plan, and independently loaded emitted carriers. This is the exact missing private-form boundary; no Lua production source changed before capture. GREEN evidence: one Lua-5.1-compatible dedicated node, exact static target/operand/rule validation, recursive rule/function effect closure, direct-parent and rejected-attempt identity in the existing authority, pending-entry-only scopes, one ephemeral completion, detached nine-field binding, Unicode-scalar projection from zero-based UTF-8-byte registers, and action-edge single dispatch now converge through the shared engine. The final-path consumer passes 43 assertions independently on PUC Lua and LuaJIT across native, reconstructed, generated-plan, and independently loaded emitted-source carriers; combined per-ABI transaction/observation/typed-source/repeated-action proof passes 246+43+240+175. Full ordinary Lua, storage 18/3, neutral 8/6/75, exact six-runtime typed-source composition, and exact five-backend repeated-action composition pass. The synchronized book renders 79 files / 14,548 KiB, Knowledge indexes 826 facts / 6,897 question keys, and all eight doctrines pass. The first staged canonical run correctly stopped at the README-policy routed-destination guard because ADR 0056 reached 653 lines against its reviewed 640-line cap; content-preserving compaction returns it to exactly 640 without raising or bypassing the control. Recognition remains 129+4/246/58 and language remains 246/105+1/122; no public surface moves. Definitive signoff evidence: the corrected sandboxed canonical restart passed every doctrine and gate through relocation, then stopped only when the outer harness denied nested macOS `sandbox-exec` at representative containment with status 71. The unchanged permission-authorized `LINKEDSPEC_RUN_TYPED_SOURCE_MATRIX=1 bash tools/run_ci_local.sh` run passes containment/relocation, CLI 66/66 in both option environments, RAM 61%, Phase 0 1,031/1,031 in 734 seconds, and the complete six-runtime typed-source opt-in. Its final matrix independently passes Rust observation 7 plus typed source 4, Dart +11, Julia typed source 127 plus observation 30, and Lua typed source 240 plus recursive observation 43 on PUC Lua and LuaJIT before exact `[ci] local CI gate passed` and exit 0.
- ID: `FUTURE-PARITY-BACKLOG.14.4.7`
  Status: `done; signoff-complete` (2026-08-12; task-tree-first from clean shared-Lua admission commit `77806855`; intended atomic 215/300; no push); Goal: Compose the unchanged neutral and five-backend/six-runtime recursive-observation consumers plus support ledgers into one exact repository-routed recurring proof; Depends on: `.14.4.6`; Acceptance: retrieve the committed neutral, five backend/six runtime admission, recurring-driver, support-ledger, storage, CI, Knowledge, ADR, Toolbox, and mdBook authorities before implementation archaeology; write omission/order/multiplicity/route/storage/canonical-registration RED before any production or driver edit; bind exact sources, repository-routed commands, runtime order, one shared-Lua source over two ABIs, support-ledger order, and project-local storage into one fail-fast proof; promote only recursive-observation recurrence; reject topology drift and preserve public RED plus runtime/API/schema/semantic/MCP/CLI/README behavior; synchronize task/roadmap/live/Knowledge/mdBook; pass focused/composed/book/doctrine/canonical signoff; commit as `FUTURE-PARITY-BACKLOG.14.4.7 - recur recursive observation`; clear the brief and land clean before public closeout `.14.4.8`; Checklist: [x] clean activation/task ownership; [x] committed authority retrieval; [x] exact topology RED; [x] recurring driver/checker implementation; [x] runtime/support-ledger composition; [x] recurrence-only rollout promotion and public RED; [x] canonical/storage registration; [x] roadmap/ADR/Knowledge/book/live alignment; [x] doctrine/canonical signoff; [x] atomic commit/clean handoff; Activation evidence: `.14.4.6` landed at `77806855` as clean atomic 214/300 with empty status and staged/unstaged diffs, zero-byte brief, valid post-commit memory pointer, fresh Knowledge, no rendered-book residue, no background result, and no ambiguous artifact deletion. No recurrence source or non-task documentation changed before this activation. Authority evidence: Knowledge retrieval followed the recursive-observation audit and all five backend admission cards, typed-source rollout and recurring-gate cards, the recognition-transaction recurring precedent, ADR 0056 sections 17 and 19-26, TOOLBOX typed-source/transaction/storage routes, the current neutral contract/checker, both six-runtime drivers, canonical CI registration, project-data routing, and the four sole-facing mdBook pages before recurrence implementation archaeology. These authorities require a dedicated observation-only five-source/six-route proof, project-local routing, three support ledgers, and one opt-in canonical switch; they require promoting only `recursive_observation` to complete while the combined `recurring_public_no_drift` row remains pending for `.14.8`. No parser, compiler, backend runtime, public facade, schema version, semantic/MCP response, CLI, or README behavior may move. RED evidence: the full checker-side topology oracle was added before contract, driver, CI, or production edits. The repository-routed command exits 1 at the exact absent boundary with `ContractError: recursive-observation recurring gate is missing`; it already expects five unique observation sources, six ordered runtime routes, exact commands/source binding, three ordered support ledgers, repository-local storage, workflow routing, canonical opt-in registration, recurrence completion, and 12 new drift regressions while preserving `.14.8` pending. GREEN evidence: the exact contract now binds five tracked observation sources to six ordered runtime routes, one project-data initializer/managed entrypoint, three ordered support ledgers, outside-CWD workflow routing, one canonical opt-in, and 12 new regressions. The neutral checker passes 9 complete / 5 pending / 87 mutations. The dedicated driver passes Perl 7, Rust 7, Dart 7, Julia 30, PUC Lua 43, LuaJIT 43, generated-source strict Rust 105/105, capability 80/0/0, and language 246/105+1/122 through its exact marker. Storage locality passes 1,886 governed files / 447,697 lines / 28 classifier cases, outside-CWD workflow routing passes, and the broader six-runtime typed-source driver remains exact. Only recursive_observation is complete; recurring_public_no_drift remains pending and no runtime or public behavior moved. Documentation evidence: ADR 0056 section 27, Toolbox 4.9.1.1, capability guidance, both roadmaps, architecture/live/memory/change/note layers, the audit/rollout/admission cards plus a new dedicated recurrence card, and all four sole-facing book pages now distinguish current recurrence from pending public no-drift. The generated Knowledge Map passes 827 facts / 6,908 question keys. The repository-routed book build passes 79 generated files / 14,568 KiB; direct HTML checks confirm the command, 9/5/87 status, and plain-language RED/GREEN explanation, and the rendered artifact is removed. Definitive signoff evidence: the first fully staged canonical run passed all eight doctrines and every executable gate through the task-specific matrix but the outer harness denied nested macOS `sandbox-exec` at representative containment with status 71. The unchanged permission-authorized `LINKEDSPEC_RUN_RECURSIVE_OBSERVATION_MATRIX=1 bash tools/run_ci_local.sh` run then passes exact containment and relocation, CLI 66/66 in both option environments, RAM 62%, Phase 0 1,031/1,031 in 723 seconds, and the dedicated matrix's Perl/Rust/Dart 7 each, Julia 30, PUC Lua/LuaJIT 43 each, and all support ledgers before exact `[ci] local CI gate passed` with exit 0.
- ID: `FUTURE-PARITY-BACKLOG.14.4.8`
  Status: `done; signoff-complete` (2026-08-12; task-tree-first from clean recurrence commit `eb8d052c`; intended atomic 216/300; no push); Goal: Complete recursive-observation public projection/no-drift and close `.14.4` without widening the exact neutral surface; Depends on: `.14.4.7`; Acceptance: retrieve and hash the committed neutral/contract/driver/runtime/support/public/ADR/Knowledge/Toolbox/mdBook authorities before implementation archaeology; write exact stale-current/premature-surface/rollout RED before changing the contract or public projections; add an independently governed recursive-observation public projection without changing the accepted 14-row rollout; leave combined `recurring_public_no_drift` pending for final `.14.8`; reject any public helper, authored value, facade, descriptor/generated schema, result schema, semantic/MCP, CLI, README, runtime, or storage drift; recompose all six exact runtime routes plus support ledgers; synchronize the parent/activity, capability guidance, examples, Toolbox, Knowledge, mdBook, roadmaps, and live docs; pass focused/book/doctrine/canonical signoff; commit as `FUTURE-PARITY-BACKLOG.14.4.8 - close recursive observation rollout`; clear the brief and land clean before `.14.5` or another eligible activity; Checklist: [x] clean activation/task ownership; [x] committed-authority retrieval; [x] exact public-no-drift RED; [x] public projection/no-rollout governance; [x] six-runtime/support recomposition; [x] parent/activity closeout; [x] roadmap/ADR/Knowledge/book/live alignment; [x] doctrine/canonical signoff; [x] atomic commit/clean handoff; Activation evidence: `.14.4.7` landed at clean `eb8d052c` as atomic 215/300 with empty staged and unstaged diffs, zero-byte commit brief, fresh Knowledge Map, no rendered-book residue, no background result, and a post-commit pointer resolving activation `77806855` to `HEAD^1`. No contract, implementation, public projection, or non-task documentation changed before this activation. Authority evidence: committed blobs are contract `70e2dfbe`, checker `a141cd5e`, recurrence driver `69a1ed50`, Perl/Rust/Dart/Julia/Lua consumers `35899bf4`/`7410850b`/`f2a12d45`/`641f01c2`/`c6a5b312`, support ledgers `1e0f8a6c`/`1b05d586`/`c8acefff`, capability guide `75583beb`, ADR `0056` `0cb9b0cb`, Toolbox `f6e3f8eb`, four book pages `26db58dc`/`e0d0b1d7`/`b58acc86`/`d3759f6d`, recurrence cards `d2ca73f8`/`50dcb948`, and recognition public-closeout precedent `3a7aeae4`. Director decision: preserve the original accepted 14-row architecture. `.14.4.8` closes recursive-observation public projection and stale-claim governance without rollout movement; it neither adds a fifteenth row nor consumes the combined `.14.8` row early. The `recursive_observation` row stays complete from `.14.4.7`, and `recurring_public_no_drift` stays pending for final program-wide `.14.8`. RED evidence: before contract or public-projection edits, the complete checker-side oracle expected six exact current documents, six forbidden stale claims, ten public-surface guards, exact 14-row ownership/status, and 27 new contract/text/surface mutations. The repository-routed checker exits 1 at the intended absent boundary with exact `ContractError: recursive-observation public no-drift contract is missing`. GREEN evidence: the exact contract binds six current projections, six forbidden stale claims, and ten public facade/API/schema/CLI/README guards while asserting the unchanged 14-row ownership boundary. Nine contract mutations plus eighteen in-memory document/surface mutations advance governance from 87 to 114; the checker passes 9 complete / 5 pending without a public API or rollout promotion. Focused recomposition evidence: the unchanged rooted driver passes neutral 6/6/10/9/5/114, Perl 7, Rust 7, Dart 7, Julia 30, PUC Lua 43, LuaJIT 43, generated-source strict Rust 105/105, capability 80/0/0, and language 246/105+1/122 through its exact success marker. Documentation evidence: ADR 0056 section 28, the capability guide, Toolbox 4.9.1.1, both roadmaps, architecture/live layers, the updated rollout/recurrence cards plus new public-closeout card, and all four sole-facing book pages now distinguish current recursive-observation projection from public API admission and the pending combined `.14.8` row. Knowledge Map passes 828 facts / 6,919 question keys. The repository-routed book build passes 78 generated files / 14,576 KiB; direct HTML checks confirm all four exact current markers plus 9/5/114, and the rendered artifact is removed. All eight doctrines pass. Definitive signoff evidence: the first fully staged sandboxed canonical run passed every doctrine and executable gate through the complete task-specific matrix, then stopped only when the outer harness denied the nested macOS `sandbox-exec` representative-containment probe with status 71. The unchanged permission-authorized `LINKEDSPEC_RUN_RECURSIVE_OBSERVATION_MATRIX=1 bash tools/run_ci_local.sh` run passes all eight doctrines, exact six-family containment and five-anchor relocation, CLI 66/66 in both option environments, RAM 57%, Phase 0 1,031/1,031 in 713 seconds, and the final Perl/Rust/Dart 7, Julia 30, PUC Lua/LuaJIT 43 observation routes plus strict Rust generated-source 105/105, capability 80/0/0, and language 246/105+1/122 ledgers before exact `[ci] local CI gate passed` with exit 0.
- ID: `FUTURE-PARITY-BACKLOG.14.5`
  Status: `done; canonical-signoff-complete for atomic 256` (2026-08-17; `.14.5.0-.1` complete; no push)
  Goal: Compose stable named regex-slot identity and the separately owned `INTER-MATCH-GAP-CAPTURE` contract into lossless prefix/gap/tail span segmentation without duplicating its syntax, lifecycle, or compatibility owner; Children: `.14.5.0`, `.14.5.1`
- ID: `FUTURE-PARITY-BACKLOG.14.5.0`
  Status: `done; landed at 3d0384d1` (2026-08-13; atomic 217/300; no push); Goal: Audit the committed named-slot, typed-source, historical-gap, marker-divergence, and cross-tree authorities and freeze the exact ownership/dependency handoff before gap syntax or implementation work; Depends on: `.14.4.8`, `INTER-MATCH-GAP-CAPTURE.0`, completed duplicate-regex-slot identity rollout; Acceptance: prove clean activation; retrieve and hash ADRs `0045`/`0047`/`0056`, both owning trees, Knowledge facts, contracts, and recurring gates before archaeology; use Toolbox probes to verify numeric identity, named-slot absence, historical Perl gaps, marker divergence, typed spans, and carriers; preserve `INTER-MATCH-GAP-CAPTURE.1-.7` as sole syntax/lifecycle/compatibility/backend owner and `.14.5.1` as post-admission typed-source composition only; freeze prerequisites/evidence/no-overclaim/clean-pivot policy; change no grammar/parser/compiler/runtime/descriptor/generated/helper/value/schema/semantic/MCP/CLI/README/rollout/current claim; synchronize task/index, roadmaps, ADR/Knowledge, mdBook, and live layers; pass focused/book/doctrine/canonical signoff; commit `FUTURE-PARITY-BACKLOG.14.5.0 - freeze lossless gap handoff`; clear the brief and land clean before switching trees; Checklist: [x] clean activation/task ownership; [x] committed authority retrieval; [x] Toolbox-led current audit; [x] cross-tree ownership freeze; [x] no behavior/public overclaim; [x] verify/commit/clean. Activation evidence: `.14.4.8` landed cleanly at `d26e4d4e` as atomic 216/300 with empty status/diffs, zero-byte brief, fresh Knowledge, no rendered-book residue, and no background result. Authority evidence: committed duplicate/typed contracts `ecef5cd5`/`a9e2ca7`, ADRs `0045` `8cf73db2`, `0047` `e9edc734`, ADR `0056` `c37fefb6`, gap/marker/typed Knowledge cards `ad1a41b`/`4da68ef0`/`4b91b43`, both owning task trees `2a17d755`/`97dfdd6`, and exact checker/driver authorities were retrieved before archaeology. Audit evidence: descriptors resolve current `Document[1]` to action-owned slot 1; current named declaration/selector forms reject; corrected historical Perl returns exact prefix/interstitial pairs and no automatic tail; current marker divergence is explicit. Design freeze: brackets alone select slots, numeric is positional, named is stable, dot remains fluent behavior, and the separate gap tree exclusively owns implementation/admission. Focused duplicate-slot 59 and typed-source 114, book 79/14,580 KiB, Knowledge 829/6,931, all eight doctrines, containment/relocation, CLI 66x2, RAM 68%, and Phase 0 1,031/1,031 in 771 seconds pass. Commit `3d0384d1` is the clean handoff now consumed by `INTER-MATCH-GAP-CAPTURE.1.0`.
- ID: `FUTURE-PARITY-BACKLOG.14.5.1`
  Status: `done; canonical-signoff-complete from clean 5b9c343a` (2026-08-17; intended atomic 256; no push); Goal: Compose the closed separate program's unchanged named-slot/gap-span evidence into typed-source `gap_composition` and a dedicated recurring proof; Depends on: `.14.5.0`, `INTER-MATCH-GAP-CAPTURE.7`; Acceptance: reuse exact gap 9/0/63, public 6/12/10/29, language 250/105+1/126, recognition 137/250/58, six-runtime/carrier, compatibility, and outward-no-drift evidence; add no second syntax/lifecycle/implementation/compatibility/migration owner; promote only `gap_composition`; preserve `recurring_public_no_drift` for `.14.8`; recompose runtime/support ledgers and close `.14.5`; RED evidence: after the complete checker oracle but before contract/driver/CI edits, `bash tools/run_python_project_data.sh tools/check_typed_source_location_contract.py` exits 1 at exact `ContractError: lossless-gap composition contract is missing`; GREEN evidence: typed 10/4/126; gap 9/0/63 plus public 6/12/10/29; composed neutral/Perl-124/Rust-1/Dart-5/Julia-319/PUC-Lua-392/LuaJIT-392; recognition 137/250/58; generated strict Rust 105/105; capability 80/0/0; language 250/105+1/126; full typed matrix Perl-17/Rust-11/Dart-11/Julia-157/PUC-Lua-283/LuaJIT-283; outside-CWD routing; mdBook 79 files/14,984 KiB with exact HTML markers and removed output; canonical evidence: nine doctrines, containment/relocation, CLI 66x2, RAM 51%, Phase 0 1,031/1,031 in 729 seconds, and exact opt-in success; parent `.14.5` closed.
  Tier/checks/trigger: canonical; exact checker-first RED, typed 10/4/126, gap and typed six-runtime matrices, recognition/generated/capability/language, outside-CWD, mdBook 79/14,984, Knowledge 841/7,112, nine doctrines; triggered by executable-governance/local-CI topology movement. Checklist: [x] reproduce missing-composition RED [x] root-cause absent projection/route over already-current detached carriers [x] bind unchanged gap authority and promote only `lossless_gap_composition` [x] verify focused/canonical/book/Knowledge/containment/relocation/CLI/Phase-0 [x] preserve `.14.8` and all adjacent surfaces/owners [x] synchronize and land clean.
- ID: `FUTURE-PARITY-BACKLOG.14.6`
  Status: `done; canonical-signoff-complete` (2026-08-25; audit/correction/neutral, all five source backends over six runtime routes, recurrence, and public no-drift complete through `.14.6.8`; no push); Goal: Specify and implement authority-preserving span-native progressive in-parse dispatch; Children: audit `.0`, corrective prerequisite `.0.1`, neutral `.1`, Perl `.2`, Rust `.3`, Dart `.4`, Julia `.5`, shared-Lua `.6`, recurrence `.7`, and public closeout `.8`; Closure: behavioral 9/9/116, typed 12/2/170, public 6/12/10/60, no outward API; staged `.14.7` next.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.0.1`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from clean audit commit `1a6e0b1f`; intended atomic 258; no push); Goal: Correct the typed-source transaction-composition ledger and reject stale transaction/observation current-state projection without changing transaction or progressive behavior; Depends on: `.14.6.0`, completed recognition-transaction `.14.3` authority; Acceptance: write checker-first RED for the missing typed transaction-composition authority; bind committed recognition 9/9, the exact six-runtime driver, effect/progress semantics, and public-no-drift; promote only typed `transaction_safety`; add stale-current/regression mutations; keep progressive/staged/combined pending and change no runtime/public behavior; Tier/checks/trigger: focused; RED, typed/recognition checkers and six-runtime route, support ledgers, mdBook, Knowledge, tasks, histories, README/memory, doctrines, no-production-diff, exact diff; no canonical trigger; Checklist: [x] ownership [x] retrieval [x] RED [x] correction [x] mutations [x] focused six-runtime proof [x] synchronization [x] clean handoff; Evidence: exact RED `ContractError: transaction-safety composition contract is missing`; GREEN typed 11/3/152 binds recognition 9/9/58, five sources/six runtimes, 9 allowed/11 rejected effects, eight progress cases, public 3/26/45, guide 1/14/18, and ten stale-projection mutations; recurring proof passes Perl 51, Rust 12, Dart, Julia 207, PUC Lua 246, LuaJIT 246 plus strict Rust 105/105, capability 80/0/0, language 250/105+1/126; Knowledge 842/7,122, task 535 IDs, book 79/15,004 KiB, README 106/5,197, memory, histories, storage, no-production-diff, and nine doctrines pass; Commit: `FUTURE-PARITY-BACKLOG.14.6.0.1 - correct typed transaction composition`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.1`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from clean corrective commit `27f9c87f`; intended atomic 259; no push); Goal: Select the private authored progressive form and add the executable backend-neutral authority; Depends on: `.14.6.0.1`, ADR `0080`, typed/recognition authorities; Decision: reserve `value = dispatch_span("expr-v1", "Expr", span)` as dedicated future `PROGRESSIVE_DISPATCH_SPAN`, with literal normalized identity/top rule, exact four-field direct span, `parser_registry_or_staged_dispatch`, detached fail-only result, and no enabled backend; Tier: canonical; Checklist: [x] ownership [x] retrieval [x] decision [x] RED [x] contract/checker [x] mutations/CI [x] focused/canonical proof [x] synchronization [x] clean handoff; Evidence: exact missing-contract RED; GREEN `linkedspec-progressive-span-dispatch-v1` passes 2 entries, 2 sources/8 views, 6 authority, 6 cancellation, 8 chain, 4 execution cases, 5 backend groups/17 paths, 10 outward guards, 26 diagnostics, rollout 1/9, and 86 mutations; CI registers it once, typed remains pending, every backend/outward/current-boundary guard stays closed, and Perl returns the unsupported sentinel; typed 11/3/152, recognition 137/250/58, capability 80/0/0, language 250/105+1/126, tool locality 3/14/31, Knowledge 842/7,124, task 535 IDs/5,000 lines, book 79/15,024 KiB, histories, memory, README, nine doctrines, exact staging, receipt-bound canonical CI, brief clear, and clean handoff pass; Commit: `FUTURE-PARITY-BACKLOG.14.6.1 - add neutral progressive span dispatch authority`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.2`
  Status: `done; canonical-signoff-complete` (2026-08-17; dormant RED, private authority, four carriers, and exact Perl-only admission complete through intended atomic 263; no push); Goal: Implement and privately admit the Perl reference through exact RED, registry/source-view authority, live/generated carriers, and ordinary/canonical admission; Depends on: `.14.6.1`; Children: `.14.6.2.0-.14.6.2.3`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.0`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from clean neutral atomic 259 `a0a33c32`; intended atomic 260; no push); Goal: Establish the exact dormant Perl RED and freeze the implementation/carrier plan before production behavior; Depends on: `.14.6.1`; Acceptance: retrieve committed ADR/Knowledge/contract and current Perl registry/lowering/runtime/generated authorities before archaeology; add or freeze one exact repository-owned failing semantic consumer without changing production behavior; prove current private syntax/node rejection and map `.1-.3` to disjoint authority/core, carrier integration, and admission changes.
  Tier/checks/trigger: `focused`; exact 83/1 dormant RED, syntax/routing absence, neutral/typed/recognition/generated direct dependents, Knowledge, task metadata, book, histories, README/memory, nine doctrines, no-production-diff, exact diff; no canonical trigger because this is a dormant unrouted test and durable plan with no production, executable-governance, CI-topology, admission, generated-format, storage, path, doctrine, or public movement.
  Checklist: [x] ownership [x] authority retrieval [x] Toolbox probes [x] exact RED [x] carrier seam [x] `.1-.3` split [x] durable synchronization [x] focused signoff [x] clean handoff; Evidence: final-path consumer derives complete neutral 2/2+8/6/6/8/4/26/1-of-9/86 inventory, passes 83 then fails only on missing `PROGRESSIVE_DISPATCH_SPAN`; current descriptor has ASSIGN/RETURN, one unresolved helper, zero raw dependencies; generated-v2 has one sentinel and loads null; staged adapter rejects `expr-v1` at resolve; consumer absent from CI; Commit: `FUTURE-PARITY-BACKLOG.14.6.2.0 - freeze Perl progressive dispatch RED`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.1`
  Status: `done; focused-signoff-complete` (2026-08-17; clean dormant-RED atomic 260 `191465f4`; intended atomic 261; no push); Goal/evidence: private immutable registry/invocation/view authority executes neutral 8/6/6/8/4/26 plus mutation, nesting, expiry, rebase, false/cyclic/detachment adversaries; focused six-file proof, neutral 1/9/86, typed 11/3/152, recognition 137/250/58, dormant 83/1/CI absence, Knowledge/book/task/history/memory/doctrines/diff pass with no carrier/generated/rollout/outward movement; Commit: `FUTURE-PARITY-BACKLOG.14.6.2.1 - add private Perl progressive dispatch authority`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.2`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from clean authority atomic 261 `e185b352`; intended atomic 262; no push); Goal: Integrate the dedicated private node through Perl ActionIR recognition/lowering and live, reconstructed, generated-plan, and independently compiled generated-source carriers without widening public surfaces; Depends on: `.14.6.2.1`; Decision: ADR `0081` admits only the mandatory engineering-notes rollover's fifteenth bounded member.
  Acceptance: retrieve the committed authority/card, dormant RED, ActionIR contracts/scanners/evaluator, descriptor reconstruction, generated-plan/emitted-source, invocation-options, source-location, and transaction authorities first; add exact literal/bare-span static recognition plus one `PROGRESSIVE_DISPATCH_SPAN` carrier; inject a fresh host authority only through invocation options across all four routes; serialize logical operands only; execute the unchanged final-path consumer green locally while keeping it absent from ordinary/canonical CI and every rollout/outward surface for `.2.3`; repair the pre-existing raw-truth/logical trace expectation drift exposed by the focused ActionIR direct-dependent check, without changing the already-adopted ADR-0043 runtime behavior; classify private `dispatch_span` out of the independently derived public-call inventory until `.2.3`; restore the erased checker-owned `.24.2` public-close marker in the stable closed-capability section and durably annotate the already-adopted marker-placement rule; preserve Compiler's require-time LinkedRE laziness by loading recognition-transaction runtime only when a progressive dispatch actually queries transaction state; admit the mandatory engineering-notes rollover's exact fifteenth member through a new finite-capacity ADR while preserving all aggregate/per-file/byte controls; Tier/checks/trigger: `canonical`; exact carrier RED/GREEN across native, reconstructed, generated-plan, and fresh emitted source; authority consumer; neutral/typed/recognition/generated direct dependents; dormant CI absence and unchanged rollout; language/capability governance; Phase 0; Knowledge, task metadata, mdBook, histories, README/memory, nine doctrines, exact diff; receipt-bound canonical local CI because executable language-governance classification and bounded-history routing-pressure moved under ADR `0073`, despite unchanged public/runtime admission.
  Checklist: [x] ownership [x] committed authority retrieval [x] carrier RED [x] static node/lowering [x] invocation-options authority [x] four carrier routes [x] focused proof [x] durable synchronization [x] atomic commit/clean handoff; Evidence: exact 125-case carrier consumer plus authority/transaction 193, typed/generated/source 16, and ActionIR/trace 38 pass; neutral 1/9/86, typed 11/3/152, recognition 137/250/58, generated-v2 strict Rust 105/105, language 250/105+1/126, capability 80/0/0, Compiler laziness, corrected Phase 0 1,031/1,031 in 769 seconds, Knowledge 846/7,162, book 79/15,044 KiB, history/task/README/memory/nine-doctrine/diff proof, and exact staged receipt-bound canonical CI pass; final consumer remains unrouted and rollout/outward state unchanged; Commit: `FUTURE-PARITY-BACKLOG.14.6.2.2 - integrate private Perl progressive dispatch carriers`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.2.3`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from exact clean carrier commit `075cb7b8188c9cfd8ce56fbfa55f2474efe2499d`; intended atomic 263; no push); Goal: Admit the exact Perl contract, remove RED dormancy, promote only the Perl progressive rollout leg, recompose direct dependents, and close `.14.6.2`; Depends on: `.14.6.2.2`.
  Verification tier: `canonical`; Canonical trigger: exact CI-topology registration plus executable rollout/admission promotion.
  Focused checks: exact Perl consumer plus authority/transaction/generated-source; progressive/typed/recognition/generated/capability/language direct dependents; Knowledge, mdBook, bounded histories, README/memory, nine doctrines, and exact staged diff.
  Acceptance: register the unchanged green final-path Perl consumer exactly once in canonical CI; promote only the Perl rollout leg; update dormant/current governance and direct dependents without changing another backend, generated format, facade/schema/CLI/README, typed rollout, recurrence, or public projection; apply the mandatory change-history rollover and authorize only its exact twentieth-file/nineteenth-manifest-line finite capacity through ADR `0082`, preserving every byte/root/per-segment/aggregate control; close `.14.6.2` only after receipt-bound proof.
  Checklist: [x] clean ownership/activation [x] committed authority retrieval [x] exact CI admission [x] Perl-only rollout [x] direct-dependent recomposition [x] live-doc/book/Knowledge synchronization [x] canonical receipt [x] atomic commit/clean handoff. Evidence: exact consumer 125 and authority/transaction 193 pass; first canonical attempt catches Rust's stale 133-node neutral snapshot after 11 behavior passes, then exhaustive Rust/Dart/Julia/Lua synchronization makes every admitted consumer exact at recognition 138/250/58; progressive 2/9/86, typed 11/3/152, generated strict Rust 105/105, capability 80/0/0, language 250/126, Knowledge 848/7,174, clean rendered book, bounded histories including change segment 4993 plus exact ADR-0082 20-file/19-manifest-line capacity/task/README/memory/nine doctrines/diff, and receipt-bound canonical CI pass; only private Perl moves, while generated format, shared calls, other backends, typed recurrence, public/outward surfaces remain unchanged; Commit: `FUTURE-PARITY-BACKLOG.14.6.2.3 - admit private Perl progressive dispatch`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3`
  Status: `done; composition-closed` (2026-08-17; private authority `.3.1` focused-signoff-complete at atomic 265 `58d39fe5`; carriers `.3.2` canonical-signoff-complete at atomic 266 `eecacead`; exact canonical admission `.3.3` signoff-complete for intended atomic 267; no push); Goal: Split, implement, and privately admit Rust parity across native, reconstructed, generated-plan, and independently compiled emitted carriers; Depends on: `.14.6.2`; Children: `.14.6.3.0-.14.6.3.3`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.0`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from exact clean Perl admission `78bc66e10066d27ffb93197b8b88e3e9af1d4aa4`; intended atomic 264; no push); Goal: Establish one exact dormant final-path Rust RED and freeze disjoint authority/core, carrier-integration, and admission leaves without production behavior; Depends on: `.14.6.2.3`.
  Tier/checks/trigger: `focused`; exact dormant RED, zero ordinary/canonical discovery, staged-registry/four-carrier probes, progressive/typed/recognition/generated/capability/language dependents, task/index, Knowledge, book, histories, README/memory, doctrines, no-production-diff, exact diff; no canonical trigger because only a dormant outer-cfg test and durable plan move.
  Checklist/evidence: [x] ownership/retrieval/Toolbox audit [x] exact final-path RED [x] dormancy [x] `.1-.3` split [x] synchronization/focused proof/clean handoff; neutral 2/2+8/6/6/8/4/26 and 2/9/86, staged `expr-v1` rejection, and native/reconstructed/generated-plan/independently compiled emitted routes all pass through the same generic call returning `null`; the opt-in run fails only on missing `progressive_dispatch_span` / `PROGRESSIVE_DISPATCH_SPAN`, ordinary/canonical discovery remains inert, production/governance is unchanged, and `.3.1-.3` exclusively own authority/carriers/admission; Commit: `FUTURE-PARITY-BACKLOG.14.6.3.0 - freeze Rust progressive dispatch RED`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.1`
  Status: `done; focused-signoff-complete` (2026-08-17; exact clean `511865bc`; atomic 265 `58d39fe5`; no push); Evidence: private immutable registry/invocation/rebased views, shared authority/limits, detachment, 26 diagnostics, opt-in 4/4, ordinary 0/0, exact missing-node RED, package/format/staged 1/1, progressive 2/9/86, typed 11/3/152, recognition 138/250/58, generated 105/105, capability 80/0/0, language 250/126, Knowledge/book/histories/task/memory/nine doctrines/diff all pass; no node/carrier/rollout/outward movement; Commit: `FUTURE-PARITY-BACKLOG.14.6.3.1 - add private Rust progressive dispatch authority`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.2`
  Status: `done; canonical-signoff-complete` (2026-08-17; clean atomic 266 `eecacead`; exact private authority plus dedicated node and native/reconstructed/generated-plan/independently compiled emitted-source carriers pass one unchanged dormant cfg consumer; canonical receipt, 2/9 rollout, 3 pending groups/11 paths, 9 carrier paths, 10 outward guards, 26 diagnostics, 91 mutations, direct dependents, Knowledge/book/histories/nine doctrines, atomic commit/brief/clean handoff all pass; no admission/format/dependency/other-backend/typed/public/outward movement); Commit: `FUTURE-PARITY-BACKLOG.14.6.3.2 - add dormant Rust progressive dispatch carriers`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.3`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from exact clean carrier atomic 266 `eecacead04a9313339b7237547024b82a8ccbc3d`; intended atomic 267; no push); Goal: Admit the unchanged exact Rust consumer in canonical CI, promote only the Rust progressive rollout leg, recompose direct dependents, and close `.14.6.3` without outward or typed-recurring movement; Depends on: `.14.6.3.2`.
  Acceptance: retrieve ADR `0080`, committed Rust authority/carrier facts, the exact dormant cfg consumer, Perl admission precedent, neutral checker/current boundary, canonical driver/tracked-input topology, and direct dependents before implementation; preserve the consumer identity/cfg, fixture, four-route behavior, authority, node, generated format, and production code while updating only its admission/governance snapshots; add one exact tracked requirement plus one cfg-enabled canonical marker/invocation, promote only Rust rollout and admission truth, retain pending-backend guards for Dart/Julia/Lua, and preserve typed recurrence, outward guards, public inventory, facade/schema/MCP/CLI/README, and all other rollout rows.
  Verification tier: `canonical`
  Focused checks: unchanged exact cfg consumer GREEN and ordinary zero-test discovery; neutral progressive checker plus Perl admitted consumer; typed-source, recognition, generated-source, capability, and language direct dependents; canonical-driver exact-count probes; Knowledge, mdBook, bounded histories, task/index, README/memory, nine doctrines, exact diff.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.4`
  Status: `done; composition-closed; canonical-signoff-complete` (2026-08-17; authority `.1` committed at `e6968b7b`; dedicated-node/four-carrier `.2` at `5b4d9c2d`; admission `.3` closes the parent from exact clean atomic-270 base at intended atomic 271; no push); Goal: Split, implement, and privately admit Dart parity across native, reconstructed, generated-plan, and independently analyzed emitted carriers; Depends on: `.14.6.3`; Children: `.14.6.4.0-.14.6.4.3`.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.4.1`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from exact clean Dart RED atomic 268 `bab4fda6`; intended atomic 269; no push); Goal: Add the private immutable Dart registry, invocation, same-source rebased view, narrowing authority, shared cancellation/budgets, chain limits, detachment, and exact diagnostics while preserving the final-path missing-node RED; Depends on: `.14.6.4.0`.
  Acceptance: retrieve ADR `0080`, the committed Dart RED, typed-source/runtime authority, neutral matrix/current boundary, and Perl/Rust authority precedents before implementation; add one private Dart authority module and one analyzed-but-undiscovered focused consumer covering immutable already-compiled entries, same-source Unicode-scalar views/rebasing, narrowing grants and ceilings, shared cancellation/deadline/steps, decreasing chains/depth/calls, callback containment, expiry, and deep detached results with all 26 diagnostics; preserve the exact final-path missing-node RED and change no syntax, ActionIR, execution carrier, generated format, rollout, canonical route, or outward surface.
  Verification tier: `focused`.
  Focused checks: exact authority consumer and fatal Dart analysis; original final-path 4-pass/1-missing-node RED and ordinary/canonical absence; neutral progressive, typed-source, recognition, generated, capability, and language direct dependents; Knowledge, mdBook, bounded histories, task/index, README/memory, nine doctrines, no-carrier/no-rollout boundary, and exact diff.
  Canonical trigger: `none` — private unrouted authority and its dormant consumer move without syntax, ActionIR, execution carriers, generated format, admission/rollout, dependency/toolchain, storage/path/doctrine infrastructure, or public behavior.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.4.3`
  Status: `done; canonical-signoff-complete` (2026-08-17; task-tree-first from exact clean Dart-carrier atomic 270 `5b4d9c2d`; intended atomic 271; no push); Goal: Admit the unchanged Dart consumer exactly once in ordinary/canonical proof, promote only Dart rollout, recompose direct dependents, and close `.14.6.4`; Depends on: `.14.6.4.2`.
  Acceptance: retrieve ADR `0080`, committed Dart authority/carrier facts and exact dormant consumer, Perl/Rust admission precedents, neutral checker/current boundary, canonical driver/tracked-input topology, direct dependents, Knowledge, and book before implementation; preserve the consumer path, fixture, seven groups, authority/node/four routes, generated format, and production code while moving that same file into ordinary discovery and registering exactly one canonical requirement/marker/invocation; promote only Dart rollout and admission truth, close `.14.6.4`, retain Julia/Lua guards and every typed/recurring/public/outward boundary; if mandatory history rollover crosses a finite pressure bound, measure the exact resulting collection and authorize only that increment; land only after receipt-bound canonical proof.
  Verification tier: `canonical`.
  Focused checks: unchanged exact Dart consumer GREEN through its admitted path and no dormant duplicate; neutral progressive plus admitted Perl/Rust consumers; typed-source, recognition, generated-source, capability, and language direct dependents; canonical-driver exact-count probes; Knowledge, mdBook, bounded histories, task/index, README/memory, nine doctrines, exact staged diff.
  Canonical trigger: `the canonical CI trust boundary and executable Dart rollout/admission truth move together; exact staged receipt-bound local CI is required before landing and closing the Dart parent`.
  Checklist: [x] clean activation/task ownership [x] ADR/Knowledge/carrier/admission retrieval [x] exact stable-identity Dart consumer move [x] exact canonical registration [x] Dart-only neutral rollout/current-boundary promotion [x] direct-dependent/live-doc recomposition [x] exact ADR-0083 history-capacity increment [x] focused proof [x] staged canonical receipt [x] atomic commit/brief/clean handoff. Evidence: the same seven-group consumer moves from `test_dormant` to ordinary discovery with no duplicate and one exact canonical requirement/marker/invocation; canonical attempt one passes Rust then exposes root-CWD Dart pubspec lookup, and the corrected route enters `dart/` before the repository-managed wrapper; fatal analysis and ordinary Dart 415, authority 4/4, Perl 127/127, exact cfg Rust 1/1 in 132.16s, progressive 4/9/103 with 9 Rust + 8 Dart carriers and 2 Julia/Lua guards/8 paths, typed 11/3/152, recognition 138/250/58, generated strict Rust 105/105, capability 80/0/0, language 250/126, Knowledge 857/7,241, rendered book 79/15,116 KiB then removed, histories, task/index, README/memory, nine doctrines, exact staged diff, and receipt-bound canonical CI pass; mandatory note segment 4992 advances only finite capacity to 16 files / 15 manifest lines under ADR `0083`; only Dart admission/rollout and governance snapshots move; production/generated format, dormant authority test, Julia/Lua, recurrence, typed/public/outward surfaces remain exact; Commit: `FUTURE-PARITY-BACKLOG.14.6.4.3 - admit private Dart progressive dispatch`.
