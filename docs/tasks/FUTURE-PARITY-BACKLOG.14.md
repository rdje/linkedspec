...
- ID: `FUTURE-PARITY-BACKLOG.14.6.3`
  Status: `active` (2026-08-17; private authority `.3.1` focused-signoff-complete for intended atomic 265; four-carrier integration `.3.2` next; no push); Goal: Split, implement, and privately admit Rust parity across native, reconstructed, generated-plan, and independently compiled emitted carriers; Depends on: `.14.6.2`; Children: `.14.6.3.0-.14.6.3.3`.
...
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.1`
  Status: `done; focused-signoff-complete` (2026-08-17; task-tree-first from exact clean dormant-RED atomic 264 `511865bc8055074ee4a2a7d019bb2712ec1517c0`; intended atomic 265; no push); Goal: Add the private immutable Rust registry, invocation, rebased-source-view, cancellation/budget, cycle/progress, policy-ceiling, and typed diagnostic authority without ActionIR/carrier or rollout movement; Depends on: `.14.6.3.0`.
  Acceptance: retrieve the neutral contract, ADR `0080`, dormant RED, admitted Perl authority topology, Rust typed-source/recognition/invocation/runtime seams, and generated-v2 boundary before implementation; add one private immutable host-seeded registry over already compiled parsers plus invocation-local same-source bounded views, intersected capabilities/policies/ceilings, inherited cancellation/deadline/budget, decreasing-span/depth/call bounds, detached results, and all 26 typed diagnostics; execute the neutral cases plus mutation/nesting/rebase/expiry/false/cycle/detachment adversaries through a focused authority consumer; add no dedicated expression node, engine/descriptor/generated carrier, rollout, CI route, dependency, format, other backend, or outward surface.
  Verification tier: `focused`
  Focused checks: exact Rust authority consumer; dormant RED still reaches only the missing node; progressive, typed-source, recognition, generated-source, capability, and language direct dependents; Rust local direct dependents; task/index, Knowledge, mdBook, bounded histories, README/memory, nine doctrines, exact diff.
  Canonical trigger: `none — private Rust authority and focused consumer only; no ActionIR/carrier, rollout/admission, CI topology, generated format, dependency/toolchain, storage/path/doctrine infrastructure, cross-backend contract, or public surface movement`.
  Checklist: [x] clean activation/ownership [x] committed authority retrieval [x] Toolbox-led seam audit [x] private immutable registry/invocation/view authority [x] cancellation/policy/cycle/diagnostic closure [x] focused consumer/adversaries [x] durable synchronization [x] focused verification [x] atomic commit/clean handoff. Evidence: exact opt-in authority 4/4 over every 8-view, 6-authority, 6-cancellation, 8-chain, 4-execution, and 26-diagnostic neutral row plus nesting/rebase/expiry/mutation/detachment adversaries; ordinary authority and final-path targets execute 0 tests; explicit final-path RED still passes four carrier preconditions then fails only on missing `PROGRESSIVE_DISPATCH_SPAN`; package check, format, staged registry 1/1, progressive 2/9/86, typed 11/3/152, recognition 138/250/58, generated strict Rust 105/105, capability 80/0/0, language 250/126, Knowledge 850/7,190, book 79/15,076 KiB, histories/task/index/memory/nine doctrines/diff pass; no node, carrier, rollout, CI, format, dependency, other-backend, or outward movement; Commit: `FUTURE-PARITY-BACKLOG.14.6.3.1 - add private Rust progressive dispatch authority`.
- ID: `FUTURE-PARITY-BACKLOG.14.6.3.2`
  Status: `pending`; Goal: Integrate the dedicated private Rust node through static recognition/lowering and native, reconstructed, generated-plan, and independently compiled emitted-source carriers while the final consumer remains unrouted; Depends on: `.14.6.3.1`.
