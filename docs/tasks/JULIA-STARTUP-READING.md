...
- Status: `active` / reading 23/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged and diagnostic repairs pending
...
- Current physical reading: 23/52 children, 32,925/75,984 lines and 1,178,390/2,693,170 bytes; twenty-nine complete files.
