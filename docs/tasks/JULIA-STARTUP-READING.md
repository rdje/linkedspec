...
- Status: `active` / reading 24/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged and diagnostic repairs pending
...
- Current physical reading: 24/52 children, 34,425/75,984 lines and 1,219,544/2,693,170 bytes; twenty-nine complete files.
