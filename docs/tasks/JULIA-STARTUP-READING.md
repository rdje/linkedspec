...
- Status: `active` / reading 22/52; selector, switch, recognition, pattern, observer, token, callback, numeric, bounds, arity, matching, staged and diagnostic repairs pending
...
- Current physical reading: 22/52 children, 31,425/75,984 lines and 1,137,243/2,693,170 bytes; twenty-nine complete files.
