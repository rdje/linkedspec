...
| --- | --- | --- | --- |
| 1 | `PUBLIC-STATUS-DRIFT-SYNC.1` | `pending` | Tracking is in place; update only the discovered public status drift before any broader roadmap reconciliation. |
...
| `PUBLIC-STATUS-DRIFT-SYNC.1` | `pending` | `pending` |
