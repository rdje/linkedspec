...
- Created: `2026-07-09`
- Last updated: `2026-08-26` (progressive `.14.6` and staged `.14.7.0-.3.1` are committed through exact clean
  `3a99202ece0cf0c942d38aa7d8789a5690e76df3`; Perl current-depth authority `.14.7.3.2` is focused-signoff-complete
  for its intended atomic commit, and recursive authority `.14.7.3.3` is the next task-tree-first action)
...
`.14.7.3.1` are committed through exact clean `3a99202e`; resolution/cache/result/failure `.14.7.3.2` is the active
task-tree-first frontier, while combined
