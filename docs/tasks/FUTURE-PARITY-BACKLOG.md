...
- Created: `2026-07-09`
- Last updated: `2026-07-10` (`.1.5.3.1` closes Dart boundary at 29/61; `.1.5.3.2` active; `.11.1` parked).
...
| 19 | `FUTURE-PARITY-BACKLOG.1.5.3.2` | `active` | Compose native execution, direct canonical results, and stable failures. |
