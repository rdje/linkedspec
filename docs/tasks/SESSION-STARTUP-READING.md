...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading16/143: cumulative18431 fragments/892969 bytes,51 complete files and Unicode-case1-4138. Prior unchanged Unicode generation proof remains scoped; .1.17 owns the continuation. All repairs/prerequisites remain.
