...
- ID: `SESSION-STARTUP-READING.3.4`
  ...
  Verification: Dart reading remains incomplete: DART-STARTUP-READING.1.23 closes 23/55 children, 32,528 fragments / 1,030,832 bytes with exact baseline identity and 99 selected tests. Matching is fully read; recognition reaches 483. Six public-alternation/native/reconstructed and Perl source-backed controls own literal quantifier-rewrite corruption .2.16. Startup .37/.55/.60, Dart .2.1-.2.15 and FUTURE-PARITY-BACKLOG.5 retain prior ownership; .54.3 retains regex-brace recurrence. Capacity intake .4 is closed through containment .8 / ADR0110; next .1.24 finishes recognition and reads semantic/source authority plus staged entry. Earlier evidence and repairs remain intact.
  Commit: `pending`
...
Canonical admission a67a18bf and completed `DART-STARTUP-READING.0` decomposition preserve the full baseline. Approved history capacity is committed at 7d52c98e; resume `DART-STARTUP-READING.1.24` after the clean .1.23 reading commit in `docs/tasks/DART-STARTUP-READING.md`.
...
| --- | --- | --- | --- |
| 1 | `DART-STARTUP-READING.1.24` | `pending` | Finish recognition and read semantic/source authority plus staged entry; 23/55 children complete. Source repairs remain gated. |
