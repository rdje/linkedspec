...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading17/143: cumulative19931 fragments/907469 bytes,51 complete files and Unicode-case1-5638. Prior unchanged Unicode generation proof remains scoped; .1.18 owns the continuation. All repairs/prerequisites remain.
