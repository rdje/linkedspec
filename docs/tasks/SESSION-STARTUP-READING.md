...
- ID: `SESSION-STARTUP-READING.3.4`
  ...
  Verification: Dart reading remains incomplete: DART-STARTUP-READING.1.17 closes 17/55 children, 23,528 fragments / 776,881 bytes with exact baseline identity and 124 selected tests. Ten native/reconstructed controls own mixed value-control return escape and skipped else under Dart .2.9; .37.1/.37.2 retain nested progressive findings and Dart .2.1-.2.8 retain earlier repairs; .54.3 retains broad regex recurrence. Capacity intake .4 is closed through containment .8 / ADR0110; next .1.18 continues interpreter expression and helper dispatch. Earlier evidence and repairs remain intact.
  Commit: `pending`
...
Canonical admission a67a18bf and completed `DART-STARTUP-READING.0` decomposition preserve the full baseline. Approved history capacity is committed at 7d52c98e; resume `DART-STARTUP-READING.1.18` after the clean .1.17 reading commit in `docs/tasks/DART-STARTUP-READING.md`.
...
| --- | --- | --- | --- |
| 1 | `DART-STARTUP-READING.1.18` | `pending` | Continue interpreter expression and helper dispatch; 17/55 children complete. Source repairs remain gated. |
