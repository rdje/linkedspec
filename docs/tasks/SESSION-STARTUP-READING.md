...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading24/143: cumulative30431 fragments/1010244 bytes,51 complete files and Unicode-case1-16138. Prior unchanged Unicode generation proof remains scoped; .1.25 owns the continuation. All repairs/prerequisites remain.
...
| --- | --- | --- | --- |
| 1 | `CONFORMANCE-SOURCE-READING.1.25` | `pending` | `capability_conformance/unicode_case_contract.json` lines 16139-17638; 1500 fragments/14739 bytes. Preserve complete bounded windows, source identity and all repairs. |
