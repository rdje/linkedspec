...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading15/143: cumulative16931 fragments/878469 bytes,51 complete files and Unicode-case1-2638. Prior unchanged Unicode generation proof remains scoped; .1.16 owns the continuation. All repairs/prerequisites remain.
