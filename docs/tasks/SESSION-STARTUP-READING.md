...
- ID: `SESSION-STARTUP-READING.3.5`
  ...
  Verification: Containment .13 / ADR0116 implements the director-approved Knowledge lines72000→79000 and decision lines12000→13000. Only these two registry scalars change; the .13-only focused exception keeps normal hooks and future canonical/push requirements. Production validators pass20 threshold and24 authorization executions; exact prior evidence and the full actual-plus-reserve census are preserved. Julia reading remains37/52 groups,53925 lines/1880598 bytes and53 complete files; .1.38 resumes after the clean capacity commit. All previously owned repairs remain open. Exact plan and all source identities remain frozen in the Julia owner.
  Commit: `pending`
