...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading27/143: cumulative34931 fragments/1055117 bytes,51 complete files and Unicode-case1-20638. Prior unchanged Unicode generation proof remains scoped; .1.28 owns the continuation. All repairs/prerequisites remain.
