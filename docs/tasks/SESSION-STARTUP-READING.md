...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading7/143: cumulative7790 fragments/437697 bytes,29 complete files and progressive dispatch1-540. Fresh native/progressive neutral proof passes; .1.8 owns the crossing cancellation case and following contracts. All repairs/prerequisites remain.
