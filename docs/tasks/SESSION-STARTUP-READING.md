...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; 143 groups/302 baseline ranges over160 inputs. Physical reading64/143:82,253 fragments/3,234,113 baseline bytes and97 complete files; Phase0 through32758. Approved113-byte inventory delta stays separate. Retained eleven-subtest proof has95 direct assertions including42 nested results/329 inner assertions. Deep mutual marker fixtures inspect minimum helper hits and node presence; existing .2.10 code-observation limits remain; .2.5–.2.11 and all prerequisites remain. .1.65 continues the composite-if deep-marker action fixture. ADR0122/containment .15 are canonically admitted at ec10be6b.
...
| --- | --- | --- | --- |
| 1 | `CONFORMANCE-SOURCE-READING.1.65` | `pending` | Read Phase0 lines 32759–33715 (957 fragments / 65,498 baseline bytes), continuing the first fixture of the composite-if branch-block deep mutual marker action test. Repairs .2.5–.2.11 and earlier repairs retain required reading prerequisites. |
