...
- ID: `SESSION-STARTUP-READING.3.4`
  ...
  Verification: Dart reading remains incomplete: DART-STARTUP-READING.1.4 closes 4/55 children, 6,000 fragments / 183,326 bytes with exact baseline identity and 79/79 selected tests. Attached-switch omission/default replacement remains owned by Dart .2.1 with two gated repair children. Next .1.5; earlier evidence and repairs remain intact.
  Commit: `pending`
...
Canonical admission a67a18bf and completed `DART-STARTUP-READING.0` decomposition preserve the full baseline. Resume `DART-STARTUP-READING.1.5` in `docs/tasks/DART-STARTUP-READING.md` after the clean .1.4 reading commit.
...
| --- | --- | --- | --- |
| 1 | `DART-STARTUP-READING.1.5` | `pending` | Resume parser tail/callable/registry/spec AST; 4/55 reading children complete, Dart .2.1 repair gated, and startup .3.4 remains pending. |
