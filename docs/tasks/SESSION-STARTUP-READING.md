...
- ID: `SESSION-STARTUP-READING.3.8`
  ...
  Reading owner: `docs/tasks/CONFORMANCE-SOURCE-READING.md`; .3.8.0 preserves143 groups/302 exact ranges over160 baseline-identical inputs. Physical reading18/143: cumulative21431 fragments/921969 bytes,51 complete files and Unicode-case1-7138. Prior unchanged Unicode generation proof remains scoped; .1.19 owns the continuation. All repairs/prerequisites remain.
