...
## 2026-09-11 — exact Julia prefix reading and fresh composition

Julia .1.25 physically reads SemanticCallProjection1-1011:33,638 unchanged
bytes, SHA91594bb5af8e2830d3095a4dd30026b6cefc5572953b17fefbcb1c21f8332249.
The prefix merges authored definitions; validates native staged payload/job/
signature metadata and retained generated-plan identity/order/entry; projects
typed outer-before-inner calls, separate occurrence-counted bindings, helper/
user-function resolution and bounded shape evidence. Child traversal includes
aggregate/access/control expressions and mutation continuations; callable literals
remain deferred. The correlation/shape suffix remains unread. Supporting owner
source1012-1105 was inspected without advance reading credit.

Fresh source135/outcome85/static70/remaining99/call79/staged62 compose at530.
Casing39 separately refreshes the completed Unicode evaluator, for569 existing
assertions plus selection1. Neutral semantic6/20/128 stays rollout9/0 and
admission6/0; pinned Unicode regeneration remains1563/1581 mappings,158/464
ranges and12 fixtures with every generated byte preserved. No full component
or canonical gate, dependency build, new defect or repair closure is claimed.
The unchanged empty-function guard remains [[semantic-rule-calls-empty-function-gate]]
and startup .22-owned. Other startup .66/.67 and Julia repair acceptance remains
bounded to its own evidence. Existing fixture success is not general signoff.

Exact managed composition replay:
...
for expression in Meta.parseall(read("julia/test/runtests.jl",String)).args
    if expression isa Expr && expression.head==:macrocall &&
       expression.args[1]==Symbol("@testset") &&
       expression.args[3]=="Generated Unicode 17 casing and runtime paths"
