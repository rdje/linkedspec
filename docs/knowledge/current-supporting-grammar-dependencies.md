...
date: 2026-09-13
status: current dependency disposition; first required grammar group read, two remain
...
Subsequent `.1.17` completes its two required ranges; `.1.18-.1.19` remain pending.
