...
date: 2026-09-13
status: current dependency disposition; two required grammar groups read, one remains
...
Subsequent `.1.17-.1.18` complete four required ranges; `.1.19` remains pending.
