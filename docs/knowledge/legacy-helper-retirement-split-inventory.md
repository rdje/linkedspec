...
- Rust `.8.4` initially diagnosed `declare`, `array_copy`, `hash_copy`, `concat`, `push_value`, `push_nonempty`,
  ...
  runtime now handles helper-looking retired names through the generic unknown-helper fallback.
