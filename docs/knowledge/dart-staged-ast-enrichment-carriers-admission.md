...
date: 2026-08-27
status: current private Dart carrier admission; Julia FUTURE-PARITY-BACKLOG.14.7.6.0 is next
...
This is private backend behavior, not public `parse_job(...)` authoring. Dart rollout is complete. Julia, Lua,
six-runtime recurrence, public authoring, independent recomposition, and combined no-drift retain their existing
owners.
...
[[rust-staged-ast-enrichment-carriers-admission]], [[general-staged-ast-enrichment-neutral-contract]], and ADR
`0088`.
