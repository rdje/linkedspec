...
date: 2026-08-27
status: current private Dart carrier admission; Julia is dormant RED and FUTURE-PARITY-BACKLOG.14.7.6.1 is next
...
one dormant RED while Lua, six-runtime recurrence, public authoring, independent recomposition, and combined
no-drift retain their existing owners.
