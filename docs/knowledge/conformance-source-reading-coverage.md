...
date: 2026-09-21
status: exact baseline decomposition preserved; physical reading 43/143, 97 files complete and 100 groups remain; one approved current-source delta
...
`CONFORMANCE-SOURCE-READING.1.43` reads 11 windows, 1,500 fragments and 64,877 baseline bytes.
Cumulative reading is 43/143, 56,131 fragments, 1,919,572 baseline bytes and 97 complete files.
Phase0 is partial through line 6636, inside the unclosed-multiline-block fixture heredoc.
[[conformance-perl-consumer-reading]] distinguishes bounded sequence execution, paragraph
normalization and validation-only controls. Fifty-four completed subtests retain unchanged
PASS at 87b35665e (311 assertions). All runtime repairs remain open.
The pinned 113-byte current cursor-inventory delta stays separate from historical reading;
the same current ranges total 1,919,685 bytes. Next .1.44 reads Phase0 lines 6637–7826.
