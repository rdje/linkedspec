...
date: 2026-09-21
status: exact baseline decomposition preserved; physical reading 47/143, 97 files complete and 96 groups remain; one approved current-source delta
...
`CONFORMANCE-SOURCE-READING.1.47` reads 11 windows, 979 fragments and 65,510 baseline bytes.
Cumulative reading is 47/143, 60,318 fragments, 2,181,495 baseline bytes and 97 complete files.
Phase0 is partial through line 10823, after eight reused-context resolution-failure assertions.
[[conformance-perl-consumer-reading]] distinguishes single-mode result validation,
preserved error ownership, source-capture replacement and context reuse. Twenty-eight completed subtests retain unchanged
PASS at 87b35665e (280 assertions). All runtime repairs remain open.
The pinned 113-byte current cursor-inventory delta stays separate from historical reading;
the same current ranges total 2,181,608 bytes. Next .1.48 reads Phase0 lines 10824–11855.
