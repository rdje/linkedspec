...
date: 2026-09-21
status: exact baseline decomposition preserved; physical reading 41/143, 97 files complete and 102 groups remain; one approved current-source delta
...
`CONFORMANCE-SOURCE-READING.1.41` reads 11 windows, 1,173 fragments and 65,484 baseline bytes.
Cumulative reading is 41/143, 53,234 fragments, 1,789,223 baseline bytes and 97 complete files.
Phase0 is partial through line 3739, after three missing-dot-spec-name assertions.
[[conformance-perl-consumer-reading]] separates legacy plugin fixtures, real Lispish
execution and source-shape checks. Forty-two completed subtests retain unchanged PASS
at 87b35665e (282 assertions). All runtime repairs remain open.
The pinned 113-byte current cursor-inventory delta stays separate from historical reading;
the same current ranges total 1,789,336 bytes. Next .1.42 reads Phase0 lines 3740–5136.
