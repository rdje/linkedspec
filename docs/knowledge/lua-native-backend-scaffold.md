...
runs 173 current tests on PUC Lua and the same 173 on LuaJIT, passes the exact primary adapter at 61/61 under
...
`.8.1.2` is closed; exact ten-family `.8.2` is active.
