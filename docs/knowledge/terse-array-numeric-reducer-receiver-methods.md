...
pending. `TRACE-OBSERVABILITY.1` and `.2` have since closed, and PNT returns to
`TRACE-OBSERVABILITY.3` unless a new terse leaf is split or another active tree is reprioritized.
