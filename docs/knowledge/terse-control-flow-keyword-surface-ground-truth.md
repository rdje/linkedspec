...
- **Perl raw today:** attached `if(cond) { ... } elseif(cond2) { ... } else { ... }` executes only because raw
  Perl remains in the generated handler; ActionIR metadata marks it not language-agnostic-ready.
