...
date: 2026-07-20
status: confirmed audit; language decision and repairs owned by FUTURE-PARITY-BACKLOG.9.1.8.1.1-.7
...
`GeneratedPlanExecutor`. Dart, Julia, and Lua already implement the required-
slot algorithm and need conformance locks rather than semantic changes.
