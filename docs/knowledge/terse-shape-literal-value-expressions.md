...
answers:
  ...
  - "where is historical RHS shape target-kind inference recorded"
...
Historical RHS target-kind inference is recorded separately in [[terse-rhs-shape-target-kind-inference]]. Current
bare assignment behavior is duck-typed value binding, recorded in [[terse-duck-typed-assignment-perl-reference]].
Rust parity for these shape-literal values landed in [[terse-rust-shape-literal-value-parity]].
