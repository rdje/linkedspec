...
date: 2026-07-19
status: verified normal execution, descriptor v1, and generated-source v2; option removal and admission remain staged
...
One staged compatibility seam remains deliberate. An explicitly supplied outer `parse_mode` still overrides
ordinary rule cursor policy until `.9.1.7.5` removes that high-level surface. Generated-source v1 historically
derived sequence/choice and dispatch while defaulting to seek; `.9.1.7.4` has now replaced that versioned seam.
Generated-source v2 derives policy and structural dispatch from the validated family row, treats compact Pipe as
OR/choice, and carries no cursor field. Descriptor `.3` and generated v2 `.4` are complete; public removal and
exact dual-ABI admission remain `.5-.6`.
...
loaded execution, recursion, trace attribution, explicit outer compatibility, and generated-v2 policy agreement.
