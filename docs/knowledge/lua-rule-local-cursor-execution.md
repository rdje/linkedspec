...
date: 2026-07-19
status: verified normal execution; descriptor, generated-v2, option removal, and admission remain staged
...
OR/choice. Descriptor v1, generated-source v2, public removal, and exact dual-ABI admission remain `.3-.6`, so
this runtime slice does not advance neutral rollout.
...
Related: [[lua-rule-local-cursor-normalization]], [[lua-rule-local-cursor-preflight]],
