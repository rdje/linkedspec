...
date: 2026-07-19
status: verified normalization and composed admission through FUTURE-PARITY-BACKLOG.9.1.7.6
...
evidence_update_2026_07_19_admission: "Lua admission .9.1.7.6 composes normalized families, typed bare edges, and portable diagnostics with all later cursor roles exactly once on PUC Lua and LuaJIT. Focused composition passes 119/119 per ABI and governance advances to 69/6+2/49."
reverify: "env LUA_PATH='lua/src/?.lua;lua/src/?/init.lua;;' lua lua/test/rule_local_cursor_normalization_test.lua && env LUA_PATH='lua/src/?.lua;lua/src/?/init.lua;;' luajit lua/test/rule_local_cursor_normalization_test.lua && bash tools/run_python_project_data.sh tools/check_rule_local_cursor_contract.py"
---
