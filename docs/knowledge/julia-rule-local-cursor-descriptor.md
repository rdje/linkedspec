...
date: 2026-07-18
status: verified implementation; generated-v2/public/admission remain FUTURE-PARITY-BACKLOG.9.1.6.4-.6
...
field sets, direct/normalized/loaded byte identity, and loaded AND execution. Generated source remains v1/format 1;
generated v2, public removal, and 15-role admission remain `.9.1.6.4-.6`.
