...
reverify: "LINKEDSPEC_JULIA_DEPOT_PATH=/tmp/linkedspec-julia-depot:/Users/richarddje/.julia bash tools/run_julia_local.sh && python3 tools/check_root_rule_selection_contract.py"
---
