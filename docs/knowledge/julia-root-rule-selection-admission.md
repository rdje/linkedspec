...
reverify: "LINKEDSPEC_JULIA_DEPOT_PATH=\"${TMPDIR:-/tmp}/linkedspec-julia-depot:$(julia --startup-file=no --history-file=no -e 'print(join(Base.DEPOT_PATH, \":\"))')\" bash tools/run_julia_local.sh && python3 tools/check_root_rule_selection_contract.py"
---
