...
date: 2026-08-16
status: Julia private gap path admitted through exact nine-role primary composition; shared Lua has since advanced governance to 7 complete / 2 pending while public rows remain pending
