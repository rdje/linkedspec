...
evidence_update_2026_08_28_final_recomposition: "FUTURE-PARITY-BACKLOG.14.7.10 reruns the same committed source at 890/890 on each ABI inside final six-runtime recomposition. Parent .14.7 closes without Lua executable or topology movement."
...
assignment-form `parse_job(...)` authoring and final `.14.7.10` recomposition are current.
...
Related: [[lua-staged-ast-enrichment-carriers-admission]], [[general-staged-ast-enrichment-recomposition]],
