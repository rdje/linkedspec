---
id: dart-progressive-span-dispatch-admission
title: Dart progressive span dispatch is privately admitted through ordinary discovery and one exact canonical route
answers:
  - "is Dart progressive span dispatch admitted"
  - "where does canonical CI run the Dart progressive span dispatch consumer"
  - "does ordinary Dart test discovery run progressive span dispatch"
...
evidence_update_2026_08_25_lua_recomposition: "FUTURE-PARITY-BACKLOG.14.6.6.4 independently reruns the unchanged Dart consumer at 7/7 while PUC Lua and LuaJIT remain admitted at rollout 7/9/112. All six private runtime rows are current; recurrence, typed projection, generated format, public inventory, and outward surfaces retain separate owners."
reverify:
  ...
  - "test \"$(rg -c 'require_tracked_file dart/test/progressive_span_dispatch_contract_test[.]dart' tools/run_ci_local.sh)\" -eq 1"
...
the admission boundary explicit and recoverable.

This leaf changes no parser, compiler, runtime, generated format, registry authority, or public API. It promotes
only Dart's private rollout row. Julia, PUC Lua, and LuaJIT have since been admitted independently; recurring
six-runtime composition, typed progressive projection, and public no-drift retain their separate owners.
