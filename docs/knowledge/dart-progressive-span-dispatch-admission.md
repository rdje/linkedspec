...
date: 2026-08-17
status: current private Dart admission; Julia, Lua, recurrence, typed projection, and public no-drift pending
...
only Dart's private rollout row. Julia, shared Lua, recurring six-runtime composition, typed progressive
projection, and public no-drift retain their separate owners.
