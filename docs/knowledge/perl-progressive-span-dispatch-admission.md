...
date: 2026-08-17
status: current private Perl admission; all six private runtime rows admitted and recomposed; recurrence, typed projection, and public no-drift pending
...
evidence_update_2026_08_17_dart_admission: "FUTURE-PARITY-BACKLOG.14.6.4.3 leaves Perl runtime behavior and its exact canonical route unchanged while adding one Dart rollout/path snapshot assertion, for 127 passing assertions, as Dart becomes the third admitted backend. Progressive governance is 4/9/103; Julia/Lua, recurring, typed progressive, public no-drift, generated format, and outward surfaces remain pending or unchanged."
evidence_update_2026_08_25_julia_recomposition: "FUTURE-PARITY-BACKLOG.14.6.5.4 independently reruns the unchanged Perl consumer at 128/128 while Julia remains admitted at rollout 5/9/106. Rust, Dart, and Julia are now private peers; shared Lua, recurring six-runtime composition, typed progressive projection, public no-drift, generated format, and outward surfaces remain pending or unchanged."
evidence_update_2026_08_25_lua_recomposition: "FUTURE-PARITY-BACKLOG.14.6.6.4 independently reruns the unchanged Perl consumer at 129/129 while PUC Lua and LuaJIT remain admitted at rollout 7/9/112. All six private runtime rows are current; recurring typed projection, public no-drift, generated format, and outward surfaces retain separate owners."
reverify:
...
six current private runtime admissions is the first safe owner for reclassification. Rust, Dart, Julia, PUC Lua,
and LuaJIT are admitted independently without moving this boundary.
