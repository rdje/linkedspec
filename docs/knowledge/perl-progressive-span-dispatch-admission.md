...
date: 2026-08-17
status: current private Perl admission; Rust, Dart, and Julia also admitted; Lua, recurrence, typed projection, and public no-drift pending
...
remaining shared-Lua admission and exact recurrence are the first safe owners for reclassification. Rust, Dart,
and Julia are already admitted independently without moving this boundary.
