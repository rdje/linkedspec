...
`/proj/foo`, and ordinary scalar-held indexed reads still work. The actual
boundary is now `DART-BACKEND-PARITY.6.2.4.4.6`; deeper PCRE structural regex
