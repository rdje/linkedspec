...
evidence_update_2026_08_25_julia_recomposition: "FUTURE-PARITY-BACKLOG.14.6.5.4 independently reruns the unchanged cfg-enabled Rust consumer at 1/1 while Julia remains admitted at rollout 5/9/106. Dart and Julia are now private peers; shared Lua, recurrence, typed projection, generated format, public inventory, and outward surfaces remain pending or unchanged."
evidence_update_2026_08_25_lua_recomposition: "FUTURE-PARITY-BACKLOG.14.6.6.4 independently reruns the unchanged cfg-enabled Rust consumer at 1/1 while both Lua ABI rows remain admitted at rollout 7/9/112. All six private runtime rows are current; recurrence, typed projection, generated format, public inventory, and outward surfaces retain separate owners."
reverify:
