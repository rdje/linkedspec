...
date: 2026-08-17
status: current private Rust admission; Dart and Julia also admitted while Lua, recurrence, typed projection, and public no-drift remain pending
...
been admitted independently; shared Lua, recurring six-runtime composition, typed progressive projection, and
