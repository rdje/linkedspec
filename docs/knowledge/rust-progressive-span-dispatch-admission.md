...
date: 2026-08-17
status: current private Rust admission; Dart, Julia, Lua, recurrence, typed projection, and public no-drift pending
...
semantic/MCP field, CLI, README, or public helper. It promotes only the Rust rollout row. Dart, Julia, shared Lua,
recurring six-runtime composition, typed progressive projection, and public no-drift keep their separate owners.
