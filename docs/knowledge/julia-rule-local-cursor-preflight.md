...
date: 2026-07-18
status: verified historical preflight; normalization boundary superseded by FUTURE-PARITY-BACKLOG.9.1.6.1
...
[[julia-rule-local-cursor-normalization]]. Runtime, descriptor, generated,
option, and admission measurements below remain the staged boundaries for
`.9.1.6.2-.6`.
