...
evidence_update_2026_07_13_callbacks: "LUA-BACKEND-PARITY.4.3.6.5.1.2 closes hash-root callback execution; .4.3.6.5.2 then executes the three ARRAY_HELPERS callback methods through the same root-kind dispatcher at 114/114 on both ABIs."
...
inventory from 31 to 27 genuine removed/history references without changing its zero-current-example result. Hash
helpers closed under `LUA-BACKEND-PARITY.4.3.5`; tree callbacks subsequently closed under
`LUA-BACKEND-PARITY.4.3.6.5` at 114/114.
...
[[uniform-binding-array-end-result-supersession]], [[lua-runtime-array-tree-callbacks]].
