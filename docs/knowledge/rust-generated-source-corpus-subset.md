...
strict staged classifier now validates generated source over all 105 oracle
fixtures with zero failures. The compact subset remains for localization; the
full gate is unconditional, contract-checked, and admitted.
