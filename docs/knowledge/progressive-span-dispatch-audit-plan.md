...
date: 2026-08-17
status: executable neutral authority and private Perl/Rust/Dart/Julia admissions current; exact shared Lua dual-ABI RED frozen and private authority next
...
carriers `.2`, canonical admission `.3`, and independent recomposition `.4` are complete. Shared Lua `.6` must split
