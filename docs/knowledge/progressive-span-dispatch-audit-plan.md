...
date: 2026-08-17
status: executable neutral authority and all six private runtime admissions current; recurrence and public no-drift pending
...
`.6.0`, private authority `.6.1`, dormant carriers `.6.2`, and dual-ABI admission `.6.3` are complete;
recomposition `.6.4` follows.
