...
date: 2026-08-17
status: executable neutral authority, all six private runtime admissions, and typed recurrence complete; public no-drift pending
...
are privately admitted at rollout 7/9/112. Julia's exact historical dormant RED `.0`, private authority/core `.1`,
...
`progressive_span_dispatch`, making typed truth 12/2/170 while behavioral truth remains 7/9/112. `.8` next closes public projection/no-drift without exporting a facade or
