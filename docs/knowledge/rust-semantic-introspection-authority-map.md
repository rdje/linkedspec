...
evidence: docs/tasks/FUTURE-PARITY-BACKLOG.md leaves .10.4.0-.10.4.3; docs/decisions/0049-versioned-semantic-introspection-model-and-thin-mcp.md; docs/decisions/0051-unicode-17-xid-continue-rule-labels.md; capability_conformance/semantic_introspection_model.json; capability_conformance/unicode_rule_label_contract.json; rust/linkedspec-runtime/src/semantic_index.rs; rust/linkedspec-runtime/src/semantic_index/static_projection.rs; rust/linkedspec-runtime/src/semantic_index/call_projection.rs; rust/linkedspec-runtime/src/engine.rs
...
Rust now has an opaque `SemanticIndex` source/outcome foundation plus private clone-safe static and call/staged/
generated v1 projections, but no query evaluator or typed semantic observation sink. Its strict source constructors copy caller text/bytes,
retain private
...
Unicode ranges, and provenance; no ActionIR, generated source, path, or public query escapes. See
