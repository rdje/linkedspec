...
title: The typed source-location neutral contract is executable and the Perl runtime is admitted
answers:
...
date: 2026-08-01
status: neutral artifact, public teaching/recomposition, and Perl runtime complete; 4 of 14 rollout legs complete
...
two internal contract ids, 31 exact diagnostic/negative fixtures, 14 rollout legs, and 38 independent mutations.
...
surface. Perl helpers now project through internal typed values while preserving those public results; public
authored typed values and every non-Perl runtime remain future.
...
admission `.14.2.1.3` advances the current ledger to 4 complete / 10 pending with 38 mutations. Internal Perl
values/projections are current; public authored values, transactions, and the other five runtimes remain future.
