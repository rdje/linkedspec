...
title: The typed source-location neutral contract is executable and the Perl and Rust runtimes are admitted
answers:
...
date: 2026-08-01
status: neutral artifact, public teaching/recomposition, and Perl/Rust runtimes complete; 5 of 14 rollout legs complete
...
two internal contract ids, 31 exact diagnostic/negative fixtures, 14 rollout legs, and 39 independent mutations.
...
surface. Perl and Rust helpers now project through internal typed values while preserving those public results;
public authored typed values and the Dart, Julia, PUC Lua, and LuaJIT runtimes remain future.
...
admission `.14.2.1.3` and Rust admission `.14.2.2.3` advance the current ledger to 5 complete / 9 pending with 39
mutations. Internal Perl/Rust values and projections are current; public authored values, transactions, and the
Dart, Julia, PUC Lua, and LuaJIT runtimes remain future.
