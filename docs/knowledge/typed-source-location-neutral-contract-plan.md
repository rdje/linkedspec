...
title: The typed source-location neutral contract is executable and the Perl, Rust, and Dart runtimes are admitted
answers:
...
date: 2026-08-01
status: neutral artifact, public teaching/recomposition, and Perl/Rust/Dart runtimes complete; 6 of 14 rollout legs complete
...
two internal contract ids, 31 exact diagnostic/negative fixtures, 14 rollout legs, and 40 independent mutations.
...
surface. Perl, Rust, and Dart helpers now project through internal typed values while preserving those public
results; public authored typed values and the Julia, PUC Lua, and LuaJIT runtimes remain future.
...
admission `.14.2.1.3`, Rust admission `.14.2.2.3`, and Dart admission `.14.2.3.3` advance the current ledger to
6 complete / 8 pending with 40 mutations. Internal Perl/Rust/Dart values and projections are current; public
authored values, transactions, and the Julia, PUC Lua, and LuaJIT runtimes remain future.
