...
date: 2026-09-03
status: implemented under FUTURE-PARITY-BACKLOG.19.5.2; Lua also implemented, portable/public admission pending
...
evidence_update_2026_09_04_lua_implementation: "FUTURE-PARITY-BACKLOG.19.6.2 implements the same unchanged typed identity-guarded receiver mutation in shared Lua on PUC Lua and LuaJIT. Julia behavior and proof remain unchanged; only portable/public admission and recurring proof remain pending."
