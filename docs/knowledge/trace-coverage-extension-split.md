...
reverify: "rg -n 'TRACE-OBSERVABILITY\\.3\\.2|trace_generated_handler_branch|non-repetition generated|repetition|min/max|ActionIR owner|backend parity' docs/tasks/TRACE-OBSERVABILITY.md docs/TASK_TREE.md MEMORY.md LIVE_ACHIEVEMENT_STATUS.md perl/LinkedSpec/Trace.pm"
---
...
- `.3.2`: non-repetition generated handler dispatch decisions (next);
