...
title: Engineering-notes history has a finite eighteen-member routing capacity
answers:
...
the manifest remains capped at 16,384 bytes. Any nineteenth member requires another exact staged ADR.

Related: ADR `0090`, [[engineering-notes-seventeenth-member-capacity]], and
[[bounded-change-notes-history-contract]]. Owner: [[TRACE-OBSERVABILITY]] `.5.4`.
