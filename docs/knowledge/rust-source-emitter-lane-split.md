...
title: RUST-PARITY.8 is split into narrow source-emitter leaves; Rust generated source now directly runs non-REP and REP family matrices
answers:
...
- `.8.5`: current executable frontier — all-variant smoke matrix and oracle/corpus integration.
...
execution for every current generated family.
