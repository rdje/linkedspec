...
After `DART-BACKEND-PARITY.7.4` productized the Dart-specific CLI, the active
Dart frontier is `DART-BACKEND-PARITY.7.5` final no-drift closeout. The
generated-source deferral remains unchanged.
