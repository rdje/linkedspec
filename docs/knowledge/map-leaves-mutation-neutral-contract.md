...
date: 2026-08-31
status: accepted neutral contract; implemented on all five backends; portable capability admitted under FUTURE-PARITY-BACKLOG.19.7
...
Perl, Rust, Dart, Julia, and Lua now implement this contract through dedicated typed ASTs and copy-on-write runtimes. Rust
...
control remains unchanged on all five backends. `.19.7` admits the exact portable capability row; recurring proof
and public-current closeout remain `.19.8-.19.9`.
