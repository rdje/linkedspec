...
family. Descriptor v1 and generated-source v1 retain only the bounded
`legacy_artifact_parse_mode()` adapter until `.9.1.4.4-.5`; the ambiguous runtime
compatibility predicate is no longer a live execution authority.
