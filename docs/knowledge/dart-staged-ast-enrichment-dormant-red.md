...
date: 2026-08-26
status: historical boundary superseded by current private marker/provenance/current-depth authority; consumer remains dormant
...
and canonical CI do not execute it. Its current first twelve groups are GREEN;
the thirteenth and sole deliberate RED names `.14.7.5.3` recursive bounded
authority. `.3-.4` retain recurrence/rebasing and fresh carriers/admission.
