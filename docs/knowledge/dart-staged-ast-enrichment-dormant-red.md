...
date: 2026-08-26
status: historical boundary superseded by current private marker/provenance; consumer remains dormant
...
and canonical CI do not execute it. Its current first seven groups are GREEN;
the eighth and sole deliberate RED names `.14.7.5.2` caller-frozen authority.
`.2-.4` retain resolution/policies, recursive authority, and fresh
carriers/admission respectively.
