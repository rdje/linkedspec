...
date: 2026-08-26
status: historical boundary superseded by complete private Dart admission; consumer is final-path and GREEN
...
evidence_update_2026_08_27_admission: "FUTURE-PARITY-BACKLOG.14.7.5.4 supersedes the final carrier RED. The same stable consumer moves to dart/test/staged_ast_enrichment_contract_test.dart, passes 19/19, runs in ordinary discovery, and is required/invoked exactly once canonically. A fresh host-only seed covers native, reconstructed, generated-plan, and emitted post-parent execution; Dart rollout is complete and neutral governance is 90 mutations."
last_verified: 2026-08-27
reverify:
  - "git show 93b035c3f1417d81abbf2527ffe3280f66d33df8:dart/test_dormant/staged_ast_enrichment_contract_test.dart"
  ...
  - "rg -n 'ActionStagedParseJobExpr|constructStagedParseJobMarker|stagedCaptureCodeUnitSpan|STAGED_PARSE_JOB_MARKER|staged_parse_job_v2' dart/lib/src dart/test/staged_ast_enrichment_contract_test.dart"
---
...
The historical consumer lived under `dart/test_dormant/`. `.14.7.5.4` moved the
same stable test to `dart/test/staged_ast_enrichment_contract_test.dart`, where
all nineteen groups are GREEN and ordinary/canonical topology executes it
exactly once.
