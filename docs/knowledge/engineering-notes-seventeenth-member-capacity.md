...
date: 2026-08-25
status: historical; superseded by eighteenth-member capacity
...
evidence_update_2026_08_26: "TRACE-OBSERVABILITY.5.4 mandatory rollover creates segment 4990. ADR 0090 advances only finite collection and manifest-line capacity to 18 files / 17 manifest lines. This card preserves the exact historical seventeenth-member boundary; engineering-notes-eighteenth-member-capacity owns current limits."
...
the manifest remains capped at 16,384 bytes. ADR `0090` subsequently authorizes the exact eighteenth member.

Related: ADR `0087`, [[engineering-notes-sixteenth-member-capacity]], and
[[bounded-change-notes-history-contract]], and [[engineering-notes-eighteenth-member-capacity]]. Historical owner:
[[FUTURE-PARITY-BACKLOG.14]] `.14.6.7`.
