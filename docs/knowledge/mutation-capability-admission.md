...
date: 2026-09-04
status: portable capability admission .19.7 and recurring six-runtime proof .19.8 complete; public closeout remains .19.9
...
Capability admission is distinct from recurring execution. `.19.8` now supplies one routed Perl/Rust/Dart/Julia/
PUC-Lua/LuaJIT driver plus exact canonical registration, while `.19.9` still owns final public-current examples,
no-drift, parent `.19` closeout, and the push boundary.
