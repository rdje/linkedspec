...
Standalone user-function call discard, recursion/purity diagnostics, and stricter
side-effect/caller-capture rejection are owned by `SPEC-FORMAT-TERSE.4.2.3`.
