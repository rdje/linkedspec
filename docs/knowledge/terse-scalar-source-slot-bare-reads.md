...
This is deliberately narrower than generic value-expression bare reads. Mutation key/RHS slots were handled by
`SPEC-FORMAT-TERSE.1.2.3.3.2`; generic helper arguments and direct path atoms such as `[z]` remain separate
children.
