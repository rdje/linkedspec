...
evidence_update_2026_07_15_closeout: "Variadic-v2 and contextual execution extend the same runtime through .5.1.4.2; .5.1.5 closes parent .5.1 at 146/146 with status runtime-user-functions-contextual-codeblock-v1 and activates .5.2."
...
and function-owned runtime diagnostic attribution. This leaf first published
`runtime-user-functions-fixed-v1`; later variadic/contextual leaves advance current status to
`runtime-user-functions-contextual-codeblock-v1`, close parent `.5.1`, and activate native loading `.5.2`.
