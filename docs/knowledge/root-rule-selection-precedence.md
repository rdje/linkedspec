...
admission consumer. Julia and Lua still make their no-marker fallbacks unreachable in validation. Follow task
subtree `.9.1.1.2` for the 4/7 rollout state; do not report markerless selection as uniform across all backends
until Julia, Lua/LuaJIT, and final no-drift close.
