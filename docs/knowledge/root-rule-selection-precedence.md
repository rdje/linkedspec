...
date: 2026-07-18
status: neutral contract plus Perl and Rust admitted; Dart core implemented; rollout 3 complete / 4 pending
...
and Rust backends are complete. Dart core/native/primary behavior now implements the same rule, but its composed
routes and admission remain `.3.2-.3`; Julia and Lua still make their no-marker fallbacks unreachable in
