...
title: Dart progressive span dispatch has callback-scoped private authority without carriers
answers:
...
date: 2026-08-17
status: private authority/core current; dedicated node, four carriers, admission, and Dart rollout pending
...
The dedicated expression and four execution carriers remain absent. `.14.6.4.2` will attach fresh opaque host
authority to native, reconstructed, generated-plan, and independently analyzed emitted-source execution;
