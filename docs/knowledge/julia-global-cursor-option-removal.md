...
reverify: "bash tools/run_julia_project_data.sh --project=julia --startup-file=no --history-file=no julia/test/runtests.jl && bash tools/check_julia_primary_cli.sh && python3 tools/check_rule_local_cursor_contract.py"
---
