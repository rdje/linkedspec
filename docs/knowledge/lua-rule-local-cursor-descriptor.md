...
reverify: "bash tools/run_lua_project_data.sh puc lua/test/rule_local_cursor_descriptor_test.lua && bash tools/run_lua_project_data.sh luajit lua/test/rule_local_cursor_descriptor_test.lua && python3 tools/check_rule_local_cursor_contract.py"
---
