...
date: 2026-08-27
status: current private Julia carrier admission; Lua, recurrence, public authoring, and recomposition remain pending
...
backend boundary and neutral governance is 97 mutations. Lua, six-runtime recurrence, public authoring/no-drift,
independent recomposition, and combined program-wide composition retain their existing owners.
