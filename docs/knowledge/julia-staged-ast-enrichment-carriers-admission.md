...
date: 2026-08-27
status: current private Julia carrier admission; shared Lua marker/provenance dormant; recurrence, public authoring, and recomposition remain pending
...
This is private backend behavior, not public `parse_job(...)` authoring. Julia rollout is complete at the 5/9
backend boundary and neutral governance is 98 mutations after shared Lua dormant activation. Lua marker/provenance,
later private authority and admission, six-runtime recurrence, public authoring/no-drift, independent
recomposition, and combined program-wide composition retain their existing owners.
