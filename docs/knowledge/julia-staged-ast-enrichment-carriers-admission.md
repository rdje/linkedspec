...
date: 2026-08-27
status: current private Julia carrier admission; all private backends admitted; recurrence, public authoring, and recomposition remain pending
...
Six-runtime recurrence, public authoring/no-drift, independent recomposition, and combined program-wide
composition retain their existing owners.
