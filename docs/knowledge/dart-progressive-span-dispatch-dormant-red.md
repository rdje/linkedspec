...
date: 2026-08-17
status: historical RED superseded by dormant GREEN carriers; admission and rollout pending
...
That exact RED is now historical. `.14.6.4.2` adds static syntax, the dedicated node, and authority plumbing across
the four carriers without changing the test identity. `.14.6.4.3` still owns ordinary/canonical discovery and
...
final-path consumer is now GREEN through the carriers documented in [[dart-progressive-span-dispatch-carriers]],
while ordinary and canonical discovery remain absent.
