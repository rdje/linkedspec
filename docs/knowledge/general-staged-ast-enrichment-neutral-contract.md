...
date: 2026-08-25
status: executable neutral with private Perl and Rust admissions complete; Dart recursive authority dormant; Julia, Lua, recurrence admission, and public authoring pending
...
dormant consumer whose private marker, typed provenance, frozen resolver/cache/policy engine, breadth-first
recurrence, strict lineage, shared resources, expiring safe points, and typed source rebasing are complete through
`.14.7.5.3`. Fresh production carriers, admission, and Dart rollout remain `.14.7.5.4`.
