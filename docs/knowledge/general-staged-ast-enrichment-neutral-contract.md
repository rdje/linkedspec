...
date: 2026-08-25
status: executable neutral with private Perl, Rust, and Dart admissions complete; Julia, Lua, recurrence admission, and public authoring pending
...
`.14.7.6.0` is the next backend boundary.
