...
date: 2026-08-25
status: executable neutral and private Perl admission complete; Rust dormant marker/provenance complete; authority, later rollout, backends, recurrence, and public authoring pending
...
options, typed direct/ordered-derived provenance, and all four logical carrier observations before one final
caller-frozen-authority RED. Rust rollout remains pending.
...
[[rust-staged-ast-enrichment-dormant-red]], and [[rust-staged-ast-enrichment-marker-provenance]].
