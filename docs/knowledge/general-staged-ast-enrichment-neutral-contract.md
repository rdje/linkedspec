...
date: 2026-08-25
status: executable neutral with all five private backends and six runtime routes admitted; recurrence and public authoring pending
...
and rollout rows complete; six-runtime recurrence, public authoring, and independent recomposition remain pending.
