...
title: Engineering-notes history has a finite fifteen-member routing capacity
answers:
...
bytes; and the manifest remains capped at 16,384 bytes. Any sixteenth member requires another exact staged ADR.
