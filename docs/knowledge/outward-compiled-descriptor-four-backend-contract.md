...
answers:
  ...
  - "do Perl Rust Dart Julia and Lua expose the same descriptor shape"
...
variant from `.9.1.3.3`, Rust from `.9.1.4.4`, Dart from `.9.1.5.3`, Julia from `.9.1.6.3`, and Lua from
`.9.1.7.3`.
...
Rust's typed projection already uses the canonical fields. Julia and Lua additionally prove direct, normalized
