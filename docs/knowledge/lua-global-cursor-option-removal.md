...
date: 2026-07-19
status: implemented, verified, and composed-admitted by FUTURE-PARITY-BACKLOG.9.1.7.6
...
evidence_update_2026_07_19_admission: "Lua admission .9.1.7.6 composes this removal boundary with every other cursor role in one exact 15-role consumer on PUC Lua and LuaJIT. Focused composition is 119/119 per ABI and governance advances to 69/6+2/49."
reverify: "tools/run_lua_local.sh && bash tools/run_python_project_data.sh tools/check_rule_local_cursor_contract.py"
---
