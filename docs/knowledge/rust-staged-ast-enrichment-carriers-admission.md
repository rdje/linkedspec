...
date: 2026-08-26
status: current private Rust carrier admission; Dart is also admitted, Julia recursive authority is dormant, and .14.7.6.4 is next
...
reached the same private admission boundary; Julia now has its private marker and typed provenance while one
authority/policy sentinel remains RED. Lua, six-runtime recurrence, public authoring, independent recomposition,
and combined no-drift retain their existing owners.
