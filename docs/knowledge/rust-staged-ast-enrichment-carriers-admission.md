...
date: 2026-08-26
status: current private Rust carrier admission; Dart is also admitted, Julia is dormant RED, and .14.7.6.1 is next
...
reached the same private admission boundary; Julia now has one dormant RED while Lua, six-runtime recurrence,
