...
date: 2026-08-26
status: current private Rust carrier admission; all private backends are admitted
...
PUC Lua, and LuaJIT have since reached the same private admission boundary. Six-runtime recurrence, public
authoring, independent recomposition, and combined no-drift retain their existing owners.
