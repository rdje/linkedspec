...
date: 2026-08-26
status: current private Rust carrier admission; Dart and Julia are also admitted; Lua marker/provenance is dormant
...
This is private backend behavior, not public `parse_job(...)` authoring. Rust rollout is complete. Dart and Julia
have since reached the same private admission boundary. Lua, six-runtime recurrence, public authoring, independent
