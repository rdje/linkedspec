...
evidence_update_2026_07_18_rust_generated_v2: "FUTURE-PARITY-BACKLOG.9.1.4.5 migrates Rust's typed direct/traced generated roles from v1 to v2 without changing logical values, eager effects, exact pre-effect arity, or the separate compatibility parse-output shape. The recurring neutral topology now requires generated_v2_direct/generated_v2_traced and rejects all 26 omission mutations."
