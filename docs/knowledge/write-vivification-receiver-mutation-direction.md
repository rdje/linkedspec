...
date: 2026-07-15
status: accepted direction; both mechanisms complete on all five backends, portable/public admission pending
...
four under `.19.6.2`. Every backend may now claim both mechanisms; recurring proof and
portable/public admission remain pending under `.19.7-.9`.
