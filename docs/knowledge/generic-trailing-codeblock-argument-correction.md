...
evidence_update_2026_08_01_five_implementations: "Perl .11.3, Rust .11.4, Dart .11.5, Julia .11.6, and Lua .11.8.1-.3 now implement explicit literals, dynamic calls, and metadata-governed contextual helper/user-function/receiver/tree equivalence through their ordinary evaluators. At that boundary Lua five-backend recurring admission was still owned by .11.8.4."
evidence_update_2026_08_01_five_backend_admission: "FUTURE-PARITY-BACKLOG.11.8.4 makes the recurring five-backend/public projection current on both Lua ABIs."
