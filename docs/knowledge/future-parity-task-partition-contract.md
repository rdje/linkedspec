...
reverify:
  ...
  - "sed -n '1,9p' docs/tasks/FUTURE-PARITY-BACKLOG.index.jsonl"
...
line is accounted exactly once by root provenance, the seven semantic parts, or
...
Capability exclusion reads all seven semantic parts for its full task census and `.15-.24` for its public
