...
evidence_update_2026_09_08_capacity: "Director-approved containment .7.2 and ADR 0109 change only aggregate task ceilings to 88,000 lines / 9,437,184 bytes. File count 128, global and stricter member limits, eight semantic parts, index/provenance and stable-ID retrieval remain unchanged. Actual collection-validator boundary proof brings the checker to 31 self-test classes; prior 27/27 and 80,000-line/8-MiB evidence above describe the earlier dated state."
