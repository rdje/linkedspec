...
reverify: "python3 tools/check_root_rule_selection_contract.py && rg -n 'ROADMAP.md|ROADMAP_V2.md' tools/check_root_rule_selection_contract.py capability_conformance/root_rule_selection_contract.json"
---
