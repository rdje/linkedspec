...
Shared CLI/public admission remains separately owned and must close before the Perl rollout row is promoted.

Related: [[perl-root-rule-selection-core]], [[perl-root-rule-selection-preflight]], and
