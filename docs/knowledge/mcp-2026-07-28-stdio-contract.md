...
date: 2026-07-29
status: exact neutral contract canonical; Perl/Rust/Dart admitted at 3/5 + 3/6; rollout pending
...
`0059`; ADR `0060` freezes Julia's implementation seams before code, while Julia, Lua, recurring six-runtime
...
Related facts: [[mcp-native-server-topology]], [[julia-native-mcp-server-plan]], [[dart-native-mcp-server-plan]], [[dart-mcp-decoded-server]], [[dart-mcp-strict-stdio]], [[semantic-introspection-api-mcp-direction]],
