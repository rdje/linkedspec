...
evidence_update_2026_07_29_perl_and_rust: "Perl .10.9.2 is implemented, admitted, and parent-closed at 1/5 implementations + 1/6 runtimes with shared rollout pending. Rust behavior-free .10.9.3.0 and ADR 0058 freeze its native generated-binding/registry/wire/admission seams without behavior."
...
28-positive/7-negative schema and 68-mutation proof. Perl now implements and admits that contract; Rust is the
active behavior-free owner plan, and Dart/Julia/Lua implementations remain later work.
