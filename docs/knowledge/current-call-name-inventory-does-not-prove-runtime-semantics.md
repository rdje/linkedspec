...
evidence_update_2026_07_10: "FUTURE-PARITY-BACKLOG.1.6.1.2.2.1.1 repairs Rust's pure fixture: numeric predicate results, direct-literal flat splicing, and explicit working-array statement transforms now match Perl. The governed exact fixture, 191 integration tests, and unchanged 99-case oracle pass. Dart `.1.2` is the next pure-value child; the overall card remains a confirmed gap until every mechanism/backend and final 105-case admission close."
