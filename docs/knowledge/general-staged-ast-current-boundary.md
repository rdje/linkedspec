...
date: 2026-08-25
status: current runtime audit; neutral and private Perl admission complete; Rust dormant current-depth authority complete through .14.7.4.2; recurrence through public implementation remains .14.7.4.3-.10
...
discovery. This remains private Perl behavior, not public authoring. Rust `.14.7.4.0-.2` now freeze its equivalent
dormant boundary, add private declaration behavior, and complete one current marker depth: current v1 remains
...
The sole opt-in RED names missing recurrence/bounds/rebasing. Ordinary Rust discovery stays at zero tests and
canonical CI stays unchanged.
