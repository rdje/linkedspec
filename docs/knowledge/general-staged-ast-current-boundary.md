...
date: 2026-08-25
status: current runtime audit; private Perl, Rust, Dart, and Julia admissions complete; Lua current-depth authority is dormant under .14.7.7.2
...
The Julia consumer is 491/491 GREEN and admitted. Lua now has one shared 888/888 dormant GREEN consumer on both
ABIs with private marker/provenance, current-depth authority, bounded recursive scheduling, source rebasing, and
four fresh production carriers complete; its function-body-v1 path remains unchanged and `.14.7.7.4` alone owns
ordinary/canonical dual-ABI admission plus Lua rollout promotion.
