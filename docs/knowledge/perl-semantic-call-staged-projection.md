...
date: 2026-07-21
status: current private compiled projection; public query, observations, and admission pending
...
`capabilities`/`query`, runtime observations, the composed Perl consumer, and ledger admission remain owned by
`.10.3.4-.10.3.6`; neutral rollout stays 1/9 and backend admission 0/6.
