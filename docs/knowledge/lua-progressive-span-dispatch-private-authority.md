...
date: 2026-08-25
status: private authority and dormant carriers current on both ABIs; admission next
...
Carrier leaf `FUTURE-PARITY-BACKLOG.14.6.6.2` now starts fresh execution state
from this core for every native and generated top-level run. The module remains
private and unexported; admission stays exclusively owned by `.14.6.6.3`.
