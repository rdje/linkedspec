...
also closed. `RUST-PARITY.8.1` has since split the source-emitter lane; the
current RUST-PARITY frontier is `.8.2`, the minimal generated-source scaffold
and compile/run harness.
