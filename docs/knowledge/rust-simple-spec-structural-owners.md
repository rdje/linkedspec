...
`.8.3.3` landed direct acode generated execution, and `.8.3.4` landed direct
AND/OR bcode generated execution. The current RUST-PARITY frontier is `.8.3.5`,
close the non-repetition generated-family matrix.
