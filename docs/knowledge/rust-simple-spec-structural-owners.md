...
generated-family matrix, and `.8.4` closed direct REP generated-family
execution. The current RUST-PARITY frontier is `.8.5`, generated-source
validation against the oracle/corpus contract.
