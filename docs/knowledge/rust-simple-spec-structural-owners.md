...
harness, `RUST-PARITY.8.3.1` landed the generated family plan, and
`RUST-PARITY.8.3.2` / `.8.3.3` landed direct acode generated execution. The
current RUST-PARITY frontier is `.8.3.4`, direct AND/OR bcode generated
execution.
