...
AND/OR bcode generated execution, `.8.3.5` closed the non-repetition
generated-family matrix, `.8.4` closed direct REP generated-family execution,
and `.8.5` added the generated-source manifest-backed corpus-subset proof. The
current RUST-PARITY frontier is `.9`.
