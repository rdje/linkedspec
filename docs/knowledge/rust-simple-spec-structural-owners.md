...
The structural branch is closed. The follow-on null-output/spec-smoke triage and
RTL/plugin/legacy safety-smoke audit are also closed; the current RUST-PARITY frontier is
`.7.4`, the regression guard and oracle corpus finalization leaf.
