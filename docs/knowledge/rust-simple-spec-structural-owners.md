...
The structural branch is closed. The next RUST-PARITY frontier after the null-output/spec
smoke triage is `.7.3.6`, which audits RTL/plugin/legacy shipped-spec candidates under
