...
title: "Exact array(name) and hash(name) selectors are migrated and hard-rejected on all five backends"
answers:
...
evidence_update_2026_08_30_public_migration_contrasts: "FUTURE-PARITY-BACKLOG.23.1 restores seven concrete retired spellings only inside one explicit mdBook migration section and adds five-pair/eleven-mutation semantic governance. Public proof is 61 files / 32 historical references / zero current examples; executable proof remains zero-positive/20-classified."
