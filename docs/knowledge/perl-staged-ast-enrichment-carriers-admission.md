...
date: 2026-08-26
status: current private Perl admission; Rust and Dart also admitted; Julia dormant RED; Lua, recurrence, and public authoring pending
...
`.14.7.6.1` is the next backend leaf after its dormant boundary.
