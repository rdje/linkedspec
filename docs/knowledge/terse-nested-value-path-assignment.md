...
date: 2026-07-05
status: current; Perl and Rust vivify under FUTURE-PARITY-BACKLOG.19.2.1/.19.3.1 while Dart/Julia/Lua retain the prior checked boundary
...
reverify: "prove -Iperl t/write_vivification_perl_contract.t && cargo test --manifest-path rust/Cargo.toml -p linkedspec-runtime --test write_vivification_contract"
---
...
Dart, Julia, and Lua retain the earlier checked boundary:
...
[[write-vivification-perl-reference]] and [[write-vivification-rust-runtime]]. Cross-backend and public admission
