...
date: 2026-07-23
status: historical private non-traversal foundation; traversal complete and public exposure pending
...
`.10.6.5.3`. Traversal and limits are now complete under `.10.6.5.2`; see
...
That completion is now implemented and exact; raw malformed-request validation, public exports, typed/raw-neutral
entry points, and complete clone/non-interference admission stay in `.10.6.5.3`. Runtime events remain
`.10.6.6`.
...
Related facts: [[julia-semantic-query-traversal]], [[julia-semantic-query-authority-map]], [[julia-semantic-static-projection-plan]],
