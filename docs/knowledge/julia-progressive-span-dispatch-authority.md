...
date: 2026-08-24
status: private authority/core and dormant carriers current; Julia admission pending
...
The focused dormant consumer proves the core independently. `.14.6.5.2` now attaches the dedicated node, opaque
execution seed, and four carriers while preserving this authority's private and independently tested boundary.
The carrier consumer remains dormant until `.14.6.5.3` admits it.
