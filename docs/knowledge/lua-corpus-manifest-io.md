...
evidence: "LUA-BACKEND-PARITY.1.3 adds linkedspec.json and linkedspec.corpus. The local gate passes 10/10 on PUC Lua and 10/10 on LuaJIT, loads exactly 105 checked-in fixtures, and process-validates the corpus without parser execution."
