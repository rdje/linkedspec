...
No `SPEC-FORMAT-TERSE` leaf is currently pending. PNT returns to `TRACE-OBSERVABILITY.1` unless a new terse leaf
is split or another active tree is reprioritized.
