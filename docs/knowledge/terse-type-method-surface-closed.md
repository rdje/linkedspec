...
No `SPEC-FORMAT-TERSE` leaf is currently pending. `TRACE-OBSERVABILITY.1` has since closed its read-only audit;
PNT returns to `TRACE-OBSERVABILITY.2` unless a new terse leaf is split or another active tree is reprioritized.
