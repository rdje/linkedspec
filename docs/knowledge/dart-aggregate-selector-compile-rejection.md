...
reverify: "cd dart && dart test test/uniform_binding_contract_test.dart && dart analyze --fatal-infos --fatal-warnings; cd .. && bash tools/run_python_project_data.sh tools/check_executable_aggregate_selector_sources.py"
---
