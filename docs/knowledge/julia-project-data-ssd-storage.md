...
answers:
  ...
  - why did the Julia temporary owner count change from 20 to 21
date: 2026-08-16
status: current
...
`tools/test_julia_project_data_storage.sh` freezes all 21 tracked `mktempdir()`/`tempdir()` owners, checks actual
