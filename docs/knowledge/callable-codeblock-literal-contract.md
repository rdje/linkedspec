...
native/generated identity. Contextual equivalence remains `.11.4.3`, and Dart/Julia/Lua explicit values remain
future, so the complete feature is not yet portable.
