...
evidence: "LUA-BACKEND-PARITY.2.1 adds lua/src/linkedspec/spec_ast.lua; .2.2 adds its first source producer; .2.3 adds validation. The current full local gate passes 31/31 on PUC Lua and 31/31 on LuaJIT."
