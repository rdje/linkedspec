...
The test remains explicitly invoked during classification. Zero-failure
closeout is complete; Rust's capability state therefore stays partial only
until the proof becomes a strict recurring admission gate under `.3.2.2`.
