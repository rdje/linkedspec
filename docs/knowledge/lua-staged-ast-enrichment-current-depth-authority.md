...
evidence_update_2026_08_27_admission: "FUTURE-PARITY-BACKLOG.14.7.7.4 preserves enrich_current_depth, recursive authority, and every production byte while admitting the exact 888/888 consumer once per ABI. Only Lua lifecycle/rollout and exact 106-mutation topology truth move."
