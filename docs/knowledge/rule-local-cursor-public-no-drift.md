...
The rollout closes only the cursor contract. It does not falsely close the broader AND/OR semantics parents:
`FUTURE-PARITY-BACKLOG.9.1.10` remains pending for explicit repeated-OR action-edge result shape.
