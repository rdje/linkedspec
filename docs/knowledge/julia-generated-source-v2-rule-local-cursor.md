...
date: 2026-07-18
status: current and fully verified; public option removal and admission remain FUTURE-PARITY-BACKLOG.9.1.6.5-.6
...
the v2 APIs. Public/CLI global option removal remains `.9.1.6.5`; composed 15-role admission remains `.9.1.6.6`.

Related: [[julia-generated-source-scaffold]], [[julia-generated-source-family-plan]],
[[julia-rule-local-cursor-execution]], [[julia-root-rule-selection-routes]],
