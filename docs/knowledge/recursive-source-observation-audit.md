...
date: 2026-08-12
status: accepted audit; numeric lineage corrected, neutral executable, and all six runtimes privately admitted
...
Rust, Dart, Julia, PUC Lua, and LuaJIT recorded. Recurrence, facades, schemas, semantic/MCP, CLI, README, and public
behavior remain owned by `.14.4.7-.8`.
