...
date: 2026-08-12
status: accepted audit; numeric lineage corrected, neutral executable, and Perl privately admitted
...
mutation, bringing governance to 71 while the parent row stays pending with only Perl recorded. Other runtimes,
facades, schemas, semantic/MCP, CLI, README, and public behavior remain owned by `.14.4.3-.8`.
