...
lockstep parity landed under [[terse-rust-scalar-bare-read-parity]]. The legacy `scalaref(...)` helper was later
retired and removed under [[scalaref-implementation-removed]]. The next Channel 2 frontier is
