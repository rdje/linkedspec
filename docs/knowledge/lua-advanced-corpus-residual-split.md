...
No expected value is backend-local or weakened. The four repairs reach 59/59 with
no residual; `.6.2.5` records that zero-residual boundary before `.6.2.6` owns
permanent 59/59 admission.
