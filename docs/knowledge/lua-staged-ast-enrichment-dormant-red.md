...
date: 2026-08-27
status: current shared dual-ABI dormant RED at caller-frozen authority; marker/provenance is implemented
...
Each ABI reports 392 GREEN assertions and one intentional RED. Leaf `.14.7.7.1` owns the completed dedicated inert
...
[[function-body-staged-registry-dispatch]], and [[lua-staged-ast-enrichment-marker-provenance]].
