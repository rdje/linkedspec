...
evidence_update_2026_08_01_emitted_identity: "FUTURE-PARITY-BACKLOG.11.8.3 implements the third planned seam: native, effective-SpecFile reconstruction, generated-plan, and fresh emitted-module routes use one typed record/interpreter and pass 449 assertions per ABI. The storage manifest advances exactly from Lua owner 16 to 17; at that boundary admission was still owned by .11.8.4."
evidence_update_2026_08_01_admission: "FUTURE-PARITY-BACKLOG.11.8.4 completes the fourth seam by admitting PUC Lua and LuaJIT into recurring five-backend/public proof."
...
The exact pre-implementation probe produced the same result on PUC Lua and LuaJIT. Exact `{|` forms originally
...
Runtime probes froze the existing boundaries. A `block_value` executes eagerly. A contextual block passed to a
...
Related facts: [[lua-explicit-callable-codeblock-gap]], [[lua-callable-codeblock-dynamic-invocation]],
