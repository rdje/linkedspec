...
evidence_update_2026_07_18_routes: "Superseded for current route status by [[dart-root-rule-selection-routes]]. Leaf `.9.1.1.2.3.2` proves loaded/normalized and generated/emitted direct/traced reuse of this resolver, portable route failures, trace basis, and stale-contract-first ordering without changing generated v2 identity. Topology admission `.3.3` remains pending, so rollout stays 3/7."
evidence_update_2026_07_18_admission: "Superseded for current rollout status by [[dart-root-rule-selection-admission]]. Leaf `.9.1.1.2.3.3` topology-locks one 15-role Dart consumer, passes package 270 / primary 65x2 / corpus 105, and advances only Dart to complete at 4/7."
reverify: "cd dart && bash ../tools/run_dart_project_data.sh test test/root_rule_selection_core_test[.]dart test/spec_parser_test[.]dart test/spec_validator_test[.]dart test/runtime_interpreter_test[.]dart test/compiled_spec_test[.]dart test/rule_local_cursor_descriptor_test[.]dart test/primary_cli_test.dart && cd .. && bash tools/run_python_project_data.sh tools/check_root_rule_selection_contract.py && bash tools/run_dart_local.sh"
---
...
This card covers the core/native/primary owner. [[dart-root-rule-selection-preflight]] is the superseded baseline,
and [[dart-root-rule-selection-routes]] now records completed loaded/normalized/generated/emitted/trace route
composition. [[dart-root-rule-selection-admission]] now records the completed topology/reference promotion at
4/7.
