...
date: 2026-07-18
status: superseded by composed route proof; topology admission pending
...
composition. Topology/reference admission remains `.3.3`; only admission may promote Dart in the 3/7 rollout.
