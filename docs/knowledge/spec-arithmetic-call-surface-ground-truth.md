...
title: SPEC-FORMAT-TERSE.3.2 arithmetic/comparison call surface ground truth after numeric comparison word aliases
answers:
...
`SPEC-FORMAT-TERSE.3.2.2` landed arithmetic symbol callees, and
`SPEC-FORMAT-TERSE.3.2.3.3` landed numeric comparison word aliases.
