...
Rust must not copy the stale Perl tag merely because Perl is the behavioral reference. `.1.6.2.1` owns the public
identity reconciliation; `.1.6.2.2` adds Rust only after the contract is singular.
