...
evidence_update_2026_07_11_admission: "FUTURE-PARITY-BACKLOG.1.6.3.2 passes the complete Rust/CLI recurring gate and promotes structured runtime diagnostics to pass for all four variants."
...
adapters. `.1.6.3.2` closed full no-drift proof and capability admission.
