...
`.1.6.3.1` owns typed records and diagnostic-aware methods while retaining existing string-returning adapters.
`.1.6.3.2` owns full no-drift proof and capability admission.
