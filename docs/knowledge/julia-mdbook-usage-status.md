...
evidence: "JULIA-BACKEND-PARITY.7.1 documents native usage and 99/99; .7.2 defers generated source. ADR 0023 defines exact parity; .7.3.2.1 closes trace and .7.3.2.2 documents exact arguments/resolution/loading. Current suite is 920; .7.3.2.3 owns execution/JSON."
...
The accepted interpreter-first boundary is 99/99 exact corpus outputs, 920 package assertions, and package/CLI
...
loading; valid primary requests stop at active `.7.3.2.3` until execution/JSON lands. `JuliaFormatter`
