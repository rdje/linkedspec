...
- `.4.5.1`: structured runtime diagnostics and diagnostic-carrying exceptions;
...
The active executable frontier after `.4.5.0` is
`JULIA-BACKEND-PARITY.4.5.1`. Julia-native exception, configuration, and I/O
