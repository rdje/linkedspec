...
reverify: "cd dart && dart test test/root_rule_selection_admission_test.dart test/root_rule_selection_core_test.dart test/root_rule_selection_routes_test.dart test/source_emitter_test.dart && cd .. && bash tools/run_python_project_data.sh tools/check_root_rule_selection_contract.py && bash tools/run_dart_local.sh"
---
