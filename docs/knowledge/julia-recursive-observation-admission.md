...
date: 2026-08-12
status: current private Julia admission; Lua recurring and public closeout pending
...
marker. Shared Lua recursive observation remains the next private admission; public values remain future.
