...
evidence_update_2026_08_11_dart_admission: "FUTURE-PARITY-BACKLOG.14.3.4.3 advances both required markers to neutral + Perl + Rust + Dart 4/9 and Perl/Rust/Dart-current with Julia/Lua future. It adds the superseded neutral+Perl+Rust and Perl/Rust-current-only forms to the forbidden inventory. The guide guard is now 1 document / 6 forbidden claims / 10 mutations, independent of semantic 43, public 3/14/29, Rust admission 8, and Dart admission 13."
evidence_update_2026_08_11_julia_admission: "FUTURE-PARITY-BACKLOG.14.3.5.3 advances both required markers to neutral + Perl + Rust + Dart + Julia 5/9 and Perl/Rust/Dart/Julia-current with both Lua runtimes future. It adds the superseded neutral+Perl+Rust+Dart and Perl/Rust/Dart-current-only forms to the forbidden inventory. The guide guard is now 1 document / 8 forbidden claims / 12 mutations, independent of semantic 44, public 3/17/33, and Julia admission 14."
...
one neutral-plus-Perl-plus-Rust-plus-Dart-plus-Julia marker and one Perl/Rust/Dart/Julia-current/
later-runtimes-future marker. Eight forbidden claims cover the older neutral-only,
all-backends-unavailable, neutral-plus-Perl, Perl-current-only, neutral-plus-
Perl-plus-Rust, Perl/Rust-current-only, neutral-plus-Perl-plus-Rust-plus-Dart, and Perl/Rust/Dart-current-only
forms. Twelve mutations cover path,
marker contract, deletion, duplication, and every stale
