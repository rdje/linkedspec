...
executors, trace, diagnostic sinks, and runtime observers do not cross it. Staged payload/job/result and generated
handler provenance remain absent until `.10.5.3.2`; public query, runtime observation, rollout, and admission remain
unchanged.
