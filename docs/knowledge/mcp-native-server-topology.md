...
evidence_update_2026_07_29_perl_and_rust: "Perl .10.9.2 closes the first native implementation/runtime at 1/5 + 1/6. Rust .10.9.3.1 implements its generated binding, frozen runtime, secure registry, and decoded public server; strict stdio and admission remain pending, so the ledger and shared rollout do not move."
