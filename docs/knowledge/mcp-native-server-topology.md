...
date: 2026-07-29
status: exact neutral contract canonical; Perl/Rust admitted at 2/5 + 2/6; Dart decoded server implemented
...
Related facts: [[mcp-2026-07-28-stdio-contract]], [[dart-native-mcp-server-plan]], [[dart-mcp-decoded-server]], [[semantic-introspection-api-mcp-direction]], [[native-in-memory-backend-contract]],
