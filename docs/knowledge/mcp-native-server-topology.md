...
date: 2026-07-29
status: exact neutral contract canonical; Perl closed/admitted, Rust decoded/stdio implemented but admission pending
...
evidence_update_2026_07_29_perl_and_rust: "Perl .10.9.2 closes the first native implementation/runtime at 1/5 + 1/6. Rust .10.9.3.1-.2 implement its generated binding, frozen runtime, secure registry, decoded public server, and strict borrowed-stream stdio; exact admission remains pending, so the ledger and shared rollout do not move."
