...
The next PNT frontier after mutation assignment expression values is `SPEC-FORMAT-TERSE.3.3.4`, the legacy
function spelling cleanup and full assignment-expression closure child created by the `.3.3` split.
