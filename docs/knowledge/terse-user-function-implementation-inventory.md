...
The next PNT frontier after the aggregate assignment-expression implementation is `SPEC-FORMAT-TERSE.3.3.3`,
the array append and hash-index mutation expression-value child created by the `.3.3` split.
