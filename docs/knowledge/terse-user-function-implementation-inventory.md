...
The next PNT frontier after the scalar assignment-expression implementation is `SPEC-FORMAT-TERSE.3.3.2`,
the aggregate assignment-expression child created by the `.3.3` split.
