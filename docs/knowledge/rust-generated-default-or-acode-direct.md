...
`RUST-PARITY.8.3.4` later added direct `AndBcode` and `OrBcode`, and `.8.3.5`
closed the non-REP matrix. The remaining generated fallback family is REP,
owned by `.8.4`.
