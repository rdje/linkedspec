...
title: Rust general staged-AST enrichment retains one dormant authority RED after private marker/provenance
answers:
...
date: 2026-08-26
status: dormant marker/provenance complete; caller-frozen authority remains FUTURE-PARITY-BACKLOG.14.7.4.2-owned
...
marker, strict options, typed provenance, denials, and all four logical carriers, then fails one test only at the
final caller-frozen-authority assertion. That RED is a deliberate boundary contract, not an admitted runtime
failure.

`.14.7.4.1` completes the private dedicated marker and typed direct/ordered-derived provenance. `.2` owns frozen
...
[[staged-parser-registry-dispatch-contract]], [[rust-staged-ast-enrichment-marker-provenance]], and
