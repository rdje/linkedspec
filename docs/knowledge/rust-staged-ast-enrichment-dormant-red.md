...
title: Rust general staged-AST enrichment retains one dormant carrier-admission RED after recursive authority
answers:
...
date: 2026-08-26
status: dormant recursive authority complete; carriers, production seam, admission, and rollout remain FUTURE-PARITY-BACKLOG.14.7.4.4-owned
...
recursive queue/chain/resources, and original-source rebasing, then fails one test only at the final carrier-
admission assertion. That RED is a deliberate boundary contract,
...
rebasing, and `.4` owns four fresh-authority carriers, the production seam, ordinary/canonical admission, and Rust
rollout. No earlier leaf may
