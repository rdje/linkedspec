...
date: 2026-08-26
status: current private declaration carrier; caller-frozen authority remains dormant RED for FUTURE-PARITY-BACKLOG.14.7.5.2
...
reverify:
  ...
  - "rg -n 'ActionStagedParseJobExpr|stagedCaptureCodeUnitSpan|constructStagedParseJobMarker|validateAndMaterializeStagedProvenance' dart/lib/src dart/test_dormant/staged_ast_enrichment_contract_test.dart"
---
...
format v2. Resolution, caching, result/failure stitching, recurrence, fresh
host authority, admission, and rollout remain later leaves.
...
[[general-staged-ast-enrichment-neutral-contract]], and ADRs `0056`, `0088`.
