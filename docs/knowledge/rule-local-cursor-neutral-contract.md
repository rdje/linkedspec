...
date: 2026-07-18
status: accepted neutral contract; Perl and Rust admitted at 3 complete / 5 pending
tags: [dsl, cursor, parse-mode, bare-edge, contract, migration, descriptor, generated-source, parity]
evidence: "FUTURE-PARITY-BACKLOG.9.1.2 adds linkedspec-rule-local-cursor-v1 plus an independent offline checker over 36 family spellings, 18 edges, six ownership sets, eight parent/child mechanisms, two structural replacements, removal, descriptors, generated v2, and eight diagnostics. Perl .9.1.3.6 adds a 14-role contract-declared consumer and canonical registration. Rust .9.1.4.3 grows the scan from 72 to 74; descriptor .4 retires descriptor.rs to 73, generated v2 .5 contracts it to 71, and public removal .6 contracts it to 68. Admission .7 adds a token-free 15-role Rust consumer, requires canonical/default-to-optional-Rust registration, rejects 34 mutations, advances only rust_parity, and retains 68 files at 3 complete / 5 pending."
...
CLI/documentation migration reaches the current 68 files during `.9.1.4.5-.6`; composed admission `.7` retains
that exact count. Files are partitioned
...
Dart, Julia, dual-ABI Lua, recurring five-backend admission, and public no-drift follow. Generated-source v1 remains
the unmigrated-backend baseline, while the 63-case primary interface is current on Perl and Rust until later owners
land.
