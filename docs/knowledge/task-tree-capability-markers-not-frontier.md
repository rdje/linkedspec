...
reverify: "bash tools/run_python_project_data.sh tools/check_logical_helper_contract.py && perl tools/check_capability_conformance.pl && rg -n 'Canonical Closed-Capability Markers|Logical helper parent|Capability exclusion public closeout' docs/TASK_TREE.md"
---
...
now lives in this stable section as well, so current-frontier updates cannot invalidate the public-close contract.
