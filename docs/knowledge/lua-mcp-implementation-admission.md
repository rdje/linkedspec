...
date: 2026-07-29
status: exact one-source dual-ABI admission implemented and canonically signed off; clean closeout pending
...
`FUTURE-PARITY-BACKLOG.10.9.7`; committed-owner Lua closeout `.10.9.6.4` comes first.
