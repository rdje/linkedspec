...
date: 2026-07-18
status: core implemented; composed routes, cursor prerequisite, and admission remain pending
...
exemption. Loaded, normalized/reconstructed, generated/emitted, and selection-trace convergence remains the next
owned route leaf; final rollout must not be inferred from this core fact.

Related: [[julia-root-rule-selection-preflight]], [[root-rule-selection-precedence]],
[[dart-root-rule-selection-core]], and [[rust-root-rule-selection-core]].
