...
title: Native diagnostic helpers share one event contract while generated admission remains pending
answers:
...
a rich diagnostic sink, and ADR `0024`'s canonical phase trace is independent. Native helper bypasses are
