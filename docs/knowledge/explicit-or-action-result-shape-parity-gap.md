...
all five backends and recurring composition are complete at 7 complete / 1 pending
with 44 rejected mutations. Public no-drift remains `.9.1.10.7`; no backend is
admitted from the primary matrix alone.
