...
date: 2026-08-27
status: historical .14.7.6.0 baseline; .14.7.6.1-.3 now supply marker, current-depth, and recursive authority while dormancy remains
...
and `.3` adds private breadth-first recurrence, shared resources, safe points, and source projection. The same
consumer is now 386 GREEN / one `.4` carrier/production/admission/rollout RED.
