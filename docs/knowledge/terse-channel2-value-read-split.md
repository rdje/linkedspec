...
title: "SPEC-FORMAT-TERSE.1.2.3 — Channel 2 value reads split by aggregate/scalar surfaces; aggregate reads landed on Perl/Rust."
answers:
...
- `.1.2.3.3`: Perl scalar bare value reads. **Current frontier after `.1.2.3.2`.**
...
requires a Perl-reference leaf and then a Rust lockstep/conformance leaf, not a bundled aggregate-read change.
