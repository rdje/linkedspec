...
evidence: "ADR 0023 defines canonical CLI and complete capability parity. FUTURE-PARITY-BACKLOG.1.5/.1.6/.3 own global repair/census/codegen. Julia .7.3.2.5 closes its local primary process gate; global identity remains open."
...
does not replace global cross-backend fixture comparison.
