...
evidence: "ADR 0023 defines canonical CLI and complete capability parity. FUTURE-PARITY-BACKLOG.1.5/.1.6/.3 own global repair/census/codegen. Julia .7.3.2.4 closes local errors/exits/trace routing; .7.3.2.5 owns direct no-drift."
...
routing, and `.7.3.2.5` is active for direct-process no-drift.
