...
evidence_update_2026_08_25_lua_closeout: "FUTURE-PARITY-BACKLOG.14.6.6.4 closes the subsequent five-leaf shared Lua split without changing partition topology, stable IDs, pressure ceilings, routes, or capability truth. The bounded owner now hands off typed recurring proof .14.6.7."
reverify:
...
now closed. Shared Lua `.14.6.6.0-.4` subsequently uses the same owner and closes unchanged; typed recurring
proof `.14.6.7` is the current clean frontier.
