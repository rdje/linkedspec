---
id: inter-match-gap-recurring-public-closeout-plan
title: "Gap closeout separates recurring admission, public language admission, and no-change handoff"
answers:
  - "what is the exact inter-match gap recurring and public closeout plan"
  - "which leaf promotes recurring inter-match gap proof"
  - "which leaf makes entry_slot and gap accessors public current calls"
  - "when do shared ActionIR calls move from 246 to 250"
  - "when do public Perl helper contracts move from 122 to 126"
  - "why did stale Lua skip claims survive the inter-match gap checker"
...
date: 2026-08-16
status: recurring/public admission and independent no-change handoff complete at 9/0/63
...
`@capture_slice`, `@capture_from_here`, and `@move_pos` remain accepted legacy behavior and are not aliases for
`@capture_gaps`; mixing them with the new directive remains a diagnostic. Named marks and explicit capture/mark
helpers remain independent and may coexist. No `@emit_gaps` surface or forced AST emission is introduced.

## Links

- Owning task: `docs/tasks/INTER-MATCH-GAP-CAPTURE.md`
- Semantic decision: `docs/decisions/0045-inter-match-gap-capture.md`
- Closeout decision: `docs/decisions/0079-inter-match-gap-recurring-public-closeout.md`
- Existing contract: `capability_conformance/inter_match_gap_capture_contract.json`
- Cross-tree handoff: [[lossless-gap-cross-tree-handoff]]
