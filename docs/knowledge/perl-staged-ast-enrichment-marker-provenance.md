...
date: 2026-08-26
status: current private carrier; consumed by admitted Perl runtime through FUTURE-PARITY-BACKLOG.14.7.3.4
...
complete AST through caller-prepared resolution/cache, breadth-first complete depths, and all stitch/failure policies. The
carrier still owns no parser or authority and remains explicitly non-public in the language inventory. The admitted
runtime supplies fresh host authority after complete parent execution; see
