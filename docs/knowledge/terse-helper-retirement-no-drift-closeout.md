...
`NONCURRENT-HELPER-CODE-PURGE.5` closed the active code/test/tool/spec audit by replacing the
last Rust generic-unknown-helper unit fixture's retired examples with invented unknown names.
