...
date: 2026-08-17
status: historical RED boundary; private Rust authority and carriers current, admission and rollout pending
...
The same outer-cfg consumer now walks four GREEN carriers under `.14.6.3.2`; its historical cfg name and canonical
absence remain intentional continuity anchors. `.14.6.3.3` alone may route it and promote Rust rollout, which
remains 2/9 until that admission.
