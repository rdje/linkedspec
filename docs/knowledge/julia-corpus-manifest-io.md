...
corpus-runner non-execute commands report the validated fixture count. Corpus execution is still not implemented:
`--execute` deliberately returns an error until parser/runtime leaves land.
