...
date: 2026-08-25
status: exact dormant final-path RED preserved on PUC Lua and LuaJIT; private authority current, carriers next
...
Child `.14.6.6.1` now owns one private ActionIR-independent authority shared by
both ABIs and proven separately at 273/273 per host. `.2` alone owns the dedicated node and four dormant carriers. `.3` alone
