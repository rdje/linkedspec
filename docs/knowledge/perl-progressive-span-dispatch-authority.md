...
routes without serializing live authority. Admission leaf `.14.6.2.3` first routed the final-path consumer and promoted only
the Perl rollout row. That dated milestone is followed by the six-runtime recurrence
and completed 9/9 public no-drift boundary in
[[progressive-span-dispatch-public-no-drift]]. The intrinsic remains private.
