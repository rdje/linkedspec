...
- `2026-07-10` refresh: `JULIA-BACKEND-PARITY.5.3` locks neutral staged function descriptor shape through one
  ...
  No projection correction was required; status remains `runtime-user-functions`, full tests pass with 691
  assertions, `.5` closes, and `.6.1` controlled corpus execution is active.
- `2026-07-10` refresh: `JULIA-BACKEND-PARITY.5.2` adds registered exact-arity runtime calls before helper
  ...
  `runtime-user-functions`, and the full suite passes with 671 assertions. `.5.3` has since closed `.5`, and `.6.1`
  is active.
- `2026-07-10` refresh: `JULIA-BACKEND-PARITY.5.1` adds Julia's narrow staged function-body registry. It resolves
  ...
  since landed, `.5` is closed, and `.6.1` is active.
