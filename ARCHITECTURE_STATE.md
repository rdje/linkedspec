...
- `2026-07-12` refresh: `linkedspec-uniform-binding-v1` is adopted before backend behavior. One observable typed
  ...
  canonical ActionIR boundary before lowering; Rust `.12.1.8.2` validates complete compiled ActionIR before native
  or generated execution. Dart `.12.1.8.3` is next.
- `2026-07-12` refresh: Spec-facing aggregate-selector removal is fully split under
  ...
  migration `.12.1.7.1-.3` are complete. Perl hard retirement `.12.1.8.1` and Rust hard retirement `.12.1.8.2`
  are complete; Dart `.12.1.8.3` is active.
...
- `2026-07-12` refresh: ADR `0031` and `FUTURE-PARITY-BACKLOG.11.1` settle the callable-codeblock design.
  ...
  has removed spec-facing aggregate selectors from Perl and Rust; Dart, Julia, and Lua hard rejection remains.
