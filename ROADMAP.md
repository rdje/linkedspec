...
and exact decoded server with focused and canonical public corpus proof. Strict stdio `.10.9.3.2` follows only
after the clean `.1` commit; the implementation/runtime
ledger remains unchanged at 1/5 + 1/6 until exact admission `.10.9.3.3`.
