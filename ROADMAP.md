...
and unchanged governance pass. Public query names remain absent; traversal/pages/budgets/costs and the remaining
ten static hashes stay `.2`, while raw validation and full public exposure stay `.3`. Canonical Rust 80.95s +
