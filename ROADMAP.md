...
surfaces, and other backend behavior remain unchanged. Independent Lua recomposition `.5` reruns the committed
888/888 source on both ABIs, all admitted peers, exact topology, and 106-mutation governance without executable
movement, closes parent `.14.7.7`, and hands off six-runtime recurrence `.14.7.8`. Public `parse_job(...)`
authoring/no-drift `.9`, final recomposition `.10`, and combined `.14.8` remain separately owned.
