...
are executable through six fixture groups, 20 digest-locked responses, and 50 rejected mutations. ADR `0050`
...
records, or queries. Neutral rollout remains 1/9 and native admission 0/6; static graph projection `.10.3.2` waits
for the clean foundation commit, followed by `.10.3.3-.10.3.6`.
