...
is complete: all three Python temporary owners, 13 shell allocators, and 19 Python checker entrypoints are frozen;
...
`.10.9.1.1-.7`. Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT are admitted through
...
Julia `.5`, shared Lua `.6`, and recurring six-runtime closeout `.7`. Protocol-policy leaf `.10.9.1.0` is now
complete under ADR `0055`; machine schemas/fixtures `.10.9.1.1` are next.
