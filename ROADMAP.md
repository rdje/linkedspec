...
admits the unchanged seven-group consumer through ordinary discovery and one exact canonical route. Recurrence `.7`, public `.8`, staged `.14.7`,
and combined `.14.8` retain their order. Capacity `.0` freezes, canonical `.1` implements,
...
ABI owners unchanged, closes the shared Lua parent at 7/9/112, and hands off typed recurring proof `.14.6.7`.
