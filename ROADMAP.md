...
| Inter-match gap capture | `active; Perl emitted/loaded parity .2.3 signoff-complete from 34d02e0c for atomic 225` | Recover historical “super split” as automatic source-gap access between repeated OR/default action-edge matches, with target rules retaining their regex slots and lifecycle code. ADR `0045` accepts `@capture_gaps`, spacing-insensitive `name=/regex/`, and `Rule[name]` while rejecting blind-call/adjacency reinterpretation. | Neutral `.1` remains 1/8 rollout and 55 mutations. Perl `.2.1` implements permanent syntax/static provenance; `.2.2` supplies same-guard native-live state; `.2.3` imports the private runtime in emitted source, aligns the generated entry boundary, preserves typed gap errors and named/unindexed selector identity, and passes five independently loaded groups / 138 internal assertions against live execution. Generated plan v2 is unchanged. Canonical signoff passes Knowledge 834/6,995, containment/relocation, CLI 66/66 twice, RAM 57%, Phase 0 1,031/1,031 in 773 seconds, and exact opt-in routing. `.2.4` alone registers and admits Perl. Recognition remains 137/246/58, language remains 122 public helpers, typed source remains 9/5/114, and all outward surfaces remain guarded. |
