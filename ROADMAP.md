...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141. Typed-source `.14.2` is composition-closed at 8 complete / 6 pending / 53 mutations across all six runtimes. Recognition transactions are executable at 132 ActionIR rows / 246 calls / 43 semantic mutations with neutral + Perl + Rust + Dart admitted at rollout 4/9, public governance 3/14/29, and guide 1/6/10. Clean atomic 198 `923285aa` lands the non-exported Julia authority at 155/155. Private Julia integration `.14.3.5.2` now adds four dedicated non-eager nodes, recursive effect closure, cursor-only progress, and live UTF-8 code-unit cursor/boundary/same-label-mark synchronization through one invocation adapter. Native, reconstructed, generated-plan, and independently loaded emitted-module execution preserve a successful `false` payload; the unchanged dormant integration consumer passes 203/203. Complete ordinary Julia remains green at typed source 127/127, storage 19/5, primary CLI, and corpus 105/105; the synchronized book renders 79 files / 14,404 KiB. The namespace remains unexported and ordinary/canonical discovery omit the consumer, so no authored support, rollout, public, API, schema, CLI, README, storage, or other-backend claim moves. Atomic 199 signoff passes all eight doctrines, CLI 66x2, RAM 65%, and canonical Phase 0 1,031/1,031 in 731 seconds; Julia admission `.14.3.5.3` awaits its clean activation. PUC Lua, LuaJIT, recurring composition, and final public no-drift remain RED. Reversed-span remains `.14.2`-owned and `.14.8` retains final no-drift. `TASK-TREE-METADATA-HYGIENE.5`, rendered readability, `.22`, `.23`, format/inter-match work, mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
