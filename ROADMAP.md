...
requires no repository repair, closing Rust parent `.19.3`. Dart nested write-vivification `.19.4.1` is next.
...
Perl/Rust/Dart/Julia/Lua behavior remains non-vivifying; `.19.1.2` owns bang-mutation semantics next.
