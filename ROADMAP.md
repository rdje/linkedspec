...
capture. Foundation `.10.3.1` now implements opaque `LinkedSpec::semantic_index(...)` construction, strict UTF-8
normalization, exact byte/scalar source mapping, and compiled-or-failed outcomes without path reads, execution,
records, or queries. Neutral rollout remains 1/9 and native admission 0/6; `.10.3.2.0` repairs and independently
gates the neutral static-rule oracle before Perl projection `.10.3.2.1`, followed by `.10.3.3-.10.3.6`.
