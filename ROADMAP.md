...
Private traversal/limits `.10.7.5.2` now completes all 19 static hashes with canonical pages, filtered directional
BFS, deterministic record/relation/depth budget prefixes, logical costs, and portable typed errors at query
283/focused 1,204 per ABI. Its signoff passes primary 5x2x66, Unicode 10/10, all six generated ledgers, the complete
...
Public names and 26 raw boundaries remain `.10.7.5.3`, which is next.
