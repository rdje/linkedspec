...
and passes one 12-role consumer without widening generated plan rows. Governance is five fixtures, two
diagnostics, six runtime rows, 2 complete + 5 pending, and 26 mutations. The dependency-safe path continues Rust
`.3`, Dart/Julia/Lua locks `.4-.6`, then recurring/public admission `.7`.
