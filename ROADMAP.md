...
recomposition `.4`. The same Lua-5.1 consumer is exact at 85-pass/one-RED on PUC Lua and LuaJIT without behavior,
discovery, format, rollout, typed, or outward movement. Private authority `.1` now passes 273/273 on both hosts
while staying ActionIR-independent, unexported, and dormant; dedicated-node/four-carrier `.2` is next.
