...
mutations, and Lua-only promotion. Governance advances to 6/20/98 at 6/9 + 6/6; `.10.7` is closed and recurring
six-runtime proof `.10.8` is active task-tree-first from clean `e335ea8b`. Its behavior-free plan freezes one
exact repository-routed driver over all admitted consumers, three 5x2 primary no-drift cases, generated/
capability/language ledgers, canonical opt-in, seven topology mutations, premature-MCP denial, and recurring-only
