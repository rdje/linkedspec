...
data and exports no public query seam. Traversal/limits `.10.5.4.2` adds exact directional breadth-first relations,
canonical after-id pages, logical record/relation/depth budgets, costs, deterministic prefixes, and all 16
successful static response digests. Public typed/raw-neutral completion `.10.5.4.3` is next.
