...
explanation. Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT are admitted through exact 12-role consumers, so neutral
rollout is 6 complete / 3 pending and backend admission is 6 complete / 0 pending. Dependency-ordered `.10.3-.10.10` own
...
denial, and recurring-only promotion. It passes exact 6/20/105 at rollout 7/9 and admission 6/6; thin MCP `.10.9`
is next after the clean commit.
