...
requires no repository repair, closing Rust parent `.19.3`. Lua nested-write `.19.6.1` is next.
...
Perl/Rust/Dart/Julia/Lua behavior remains non-vivifying; `.19.1.2` owns bang-mutation semantics next. Perl, Rust,
Dart, and Julia have since implemented this unchanged nested-write contract under `.19.2.1`, `.19.3.1`, `.19.4.1`,
and `.19.5.1`; Lua and portable/public admission remain pending.
