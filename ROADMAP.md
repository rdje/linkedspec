...
admission `.6.0-.3` are complete. All six private runtime rows are 7/9 with 112 mutations; every admitted backend preserves private immutable
...
admits the unchanged seven-group consumer through ordinary discovery and one exact canonical route. Lua recomposition `.6.4`, recurrence `.7`, public
`.8`, staged `.14.7`, and combined `.14.8` retain their order. Capacity `.0` freezes, canonical `.1` implements,
...
leaves the 273-assertion-per-ABI authority proof dormant. Independent recomposition `.4` is next.
