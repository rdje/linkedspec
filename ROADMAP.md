...
1. Keep staged extraction as a first-class concept.
   - Current staged linked parsing status (2026-07-09):
     ...
     dormant routes, rollout, and exact ownership pass 72 reason-checked mutations. Perl
     dormant-boundary work begins at `.14.7.3.0`. Director clarification `.14.0` now distinguishes active
