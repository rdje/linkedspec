...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141. Typed-source `.14.2` is composition-closed at 8 complete / 6 pending / 53 mutations across all six runtimes. Recognition transactions are executable at 132 ActionIR rows / 246 calls / 43 semantic mutations with neutral + Perl + Rust + Dart admitted at rollout 4/9, public governance 3/14/29, and guide 1/6/10. Dart admission landed cleanly at `38318827` as atomic 196/300. Dormant Julia RED `.14.3.5.0` is now signoff-complete from that boundary: one final-path consumer freezes private authority, falsey-safe tokens, detached cursor/boundary/mark state, exact diagnostics, four dedicated nodes, recursive effect closure, cursor-only progress, native/reconstructed/generated-plan/independently loaded emitted carriers, and ordinary cursor compatibility. Explicit authority and integration modes parse fully and fail only for absent private `LinkedSpecJulia.RecognitionTransaction`; ordinary Julia remains green at storage 19/5 and corpus 105/105, with no production, discovery, rollout, public, API, schema, CLI, README, or mdBook support-claim movement. Full canonical proof passes all eight doctrines, admissions, containment/relocation, CLI 66x2, RAM 60%, and Phase 0 1,031/1,031 in 724 seconds. Commit-ready atomic 197 precedes private Julia authority `.14.3.5.1`; PUC Lua, LuaJIT, recurring composition, and final public no-drift remain RED. Reversed-span remains `.14.2`-owned and `.14.8` retains final no-drift. `TASK-TREE-METADATA-HYGIENE.5`, rendered readability, `.22`, `.23`, format/inter-match work, mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
