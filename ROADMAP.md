...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability parity is 80/0/0; semantic introspection is 6 groups / 20 responses / 128 mutations, rollout 9/9, and native admission 6/6; MCP is complete/141. Typed-source `.14.2` is composition-closed at 8 complete / 6 pending / 53 mutations across all six runtimes. Recognition transactions remain 132 ActionIR rows / 246 calls / 44 semantic mutations with neutral + Perl + Rust + Dart + Julia admitted at rollout 5/9, public governance 3/17/33, and guide 1/8/12. Lua RED `.14.3.6.0` and private authority `.14.3.6.1` landed as atomics 201-202 at `6a8ec091`/`d87dcac3`. Integration `.14.3.6.2` is signoff-complete and commit-ready: authority remains 187/187 and four dedicated non-eager nodes, recursive effect/progress policy, and authority-backed native/reconstructed/generated-plan/emitted execution pass 243/243 on both PUC Lua and LuaJIT. Nineteen integration mutations join 22 authority and 12 dormancy mutations; no facade/discovery/rollout truth moves. Ordinary Lua stays 177/177 per ABI, CLI 66x2, corpus 105, storage 18/3, book 79/14,412 KiB, and KM 817/6,781; all eight doctrines, containment, RAM 65%, and Phase 0 1,031/1,031 in 736 seconds pass through exact canonical success for atomic 203. Lua admission `.14.3.6.3`, recurring composition, and final public no-drift remain RED. Reversed-span remains `.14.2`-owned and `.14.8` retains final no-drift. `TASK-TREE-METADATA-HYGIENE.5`, rendered readability, `.22`, `.23`, format/inter-match work, mutation execution, inspector `.13.1`, and `.15` remain separately owned. |
