...
failed 6/4, runtime-static 7/8, repeated-lifecycle, clone, and host isolation. Final canonical closeout child `.2`
follows the separately task-owned process-oracle correction.
