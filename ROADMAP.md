...
Governance is five fixtures, two diagnostics, six runtime rows, 4 complete + 3 pending, and 36 mutations. The
dependency-safe path continues Julia/Lua locks `.5-.6`, then recurring/public admission `.7`.
