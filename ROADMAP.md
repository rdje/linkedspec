...
consumer. Governance is five fixtures, two diagnostics, six runtime rows, 3 complete + 4 pending, and 31
mutations. The dependency-safe path continues Dart/Julia/Lua locks `.4-.6`, then recurring/public admission `.7`.
