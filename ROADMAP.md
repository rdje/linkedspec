...
Progressive audit/correction/neutral `.14.6.0-.1`, Perl `.2`, and Rust `.3` are complete through atomic 267.
Neutral + Perl + Rust rollout is 3/9 with 95 mutations; both admitted backends preserve private immutable
...
typed-row movement. Dart parent `.4` is active: `.4.0` freezes an analyzed but undiscovered five-test final-path
consumer whose first four groups pass and whose sole RED is missing `PROGRESSIVE_DISPATCH_SPAN`; `.4.1-.3`
separately own authority/core, four carriers, and admission. Julia/shared-Lua `.5-.6`, recurrence `.7`, public
