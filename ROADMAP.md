...
self-proving omission/wrong-value rejection. Rust `.10.4.0.2` next requires the director's Unicode-versus-ASCII
label-contract choice before native construction.
