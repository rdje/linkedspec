...
1. Keep staged extraction as a first-class concept.
   - Current staged linked parsing status (2026-07-09):
     ...
     annotation/provenance `.14.7.3.1` follows. Mandatory segment `4991` is finitely authorized by ADR `0089` at
