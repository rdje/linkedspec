...
lifecycle markers are occurrence-specific, and native `Default`/failure facts normalize only inside the future
private projector. Graph/source/evidence implementation `.10.7.3.1` follows without public query or ledger
movement.
