...
Typed core `.10.6.4.1` now implements the exact private non-staged 18/16 projection from accepted typed registry,
...
generated `.10.6.4.2` remains next after the clean commit; public query/runtime/admission remain `.10.6.5-.7`.
