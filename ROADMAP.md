...
Phase 0 1,031/1,031 plus the callable matrix pass. Manifest audit also queues unrelated exclusion-freshness governance
...
6. Drive `.spec` toward language-agnostic action semantics (no embedded Perl code-block dependency in final state).
   ...
   - ADR `0031` / `FUTURE-PARITY-BACKLOG.11.1` now settle the corrective design: callable codeblocks use
     ...
     state, and semantic signatures; the complete Lua gate remains green. Invocation stays `.2` and admission `.4`.
