...
closed exact inert construction/state at `5e80be32`; `.11.5.2` implements dynamic invocation and is signoff-complete
awaiting its clean commit before `.11.5.3` generic contextual normalization.
