...
aggregator is routing-only and outside `.10.9`. Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT are admitted through
...
Julia `.5`, shared Lua `.6`, and recurring six-runtime closeout `.7`; exact contract `.1` is next.
