...
pending. Director choice is required between the recommended five-implementation contract/policy repair followed
by exact all-twenty `.1.1`, or a non-recommended weaker 17-identity/three-boundary claim that preserves current
transport bytes. No-change `.2` remains dependency-ordered after the chosen implementation and clean commit.
