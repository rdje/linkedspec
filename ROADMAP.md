...
Julia/Lua and portable/public admission remain pending. Rust oracle/root-semantics cleanup `.19.3.3` is canonical-signoff-
complete; controlled `.19.3.4.0` classifies older-artifact launch delay as external macOS policy/cache state and
requires no repository repair, closing Rust parent `.19.3`. Julia write-vivification `.19.5.1` is next.
...
and Dart have since implemented this unchanged nested-write contract under `.19.2.1`, `.19.3.1`, and `.19.4.1`;
