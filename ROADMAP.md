...
General staged-AST enrichment now has complete private behavior and admission on Perl, Rust, Dart, Julia, PUC Lua,
...
governance from 98 to 106 mutations. Function-body v1, generated-source v2, capability state, public/outward
surfaces, and other backend behavior remain unchanged. Independent Lua recomposition `.5`, six-runtime recurrence
`.14.7.8`, public `parse_job(...)` authoring/no-drift `.9`, final recomposition `.10`, and combined `.14.8` remain
separately owned.
