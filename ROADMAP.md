...
and checker/runner/CI locks without public API, format, semantic, rollout, or admission movement. Exact positive/
distinct artifact and runtime identity `.10.7.1.2` is next.
