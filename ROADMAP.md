...
policy seams, and `.1-.4` implementation/admission order. Perl `.10.9.2.1` now implements the generated binding,
schema runtime, secure registry, and decoded dispatch; strict stdio/lifecycle `.10.9.2.2` is next.
...
complete with canonical signoff, followed by strict stdio/lifecycle `.10.9.2.2`.
