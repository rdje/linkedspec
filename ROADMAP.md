...
is complete: all three Python temporary owners, 13 shell allocators, and 20 Python tool entrypoints are frozen;
...
implementations remain `.10.9.1.2-.7`. Perl, Rust, Dart, Julia, PUC Lua, and LuaJIT are admitted through
...
artifact `.10.9.1.1` are complete under ADR `0055`; independent validator/mutations `.10.9.1.2` are next.
