...
Julia `.19.5.1` implements nested writes through native/reconstructed/generated/emitted/CLI routes; Julia bang,
Lua, and portable/public admission remain pending. Rust oracle/root-semantics cleanup `.19.3.3` is canonical-signoff-
complete; controlled `.19.3.4.0` classifies older-artifact launch delay as external macOS policy/cache state and
requires no repository repair, closing Rust parent `.19.3`. Julia `map_leaves!` `.19.5.2` is next.
