...
are executable through six fixture groups, 20 digest-locked responses, and 53 rejected mutations. Static rule
facts now cross-check the admitted rule-local cursor contract after `.10.3.2.0` corrected stale default-family and
no-edge ownership rows that response digests alone did not expose. ADR `0050`
...
no public query or admission exists. Neutral rollout remains 1/9 and native admission 0/6; calls/staging `.10.3.3`
follows, then `.10.3.4-.10.3.6`.
