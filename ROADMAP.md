...
execution, and all result/failure policies. `.14.7.4.3` now completes private breadth-first recurrence, exact
cycle/decrease guards, shared resource authority, callback safe points, and source rebasing; `.14.7.4.4` is the
clean frontier. The corrective closeout's mandatory
...
1. Keep staged extraction as a first-class concept.
   - Current staged linked parsing status (2026-07-09):
     ...
     backend routes, rollout, and exact ownership pass 78 reason-checked mutations after Perl admission. Perl dormant boundary
     ...
     oracle 143/143, and admits only Perl once through phase-0/canonical topology. Rust `.14.7.4.0-.3` now adds a
     dormant marker/provenance carrier, pure caller-frozen resolution/cache and policies, breadth-first recurrence,
     exact cycle/decrease guards, shared cancellation/resources, callback safe points, and direct/ordered-derived
     source rebasing. Fresh Rust top-level carriers, production seam, admission, and rollout remain `.4`-owned;
...
| Future parity backlog | `in progress` | Deferred/future parity lanes after the closed language-reference, terse-format, and five-backend implementation trees. | Five-backend capability is 80/0/0; semantic introspection is closed at 9/0/128; typed source is 12/2/170 with transaction safety, recursive observation, lossless-gap composition, and progressive recurrence current on all six runtimes. Progressive private six-runtime admission, exact recurrence, and public no-drift are closed at 9/9/116 plus public 6/12/10/60 without an outward API. Staged audit `.14.7.0`, diagnostic repair `.1`, neutral authority `.2`, Perl `.14.7.3.0-.4`, and Rust dormant recursive authority `.14.7.4.0-.3` are closed. The 143-check Perl oracle proves caller-frozen resolution/cache, breadth-first execution, policies, strict chains/shared resources, source rebasing, detachment, four fresh-authority carriers, serialized-authority absence, unchanged v1/v2 formats, and exact ordinary/canonical admission. Rust's outer-cfg consumer keeps ordinary discovery at zero tests; exact assignment-form `parse_job` becomes one inert detached marker with strict literal options, exact text, and typed direct/ordered-derived Unicode-scalar provenance. A private frozen already-compiled registry provides pure resolution/cache, isolated current-depth policies, breadth-first recurrence, exact cycles/strict-decrease lineage, shared cancellation/resources, expiring safe points, and original-source rebasing. Its sole final RED now names `.14.7.4.4` fresh carriers, production seam, admission, and rollout. Neutral+Perl with Rust dormant governance remains 79 mutations; Rust rollout, public, and outward behavior stay pending. Final `.14.8` no-drift, reversed-span and unrelated hygiene/readability, `.22`, `.23`, mutation-execution, inspector `.13.1`, and `.15` remain separately owned. |
