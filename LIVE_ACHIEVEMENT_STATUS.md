...
- Continue PNT on the active PHASE2-DSL-FRONTEND tree: `PHASE2-DSL-FRONTEND.5` (reject malformed extra-colon rule starts — `RuleName:::` and similar). After Phase 2 leaves exhaust or pause, pick next active tree from `docs/TASK_TREE.md` active table in order.
