...
- 2026-05-09: Removed the now-pass-through `SpecEntry` parser-source emit wrapper after moving generated-handler source emission into direct `RuntimeContext` calls.

## Recent Completed Slices
- Phase 5: Remove one-shot `SpecEntry` top-rule setter wrapper.
