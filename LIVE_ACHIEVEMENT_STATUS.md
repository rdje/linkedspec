...
- 2026-05-10: Removed the `Compiler` dependency-regex map dependency-label describer wrapper after inlining invalid dependency-label diagnostics at the map validation boundary.
