...
- 2026-07-10: **JULIA-BACKEND-PARITY.5.1 — add Julia staged function-body registry**
  (DONE — staged dispatch/stitching is green; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
  ...
  **Boundary:** Minimal function-body provider only; no general provider search, recursive staged queues, or
  public `parse_job(...)` authoring. User-function runtime execution remains `.5.2`.
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.5.4 — close Julia diagnostics trace no drift**
  (DONE — `.4.5` is closed; `.5.1` has since landed and `.5.2` is active).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.5.3 — add Julia runtime trace events**
  (DONE — runtime instrumentation is green; `.4.5.4` has since closed and `.5.1` has since landed and `.5.2` is active).
...
- 2026-07-10: **STATEMENT-SEPARATOR-EXAMPLE-ALIGNMENT.1 — align separator example style**
  (DONE — the director-identified fixture is canonical; Julia `.5.2` is the active PNT frontier).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.5.2 — add Julia trace controls**
  (DONE — trace controls/events/sinks are green; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.5.1 — add Julia runtime diagnostics**
  (DONE — structured diagnostics are green; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.5.0 — split Julia diagnostics trace controls**
  (DONE — diagnostics/trace is decomposed before code; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.4 — add Julia runtime cursor controls**
  (DONE — cursor controls and boundary capture are green; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.3.6 — close Julia helper value no drift**
  (DONE — the `.4.3` helper/value container is closed; next active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.4.3.5 — add Julia runtime controls and tree callbacks**
  ...
  split diagnostics/trace, and `.4.5.1` has since landed and `.4.5.2` has since landed and `.4.5.3` has since landed and `.4.5.4` has since closed and `.5.1` has since landed and `.5.2` is active).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.3.1 — add Julia ActionIR AST parser**
  ...
  active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.2.3 — add Julia frontend validation**
  ...
  current active leaf is `JULIA-BACKEND-PARITY.5.2`).
...
- 2026-07-10: **JULIA-BACKEND-PARITY.2.2 — add Julia source spec parser**
  ...
  and current active leaf is `JULIA-BACKEND-PARITY.5.2`).
