...
- 2026-05-09: Removed the now-one-shot `Compiler` top-rule reader wrapper after moving selected-top-rule reads into direct `RuntimeContext` calls.

## Recent Completed Slices
- Phase 5: Remove one-shot `Compiler` top-rule setter wrapper.
