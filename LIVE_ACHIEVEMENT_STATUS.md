...
- 2026-05-10: Removed the `Compiler` compiled-spec rule-info wrapper after routing dependency-rule metadata lookup directly through CompilerState.
...
- Phase 5: Inline `Compiler` compiled-spec rule-count reads.
