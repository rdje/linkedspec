...
- 2026-05-10: Removed the `Compiler` final-descriptor state describer wrapper after inlining invalid descriptor-state diagnostics at the final descriptor boundary.
