...
- 2026-05-09: Removed the now-one-shot `Compiler` top-rule setter wrapper after moving selected-top-rule writes into direct `RuntimeContext` calls.

## Recent Completed Slices
- Phase 5: Remove one-shot `Compiler` last-error read wrappers.
- Phase 5: Remove one-shot `Compiler` parser-source flush wrapper.
- Phase 5: Remove one-shot `Compiler` rule-or-top handler-label wrapper.
- Phase 5: Remove one-shot `Compiler` top-rule handler-label wrapper.
