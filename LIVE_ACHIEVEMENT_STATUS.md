...
- Continue PNT on the active PHASE2-DSL-FRONTEND tree: `PHASE2-DSL-FRONTEND.3` (add strict_syntax option — last remaining pending leaf in this tree). After Phase 2 leaves exhaust, pick next active tree from `docs/TASK_TREE.md` active table in order.
