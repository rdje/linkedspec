...
- 2026-05-10: Removed the `Compiler` dependency-regex map dependency-ref describer wrapper after inlining invalid dependency-ref diagnostics at the map validation boundary.
