...
- 2026-05-10: Removed the unused `Compiler` compiled descriptor dependency-regex-state wrapper so dependency-regex state access stays solely with CompilerState.
...
- Phase 5: Remove unused `Compiler` compiled dependency-regex predicate wrapper.
