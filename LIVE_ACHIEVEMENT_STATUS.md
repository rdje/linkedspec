...
- 2026-05-09: Removed the `SpecEntry` runtime-handler last-error setter wrapper after inlining rule-handler compile/eval error writes to direct RuntimeContext dispatch.
