...
- 2026-05-10: Removed the `Compiler` dependency-regex map dependency regex-list describer wrapper after inlining invalid referenced regex-list diagnostics at the map validation boundary.
