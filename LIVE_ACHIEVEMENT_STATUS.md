...
- 2026-05-10: Removed the `Compiler` dependency-regex map `dependency_refs` describer wrapper after inlining invalid dependency list diagnostics at the map validation boundary.
