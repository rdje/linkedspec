...
- 2026-05-10: Removed the `Compiler` compiled-spec state constructor wrapper after routing state construction directly through the CompilerState owner seam.
