...
rejects eight representative drift mutations. Perl native execution is the first complete leg; the remaining
seven backend/generated/gate/public legs stay pending under `FUTURE-PARITY-BACKLOG.5.1.3-.9`.
