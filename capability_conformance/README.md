...
The checker rejects 39 ledger, status, ownership, source-authority, role, ignored-proof, tracked-input, and
...
program/test above. It runs materializer -> independent validator -> generated Perl binding -> generated Rust
binding -> Perl binding/dispatch/stdio -> Rust unit/decoded/stdio/admission -> admission-ledger checker -> Perl
admission in that exact order. The recurring tool-topology test rejects omissions and reversed order, so neither
