...
focused contract proof. Rust v1 identity/metadata/errors plus exact neutral plan/direct result/trace roles now align
through `.3.1.3.2`. Perl and Rust remain partial until joint baseline admission `.3.1.3.3`.
