...
pub const CONTRACT_ID: &str = "linkedspec-unicode-case-v1";
pub const UNICODE_VERSION: &str = "17.0.0";
pub const DATA_SHA256: &str = "5c17653094c49a3bd69222f6e8bde5de5ebd445a121453ccb156ea540a5e3bae";

const LOWER_MAPPINGS: &[(u32, &[u32])] = &[
    (0x0041, &[0x0061]),
    (0x0042, &[0x0062]),
    (0x0043, &[0x0063]),
    (0x0044, &[0x0064]),
...
const CASE_IGNORABLE_RANGES: &[(u32, u32)] = &[
    (0x0027, 0x0027),
    (0x002E, 0x002E),
    (0x003A, 0x003A),
    (0x005E, 0x005E),
