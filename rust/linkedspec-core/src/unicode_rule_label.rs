//! Generated pinned Unicode rule-label classifier. Do not edit by hand.
//!
...
pub const UNICODE_RULE_LABEL_CONTRACT: &str = "linkedspec-unicode-rule-label-v1";
pub const UNICODE_RULE_LABEL_VERSION: &str = "17.0.0";
