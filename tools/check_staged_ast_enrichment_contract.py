...
def validate_contract(contract: dict[str, Any], *, environment: bool = True) -> None:
    ...
    require(contract["status"] == "neutral_complete_backends_pending", "contract status mismatch")
    ...
    expected_rollout = [
        ...
        {"order": 2, "leg": "perl", "owner": "FUTURE-PARITY-BACKLOG.14.7.3", "status": "pending", "paths": [BACKEND_CONSUMERS[0]["path"]]},
...
def mutation_inventory() -> list[Mutation]:
    mutations: list[Mutation] = [
        ...
        ("rollout_backend", set_value(["rollout", 1, "status"], "complete"), "rollout inventory mismatch"),
