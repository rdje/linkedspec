...
bash -n tools/run_ci_local.sh tools/run_rust_local.sh tools/run_dart_local.sh \
 tools/run_julia_local.sh tools/run_primary_cli_matrix.sh tools/build_lua_native.sh \
