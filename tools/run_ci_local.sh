...
bash -n tools/run_ci_local.sh tools/run_rust_local.sh tools/run_dart_local.sh \
 ...
 tools/check_diagnostic_output_five_backend.sh tools/check_punctuation_light_five_backend.sh
