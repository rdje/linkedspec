...
For focused helper-rewrite inspection, use the compatibility shim `LinkedSpec::call_spec_handler_subst(...)`. The older internal `LinkedSpec::_...` action-rewriter helpers are no longer part of the active surface.
