...
For focused helper-rewrite inspection, use the compatibility shim `LinkedSpec::call_spec_handler_subst(...)`. Older internal `LinkedSpec::_...` action-rewriter, RuleIR, and descriptor-assembly helpers are no longer part of the active surface.
