...
- 2026-05-09: Removed unused `Runtime::_set_runtime_ctx_last_error(...)`; runtime-owner fallback errors remain on `_set_runtime_ctx_last_error_unless_present(...)`, and phase0 source-lock coverage rejects reintroducing the dead direct setter wrapper.
