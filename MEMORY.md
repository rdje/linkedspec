...
- activation_commit: `5f2a5b0055f3703583872374a92ab77d14715648` — clean Julia .1.43 activation; derive its landed commit from Git.
- latest_completed_leaf: `JULIA-STARTUP-READING.1.43 - read helper capture and native trace consumers`; exact reading and focused proof.
- active_work_unit: `JULIA-STARTUP-READING.1.44` — pending main/semantic-call reading after clean .1.43.
- next_action: Read .1.44 main/semantic-call ranges after verifying the .1.43 commit, zero-byte brief and clean tree.
  Authoring investigations remain proposed; approved format `.2.8`/`.12` remain parked.
- in_flight_uncommitted: none after the .1.43 commit; source and all prior repair owners remain.
...
- latest_bootstrap_read: 2026-09-11 — roadmap Yes / full codebase No / physical mdBook Yes; Perl/Rust/Dart read; Julia 43/52 groups, 62925/75984 lines, 2196720/2693170 bytes, sixty-seven complete files. Lua/supporting code, formal book .4 and policy .5 remain.
