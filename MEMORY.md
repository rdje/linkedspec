...
- latest_completed_leaf: `FUTURE-PARITY-BACKLOG.10.5.3.2` — exact Dart staged/generated calls completion.
- latest_commit: `e87ececa` is the clean typed-core base; the current commit owns exact-completion leaf `.10.5.3.2`.
- active_work_unit: `.10.5.3.2` is implementation-, verification-, and documentation-complete; commit remains.
- next_action: from the clean exact-completion commit, run composed calls closeout `.10.5.3.3` and close `.10.5.3`.
...
- current_dart_semantic_map: public `SemanticIndex` copies decoded text/strict UTF-8 and privately owns canonical
  ...
  generated implementation, paths, runtime/trace/sinks, public records, and query remain absent; composed closeout
  is `.3`, and native failure/rollout/admission remain unchanged.
...
- current_signoff: exact calls 4/4; combined calls/static/foundation 16/16; selector concurrency 3/3, executable
  0/19, retirement 5/6/8/0, public 59/27/0; Dart format 77/0, analysis, package 318, primary 66x2, corpus 105/105;
  semantic 6/20/73 at 3/9+2/6; Unicode 806/9/8/2; generated v1/10/80-0-0. Canonical passes Rust admission 80.50s,
  primary 66x2, and Phase 0 1,031/1,031 in 638s. Knowledge Map is 674/5,052; mdBook/doctrines/memory/diff/cleanup pass.
...
- blockers: none. in_flight_uncommitted: verified `.10.5.3.2` exact calls docs/gates/commit pending; `.23` queued.
