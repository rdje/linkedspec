...
- latest_commit: `c3cd50d` — `SPEC-FORMAT-TERSE.1.1.2 — Rust lockstep parity for auto-existing working variables (oracle + integration locks; no engine change)`. Prior: `55c9b2f` (`.1.1.1` Perl). Ahead of origin ~45 — push threshold ~300; do NOT push mid-PNT.
