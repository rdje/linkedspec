...
- latest_commit: `b77510a` — `SPEC-FORMAT-TERSE.1.2.1 — Perl arg-position bare working-variable auto-existence (Channel 1; engine + book + 3 phase0 locks)`. Prior: `a5208e1` `.1.2 split`, `c3cd50d` `.1.1.2`. Ahead of origin ~49 — push threshold ~300; do NOT push mid-PNT.
