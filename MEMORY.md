...
- latest_commit: `SPEC-LANG-REFERENCE.10.5 — chore: record origin push + sync resume pointer` (hash backfilled by next hash-sync; **pushed to origin/main 2026-06-17** — synced through `9f511ac`; ahead of origin: ~0; push threshold ~300)
