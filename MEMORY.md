...
- latest_commit: `0117029` — `SPEC-FORMAT-TERSE.1.4.2 — Rust recognize terse helper renames`. Prior: `f0fe686` handoff for `.1.4.1`, `223723d` `.1.4.1`, `5e93af3` `.1.4` split. Ahead of origin ~57; push threshold ~300; do NOT push mid-PNT.
