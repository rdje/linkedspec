...
- latest_commit: `a5208e1` — `SPEC-FORMAT-TERSE.1.2 — split into .1.2.1 (Perl, Channel 1) + .1.2.2 (Rust parity); record bare-working-var ground truth + KM card`. Prior: `c3cd50d` `.1.1.2`, `55c9b2f` `.1.1.1`. Ahead of origin ~47 — push threshold ~300; do NOT push mid-PNT.
