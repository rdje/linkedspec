...
- latest_completed_leaf: `FUTURE-PARITY-BACKLOG.10.7.6.0` — Lua runtime-observation authority/routes frozen.
- latest_commit: `FUTURE-PARITY-BACKLOG.10.7.6.0 - freeze Lua runtime observation` (this commit).
...
- current_semantic_frontier: Lua runtime-observation audit `.10.7.6.0` freezes exact typed vocabulary, accepted
  match-end/final-result seams, no-sink/callback/digest policy, every dual-ABI route, detached static-only
  derivation, twentieth digest, and `.1-.4` order without behavior or promotion. Typed direct capture `.1` is next.
...
- current_signoff: Lua semantic 1,492 and diagnostics 119 per ABI, package 177x2, PUC primary 66x2/corpus 105/
  storage, primary 5x2x66, Unicode 10/10, six ledgers; canonical Rust 77.93s/Dart 1/1/Julia 416 in 27.3s/Phase 0
  1,031 in 624s; containment/moved-root/reference 66x2, mdBook, KM 730/5,838, doctrines/diff/storage/cleanup pass.
...
- push_policy: hard lock at 300 new local commits; current counter 53/300 after this commit; never push per commit.
...
- blockers: none. next: activate typed Lua direct observation capture `.10.7.6.1` from the clean audit commit; no push.
