...
- latest_commit: `<pending>` — "RUST-PARITY.5.1 — fix child-return (retv) propagation in the Rust engine"   (ahead of origin: ~130; push at 300; hash synced in REPO-HYGIENE follow-up)
