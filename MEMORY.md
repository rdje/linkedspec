...
- latest_commit: `a254846` — `SPEC-FORMAT-TERSE.1.2.3.3.3 — implement direct-access bare path atoms`. Ahead of origin remains below push threshold ~300; do NOT push mid-PNT.
