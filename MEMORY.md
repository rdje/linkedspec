...
- current_mutation_composition_contract: `linkedspec-write-map-leaves-composition-v1` digest-binds both unchanged
  ...
  Perl, Rust, Dart, and Julia execute both halves; Lua executes the write half and remains non-bang. Zero-regex `Top:: -> Done` lets the parent
...
- latest_bootstrap_read: 2026-09-04 — README, memory architecture, current memory/bootstrap, task-tree doctrine,
  `.19.6.1`, mutation/composition/Lua traversal Knowledge, verification policy, and exact Git state read.
