...
- latest_commit: `b898492` — "MDBOOK-VARIANT-AGNOSTIC.4 — reframe public-api chapters as variant-agnostic"   (ahead of origin: ~116; push at 300; hash-sync bumps this to the `.5` commit next)
