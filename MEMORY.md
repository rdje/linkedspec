...
- latest_commit: `808ce0d` — `TOP-RULE-AS-NORMAL.3.1 — Rust forward-progress/consume-before-recurse termination guard (mirror of .2.1); split .3; +2 Rust locks` (ahead of origin ~37 — push threshold ~300; do NOT push mid-PNT). Prior: `baf600e` (`.2.2`), `74c5450` (handoff doc).
