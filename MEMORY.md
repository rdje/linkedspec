...
- latest_commit: `5e9ef57` — `SPEC-FORMAT-TERSE.1.2.2 — Rust lockstep parity for arg-position bare working-variable auto-existence (engine + oracle + 4 integration locks)`. Prior: `b77510a` `.1.2.1`, `a5208e1` `.1.2 split`. Ahead of origin ~51 — push threshold ~300; do NOT push mid-PNT.
