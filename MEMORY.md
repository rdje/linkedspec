...
- latest_completed_leaf: `FUTURE-PARITY-BACKLOG.10.3.3.0` — generated-plan neutral authority is clean at
  `c07ba618`; calls family is exact v2 `default` without behavior, rollout, or admission.
- latest_commit: `c07ba618` — `FUTURE-PARITY-BACKLOG.10.3.3.0 - correct generated plan oracle`
  (ahead: 267; push at threshold 300).
- active_work_unit: `FUTURE-PARITY-BACKLOG.10.3.3.1.0` — complete/canonical-green spec-identity correction awaits
  only its clean commit boundary.
- next_action: commit/clear/verify the complete spec-name correction, then activate fully corrected
  calls/shapes/staged/generated projector `.10.3.3.1.1` task-tree-first.
...
- current_signoff: `.10.3.3.1.0` full RED proves exact `calls_and_staging` identity; semantic 6/20/57, static 10,
  generated/rule-local, capability 80/0/0, selector 59/27/0, repeated action 8/10/8+0/54, primary 5x2x66,
  KM 655/4,824, mdBook/doctrines, canonical primary 66x2, and Phase 0 1,031/1,031 in 618 seconds pass; exit 0.
...
- blockers: none. in_flight_uncommitted: `.10.3.3.1.0` model/checker/task/docs/KM correction is fully verified;
  cleanup/commit, then `.10.3.3.1.1` activation remain.
