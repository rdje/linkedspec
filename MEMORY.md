...
- blockers: NONE PNT-eligible-blocking. in_flight_uncommitted: none after `.4.4.1` commit; known unrelated local paths `rgx` and `.claude/projects/` must remain unstaged.
