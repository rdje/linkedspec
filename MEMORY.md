...
- latest_commit: `89e2071` — `SPEC-FORMAT-TERSE.1.2.3.3.2 — implement scalar mutation-slot bare reads`. Ahead of origin remains below push threshold ~300; do NOT push mid-PNT.
