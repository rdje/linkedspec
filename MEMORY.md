...
- latest_commit: `cc83581` — "MDBOOK-FORMAT-CORRECTNESS.2 — fix lifecycle-nesting in formal-grammar §8.1/§12; full-book format sweep" (the `.3` commit lands on top; ahead of origin: ~128; push at 300)
...
- in_flight_uncommitted: `.3` (task-file/TASK_TREE/DEVELOPMENT_NOTES/CHANGES close-out) staged for the `MDBOOK-FORMAT-CORRECTNESS.3` commit (committing now).
