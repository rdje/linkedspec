...
- latest_commit: `4b944ef` — `SPEC-FORMAT-TERSE.1.2.3.3 — split scalar bare reads by lowering seam`. Ahead of origin remains below push threshold ~300; do NOT push mid-PNT.
