...
- latest_commit: `98aa78a` — "SPEC-SPEC-SELFHOST.4 — docs sync + finalize; close the self-hosting rewrite tree"   (ahead of origin: ~123; push at 300)
...
- in_flight_uncommitted: none (`SPEC-SPEC-SELFHOST.4` committed `98aa78a`, tree closed; this hash-sync bumps the resume pointer).
