...
- 2026-05-17 (PHASE3-EXECUTION-SEMANTICS.2): Documented BACKTRACK/IBACKTRACK local cursor-rewind contract in source-boundary-helper-reference.md. 22-line subsection covers pos() rewinds, parent vs inner match distinction, local vs systemic backtracking, parse_mode interaction. PNT frontier: .3 (non-backtracking model statement).
