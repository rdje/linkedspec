...
- latest_commit: `5e93af3` — `SPEC-FORMAT-TERSE.1.4 — split into .1.4.1 (Perl reference) + .1.4.2 (Rust parity); record helper-rename lowering-site ground truth + KM card`. Prior: `5e9ef57` `.1.2.2`, `b77510a` `.1.2.1`. Ahead of origin ~53 — push threshold ~300; do NOT push mid-PNT.
