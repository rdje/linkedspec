...
LX   {assign(s(retv), capture_rest()); push_value(a(pieces), s(retv)); return(array_values(a(pieces)))}
...
-> get_pinport[1]  {return(a(flat_array(entry_groups()), array_values(a(pieces))))}
