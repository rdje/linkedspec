...
def build_outputs(upstream: Path) -> tuple[dict[str, object], str, str, str, str]:
...
def main() -> None:
    ...
    contract, perl_module, rust_module, dart_module, julia_module = build_outputs(args.upstream)
    ...
    print(
        ...
        f"{args.output}, {args.perl_output}, {args.rust_output}, {args.dart_output}, and {args.julia_output} "
