...
- Model scalar, array, harray/hash, and codeblock as the four portable value kinds. For callables whose signature
  ...
  boundary/mark-capture events at 129/129. Public status is `runtime-trace-events`; no-drift `.4.4.4` is active.
  Full frontend/compiler/function/staged propagation remains `.5.3`.
