...
is(
 ...
 'keeps every backend, recurring proof, and public projection current',
);
is(
 $contract->{task_owner},
...
is_deeply(
 ...
 [('complete') x 5],
 'keeps every private backend consumer complete',
);
is_deeply(
...
is_deeply(
 ...
 [('complete') x 9],
 'keeps every runtime, recurring proof, and public projection complete',
);
is_deeply(
