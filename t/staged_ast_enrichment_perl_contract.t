...
is(
 ...
 'keeps Perl, Rust, Dart, and Julia complete while Lua remains absent',
);
is(
 $contract->{task_owner},
...
is_deeply(
 ...
 [('complete') x 5, ('pending') x 4],
 'promotes neutral, Perl, Rust, Dart, and Julia rollout',
);
is_deeply(
