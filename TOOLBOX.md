...
- **OUTPUT:** 67 public files / 35 classified historical references / zero current examples, five exact ordered
...
- **OUTPUT:** 68 public files, 14 governed documents, eleven semantic example classes, ten stale claims rejected,
