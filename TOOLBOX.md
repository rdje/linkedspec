...
- **OUTPUT:** neutral governance reports 3 sources, 7 positions, 6 direct spans, 3 derived texts, 8+8+33 state
  ...
  33 diagnostics, 8 complete / 6 pending rollout, and 74 rejected drift mutations. The driver then reports each
...
- **RECURSIVE-OBSERVATION PREFLIGHT:** retrieve [[recursive-source-observation-audit]] before changing recursive
  ...
  tuple comparison. Perl `.14.4.2`, Rust `.14.4.3`, Dart `.14.4.4`, and Julia `.14.4.5` admit the exact observation
  surface through one dedicated private node per runtime, static policy, the existing monotonic authority, and
  their governed live/reconstructed/generated/emitted carriers; shared Lua remains pending.
